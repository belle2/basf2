...
void PedeSteering::command(const std::string& line)
{
...
void PedeSteering::fixParameters(const vector< int >& labels,
                                 const vector< double >& values,
                                 const vector< double >& presigmas)
{
  command("Parameters");
