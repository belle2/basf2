...
bool MillepedeCollectorModule::fitRecoTrack(RecoTrack& recoTrack, Particle* particle)
{
  ...
  std::vector<std::shared_ptr<VTXBaseMeasurementCreator>> vtxMeasurementCreators = { std::shared_ptr<VTXBaseMeasurementCreator>(new VTXCoordinateMeasurementCreator(genfitMeasurementFactory)) };
  ...
  factory.resetMeasurementCreators(pxdMeasurementCreators, svdMeasurementCreators, cdcMeasurementCreators, vtxMeasurementCreators,
...
tuple<B2Vector3D, TMatrixDSym> MillepedeCollectorModule::getPrimaryVertexAndCov()
{
