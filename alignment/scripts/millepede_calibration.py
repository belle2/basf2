...
def create(name,
    ...
    CollectionsList : list(namedtuple('MillepedeCollection', ['name', 'files', 'path', 'params']))
    ...
    ConstraintsList : list(alignment.Constraints)
    ...
    if ConstraintsList is None:
        ConstraintsList = []

    print("- Constraints:")
    consts = ConstraintsList
    if len(consts):
