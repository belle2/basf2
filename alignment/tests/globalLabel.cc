...
namespace Belle2 {
  ...
  {
    GlobalLabel vxdlabel1 = GlobalLabel::construct<VXDAlignment>(vxdSensor, paramid);
    GlobalLabel vxdlabel2(100422609);
    ...
    // cast operators
    EXPECT_EQ(100422609, (int)vxdlabel1);
    EXPECT_EQ(100422609, (unsigned int)vxdlabel1);
    ...
    EXPECT_EQ(100422609, (int)vxdlabel2);
    EXPECT_EQ(100422609, (unsigned int)vxdlabel2);

    // Assignment
    GlobalLabel other = GlobalLabel::construct<CDCAlignment>(cdcWire, 2);
    EXPECT_EQ(270620402, other.label());
    other = vxdlabel1;
    EXPECT_EQ(100422609, other.label());
  }
  ...
  TEST_F(GlobalLabelTest, QickTestNormalOperation)
  {
    ...
    EXPECT_EQ(100422609, vxdlabel.label());
    ...
    vxdlabel = GlobalLabel(100422609);
