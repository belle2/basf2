...
MassPointingVertexFitKFit::setInitialVertex(const HepPoint3D& v) {
  m_BeforeVertex = v;
...
enum KFitError::ECode
MassPointingVertexFitKFit::setInvariantMass(const double m) {
  m_InvariantMass = m;
...
enum KFitError::ECode
MassPointingVertexFitKFit::setProductionVertex(const HepPoint3D& v) {
...
enum KFitError::ECode
MassPointingVertexFitKFit::setCorrelation(const HepMatrix& m) {
...
const HepPoint3D
MassPointingVertexFitKFit::getVertex(const int flag) const
{
...
const HepMatrix
MassPointingVertexFitKFit::getTrackVertexError(const int id) const
{
...
double
MassPointingVertexFitKFit::getTrackCHIsq(const int id) const
{
...
const HepMatrix
MassPointingVertexFitKFit::getCorrelation(const int id1, const int id2, const int flag) const
{
...
enum KFitError::ECode MassPointingVertexFitKFit::updateMother(Particle* mother)
{
  MakeMotherKFit kmm;
