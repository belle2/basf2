...
\abstract{
We summarize the Belle 2 analysis software design decisions and discuss use cases.
}
...
\input{AnalysisModules/B2AS-DecayChainVertexFitter}
...
\input{UtilityTools/B2AS-DecayDescriptor.tex}
\input{UtilityTools/B2AS-NtupleTools.tex}

\section{Overview of analysis software designs of other HEP experiments}
\input{OtherExperiments/B2AS-ATLAS-LHCb}
\input{OtherExperiments/B2AS-BABAR-SUPERB}
