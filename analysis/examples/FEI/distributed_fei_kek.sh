...
function run_basf2 {
  ...
  basf2 $steeringFile --dump-path basf2_path.pickle -i "$persistentDirectory"/1/basf2_input.root -- --verbose --nThreads 20 --cache cache.pkl --externTeacher externClusterTeacher || return 1
  cd - > /dev/null
}
