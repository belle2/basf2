...
DVars = ['daughterProductOf(getExtraInfo(SignalProbability))', 'p', 'pt', 'p_CMS', 'pt_CMS']
BVars = ['daughterProductOf(getExtraInfo(SignalProbability))', 'p', 'pt', 'p_CMS', 'pt_CMS']
method = ('FastBDT', 'Plugin', '!H:CreateMVAPdfs:!V:NTrees=400:Shrinkage=0.10:RandRatio=0.5:NCutLevel=8:NTreeLayers=3')

particles = []

# Add FSP
#particles.append( Particle('gamma', ['p','pt','p_CMS','pt_CMS'], method))
#particles.append( Particle('pi0', ['p','pt','p_CMS','pt_CMS'], method))
