...
export OUTPUT_PATH="/group/belle2/group/physics/TDCPV/TFlaT_Belle/Test_Submission/" # Path where to store the output
...
export BELLE2_LOCAL_DIR=/home/belle2/drodermu/TFLaT/basf2
