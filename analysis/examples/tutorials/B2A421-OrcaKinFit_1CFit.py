...
from groups_of_varuables import event_variables, kinematic_variables, cluster_variables,\
    track_variables, mc_variables, pid_variables, \
    convert_to_daughter_vars, convert_to_gd_vars, \
    flight_info, mc_flight_info, vertex, mc_vertex, tag_vertex, mc_tag_vertex,\
    make_mc, momentum_uncertainty

from modularAnalysis import variablesToNTuple
rootOutputFile = 'B2A421-Orcakinfit_1CFit.root'
...
variablesToNTuple(filename=rootOutputFile,
                  ...
                  ['extraInfo(OrcaKinFitProb)', 'extraInfo(OrcaKinFitChi2)',
                   'extraInfo(OrcaKinFitErrorCode)', 'extraInfo(OrcaKinFitUnmeasuredTheta)',
                   'extraInfo(OrcaKinFitUnmeasuredPhi)', 'extraInfo(OrcaKinFitUnmeasuredE)'] +
                  event_variables + kinematic_variables + make_mc(kinematic_variables) + mc_variables +
                  convert_to_daughter_vars(kinematic_variables + mc_variables +
                                           momentum_uncertainty + make_mc(kinematic_variables), 0) +
                  convert_to_daughter_vars(kinematic_variables + mc_variables +
