...
mugvars = kinematics + mc_truth + vc.mc_vc.kinematics + momentum_uncertainty
z0vars = event_meta_data + inv_mass + kinematics + vc.mc_vc.kinematics + mc_truth + \
    convert_to_all_selected_vars(mugvars, 'Z0 -> ^gamma ^mu+ ^mu-')
