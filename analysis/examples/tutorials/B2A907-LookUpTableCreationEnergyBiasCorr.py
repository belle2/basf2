...
weightsDB = '/nfs/dust/belle2/user/kovalch/energyBiasCorrFiles/gammaEweightsDB.txt'
...
addtable.param('tableName', "BiasCorrection:TestEnergy")
...
addtable2.param('tableName', "BiasCorrection:TestEnergy2")
