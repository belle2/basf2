...
def appendBTools(toolsList, decayString):
    ...
    # B info
    toolsList += \
        ['CustomFloats[extraInfo(decayModeID):isSignal:abs(daughter(0,genMotherPDG))]'
         , decayString]
...
def appendBDTools(toolsList, decayString):
    ...
    # D info
    toolsList += \
        ['CustomFloats[daughter(0,extraInfo(decayModeID)):daughter(0,isSignal):abs(daughter(0,genMotherPDG))]'
         , decayString]
...
def appendBDSTTools(toolsList, decayString):
    ...
    # DST info
    toolsList += \
        ['CustomFloats[daughter(0,extraInfo(decayModeID)):daughter(0,isSignal)]'
         , decayString]
    # D info
    toolsList += \
        ['CustomFloats[daughter(0,daughter(0,extraInfo(decayModeID))):daughter(0,daughter(0,isSignal)):abs(daughter(0,genMotherPDG))]'
         , decayString]
