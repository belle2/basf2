...
def reconstructB0DMYPS0(q):  # reconstruct B0 -> D- Y+(S=0) decays
    ...
    reconstructDecay('B0:5  -> D-:all pi+:all pi-:all pi0:all pi0:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 5)
    ...
    reconstructDecay('B0:10 -> D-:all pi+:all pi-:all pi+:all pi-:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 10)
    ...
    reconstructDecay('B0:13 -> D-:all pi+:all pi0:all pi0:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 13)
    reconstructDecay('B0:14 -> D-:all pi+:all K_S0:all K_S0:all',
                     'Mbc>5.24 and -0.1 < deltaE < 0.1', 14)
    reconstructDecay('B0:15 -> D-:all pi+:all pi-:all K_S0:all K_S0:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 15)
    mmin = 1
    mmax = 15

    if q == 1:
        # rest of decay modes (less frequent)
        reconstructDecay('B0:16 -> D-:all pi+:all K+:all K-:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 16)
        mmax = 16
...
def reconstructB0DMYPS1(q):  # reconstruct B0 -> D- Y+(S=1) decays
    ...
    reconstructDecay('B0:19 -> D-:all pi+:all pi+:all pi-:all pi0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 19)
    mmin = 17
    mmax = 19
    ...
    if q == 1:
        ...
        reconstructDecay('B0:25 -> D-:all pi+:all pi+:all pi-:all pi-:all K+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 25)
        reconstructDecay('B0:26 -> D-:all pi+:all pi+:all pi-:all K_S0:all',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 26)
        reconstructDecay('B0:27 -> D-:all pi+:all K+:all K-:all pi0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 27)
        reconstructDecay('B0:28 -> D-:all pi+:all pi-:all K+:all K+:all K-:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 28)
        reconstructDecay('B0:29 -> D-:all pi+:all K+:all K-:all K_S0:all',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 29)
        reconstructDecay('B0:30 -> D-:all pi-:all K+:all K+:all pi0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 30)
        reconstructDecay('B0:31 -> D-:all pi+:all pi-:all K+:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 31)
        ...
        reconstructDecay('B0:35 -> D-:all K+:all K+:all K-:all pi0:all pi0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 35)
        ...
        reconstructDecay('B0:38 -> D-:all K+:all pi0:all pi0:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 38)
        reconstructDecay('B0:39 -> D-:all K+:all K_S0:all K_S0:all',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 39)
        reconstructDecay('B0:40 -> D-:all K+:all K+:all K-:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 40)
        mmax = 40
...
def reconstructB0DSTMYPS0(q):  # reconstruct B0 -> D*- Y+(S=0) decays
    ...
    reconstructDecay('B0:46  -> D*-:all pi+:all pi-:all pi0:all pi0:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 46)
    reconstructDecay('B0:47  -> D*-:all pi+:all pi-:all pi+:all pi-:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 47)
    reconstructDecay('B0:48  -> D*-:all pi+:all K+:all K-:all pi0:all',
                     'Mbc>5.24 and -0.1 < deltaE < 0.1', 48)
    reconstructDecay('B0:49  -> D*-:all pi+:all K+:all K-:all pi0:all pi0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 49)
    reconstructDecay('B0:50  -> D*-:all K+:all K-:all pi+:all',
                     'Mbc>5.24 and -0.1 < deltaE < 0.1', 50)
    reconstructDecay('B0:51  -> D*-:all pi+:all pi-:all K+:all K-:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 51)
    reconstructDecay('B0:52  -> D*-:all pi+:all K_S0:all K_S0:all pi0:all',
                     'Mbc>5.24 and -0.1 < deltaE < 0.1', 52)
    reconstructDecay('B0:53  -> D*-:all pi+:all pi0:all pi0:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 53)
    reconstructDecay('B0:54  -> D*-:all pi+:all K_S0:all K_S0:all',
                     'Mbc>5.24 and -0.1 < deltaE < 0.1', 54)
    reconstructDecay('B0:55  -> D*-:all pi+:all pi-:all K_S0:all K_S0:all pi+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 55)
    mmin = 41
    mmax = 55

    if q == 1:
        # rest of decay modes (less frequent)
        reconstructDecay('B0:56  -> D*-:all pi+:all K+:all K-:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 56)
        mmax = 56
...
def reconstructB0DSTMYPS1(q):  # reconstruct B0 -> D*- Y+(S=1) decays
    ...
    reconstructDecay('B0:58 -> D*-:all pi+:all pi+:all pi-:all pi0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 58)
    ...
    if q == 1:
        ...
        reconstructDecay('B0:65 -> D*-:all pi+:all K+:all K-:all pi0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 65)
        reconstructDecay('B0:66 -> D*-:all pi+:all pi+:all pi-:all K_S0:all',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 66)
        reconstructDecay('B0:67 -> D*-:all pi+:all pi+:all pi-:all pi-:all K+:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 67)
        reconstructDecay('B0:68 -> D*-:all pi+:all pi-:all K+:all K+:all K-:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 68)
        reconstructDecay('B0:69 -> D*-:all pi+:all K+:all K-:all K_S0:all',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 69)
        reconstructDecay('B0:70 -> D*-:all pi-:all K+:all K+:all pi0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 70)
        reconstructDecay('B0:71 -> D*-:all K+:all K+:all K-:all pi0:all ',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 71)
        reconstructDecay('B0:72 -> D*-:all pi+:all pi-:all K+:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 72)
        reconstructDecay('B0:73 -> D*-:all K+:all K+:all K-:all pi0:all pi0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 73)
        ...
        reconstructDecay('B0:78 -> D*-:all K+:all pi0:all pi0:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 78)
        reconstructDecay('B0:79 -> D*-:all K+:all K_S0:all K_S0:all',
                         'Mbc>5.24 and -0.1 < deltaE < 0.1', 79)
        reconstructDecay('B0:80 -> D*-:all K+:all K+:all K-:all K_S0:all K_S0:all', 'Mbc>5.24 and -0.1 < deltaE < 0.1', 80)
        mmax = 80
