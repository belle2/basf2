...
#               M. Lubej (November 2014)
#               A. Polsak (November 2014)
#
######################################################
...
def reconstructDSTP():  # reconstruct D*+ decays
    # decay modes in Full Event Interpretation Report (2014)
    reconstructDecay('D*+:1 -> D0:gen pi+:all', 'massDifference(0) < 0.16', 1)
    reconstructDecay('D*+:2 -> D+:gen pi0:all', 'massDifference(0) < 0.16', 2)
    reconstructDecay('D*+:3 -> D+:gen gamma:all', 'massDifference(0) < 0.16',
                     3)
    mmin = 1
    mmax = 3
...
def reconstructDST0():  # reconstruct D*0 decays
    # decay modes in Full Event Interpretation Report (2014)
    reconstructDecay('D*0:1 -> D0:gen pi0:all', 'massDifference(0) < 0.16', 1)
    reconstructDecay('D*0:2 -> D0:gen gamma:all', 'massDifference(0) < 0.16',
                     2)
    mmin = 1
    mmax = 2
