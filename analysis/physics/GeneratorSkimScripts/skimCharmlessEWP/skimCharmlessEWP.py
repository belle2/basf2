...
# Select EWP (two leptons in the final state - hasNDaughtersWithPDG(PDG,N,Sign))
cutAndCopyList(
    'B+:charmlessEWP',
    'B+:charmless',
    'hasNDaughtersWithPDG(11,2,1) > 0.5 or hasNDaughtersWithPDG(13,2,1) > 0.5 or hasNDaughtersWithPDG(15,2,1) > 0.5')
cutAndCopyList(
    'B0:charmlessEWP',
    'B0:charmless',
    'hasNDaughtersWithPDG(11,2,1) > 0.5 or hasNDaughtersWithPDG(13,2,1) > 0.5 or hasNDaughtersWithPDG(15,2,1) > 0.5')
...
skim.param('particleLists', ['B+:charmlessEWP', 'B0:charmlessEWP'])
