...
// This file is intened for for anybody continuing the work on Rave integration into basf2. It shows how to do mass constrained fits of basf2 objects with Rave.
...
//      void addMother( Particle* aMotherParticlePtr);
//
...
//
//      Particle* m_motherParticlePtr; /**< pointer to the mother particle who's  daughters will be used in the fit. the fit result will be written back to the mother particle*/
