...
variables.addAlias('B00_mcX', 'daughter(0, mcX)')
variables.addAlias('B00_mcY', 'daughter(0, mcY)')
variables.addAlias('B00_mcZ', 'daughter(0, mcZ)')
...
variables.addAlias('B00_daughter0_mcX', 'daughter(0, daughter(0, mcX))')
variables.addAlias('B00_daughter0_mcY', 'daughter(0, daughter(0, mcY))')
variables.addAlias('B00_daughter0_mcZ', 'daughter(0, daughter(0, mcZ))')
...
variables.addAlias('B00_daughter1_mcX', 'daughter(0, daughter(1, mcX))')
variables.addAlias('B00_daughter1_mcY', 'daughter(0, daughter(1, mcY))')
variables.addAlias('B00_daughter1_mcZ', 'daughter(0, daughter(1, mcZ))')
...
variables.addAlias('B01_mcX', 'daughter(1, mcX)')
variables.addAlias('B01_mcY', 'daughter(1, mcY)')
variables.addAlias('B01_mcZ', 'daughter(1, mcZ)')
...
variables.addAlias('B01_daughter0_mcX', 'daughter(1, daughter(0, mcX))')
variables.addAlias('B01_daughter0_mcY', 'daughter(1, daughter(0, mcY))')
variables.addAlias('B01_daughter0_mcZ', 'daughter(1, daughter(0, mcZ))')
...
variables.addAlias('B01_daughter1_mcX', 'daughter(1, daughter(1, mcX))')
variables.addAlias('B01_daughter1_mcY', 'daughter(1, daughter(1, mcY))')
variables.addAlias('B01_daughter1_mcZ', 'daughter(1, daughter(1, mcZ))')
