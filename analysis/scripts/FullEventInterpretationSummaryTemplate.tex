...
\includegraphics[width=0.8\textwidth]{nordbert.svg}
...
\toprule
Particle &  \multicolumn{3}{c}{Efficiency in \%}  &  \multicolumn{3}{c}{Purity in \%} \\
         &  detector & pre-cut & post-cut   &  detector & pre-cut & post-cut \\
\midrule
