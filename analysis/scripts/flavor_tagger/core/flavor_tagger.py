...
def flavor_tagger(
    ...
    config_filepath = os.path.join(os.path.dirname(__file__), '..', 'statics/config.yaml')
    ...
    # sanitise and cross check inputs
    ...
    if len(combinerMethods) == 0:
        B2FATAL('Flavor Tagger: Please specify atleast one combinerMethods.\
