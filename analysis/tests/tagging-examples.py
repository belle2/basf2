...
class TutorialsTest(unittest.TestCase):
    """Test to run all tagging examples."""

    #: list of the broken tutorials (to be removed when they are individually fixed)
    broken_tutorials = ['BtagBsigReconstruction.py',  # BII-4281
    ...
    def test_tutorials(self):
        ...
        """
        all_tutorials = sorted(glob.glob(find_file('analysis/examples/tagging/') + "*.py"))
