...
class TestLoadListCountsDictionary(unittest.TestCase):
    ...
    def test_loadListCountsDictionary(self):
        ...
        self.assertEqual(df['pi0:90786ffc748ea3b11ae9dab84cbe4fbeb49443d9_All'].sum(), 38810803.0)
        self.assertEqual(df['pi0:90786ffc748ea3b11ae9dab84cbe4fbeb49443d9_Signal'].sum(), 3291243.0)
        self.assertEqual(df['pi0:90786ffc748ea3b11ae9dab84cbe4fbeb49443d9_Background'].sum(), 38013838.0)
        ...
        self.assertEqual(df['D0:aa6a0fae9aaf8cdcefb8e22ff96c4c8d62ecb6b3_All'].sum(), 1971459.0)
        self.assertEqual(df['D0:aa6a0fae9aaf8cdcefb8e22ff96c4c8d62ecb6b3_Signal'].sum(), 49857.0)
        self.assertEqual(df['D0:aa6a0fae9aaf8cdcefb8e22ff96c4c8d62ecb6b3_Background'].sum(), 1921619.0)
