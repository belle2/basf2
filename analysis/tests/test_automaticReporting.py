...
class TestLoadMCCountsDictionary(unittest.TestCase):
    ...
    def test_loadMCCountsDictionary(self):
        ...
        # }
        self.assertEqual(df['211'].sum(), 791.0)
        self.assertEqual(df['321'].sum(), 161.0)
        self.assertEqual(df['22'].sum(), 1134.0)
        self.assertEqual(df['111'].sum(), 479.0)
        self.assertEqual(df['421'].sum(), 181.0)
        self.assertEqual(df['411'].sum(), 26.0)
        self.assertEqual(df['413'].sum(), 25.0)
...
class TestLoadListCountsDictionary(unittest.TestCase):
    ...
    def test_loadListCountsDictionary(self):
        ...
        #   cout << h.Integral() << endl;
        # }
        self.assertEqual(df['pi+:9c603352f1c7f8cde7437866da4fc795b72c9467_All'].sum(), 954.0)
        self.assertEqual(df['pi+:9c603352f1c7f8cde7437866da4fc795b72c9467_Signal'].sum(), 670.0)
        self.assertEqual(df['pi+:9c603352f1c7f8cde7437866da4fc795b72c9467_Background'].sum(), 284.0)
        self.assertEqual(df['K+:cbc5cbc816a18f1d5658701bc3322ff9c9791c99_All'].sum(), 954.0)
        self.assertEqual(df['K+:cbc5cbc816a18f1d5658701bc3322ff9c9791c99_Signal'].sum(), 130.0)
        self.assertEqual(df['K+:cbc5cbc816a18f1d5658701bc3322ff9c9791c99_Background'].sum(), 824.0)
        self.assertEqual(df['gamma:baf4804bf3e3d401ed05cc469497b0fe83377d24_All'].sum(), 1830.0)
        self.assertEqual(df['gamma:baf4804bf3e3d401ed05cc469497b0fe83377d24_Signal'].sum(), 1002.0)
        self.assertEqual(df['gamma:baf4804bf3e3d401ed05cc469497b0fe83377d24_Background'].sum(), 828.0)
        self.assertEqual(df['pi0:90786ffc748ea3b11ae9dab84cbe4fbeb49443d9_All'].sum(), 6009.0)
        self.assertEqual(df['pi0:90786ffc748ea3b11ae9dab84cbe4fbeb49443d9_Signal'].sum(), 341.0)
        self.assertEqual(df['pi0:90786ffc748ea3b11ae9dab84cbe4fbeb49443d9_Background'].sum(), 5668.0)
        self.assertEqual(df['D0:3a61b0b85d0bf1497c5bfed8ab2dc66c957dffc3_All'].sum(), 23.0)
        self.assertEqual(df['D0:3a61b0b85d0bf1497c5bfed8ab2dc66c957dffc3_Signal'].sum(), 4.0)
        self.assertEqual(df['D0:3a61b0b85d0bf1497c5bfed8ab2dc66c957dffc3_Background'].sum(), 19.0)
        self.assertEqual(df['D0:aa6a0fae9aaf8cdcefb8e22ff96c4c8d62ecb6b3_All'].sum(), 231.0)
        self.assertEqual(df['D0:aa6a0fae9aaf8cdcefb8e22ff96c4c8d62ecb6b3_Signal'].sum(), 3.0)
        self.assertEqual(df['D0:aa6a0fae9aaf8cdcefb8e22ff96c4c8d62ecb6b3_Background'].sum(), 228.0)
        self.assertEqual(df['D0:90a21bf28c01481c3dd3d8847ebacff6ec7e8bbf_All'].sum(), 4.0)
        self.assertEqual(df['D0:90a21bf28c01481c3dd3d8847ebacff6ec7e8bbf_Signal'].sum(), 1.0)
        self.assertEqual(df['D0:90a21bf28c01481c3dd3d8847ebacff6ec7e8bbf_Background'].sum(), 3.0)
        self.assertEqual(df['D0:c756a1fdbbe75673bf78b71a90e726a11202a50e_All'].sum(), 2.0)
        self.assertEqual(df['D0:c756a1fdbbe75673bf78b71a90e726a11202a50e_Signal'].sum(), 0.0)
        self.assertEqual(df['D0:c756a1fdbbe75673bf78b71a90e726a11202a50e_Background'].sum(), 2.0)
        self.assertEqual(df['D+:5144c31f84e6c83c673259778908aad82b62844b_All'].sum(), 45.0)
        self.assertEqual(df['D+:5144c31f84e6c83c673259778908aad82b62844b_Signal'].sum(), 0.0)
        self.assertEqual(df['D+:5144c31f84e6c83c673259778908aad82b62844b_Background'].sum(), 45.0)
        self.assertEqual(df['D*+:b30dfc431cd31b7ffed733dceb0f7f0cb5642d35_All'].sum(), 5.0)
        self.assertEqual(df['D*+:b30dfc431cd31b7ffed733dceb0f7f0cb5642d35_Signal'].sum(), 0.0)
        self.assertEqual(df['D*+:b30dfc431cd31b7ffed733dceb0f7f0cb5642d35_Background'].sum(), 5.0)
