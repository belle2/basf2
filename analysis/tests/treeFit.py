...
class TestTreeFits(unittest.TestCase):
    ...
    def testFit(self):
        ...
        self.assertTrue(truePositives > 34, f"Signal rejection too high. True positives: {truePositives}")

        self.assertTrue(falsePositives < 2353, f"Background rejection got worse. False positives: {falsePositives}")
