...
class TestTreeFits(unittest.TestCase):
    ...
    def testFit(self):
        ...
        conf = 0
        vertex.treeFit(list_name='B0:rec',
                       conf_level=conf,
                       massConstraint=['D0', 111],
                       path=main)
        ...
        self.assertTrue(falsePositives < 1220, f"Too many false positives: {falsePositives} out of {allBkg} total bkg events.")

        self.assertTrue(truePositives > 67, "Signal rejection too high")
