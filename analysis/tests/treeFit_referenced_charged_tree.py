...
class TestTreeFits(unittest.TestCase):
    ...
    def testFit(self):
        ...
        self.assertTrue(falsePositives < 401, f"Background rejection {falsePositives} out of {allBkg}")

        self.assertTrue(truePositives > 49, f"Signal rejection too high {truePositives} out of {allSig}")
