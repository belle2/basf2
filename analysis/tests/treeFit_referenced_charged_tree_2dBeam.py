...
class TestTreeFits(unittest.TestCase):
    ...
    def testFit(self):
        ...
        self.assertTrue(falsePositives < 1442, f"Background rejection {falsePositives} out of {allBkg}")

        self.assertTrue(truePositives > 150, f"Signal rejection too high {truePositives} out of {allSig}")
