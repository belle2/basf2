...
class TestTreeFits(unittest.TestCase):
    ...
    def testFit(self):
        ...
        self.assertTrue(falsePositives < 419, f"Background rejection {falsePositives} out of {allBkg}")

        self.assertTrue(truePositives > 41, f"Signal rejection too high {truePositives} out of {allSig}")
