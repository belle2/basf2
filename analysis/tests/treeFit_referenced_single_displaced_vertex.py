...
class TestTreeFits(unittest.TestCase):
    ...
    def testFit(self):
        ...
        self.assertTrue(falsePositives < 2361, f"Too many false positives: {falsePositives} out of {allBkg} total bkg events.")

        self.assertTrue(truePositives > 528, "Signal rejection too high")
