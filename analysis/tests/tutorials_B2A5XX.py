...
class TutorialsTest(unittest.TestCase):
    """Test to run all B2A5XX tutorials. Will fail if no tutorial directory is found."""
    ...
    def test_tutorials(self):
        ...
        all_tutorials = sorted(glob.glob(find_file('analysis/examples/tutorials/') + "/B2A5*.py"))
