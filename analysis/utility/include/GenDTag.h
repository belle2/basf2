...
namespace Belle2 {
  ...
  public:
    ...
    int Mode_Dst_plus(const std::vector<int>& genDAU); /**< returns D*+ mode identifier */
    int Mode_Dst_minus(const std::vector<int>& genDAU); /**< returns D*- mode identifier */
    int Mode_Ds_plus(const std::vector<int>& genDAU); /**< returns Ds+ mode identifier */
    int Mode_Ds_minus(const std::vector<int>& genDAU); /**< returns Ds- mode identifier */
    int Mode_D_plus(const std::vector<int>& genDAU); /**< returns D+ mode identifier */
    int Mode_D_minus(const std::vector<int>& genDAU); /**< returns D- mode identifier */
    int Mode_D0(const std::vector<int>& genDAU); /**< returns D0 mode identifier */
    int Mode_anti_D0(const std::vector<int>& genDAU); /**< returns D0bar mode identifier */
