...
namespace Belle2 {
  ...
  struct MCMatching {
    ...
    /**
     * Count the number of missing daughter of the 'particles' and set these numbers to extraInfo
     */
    static void countMissingParticle(const Belle2::Particle* particle, const Belle2::MCParticle* mcParticle);
