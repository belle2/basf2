...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2)
{
  int ndau = gp.size();
...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2, int da3)
{
  int ndau = gp.size();
...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2, int da3, int da4)
{
  int ndau = gp.size();
...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2, int da3, int da4, int da5)
{
  int ndau = gp.size();
...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2, int da3, int da4, int da5, int da6)
{
  int ndau = gp.size();
...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2, int da3, int da4, int da5, int da6, int da7)
{
  int ndau = gp.size();
...
bool GenBplusTag::PcheckDecay(const std::vector<int>& gp, int da1, int da2, int da3, int da4, int da5, int da6, int da7, int da8)
{
  int ndau = gp.size();
...
int GenBplusTag::Mode_B_plus(const std::vector<int>& genpart)
{
...
int GenBplusTag::Mode_B_minus(const std::vector<int>& genpart)
{
  if (GenBplusTag::PcheckDecay(genpart, 423, 11, -12)) {
    return -1 * (100000 * m_nPhotos + 1001);
