...
<header>
  ...
  <contact>Mario Merola (mario.merola@na.infn.it), Andrea Selce (selce@roma1.infn.it)</contact>
  <description>
...
create_validation_histograms(
    ...
    variables_1d=[
        (
            ...
            "Mario Merola <mario.merola@desy.de>; Andrea Selce <selce@roma1.infn.it>",
...
validation_metadata_update(
    ...
    contact="mario.merola@na.infn.it, selce@roma1.infn.it",
