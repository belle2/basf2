...
if len(sys.argv) != 2:
    sys.exit('Not enough arguments: [output file name]'
             )
...
reconstructDecay('D0:kk -> K-:95eff K+:95eff', '1.8<InvM<1.9')
reconstructDecay('D0:pipi -> pi+:95eff pi-:95eff', '1.8<InvM<1.9')
reconstructDecay('D0:kspipi -> K_S0:all pi+:95eff pi-:95eff', '1.8<InvM<1.9')

copyLists('D0:all', ['D0:kpi', 'D0:kpipi0', 'D0:k3pi', 'D0:kk', 'D0:pipi', 'D0:kspipi'])
...
reconstructDecay('D+:k2pipi0 -> K-:95eff pi+:95eff pi+:95eff pi0:looseFit', '1.8<InvM<1.9')
reconstructDecay('D+:ks3pi -> K_S0:all pi+:95eff pi-:95eff pi+:95eff', '1.8<InvM<1.9')
copyLists('D+:all', ['D+:kpipi', 'D+:kspi', 'D+:kspipi0', 'D+:k2pipi0', 'D+:ks3pi', 'D+:ksk'])
...
reconstructDecay('Upsilon(4S):BhadBsig+ -> B+:generic B-:all', '')
reconstructDecay('Upsilon(4S):BslBsig+ -> B+:semileptonic B-:all', '')
...
tools4SBplusHad += ['CustomFloats[R2:cosTBTO:cosTBz]', 'Upsilon(4S) -> ^B+:generic B-:all']
tools4SBplusHad += ['CustomFloats[sigProb:rank]', 'Upsilon(4S) -> ^B+:generic B-:all']
tools4SBplusHad += ['CustomFloats[d0_costheta: d0_d0_costheta:d0_costhetaCMS: d0_d0_costhetaCMS: d0_d1_costhetaCMS:
                                  d0_d1_d0_costhetaCMS:
                                  d0_d1_d1_costhetaCMS]',
                    'Upsilon(4S) ->  B +:generic ^ B-:all']
tools4SBplusHad += ['CustomFloats[d0_d0_E:d0_d1_E]', 'Upsilon(4S) ->  B+:generic ^B-:all']
tools4SBplusHad += ['CustomFloats[d0_M:d0_d0_M:d0_d1_M]', 'Upsilon(4S) ->  ^B+:generic ^B-:all']
...
tools4SBplusHad += ['CustomFloats[d0_mcPDG:d1_mcPDG:d1_d0_mcPDG:d1_d0_d0_mcPDG:d1_d0_d1_mcPDG]',
                    '^Upsilon(4S) ->  B+:generic B-:all']
tools4SBplusHad += ['CustomFloats[dmID:d0_dmID:d1_dmID:d0_d0_dmID:d0_d1_dmID:d1_d0_dmID]', 'Upsilon(4S) ->  ^B+:generic ^B-:all']
tools4SBplusHad += ['CustomFloats[isSignal:isExtendedSignal:isSignalAcceptMissingNeutrino]', 'Upsilon(4S) ->  ^B+:generic ^B-:all']
tools4SBplusHad += ['MCTruth', 'Upsilon(4S) ->  ^B+:generic ^B-:all']
...
tools4SBplusSL += ['CustomFloats[R2:cosTBTO:cosTBz]', 'Upsilon(4S) -> ^B+:semileptonic B-:all']
tools4SBplusSL += ['CustomFloats[sigProb:rank]', 'Upsilon(4S) -> ^B+:semileptonic B-:all']
tools4SBplusSL += ['CustomFloats[d0_costheta:d0_d0_costheta:d0_costhetaCMS:d0_d0_costhetaCMS:d0_d1_costhetaCMS:d0_d1_d0_costhetaCMS:
                                 d0_d1_d1_costhetaCMS]',
                   'Upsilon(4S) ->  B+:semileptonic ^B-:all']
tools4SBplusSL += ['CustomFloats[d0_d0_E:d0_d1_E]', 'Upsilon(4S) ->  B+:semileptonic ^B-:all']
tools4SBplusSL += ['CustomFloats[d0_M:d0_d0_M:d0_d1_M]', 'Upsilon(4S) ->  ^B+:semileptonic ^B-:all']
...
tools4SBplusSL += ['CustomFloats[dmID:d0_dmID:d1_dmID:d0_d0_dmID:d0_d1_dmID:d1_d0_dmID]',
                   'Upsilon(4S) ->  ^B+:semileptonic ^B-:alli']
tools4SBplusSL += ['CustomFloats[isSignal:isExtendedSignal:isSignalAcceptMissingNeutrino]',
                   'Upsilon(4S) ->  ^B+:semileptonic ^B-:all']
tools4SBplusSL += ['MCTruth', 'Upsilon(4S) ->  ^B+:semileptonic ^B-:all']
