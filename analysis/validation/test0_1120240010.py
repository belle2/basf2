#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Descriptor: [B0 -> K*0 e+ e-]cc

"""
<header>
  <output>../1120240010.dst.root</output>
...
evtgeninput.param('userDECFile', Belle2.FileSystem.findFile('/decfiles/dec/1120240010.dec'))
...
output_filename = "../1120240010.dst.root"
