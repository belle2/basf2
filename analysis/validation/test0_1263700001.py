...
"""
<header>
  <output>../1263700001.dst.root</output>
...
evtgeninput.param('userDECFile', Belle2.FileSystem.findFile('/decfiles/dec/1263700001.dec'))
...
output_filename = "../1263700001.dst.root"
