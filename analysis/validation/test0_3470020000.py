#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Descriptor: e+e- --> (tau+ --> mu+ nu_mu anti-nu_tau) (tau- --> eta' pi- nu_tau)

"""
<header>
  <output>../3470020000.dst.root</output>
...
kkgeninput.param('taudecaytableFile', './3470020000.dat')
...
add_mdst_output(main, filename='../3470020000.dst.root')
