...
tools4SB0Had += ['CustomFloats[d0_costheta:d0_d0_costheta:d0_costhetaCMS:d0_d0_costhetaCMS',
                 'Upsilon(4S) ->  B0:genericRank ^anti-B0:all']
tools4SB0Had += ['CustomFloats[d0_d1_costhetaCMS:d0_d1_d0_costhetaCMS:d0_d1_d1_costhetaCMS]',
                 'Upsilon(4S) ->  B0:genericRank ^anti-B0:all']
...
tools4SB0SL += ['CustomFloats[d0_costheta:d0_d0_costheta:d0_costhetaCMS:d0_d0_costhetaCMS]',
                'Upsilon(4S) ->  B0:semileptonic ^anti-B0:all']
tools4SB0SL += ['CustomFloats[d0_d1_costhetaCMS:d0_d1_d0_costhetaCMS:d0_d1_d1_costhetaCMS]',
                'Upsilon(4S) ->  B0:semileptonic ^anti-B0:all']
