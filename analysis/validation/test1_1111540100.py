...
tools += ['InvMass', '^B0 -> [^J/psi -> e+:Jp e-:Jp] [^K_S0 -> pi+ pi-]']
...
tools += ['DetectorStatsSim', 'B0 -> [J/psi -> ^e+ ^e-] [K_S0 -> ^pi+ ^pi-]']
tools += ['DetectorStatsRec', 'B0 -> [J/psi -> ^e+ ^e-] [K_S0 -> ^pi+ ^pi-]']
...
tools += ['CustomFloats[isSignal]', '^B0 -> [^J/psi -> e+ e-] [^K_S0 -> pi+ pi-]']
