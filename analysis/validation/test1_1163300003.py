...
# tau daughter PID
variables.addAlias('d1_d0_eid', 'daughter(1,daughter(0,electronID))')
variables.addAlias('d1_d0_muid', 'daughter(1,daughter(0,muonID))')
variables.addAlias('d1_d0_piid', 'daughter(1,daughter(0,pionID))')
variables.addAlias('d1_d0_Kid', 'daughter(1,daughter(0,kaonID))')


# D* daughter pion PID
variables.addAlias('d0_d1_eid', 'daughter(0,daughter(1,electronID))')
variables.addAlias('d0_d1_muid', 'daughter(0,daughter(1,muonID))')
variables.addAlias('d0_d1_piid', 'daughter(0,daughter(1,pionID))')
variables.addAlias('d0_d1_Kid', 'daughter(0,daughter(1,kaonID))')
