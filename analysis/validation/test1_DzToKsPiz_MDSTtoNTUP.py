...
"""
<header>
  <input>../DzToKzPiz_GENSIMRECtoMDST.mdst.root</input>
  <output>../DzToKsPiz_MDSTtoNTUP.root</output>
...
inputMdst('default', '../DzToKsPiz_GENSIMRECtoMDST.mdst.root')
...
ntupleFile('../DzToKsPiz_MDSTtoNTUP.root')
