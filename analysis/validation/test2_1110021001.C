...
void plot_validplots(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  h_mbc->GetListOfFunctions().Add(TNamed("MetaOptions", "pvalue-warn=0.7, pvalue-error=0.05"))
  ...
  h_mkpi->GetListOfFunctions().Add(TNamed("MetaOptions", "pvalue-warn=0.7, pvalue-error=0.05"))
  ...
  h_deltae->GetListOfFunctions().Add(TNamed("MetaOptions", "pvalue-warn=0.7, pvalue-error=0.05"))
  ...
  h_egam->GetListOfFunctions().Add(TNamed("MetaOptions", "pvalue-warn=0.7, pvalue-error=0.05"))
  ...
  h_eparentgam->GetListOfFunctions().Add(TNamed("MetaOptions", "pvalue-warn=0.7, pvalue-error=0.05"))
