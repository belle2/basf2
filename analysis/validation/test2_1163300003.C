...
void plotUpsHad(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  // General Info
  TH1F* h_Mbc = new TH1F("h_Mbc",title,100,5.22,5.29);
  ...
  TH1F* h_DeltaE = new TH1F("h_DeltaE",title,100,-0.50,0.50);
  ...
  TH1F* h_EExtra = new TH1F("h_EExtra",title,50,0,5);
  ...
  TH1F* h_SigProb = new TH1F("h_SigProb",title,50,0,1);
  ...
  TH1F* h_R2 = new TH1F("h_R2",title,50,0,1);
  ...
  TH1F* h_cosTBTO = new TH1F("h_cosTBTO",title,20,0,1);
  ...
  TH1F* h_missM2 = new TH1F("h_missM2",title,40,0,40);
  ...
  TH1F* h_missP = new TH1F("h_missP",title,40,0,4);
  ...
  outputFile->cd();
  TDirectory *dstartaunuHadDir =  outputFile->mkdir("UpsB0DstartaunuHad");
...
void plotUpsSL(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  h_SigProb->GetListOfFunctions()->Add(new TNamed("Check", "Consistent across versions"));
  h_SigProb->GetListOfFunctions()->Add(new TNamed("Contact", contact));
  TH1F * h_cosThetaBtag= new TH1F("h_cosThetaBtag",title, 100,-10,5);
  ...
  outputFile->cd();
  TDirectory *dstartaunuSLDir =  outputFile->mkdir("UpsB0DstartaunuSLTag");
