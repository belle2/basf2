...
void plot(TTree* ptree, TTree* pmctree, TFile *outputFile){
  ...
  gen_helK->GetListOfFunctions()->Add(new TNamed("Check", "'1-x^2'-like distribution, cut at ~0.8"));
  ...
  true_helK->GetListOfFunctions()->Add(new TNamed("Check", "'1-x^2'-like distribution, cut at ~0.8"));
  ...
  rec_helK->GetListOfFunctions()->Add(new TNamed("Check", "'1-x^2'-like distribution, cut at ~0.8"));
  ...
  gen_helR->GetListOfFunctions()->Add(new TNamed("Check", "'1-x^2'-like distribution"));
  ...
  true_helR->GetListOfFunctions()->Add(new TNamed("Check", "'1-x^2'-like distribution"));
  ...
  rec_helR->GetListOfFunctions()->Add(new TNamed("Check", "'1-x^2'-like distribution"));
