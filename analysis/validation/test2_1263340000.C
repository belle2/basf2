...
void plotUpsHad(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  ptree->Project("h_had_Mbc", "Upsilon4S_d1_Mbc");
  ...
  ptree->Project("h_had_DeltaE", "Upsilon4S_d1_deltaE");
  ...
  ptree->Project("h_had_SigProb", "Upsilon4S_B1_sigProb");
  ...
  ptree->Project("h_had_R2", "Upsilon4S_B1_R2");
...
//Different D decay modes
  ...
  ptree->Project("h_Dmass_Mode5", "Upsilon4S_d0_d0_d0_M","Upsilon4S_d_ID==5");
...
void plotDzero(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  ptree->Project("h_DmassNoCut_Mode1", "D0_M","D0_dmID==1");
