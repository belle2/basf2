...
void plotTrack(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  h_pi_d0 = new TH2F("h_pi_d0VSpt","d0 error vs transverse momentum",40,0,4,10,0,0.02);
  ...
  h_pi_z0 = new TH2F("h_pi_z0VSpt","z0 error vs transverse momentum",40,0,4,10,0,0.024);
