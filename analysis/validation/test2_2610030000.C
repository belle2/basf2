...
void plotTrack(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  h_pis_d0 = new TH2F("h_pis_d0VSpt","d0 error vs transverse momentum",10,0,0.5, 10,0,0.04);
  ...
  h_pi_d0 = new TH2F("h_pi_d0VSpt","d0 error vs transverse momentum",10,0,10.0, 10,0,0.04);
  ...
  h_k_d0 = new TH2F("h_k_d0VSpt","d0 error vs transverse momentum", 10,0,10., 10,0,0.04);
  ...
  h_pis_z0 = new TH2F("h_pis_z0VSpt","z0 error vs transverse momentum", 10,0,0.5,10,0,0.04);
  ...
  h_pi_z0 = new TH2F("h_pi_z0VSpt","z0 error vs transverse momentum", 10,0,10.0, 10,0,0.04);
  ...
  h_k_z0 = new TH2F("h_k_z0VSpt","z0 error vs transverse momentum",10,0,10., 10,0,0.04);
  ...
  h_pis_pVal = new TH1F("h_pis_pVal", "pVal slow pion", 25, 0 , 1 );
  ...
  h_pi_pVal = new TH1F("h_pi_pVal", "pVal D0 pion", 25, 0 , 1 );
  ...
  h_k_pVal = new TH1F("h_k_pVal", "pVal D0 kaon", 25, 0 , 1 );
