...
void plotTrack(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  h_pis_d0 = new TH2F("h_pis_d0VSpt","d0 error vs transverse momentum",20,0,0.5,10,0,0.1);
  ...
  h_pi_d0 = new TH2F("h_pi_d0VSpt","d0 error vs transverse momentum",40,0,4,10,0,0.1);
  ...
  h_k_d0 = new TH2F("h_k_d0VSpt","d0 error vs transverse momentum",40,0,4,10,0,0.1);
  ...
  h_pis_z0 = new TH2F("h_pis_z0VSpt","z0 error vs transverse momentum",20,0,0.5,10,0,0.1);
  ...
  h_pi_z0 = new TH2F("h_pi_z0VSpt","z0 error vs transverse momentum",40,0,4,10,0,0.1);
  ...
  h_k_z0 = new TH2F("h_k_z0VSpt","z0 error vs transverse momentum",40,0,4,10,0,0.1);
