...
void plotTime(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  TH1F* h_tres_all = new TH1F("h_tres_all", "D0 flight time resolution", 25,-ax, ax);
  ...
  TH1F* h_sigmat_all = new TH1F("h_sigmat_all", "D0 flight time error", 25,0, 0.5);
  ...
  TH1F* h_sig_all = new TH1F("h_sig_all", "D0 flight time significance", 25,0, 20);
...
void plotTrack(TFile* pfile, TTree* ptree, TFile *outputFile){
  ...
  TH2F* h_pis_d0 = new TH2F("h_pis_d0VSpt","d0 error vs transverse momentum",10,0,0.5, 10,0,0.04);
  ...
  TH2F* h_pi_d0 = new TH2F("h_pi_d0VSpt","d0 error vs transverse momentum",10,0,4, 10,0,0.03);
  ...
  TH2F* h_k_d0 = new TH2F("h_k_d0VSpt","d0 error vs transverse momentum", 10,0,4, 10,0,0.05);
  ...
  TH2F* h_pis_z0 = new TH2F("h_pis_z0VSpt","z0 error vs transverse momentum", 10,0,0.5,10,0,0.04);
  ...
  TH2F* h_pi_z0 = new TH2F("h_pi_z0VSpt","z0 error vs transverse momentum", 10,0,4, 10,0,0.03);
  ...
  TH2F* h_k_z0 = new TH2F("h_k_z0VSpt","z0 error vs transverse momentum",10,0,4,10,0,0.05);
  ...
  TH1F* h_pis_pVal = new TH1F("h_pis_pVal", "pVal slow pion", 25, 0 , 1 );
  ...
  TH1F* h_pi_pVal = new TH1F("h_pi_pVal", "pVal D0 pion", 25, 0 , 1 );
  ...
  TH1F* h_k_pVal = new TH1F("h_k_pVal", "pVal D0 kaon", 25, 0 , 1 );
