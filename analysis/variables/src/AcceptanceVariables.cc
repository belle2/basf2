...
The polar angle is computed using only the initial particle momentum.
    ...
    REGISTER_VARIABLE("ptInTOPAcceptance",   ptInTOPAcceptance,  "Returns true if particle transverse momentum :math:`p_t` is within TOP acceptance, :math:`p_t > 0.27` GeV, false otherwise.", Manager::VariableDataType::c_bool);
    REGISTER_VARIABLE("ptInBECLAcceptance",  ptInBECLAcceptance, "Returns true if particle transverse momentum :math:`p_t` is within Barrel ECL acceptance, :math:`p_t > 0.28` GeV, false otherwise.", Manager::VariableDataType::c_bool);
    REGISTER_VARIABLE("ptInBKLMAcceptance",  ptInBKLMAcceptance, "Returns true if particle transverse momentum :math:`p_t` is within Barrel KLM acceptance, :math:`p_t > 0.6` GeV, false otherwise.", Manager::VariableDataType::c_bool);
