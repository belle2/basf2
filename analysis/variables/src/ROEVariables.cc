...
namespace Belle2 {
  namespace Variable {
    ...
    REGISTER_METAVARIABLE("roeCharge(maskName)", ROE_Charge,
                          ...
                          "The unit of the charge is `` e `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("roeEextra(maskName)", ROE_ExtraEnergy,
                          ...
                          "The unit of the energy is `` GeV `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("roeM(maskName)", ROE_M,
                          ...
                          "The unit of the invariant mass is `` GeV/:math:`\\text{c}^2` `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("roeP(maskName)", ROE_P,
                          ...
                          "The unit of the momentum is `` GeV/c `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("roeMbc(maskName)", ROE_Mbc,
                          ...
                          "The unit of the beam constrained mass is `` GeV/:math:`\\text{c}^2` `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("weMissM2(maskName, opt)", WE_MissM2,
                          ...
                          "The unit of the invariant mass squared is `` :math:`[\\text{GeV}/\\text{c}^2]^2` `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("weMissPTheta(maskName, opt)", WE_MissPTheta,
                          ...
                          "The unit of the polar angle is `` rad `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("weMissP(maskName, opt)", WE_MissP,
                          ...
                          "The unit of the magnitude of missing momentum is `` GeV/c `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("weMissPx(maskName, opt)", WE_MissPx,
                          ...
                          "The unit of the missing momentum is `` GeV/c `` ", Manager::VariableDataType::c_double);
...
.. math::
    ...
    REGISTER_METAVARIABLE("weQ2lnuSimple(maskName,option)", WE_q2lnuSimple,
                      ...
                      "The unit of the momentum transfer squared is `` :math:`[\\text{GeV}/\\text{c}]^2` `` ", Manager::VariableDataType::c_double);
    ...
    REGISTER_METAVARIABLE("weMissM2OverMissE(maskName)", WE_MissM2OverMissE,
                      ...
                      "The unit of the missing mass squared `` :math:`[\\text{GeV}/\\text{c}^2]^2` `` ", Manager::VariableDataType::c_double);
