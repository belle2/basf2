...
namespace Belle2 {
  namespace Variable {
    ...
    REGISTER_VARIABLE("nVTXHits", trackNVTXHits,     "Number of VTX hits associated to the track");
    REGISTER_VARIABLE("nVXDHits", trackNVXDHits,     "Number of PXD, SVD and VTX hits associated to the track");
...
For mdst versions < 5.1, returns quiet_NaN().)DOC");
    ...
    REGISTER_VARIABLE("firstVTXLayer", trackFirstVTXLayer,     "First activated VTX layer associated to the track");
