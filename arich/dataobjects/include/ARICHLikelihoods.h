...
namespace Belle2 {
  ...
  public:
    ...
    ARICHLikelihoods(): m_flag(0), m_logL_e(0), m_logL_mu(0), m_logL_pi(0), m_logL_K(0),
    ...
    ARICHLikelihoods(int flag, double logL[5], int Nphot, double Nphot_expect[5]) {
      m_flag = flag;
      m_logL_e  = logL[0];
      m_logL_mu = logL[1];
      m_logL_pi = logL[2];
  ...
  private:
    ...
    ClassDef(ARICHLikelihoods, 1); /**< the class title */
