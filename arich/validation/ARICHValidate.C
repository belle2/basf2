...
void ARICHValidate(){
  ...
  heff->GetListOfFunctions()->Add(new TNamed("Check", "Continuous, >0.98 eff. for > 0.02 fake. NOTE: as this is not a usual histogram p-value 
calculation is not proper so it will often apear RED. If other two plots are OK please don't mind."));
