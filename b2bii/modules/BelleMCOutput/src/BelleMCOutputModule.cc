...
void BelleMCOutputModule::initialize()
{
  ...
  B2WARNING(
    ...
    "\n"
    "  1. Use global tag with smearing of beam parameters and generation "
    "flags: b2bii_beamParameters_with_smearing (there are no smearing data "
    "or generation flags in the tags B2BII or B2BII_MC).\n"
