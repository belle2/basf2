...
void BelleMCOutputModule::initialize()
{
  ...
  B2WARNING(
    ...
    "\n"
    "  1. Use global tag with smearing of beam parameters: "
    "b2bii_beamParameters_with_smearing (there are no smearing data in the "
    "tags B2BII or B2BII_MC).\n"
    "  2. Enable vertex and beam-momentum smearing by adding the module "
    "\"OverrideGenerationFlags\" before the generator.\n"
    "  3. Disable smearing in Belle simulation by removing the module "
