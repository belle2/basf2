//
// $Id: FixMdst_tof.cc 10002 2007-02-26 06:56:17Z katayama $
//
// $Log$
//
...
//===============================================================
  void FixMdstModule::shift_tof(const int mode)
  {
//===============================================================
...
//         double ocl=Tof.cl(im);                    //old cl
  ...
  void FixMdstModule::shift_tof_set(const int expno, const int runno,
