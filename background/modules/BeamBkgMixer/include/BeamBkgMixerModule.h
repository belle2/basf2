...
namespace Belle2 {
  ...
  private:
    ...
    struct BkgHits {
      ...
      TClonesArray* VTX; /**< VTX SimHits from collision file */
       ...
       */
      BkgHits():
        PXD(0), SVD(0), CDC(0), TOP(0), ARICH(0), ECL(0), BKLM(0), EKLM(0), VTX(0),
        BeamBackHits(0)
      {}
    };
                         ...
                         double timeShift, double minTime, double maxTime)
    {
      ...
      bool keep[] = {false, m_PXD, m_SVD, m_CDC, m_ARICH, m_TOP, m_ECL, m_KLM, m_KLM, m_VTX};
      if (!cloneArray) return;
    ...
    bool m_VTX = false; /**< true if found in m_components */
