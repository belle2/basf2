 ...
 */
void prepareSADsample(const std::string& inputFile = "", const std::string& outputFile = "",
		      double rangeS = 4, const std::string& ring = "LER", double d1 = -8.62e-3, double d2 = 9.35e-3)
{
