...
#ifndef NTUPLEPHASE1_V2MODULE_H
#define NTUPLEPHASE1_V2MODULE_H
...
namespace Belle2 {
   ...
   */
  class NtuplePhase1_v2Module : public Module {
  ...
  public:
     ...
     * Constructor
     */
    NtuplePhase1_v2Module();

    /**
     * Destructor
     */
    virtual ~NtuplePhase1_v2Module();
  ...
  private:
    ...
    std::vector<Double_t> m_input_LC_CSI_dose; /**< list of CSI LC dose */
    std::vector<Double_t> m_input_HC_CSI_dose; /**< list of CSI HC dose */
    std::vector<Double_t> m_input_LB_CSI_dose; /**< list of CSI LB dose */
    std::vector<Double_t> m_input_HB_CSI_dose; /**< list of CSI HB dose */

    std::vector<Double_t> m_input_LT_CSI_rate; /**< list of CSI LT rate */
    std::vector<Double_t> m_input_HT_CSI_rate; /**< list of CSI HT rate */
    std::vector<Double_t> m_input_LC_CSI_rate; /**< list of CSI LC rate */
    std::vector<Double_t> m_input_HC_CSI_rate; /**< list of CSI HC rate */
    std::vector<Double_t> m_input_LB_CSI_rate; /**< list of CSI LB rate */
    std::vector<Double_t> m_input_HB_CSI_rate; /**< list of CSI HB rate */
