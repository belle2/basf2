...
#ifndef NTUPLEPHASE1_V4MODULE_H
#define NTUPLEPHASE1_V4MODULE_H
...
namespace Belle2 {
   ...
   */
  class NtuplePhase1_v4Module : public Module {
  ...
  public:
     ...
     * Constructor
     */
    NtuplePhase1_v4Module();

    /**
     * Destructor
     */
    virtual ~NtuplePhase1_v4Module();
  ...
  private:
    ...
    TFile* m_file;        /**< TFile */
    BEAST_v3::BEASTTree_v3 m_beast; /** BEAST structure */
