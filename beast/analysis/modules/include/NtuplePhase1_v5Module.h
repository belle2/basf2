...
#ifndef NTUPLEPHASE1_V5MODULE_H
#define NTUPLEPHASE1_V5MODULE_H
...
namespace Belle2 {
   ...
   */
  class NtuplePhase1_v5Module : public Module {
  ...
  public:
     ...
     * Constructor
     */
    NtuplePhase1_v5Module();

    /**
     * Destructor
     */
    virtual ~NtuplePhase1_v5Module();
  ...
  private:
    ...
    std::vector<Double_t> m_input_Z_scaling; /**< time stamp start and stop */
