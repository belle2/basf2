...
namespace Belle2 {
  ...
  public:
    ...
    BgoSimHit(): m_energyDep(0), m_energyNiel(0), m_tkPDG(0), m_tkKEnergy(0), m_detNb(0), m_GlTime(0) {}


    /** Standard constructor
     * @param energyDep Deposited energy in electrons
     */
    BgoSimHit(float energyDep, float energyNiel, TVector3 tkPos, TVector3 tkMom, TVector3 tkMomDir, int tkPDG, float tkKEnergy, float detNb, float GlTime):
