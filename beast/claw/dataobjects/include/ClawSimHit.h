...
namespace Belle2 {
  ...
  /** ClassClawSimHit - Geant4 simulated hit for the Claw crystal in beast..
    ...
    * filled in beast/claw/simulation/src/SensitiveDetector.cc
    */

  class ClawSimHit : public SimHitBase {
  public:
    /** default constructor for ROOT */
    ClawSimHit(): SimHitBase(), m_CellId(0), m_TrackId(0), m_Pdg(0), m_FlightTime(0), m_Edep(0), m_Momentum(0, 0, 0), m_Position(0, 0,
          0) {;}
    //! Useful Constructor
    ClawSimHit(
      int CellId,            /**< Cell ID */
