...
namespace Belle2 {
  ...
  /**
    * ClassCsiSimHit - Geant4 simulated hit for the Csi detector.
    *
  ...
  public:
    ...
    CsiSimHit(): m_energyDep(0), m_energyNiel(0), m_tkPDG(0), m_tkKEnergy(0), m_detNb(0), m_GlTime(0), m_tkPos(), m_tkMom(), m_tkMomDir() {}


    /** Standard constructor
     * @param energyDep Deposited energy in electrons
     */
    CsiSimHit(float energyDep, float energyNiel, int tkPDG, float tkKEnergy, float detNb, float GlTime, const float* tkPos, const float* tkMom, const float* tkMomDir):
