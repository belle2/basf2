...
namespace Belle2 {
  ...
  /** ClassDosiHit - Geant4 ulated hit for the Dosi crystal in beast..
    ...
    * filled in beast/dosi/ulation/src/SensitiveDetector.cc
    */

  class DosiHit : public SimHitBase {
  public:
    /** default constructor for ROOT */
    DosiHit(): SimHitBase(), m_CellId(0), m_TrackId(0), m_Pdg(0), m_FlightTime(0), m_Edep(0), m_Momentum(0, 0, 0), m_Position(0, 0, 0),
      m_Erecdep(0) {;}
    //! Useful Constructor
    DosiHit(
      int CellId,            /**< Cell ID */
