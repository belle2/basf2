...
namespace Belle2 {
  ...
  /** ClassDosiSimHit - Geant4 simulated hit for the Dosi crystal in beast..
    ...
    * filled in beast/dosi/simulation/src/SensitiveDetector.cc
    */

  class DosiSimHit : public SimHitBase {
  public:
    /** default constructor for ROOT */
    DosiSimHit(): SimHitBase(), m_CellId(0), m_TrackId(0), m_Pdg(0), m_FlightTime(0), m_Edep(0), m_Momentum(0, 0, 0), m_Position(0, 0,
          0) {;}
    //! Useful Constructor
    DosiSimHit(
      int CellId,            /**< Cell ID */
