...
namespace Belle2 {
  ...
  /**
    * ClassFangSimHit - Geant4 simulated hit for the Fang detector.
    *
    * This class holds particle hit data from geant4 simulation. As the simulated
    * hit classes are used to generate detector response, they contain _local_
    * information.
    */
  class FangSimHit : public SimHitBase {
  public:
    //typedef std::vector<unsigned int>::iterator iterator;
    //typedef std::vector<unsigned int>::const_iterator const_iterator;

    /** default constructor for ROOT */
    FangSimHit(): m_energyDep(0), m_attDep(0), m_tkPDG(0), m_tkKEnergy(0), m_detNb(0), m_GlTime(0), m_tkPos(), m_tkMom(),
      m_tkMomDir() {}
     ...
     */
    FangSimHit(float energyDep, float attDep, int tkPDG, float tkKEnergy, float detNb, float GlTime, const float* tkPos,
