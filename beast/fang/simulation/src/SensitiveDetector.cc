...
namespace Belle2 {
  ...
  namespace fang {
    ...
    SensitiveDetector::SensitiveDetector():
      Simulation::SensitiveDetectorBase("FangSensitiveDetector", Const::invalidDetector)
    {
    ...
    bool SensitiveDetector::step(G4Step* step, G4TouchableHistory*)
    {
      ...
      StoreArray<FangSimHit> FangHits;
      if (!FangHits.isValid()) FangHits.create();
      FangSimHit* hit = FangHits.appendNew(
                          depEnergy,
                          attEdep,
                          tkPDG,
                          tkKEnergy,
