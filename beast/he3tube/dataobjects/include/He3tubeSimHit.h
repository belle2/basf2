...
namespace Belle2 {
  ...
  public:
    ...
    He3tubeSimHit(): m_energyDep(0), m_energyNiel(0), m_tkPDG(0), m_tkKEnergy(0), m_detNb(0), m_GlTime(0) {}


    /** Standard constructor
     * @param energyDep Deposited energy in electrons
     */
    He3tubeSimHit(float energyDep, float energyNiel, TVector3 tkPos, TVector3 tkMom, TVector3 tkMomDir, int tkPDG, float tkKEnergy, float detNb, float GlTime):
