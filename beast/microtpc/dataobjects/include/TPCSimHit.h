...
namespace Belle2 {
  ...
  /** ClassTPCSimHit - Geant4 simulated hit for the TPC crystal in beast..
    ...
    * filled in beast/TPC/simulation/src/SensitiveDetector.cc
    */

  class TPCSimHit : public SimHitBase {
  public:
    /** default constructor for ROOT */
    TPCSimHit(): SimHitBase(), m_CellId(0), m_TrackId(0), m_Pdg(0), m_FlightTime(0), m_Edep(0), m_Momentum(0, 0, 0), m_Position(0, 0,
          0), m_flag(0) {;}
    //! Useful Constructor
    TPCSimHit(
      int CellId,            /**< Cell ID */
