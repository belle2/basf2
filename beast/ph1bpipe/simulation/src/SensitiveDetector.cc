...
namespace Belle2 {
  ...
  namespace ph1bpipe {
    ...
    SensitiveDetector::SensitiveDetector():
      Simulation::SensitiveDetectorBase("Ph1bpipeSensitiveDetector", Const::invalidDetector)
    {
    ...
    bool SensitiveDetector::step(G4Step* step, G4TouchableHistory*)
    {
      ...
      StoreArray<Ph1bpipeSimHit> Ph1bpipeHits;
      if (!Ph1bpipeHits.isValid()) Ph1bpipeHits.create();
      /*Ph1bpipeSimHit* hit = Ph1bpipeHits.appendNew(
                              depEnergy,
                              detNb
            );*/
