...
namespace Belle2 {
  ...
  /** ClassPlumeSimHit - Geant4 simulated hit for the Plume crystal in beast..
    *
    * This class holds particle hit data from geant4 simulation. As the simulated
    * hit classes are used to generate detector response information.
    * relation to MCParticle
    * filled in beast/plume/simulation/src/SensitiveDetector.cc
    */

  class PlumeSimHit : public SimHitBase {
  public:
    /** default constructor for ROOT */
    PlumeSimHit(): SimHitBase(), m_CellId(0), m_TrackId(0), m_Pdg(0), m_FlightTime(0), m_Edep(0), m_Momentum(0, 0, 0), m_Position(0, 0, 0) {;}
    //! Useful Constructor
    PlumeSimHit(
      int CellId,            /**< Cell ID */
