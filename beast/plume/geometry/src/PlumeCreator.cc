  ...
  namespace plume {
    ...
    void PlumeCreator::create(const GearDir& content, G4LogicalVolume& topVolume, geometry::GeometryTypes /* type */)
    {
      ...
      */
      ...
      G4LogicalVolume* pipe_l = new G4LogicalVolume(pipe_s, geometry::Materials::get("Plume-CarbonTubes") , "PLUME.l_pipe");
    ...
    G4AssemblyVolume* PlumeCreator::buildSupport1()
    {
      ...
      G4LogicalVolume* l1_peek0 = new G4LogicalVolume(s1_peek0, geometry::Materials::get("Plume_peek"), "PLUME.l1_peek0");

      G4Box* s1_peek1 = new G4Box("s1_peek1", 24. / 2., 6. / 2. , 20. / 2.);
      G4Box* s1_peek2 = new G4Box("s1_peek2", 19.4 / 2., 3. / 2. , 20. / 2.);
      G4LogicalVolume* l1_peek1 = new G4LogicalVolume(s1_peek1, geometry::Materials::get("Plume_peek"), "PLUME.l1_peek1");
      G4LogicalVolume* l1_peek2 = new G4LogicalVolume(s1_peek2, geometry::Materials::get("Plume_peek"), "PLUME.l1_peek2");
    ...
    G4AssemblyVolume* PlumeCreator::buildSupport2()
    {
      ...
      G4LogicalVolume* l2_peek0 = new G4LogicalVolume(s2_peek0, geometry::Materials::get("Plume_peek"), "PLUME.l2_peek0");


      G4Box* s2_peek1 = new G4Box("s2_peek1", 10. / 2. ,  6.7 / 2. , 12.5 / 2.);
      G4Box* s2_peek2 = new G4Box("s2_peek2", 39.0 / 2.,  4. / 2. , 12.5 / 2.);
      G4LogicalVolume* l2_peek1 = new G4LogicalVolume(s2_peek1, geometry::Materials::get("Plume_peek"), "PLUME.l2_peek1");
      G4LogicalVolume* l2_peek2 = new G4LogicalVolume(s2_peek2, geometry::Materials::get("Plume_peek"), "PLUME.l2_peek2");
    ...
    G4AssemblyVolume* PlumeCreator::buildSupport3()
    {
      ...
      G4LogicalVolume* l3_peek0 = new G4LogicalVolume(s3_peek0, geometry::Materials::get("Plume_peek"), "PLUME.l3_peek0");
      ...
      G4LogicalVolume* l3_peek1 = new G4LogicalVolume(s3_peek1, geometry::Materials::get("Plume_peek"), "PLUME.l3_peek1");
      G4LogicalVolume* l3_peek2 = new G4LogicalVolume(s3_peek2, geometry::Materials::get("Plume_peek"), "PLUME.l3_peek2");
      G4LogicalVolume* l3_peek3 = new G4LogicalVolume(s3_peek3, geometry::Materials::get("Plume_peek"), "PLUME.l3_peek3");
    ...
    G4AssemblyVolume* PlumeCreator::buildSupport4()
    {
      ...
      G4LogicalVolume* l4_peek0 = new G4LogicalVolume(s4_peek0, geometry::Materials::get("Plume_peek"), "PLUME.l4_peek0");
