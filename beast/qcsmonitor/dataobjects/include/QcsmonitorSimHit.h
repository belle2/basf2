...
namespace Belle2 {
  ...
  /**
    * ClassQcsmonitorSimHit - Geant4 simulated hit for the Qcsmonitor detector.
    *
  ...
  public:
    ...
    QcsmonitorSimHit(): m_tkID(0), m_energyDep(0), m_attDep(0), m_tkPDG(0), m_tkKEnergy(0), m_detNb(0), m_GlTime(0), m_tkPos(),
      m_tkMom(),
      m_tkMomDir() {}
     ...
     */
    QcsmonitorSimHit(int tkID, float energyDep, float attDep, int tkPDG, float tkKEnergy, float detNb, float GlTime, const float* tkPos,
