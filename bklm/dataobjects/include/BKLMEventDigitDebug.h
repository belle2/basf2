...
namespace Belle2 {
  ...
  public:
     ...
     * Full constructor
     */
    BKLMEventDigitDebug(bool thisEventHasHits):
      m_thisEventHasHits(thisEventHasHits),
      m_nOutOfRangeHits(0),
      m_nRPCHits(0),
      m_nSciHits(0),
      m_triggerCTime(0),
    ...
    /**
     * Set True if the event has hits
     */
    void setThisEventHasHits(bool thisEventHasHits) { m_thisEventHasHits = thisEventHasHits; }
    ...
    /**
     * Returns True if the event has hits
     * @return True if the event has hits
     */
    bool getThisEventHasHits() const { return m_thisEventHasHits; }
     ...
     */
    unsigned int getTriggerInterval() const { return m_triggerCTime - m_triggerCTimeOfPreviousEvent; }

    /**
     * Returns trigger interval (triggerCTime - triggerCTimeOfPreviousEvent) in us
     * @return trigger interval in us
     */
    double getTriggerIntervalInUs() const { return (m_triggerCTime - m_triggerCTimeOfPreviousEvent) * 8.0 / 1000.0; }

  private:
    bool m_thisEventHasHits; /**< this event has hits */
    ...
    ClassDef(BKLMEventDigitDebug, 1); /**< ClassDef */
