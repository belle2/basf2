...
# running the CAF using the HCondor batch system backend with multiple test calibrations.
...
def main(argv):
    if len(argv) == 1:
        ...
        print("Usage: python3 caf_htcondor_backend.py <data directory>")
        sys.exit(1)
    ...
    for i in range(1, 3):
        ...
        # cal_test.backend_args = {'requirements' : '(OpSysAndVer == "SL6" || OpSysAndVer == "CentOS7")'}
    ...
    # Use the HTCondor backend setup, can view the default options in calibration/data/backends.cfg
