...
def main(argv):
    ...
    # Use the default PBS backend setup, can view the default options in calibration/data/caf.cfg
...
#    cal_fw.backend.load_from_config("file/path/to/config.cfg", "YourPBSSetupSection")
