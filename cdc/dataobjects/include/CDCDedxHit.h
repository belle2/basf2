...
namespace Belle2 {
  ...
  private:
    ...
    float m_x = 0; /**< POCA on track, x coordinate */
    float m_y = 0; /**< POCA on track, y coordinate */
    float m_z = 0; /**< POCA on track, z coordinate */
    float m_dx = 0; /**< DOCA, x coordinate */
    float m_dy = 0; /**< DOCA, y coordinate */
    float m_dz = 0; /**< DOCA, z coordinate */
