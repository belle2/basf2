...
namespace Belle2 {
  ...
  public:
    ...
    private:
      int m_id; /**< rib5 id. */
      double m_dr; /**< length of the rib5. */
      double m_dz; /**< length of the rib5. */
      double m_width; /**< width of the rib5. */
      double m_thick; /**< thickness of the rib5. */
      double m_rin; /**< length of the rib5. */
      double m_x; /**< the y-position of the rib5. */
      double m_y;/**< the y-position of the rib5. */
      double m_z;/**< the z-position of the rib5. */
      double m_rotx; /**< the y-position of the rib5. */
      double m_roty;/**< the y-position of the rib5. */
      double m_rotz;/**< the z-position of the rib5. */
      int m_offset; /**< Number of division. */
      int m_ndiv; /**< Number of division. */
