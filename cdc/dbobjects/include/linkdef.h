...
#pragma link C++ class Belle2::CDCAlphaScaleFactorForAsymmetry+; // checksum=0xd69e0cbf, version=1
...
#pragma link C++ class Belle2::CDCDedxInjectionTime+; // checksum=0x67331ce, version=1
