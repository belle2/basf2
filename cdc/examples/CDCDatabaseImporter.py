...
bwfile = FileSystem.findFile('data/cdc/badwire_sample.dat')
psfile = FileSystem.findFile('data/cdc/propspeed_v0.dat')
twfile = FileSystem.findFile('data/cdc/tw_crudevalues.dat')
xtfile = FileSystem.findFile('data/cdc/xt_v2.1.dat')
