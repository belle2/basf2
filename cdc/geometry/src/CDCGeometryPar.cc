...
void CDCGeometryPar::read()
{
  ...
  //------------------------------
  m_motherInnerR = gbxParams.getLength("InnerWalls/InnerWall[2]/InnerR");
  m_motherOuterR = gbxParams.getLength("OuterWalls/OuterWall[5]/OuterR");
  double R1 = gbxParams.getLength("Covers/Cover[1]/InnerR1");
  double R2 = gbxParams.getLength("Covers/Cover[1]/InnerR2");
  double angle = gbxParams.getLength("Covers/Cover[1]/Angle");
  double thick = gbxParams.getLength("Covers/Cover[1]/Thickness");
  double zpos = gbxParams.getLength("Covers/Cover[1]/PosZ");
  double length1;
  if (angle != 0) length1 = fabs(zpos - (R2 - R1) / tan(angle));
  else length1 = fabs(zpos);
  R1 = gbxParams.getLength("Covers/Cover[3]/InnerR1");
  R2 = gbxParams.getLength("Covers/Cover[3]/InnerR2");
  angle = gbxParams.getLength("Covers/Cover[3]/Angle");
  zpos = gbxParams.getLength("Covers/Cover[3]/PosZ");
  double length2;
  ...
  m_rWall[0]    = gbxParams.getLength("InnerWalls/InnerWall[3]/InnerR");
  m_zWall[0][0] = gbxParams.getLength("InnerWalls/InnerWall[1]/BackwardZ");
  m_zWall[0][1] = gbxParams.getLength("InnerWalls/InnerWall[1]/ForwardZ");

  m_rWall[1] = gbxParams.getLength("InnerWalls/InnerWall[1]/OuterR");
  m_zWall[1][0] = gbxParams.getLength("InnerWalls/InnerWall[1]/BackwardZ");
  m_zWall[1][1] = gbxParams.getLength("InnerWalls/InnerWall[1]/ForwardZ");

  // Get outer wall parameters
  m_rWall[2] = gbxParams.getLength("OuterWalls/OuterWall[1]/InnerR");
  m_zWall[2][0] = gbxParams.getLength("OuterWalls/OuterWall[1]/BackwardZ");
  m_zWall[2][1] = gbxParams.getLength("OuterWalls/OuterWall[1]/ForwardZ");

  m_rWall[3] = gbxParams.getLength("OuterWalls/OuterWall[2]/OuterR");
  m_zWall[3][0] = gbxParams.getLength("OuterWalls/OuterWall[1]/BackwardZ");
  m_zWall[3][1] = gbxParams.getLength("OuterWalls/OuterWall[1]/ForwardZ");
