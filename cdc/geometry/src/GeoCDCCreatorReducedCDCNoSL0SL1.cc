...
namespace Belle2 {
  ...
  namespace CDC {
    ...
    GeoCDCCreatorReducedCDCNoSL0SL1::GeoCDCCreatorReducedCDCNoSL0SL1()
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createGeometry(const CDCGeometry& geo, G4LogicalVolume& topVolume, geometry::GeometryTypes)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createNeutronShields(const GearDir& content)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createNeutronShields(const CDCGeometry& geom)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createCovers(const GearDir& content)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createCovers(const CDCGeometry& geom)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createCover2s(const CDCGeometry& geom)
    {
      G4Material* medHV = geometry::Materials::get("CDCHVCable");
      G4Material* medFiber = geometry::Materials::get("CDCOpticalFiber");
      G4Material* medCAT7 = geometry::Materials::get("CDCCAT7");
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createCone(const double rmin1, const double rmax1,
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createTube(const double rmin, const double rmax,
                                                     const double thick, const double posZ,
                                                     const int id, G4Material* med,
                                                     const string& name)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createBox(const double length, const double height,
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createTorus(const double rmin1, const double rmax1,
                                                      const double thick, const double posZ,
                                                      const int id, G4Material* med,
                                                      const string& name)
    {
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createTube2(const double rmin, const double rmax,
    ...
    void GeoCDCCreatorReducedCDCNoSL0SL1::createMapper(G4LogicalVolume& topVolume)
    {
