...
namespace Belle2 {
  ...
  protected:
    ...
    TH2F* m_hADCTrack = nullptr;     /**< Histogram of ADC with track associated hits for all boards (0-299) */
    TH2F* m_hTDCTrack = nullptr;     /**< Histogram of TDC with track associated hits for all boards (0-299) */
