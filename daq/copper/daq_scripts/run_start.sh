...
/usr/bin/xterm -fn 7x14 -geometry 40x10+400+442 -e "${BELLE2_LOCAL_DIR}/daq/copper/daq_scripts/RecvStream2_wobasf2.sh cpr008 0 34007 hogehoge1000; sleep 3000000;" &
