...
/*    k = 0;
    ...
    else if( !strcmp( argv[1] , "checkerr" ) )
   {
       ...
       printf("The number of error is %d of link %c when the application starts\n", err_ini,'a'+i);
       while(1)
       {
         sleep(100);
