...
#include <daq/hbasf2/modules/StorageZMQ2Ds.h>
...
REG_MODULE(StorageZMQ2Ds)

StorageZMQ2DsModule::StorageZMQ2DsModule() : Module()
{
  setDescription(
  ...
  addParam("inInitialize", m_inInitialize,
           "psh added this for test", true);
}

void StorageZMQ2DsModule::initialize()
{
  m_streamHelper.registerStoreObjects(m_param_addExpressRecoObjects);
}

void StorageZMQ2DsModule::event()
{
  setReturnValue(0);
