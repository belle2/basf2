...
void MonitorDataCOPPERModule::defineHisto()
{
  ...
  h_size_0 = new TH1F("h_size", "Event Data Size; Data size [byte]; # of entries", 100, 0.0, 2000.0);
  h_size_0->SetXTitle("Event Data Size/COPPER[byte]");
  h_size_0->SetYTitle("# of Events");

  h_size_1 = new TH1F("h_size", "Event Data Size; Data size [byte]; # of entries", 100, 0.0, 2000.0);
  h_size_1->SetXTitle("Event Data Size/COPPER[byte]");
  h_size_1->SetYTitle("# of Events");

  h_size_2 = new TH1F("h_size", "Event Data Size; Data size [byte]; # of entries", 100, 0.0, 2000.0);
  h_size_2->SetXTitle("Event Data Size/COPPER[byte]");
  h_size_2->SetYTitle("# of Events");

  h_size_3 = new TH1F("h_size", "Event Data Size; Data size [byte]; # of entries", 100, 0.0, 2000.0);
  h_size_3->SetXTitle("Event Data Size/COPPER[byte]");
  h_size_3->SetYTitle("# of Events");


  h_size_var = new TH1F("h_size", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_size_var->SetXTitle("Data Size/COPPER[byte]");
  h_size_var->SetYTitle("# of Events");

  h_size_var_0 = new TH1F("h_size_var", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_size_var_0->SetXTitle("Data Size/COPPER[byte]");
  h_size_var_0->SetYTitle("# of Events");

  h_size_var_1 = new TH1F("h_size_var", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_size_var_1->SetXTitle("Data Size/COPPER[byte]");
  h_size_var_1->SetYTitle("# of Events");

  h_size_var_2 = new TH1F("h_size_var", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_size_var_2->SetXTitle("Data Size/COPPER[byte]");
  h_size_var_2->SetYTitle("# of Events");

  h_size_var_3 = new TH1F("h_size_var", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_size_var_3->SetXTitle("Data Size/COPPER[byte]");
  h_size_var_3->SetYTitle("# of Events");


  h_flow_rate = new TH1F("h_flow", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_flow_rate->SetXTitle("Data Size/COPPER[byte]");
  h_flow_rate->SetYTitle("# of Events");

  h_flow_rate_0 = new TH1F("h_flow_rate", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_flow_rate_0->SetXTitle("Data Size/COPPER[byte]");
  h_flow_rate_0->SetYTitle("# of Events");

  h_flow_rate_1 = new TH1F("h_flow_rate", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_flow_rate_1->SetXTitle("Data Size/COPPER[byte]");
  h_flow_rate_1->SetYTitle("# of Events");

  h_flow_rate_2 = new TH1F("h_flow_rate", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
  h_flow_rate_2->SetXTitle("Data Size/COPPER[byte]");
  h_flow_rate_2->SetYTitle("# of Events");

  h_flow_rate_3 = new TH1F("h_flow_rate", "Data Size; Data size [byte]; # of entries", t_nbin, t_min, t_max);
