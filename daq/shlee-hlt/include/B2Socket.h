...
namespace Belle2 {
  ...
  */
  ...
  public:
    ...
    EHLTStatus send(const std::string data, int& sizeSent);
    EHLTStatus send(char* data, int size, int& sizeSent);
    //! Receive data from socket
    EHLTStatus receive(int newSocket, std::string& buffer, int size, int& sizeRead);
    EHLTStatus receive(int newSocket, char* buffer, int size, int& sizeRead);
