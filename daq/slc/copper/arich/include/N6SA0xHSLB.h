#ifndef _Belle2_N6SA0xHSLB_h
#define _Belle2_N6SA0xHSLB_h

#include "daq/slc/copper/arich/N6HSLB.h"

namespace Belle2 {

  class N6SA0xHSLB : public N6HSLB {
  public:
  ...
  public:
    ...
    //void mg_rst( unsigned char v ) { write1( ADDR_MG_RST, v ); }
    //void mg_tpg( unsigned char v ) { write1( ADDR_MG_TPG, v ); }
    /* read operation */
