...
namespace Belle2 {
  ...
  public:
    ...
    float getFieldValueFloat(std::string name) const throw();
    float getFieldValueFloat(int i) const throw();
    ...
    std::vector<float> getFieldValueFloatArray(std::string name) const throw();
    std::vector<float> getFieldValueFloatArray(int i) const throw();
