...
double Histo2::getOverFlowX(int) const throw() { return _data->get(_data->size() - 1); }

double Histo2::getUnderFlowX(int) const throw() { return _data->get(0); }

double Histo2::getOverFlowY(int) const throw() { return _data->get(_data->size() - 1); }

double Histo2::getUnderFlowY(int) const throw() { return _data->get(0); }
...
void Histo2::setOverFlowX(int, double data) throw() { _data->set(_data->size() - 1, data); }

void Histo2::setOverFlowY(int, double data) throw() { _data->set(_data->size() - 1, data); }

void Histo2::setUnderFlow(double data) throw() { _data->set(0, data); }

void Histo2::setUnderFlowX(int, double data) throw() { _data->set(0, data); }

void Histo2::setUnderFlowY(int, double data) throw() { _data->set(0, data); }
