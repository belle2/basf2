...
void Range::readUpdate(Belle2::Reader&) throw(Belle2::IOException)
{

}

void Range::writeUpdate(Belle2::Writer&) const throw(Belle2::IOException)
{

}

void Range::readUpdateFull(Belle2::Reader&) throw(Belle2::IOException)
{

}

void Range::writeUpdateFull(Belle2::Writer&) const throw(Belle2::IOException)
{
