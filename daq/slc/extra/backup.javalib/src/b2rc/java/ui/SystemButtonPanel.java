...
public class SystemButtonPanel extends JPanel implements Updatable {
	...
	private class CommandButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				com.getControlPanel().addLog(new Log("Pushed command: "+ _command.getLabel(), LogLevel.INFO));
			} catch (Exception e) {
	...
	public void update() {
		...
		_button_boot.setText(_boot_command.getLabel());
		_button_load.setText(_load_command.getLabel());
		_button_start.setText(_start_command.getLabel());
		_button_pause.setText(_pause_command.getLabel());
