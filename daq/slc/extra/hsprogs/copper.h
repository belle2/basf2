...
// 2005/01/17 Append
#define COPPER_EWRP_WA    0x00000140  // COPPER Event FIFO Ach Read/Write Pointer
#define COPPER_EWRP_WB    0x00000144  // COPPER Event FIFO Bch Read/Write Pointer
#define COPPER_EWRP_WC    0x00000148  // COPPER Event FIFO Cch Read/Write Pointer
#define COPPER_EWRP_WD    0x0000014C  // COPPER Event FIFO Dch Read/Write Pointer
...
#define COPPER_TS_ENV     0x00000174  // same as above?
...
#define COPPER_MAGIC2   0xde  /* in order to access registers after offset 0x100 */
...
#define CPRIOGET_FF_WA    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_WA), sizeof(unsigned int))
#define CPRIOGET_FF_WB    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_WB), sizeof(unsigned int))
#define CPRIOGET_FF_WC    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_WC), sizeof(unsigned int))
#define CPRIOGET_FF_WD    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_WD), sizeof(unsigned int))
#define CPRIOGET_FF_RA    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_RA), sizeof(unsigned int))
#define CPRIOGET_FF_RB    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_RB), sizeof(unsigned int))
#define CPRIOGET_FF_RC    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_RC), sizeof(unsigned int))
#define CPRIOGET_FF_RD    _IOR(COPPER_MAGIC2, (0xFF & COPPER_FF_RD), sizeof(unsigned int))

#define CPRIOGET_EWRP_WA  _IOR(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WA), sizeof(unsigned int))
#define CPRIOGET_EWRP_WB  _IOR(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WB), sizeof(unsigned int))
#define CPRIOGET_EWRP_WC  _IOR(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WC), sizeof(unsigned int))
#define CPRIOGET_EWRP_WD  _IOR(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WD), sizeof(unsigned int))

#define CPRIOGET_WEA_COUNTER  _IOR(COPPER_MAGIC2, (0xFF & COPPER_WEA_COUNTER), sizeof(unsigned int))
#define CPRIOGET_WEB_COUNTER  _IOR(COPPER_MAGIC2, (0xFF & COPPER_WEB_COUNTER), sizeof(unsigned int))
#define CPRIOGET_WEC_COUNTER  _IOR(COPPER_MAGIC2, (0xFF & COPPER_WEC_COUNTER), sizeof(unsigned int))
#define CPRIOGET_WED_COUNTER  _IOR(COPPER_MAGIC2, (0xFF & COPPER_WED_COUNTER), sizeof(unsigned int))

#define CPRIOGET_LWRA_DMA _IOR(COPPER_MAGIC2, (0xFF & COPPER_LWRA_DMA), sizeof(unsigned int))
#define CPRIOGET_LWRB_DMA _IOR(COPPER_MAGIC2, (0xFF & COPPER_LWRB_DMA), sizeof(unsigned int))
#define CPRIOGET_LWRC_DMA _IOR(COPPER_MAGIC2, (0xFF & COPPER_LWRC_DMA), sizeof(unsigned int))
#define CPRIOGET_LWRD_DMA _IOR(COPPER_MAGIC2, (0xFF & COPPER_LWRD_DMA), sizeof(unsigned int))

#define CPRIOGET_DMA_TRANS  _IOR(COPPER_MAGIC2, (0xFF & COPPER_DMA_TRANS), sizeof(unsigned int))
#define CPRIOGET_TS_ENV   _IOR(COPPER_MAGIC2, (0xFF & COPPER_TS_ENV), sizeof(unsigned int))
...
#define CPRIOSET_FF_WA    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_WA), sizeof(unsigned int))
#define CPRIOSET_FF_WB    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_WB), sizeof(unsigned int))
#define CPRIOSET_FF_WC    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_WC), sizeof(unsigned int))
#define CPRIOSET_FF_WD    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_WD), sizeof(unsigned int))
#define CPRIOSET_FF_RA    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_RA), sizeof(unsigned int))
#define CPRIOSET_FF_RB    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_RB), sizeof(unsigned int))
#define CPRIOSET_FF_RC    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_RC), sizeof(unsigned int))
#define CPRIOSET_FF_RD    _IOW(COPPER_MAGIC2, (0xFF & COPPER_FF_RD), sizeof(unsigned int))
// #define CPRIOSET_FF_DMA    _IOW(COPPER_MAGIC, COPPER_FF_DMA, sizeof(unsigned int))

#define CPRIOSET_EWRP_WA  _IOW(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WA), sizeof(unsigned int))
#define CPRIOSET_EWRP_WB  _IOW(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WB), sizeof(unsigned int))
#define CPRIOSET_EWRP_WC  _IOW(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WC), sizeof(unsigned int))
#define CPRIOSET_EWRP_WD  _IOW(COPPER_MAGIC2, (0xFF & COPPER_EWRP_WD), sizeof(unsigned int))

#define CPRIOSET_WEA_COUNTER  _IOW(COPPER_MAGIC2, (0xFF & COPPER_WEA_COUNTER), sizeof(unsigned int))
#define CPRIOSET_WEB_COUNTER  _IOW(COPPER_MAGIC2, (0xFF & COPPER_WEB_COUNTER), sizeof(unsigned int))
#define CPRIOSET_WEC_COUNTER  _IOW(COPPER_MAGIC2, (0xFF & COPPER_WEC_COUNTER), sizeof(unsigned int))
#define CPRIOSET_WED_COUNTER  _IOW(COPPER_MAGIC2, (0xFF & COPPER_WED_COUNTER), sizeof(unsigned int))

#define CPRIOSET_LWRA_DMA _IOW(COPPER_MAGIC2, (0xFF & COPPER_LWRA_DMA), sizeof(unsigned int))
#define CPRIOSET_LWRB_DMA _IOW(COPPER_MAGIC2, (0xFF & COPPER_LWRB_DMA), sizeof(unsigned int))
#define CPRIOSET_LWRC_DMA _IOW(COPPER_MAGIC2, (0xFF & COPPER_LWRC_DMA), sizeof(unsigned int))
#define CPRIOSET_LWRD_DMA _IOW(COPPER_MAGIC2, (0xFF & COPPER_LWRD_DMA), sizeof(unsigned int))

#define CPRIOSET_DMA_TRANS  _IOW(COPPER_MAGIC2, (0xFF & COPPER_DMA_TRANS), sizeof(unsigned int))
#define CPRIOSET_TS_ENV   _IOW(COPPER_MAGIC2, (0xFF & COPPER_TS_ENV), sizeof(unsigned int))
...
#define CPRIO_ENABLE_INTERRUPT  _IO(COPPER_MAGIC, 9)
#define CPRIO_DISABLE_INTERRUPT _IO(COPPER_MAGIC, 10)
