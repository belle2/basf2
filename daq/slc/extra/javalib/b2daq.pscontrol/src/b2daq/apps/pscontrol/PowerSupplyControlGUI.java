    ...
    public void start(Stage stage) throws Exception {
        try {
            NSM2SocketInitDialog socket = NSM2SocketInitDialog.connect((arguments.length > 1 ? arguments[1] : ".pscontrol.init"),
                    null, 9090, null, 9122, "HV_GUI", "ARICH_HV",
                    null, "Login to Belle II Power supply control",
            ...
            PSSettingMainPanelController controller
                    = ((PSSettingMainPanelController) loader.getController());
            controller.setNode(new NSMNode(socket.getNSMConfig().getNSMTarget()));
