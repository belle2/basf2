...
public class NSMVar implements Serializable {
    ...
    public int getInt() {
        return (m_type == INT && m_var_i != null && m_len == 0) ? m_var_i[0] : 0;
    }

    public float getFloat() {
        return (m_type == FLOAT && m_var_f != null && m_len == 0) ? m_var_f[0] : 0;
    }
    ...
    public int getInt(int index) {
        return (m_type == INT && m_var_i != null && m_len > index) ? m_var_i[index] : 0;
    }

    public float getFloat(int index) {
        return (m_type == FLOAT && m_var_f != null && m_len > index) ? m_var_f[index] : 0;
    }
