...
if(pv0=="READY") {
  ...
  widget.setPropertyValue("background_color",ColorFontUtil.getColorFromRGB(255,212,0));
  ...
  widget.setPropertyValue("foreground_color",ColorFontUtil.getColorFromRGB(0,0,0));
  widget.setPropertyValue("background_color",ColorFontUtil.getColorFromRGB(128,128,128));
}