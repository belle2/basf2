...
public abstract class AbstractDBObject implements Serializable {
        ...
        for (String name : getFieldNames()) {
            ...
            switch (type) {
                ...
                case FieldInfo.OBJECT: {
                    ...
                    if (nobj > 0) {
                        AbstractDBObject obj = getObject(name);
    ...
    abstract public void setObject(String name, int index, AbstractDBObject obj);

    abstract public AbstractDBObject getObject(String name, int i);

    public AbstractDBObject getObject(String name) {
