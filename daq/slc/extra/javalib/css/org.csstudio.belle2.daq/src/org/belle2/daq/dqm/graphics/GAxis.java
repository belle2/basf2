...
public abstract class GAxis extends GShape {
    ...
    protected ArrayList<GValuedText> labels = new ArrayList<>();
    ...
    protected GLine border_line0 = new GLine(0, 0, 0, 0, HtmlColor.BLACK);
    protected GLine border_line1 = new GLine(0, 0, 0, 0, HtmlColor.BLACK);
    ...
    public ArrayList<GValuedText> getLabels() {
        return labels;
    }
    ...
    @Override
    public final void setLineColor(HtmlColor color) {
