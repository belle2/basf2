...
import org.belle2.daq.graphics.GLine;
...
public class GAxisY extends GAxis {
	...
	public GAxisY(int nbin, double min, double max, String label, boolean fixMin, boolean fixMax, boolean logon) {
	...
	public void draw(GraphicsDrawer canvas) {
		...
		if (base < 20000 && base > -20000 && (base > 4 || base < -2)) {
