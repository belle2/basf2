...
public class NSMCommand extends Enum {
    ...
    final static public NSMCommand LOGSET = new NSMCommand(6, "LOGSET");
    final static public NSMCommand LOGGET = new NSMCommand(7, "LOGGET");
    ...
    public boolean copy(String msg) {
        if (msg.equals(UNKNOWN.getLabel())) {
            ...
            copy(LOG);
            return true;
        } else if (msg.equals(LOGSET.getLabel())) {
            copy(LOGSET);
            return true;
        } else if (msg.equals(LOGGET.getLabel())) {
            copy(LOGGET);
            return true;
    ...
    public boolean copy(int id) {
        if (id == UNKNOWN.getId()) {
            ...
            copy(LOG);
            return true;
        } else if (id == LOGSET.getId()) {
            copy(LOGSET);
            return true;
        } else if (id == LOGGET.getId()) {
            copy(LOGGET);
            return true;
