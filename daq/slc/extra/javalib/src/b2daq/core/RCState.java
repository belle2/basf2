...
public class RCState extends RCEnum {
	...
	final static public RCState UNKNOWN = new RCState(0, "UNKNOWN");
	final static public RCState INITIAL_S = new RCState(101, "INITIAL_S");
	final static public RCState CONFIGURED_S = new RCState(102, "CONFIGURED");
	final static public RCState READY_S = new RCState(103, "READY");
	final static public RCState RUNNING_S = new RCState(104, "RUNNING");
	final static public RCState PAUSED_S = new RCState(105, "PAUSED");
	final static public RCState BOOTING_TS = new RCState(201, "BOOTING");
	final static public RCState LOADING_TS = new RCState(202, "LOADING");
	final static public RCState STARTING_TS = new RCState(203, "STARTING");
	final static public RCState STOPPING_TS = new RCState(204, "STOPPING");
	final static public RCState ERROR_ES = new RCState(301, "ERROR");
	final static public RCState FATAL_ES = new RCState(302, "FATAL");
	final static public RCState RECOVERING_RS = new RCState(402, "RECOVERING");
	final static public RCState ABORTING_RS = new RCState(403, "ABORTING");
