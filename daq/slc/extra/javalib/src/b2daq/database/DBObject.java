...
public abstract class DBObject implements Serializable {
	...
	public void setNode(String node) { m_node = node; }
	...
	public void setRevision(int revision) { m_revision = revision; }
	public void setConfig(boolean isconfig) { m_isconfig = isconfig; }
	public ArrayList<String> getFieldNames() { return m_name_v; }
	public FieldInfo.Property getProperty(String name) { return m_pro_m.get(name); }
	public boolean hasField(String name) { return m_pro_m.containsKey(name); }
	public boolean hasArray(String name) { return hasField(name) && !hasObject(name) && !hasText(name); }
	...
	public boolean hasObject(String name) { return hasObject(name, 0); }
	public HashMap<String, Integer> getEnumList(String name) { return m_enum_m_m.get(name); }
	...
	public void addEnumList(String name, HashMap<String, Integer> enum_m)	{
	  if (!m_enum_m_m.containsKey(name)) m_enum_m_m.put(name, enum_m);
	}
	...
	public String getValueText(String name) {
	  if (hasField(name)) {
	    switch (getProperty(name).getType()) {
	      ...
	      case FieldInfo.CHAR:   return ""+(int)getChar(name);
	      case FieldInfo.SHORT:  return "" + (int)getShort(name);
	      case FieldInfo.INT:    return "" + (int)getInt(name);
	      case FieldInfo.LONG:   return "" + getLong(name);
	      case FieldInfo.FLOAT:  return "" + getFloat(name);
	      case FieldInfo.DOUBLE: return "" + getDouble(name);
	      case FieldInfo.NSM_CHAR:   return "" + (int)getChar(name);
	      case FieldInfo.NSM_INT16:  return "" + (int)getShort(name);
	      case FieldInfo.NSM_INT32:  return "" + (int)getInt(name);
	      case FieldInfo.NSM_INT64:  return "" + getLong(name);
	      case FieldInfo.NSM_BYTE8:  return "" + (int)getChar(name);
	      case FieldInfo.NSM_UINT16: return "" + (int)getShort(name);
	      case FieldInfo.NSM_UINT32: return "" + getInt(name);
	      case FieldInfo.NSM_UINT64: return "" + getLong(name);
	      case FieldInfo.NSM_FLOAT:  return "" + getFloat(name);
	      case FieldInfo.NSM_DOUBLE: return "" + getDouble(name);
	      default: break;
	    }
	  }
	  return "";
	...
	public void setValueText(String name, String value) {
		if (hasField(name)) {
			...
			case FieldInfo.CHAR:       setChar(name, (char)Integer.parseInt(value)); break;
			case FieldInfo.NSM_INT16:
			case FieldInfo.NSM_UINT16:
			case FieldInfo.SHORT:      setShort(name, (short)Integer.parseInt(value)); break;
			case FieldInfo.NSM_INT32:
			case FieldInfo.NSM_UINT32:
			case FieldInfo.INT:        setInt(name, (int)Integer.parseInt(value)); break;
			case FieldInfo.NSM_INT64:
			case FieldInfo.NSM_UINT64:
			case FieldInfo.LONG:       setLong(name, (long)Integer.parseInt(value)); break;
			case FieldInfo.NSM_FLOAT:
			case FieldInfo.FLOAT:      setFloat(name, (float)Double.parseDouble(value)); break;
			case FieldInfo.NSM_DOUBLE:
			case FieldInfo.DOUBLE:     setDouble(name, Double.parseDouble(value)); break;
	...
	public void setText(String name, String value) { addText(name, value); }
	public void setEnum(String name, String value) { addEnum(name, value); }
	public boolean isConfig() { return m_isconfig; }
	...
	public void print() {
		for (String name : getFieldNames()) {
			...
			switch (type) {
			case FieldInfo.BOOL:   System.out.print(getBool(name)); break;
			case FieldInfo.CHAR:   System.out.print(getChar(name)); break;
			case FieldInfo.SHORT:  System.out.print(getShort(name)); break;
			case FieldInfo.INT:    System.out.print(getInt(name)); break;
			case FieldInfo.LONG:   System.out.print(getLong(name)); break;
			case FieldInfo.FLOAT:  System.out.print(getFloat(name)); break;
			case FieldInfo.DOUBLE: System.out.print(getDouble(name)); break;
			case FieldInfo.TEXT:   System.out.print(getText(name)); break;
			...
			case FieldInfo.ENUM:   System.out.print(getEnum(name)); break;
			case FieldInfo.NSM_CHAR:   System.out.print(getChar(name)); break;
			case FieldInfo.NSM_INT16:  System.out.print(getShort(name)); break;
			case FieldInfo.NSM_INT32:  System.out.print(getInt(name)); break;
			case FieldInfo.NSM_INT64:  System.out.print(getLong(name)); break;
			case FieldInfo.NSM_BYTE8:  System.out.print(getChar(name)); break;
			case FieldInfo.NSM_UINT16: System.out.print(getShort(name)); break;
			case FieldInfo.NSM_UINT32: System.out.print(getInt(name)); break;
			case FieldInfo.NSM_UINT64: System.out.print(getLong(name)); break;
			case FieldInfo.NSM_FLOAT:  System.out.print(getFloat(name)); break;
			case FieldInfo.NSM_DOUBLE: System.out.print(getDouble(name)); break;
