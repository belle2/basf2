...
public class HtmlColor {
	...
	public static HtmlColor DARK_GREEN = new HtmlColor(0, 204, 102); 
	...
	public void set(String code) {
		...
		} else if (code.equals("DARK_GREEN") || code.equals("dark_green")) {
			copy(HtmlColor.DARK_GREEN);
		} else {
			copy(HtmlColor.NULL);
		}
	}
	...
	public void setRGB(int red, int green, int blue) {
		...
		_blue = blue;
		if (_blue > 255) _blue = 255;
		_html_code = String.format("#%02x%02x%02x", _red, _green, _blue);
	}
