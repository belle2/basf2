...
import b2daq.graphics.SwingGCanvas;


public class GCanvasPanel extends JPanel {

	private static final long serialVersionUID = 1L;

	private SwingGCanvas _canvas = new SwingGCanvas();
	
	public GCanvasPanel() {}
	public GCanvasPanel(int width, int height) {
	...
	static public void main(String[] argv) {
		GCanvasPanel c = new GCanvasPanel();
		c.setSize(500, 500);
