...
void ArichHVControlCallback::turnon() throw(HVHandlerException)
{
  ...
  while (!(check_all_switch("guard", true) && check_all_switch("hv", true) && check_all_switch("bias", true))) {
    if (check_all_switch("guard", false) && check_all_switch("hv", false) && check_all_switch("bias", false)) all_switch("guard", true);
    else if (check_all_switch("guard", true) && check_all_switch("hv", false)
             && check_all_switch("bias", false)) all_switch("hv", true);
    else if (check_all_switch("guard", true) && check_all_switch("hv", true)
             && check_all_switch("bias", false)) all_switch("bias", true);
    else {
...
void ArichHVControlCallback::turnoff() throw(HVHandlerException)
{
  ...
  while (!(check_all_switch("guard", false) && check_all_switch("hv", false) && check_all_switch("bias", false))) {
    if (check_all_switch("guard", true) && check_all_switch("hv", true) && check_all_switch("bias", true)) all_switch("bias", false);
    else if (check_all_switch("guard", true) && check_all_switch("hv", true)
             && check_all_switch("bias", false)) all_switch("hv", false);
    else if (check_all_switch("guard", true) && check_all_switch("hv", false)
             && check_all_switch("bias", false)) all_switch("guard", false);
    else {
      //  LogFile::debug("you should check");
    }
