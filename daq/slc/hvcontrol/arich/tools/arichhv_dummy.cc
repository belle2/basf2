...
std::string toReplyText(ArichHVMessage& msg)
{
  ...
  switch (msg.getCommand()) {
    ...
    case ArichHVMessage::SWITCH:  ss << StringUtil::form("SW=%d", msg.isSwitchOn()); break;
    case ArichHVMessage::RAMPUP_SPEED: ss << StringUtil::form("RVU=%04X", msg.getRampUpSpeed()); break;
    case ArichHVMessage::RAMPDOWN_SPEED: ss << StringUtil::form("RVD=%04X", msg.getRampDownSpeed()); break;
    case ArichHVMessage::VOLTAGE_DEMAND: ss << StringUtil::form("CH5=%04X", msg.getVoltageDemand()); break;
    case ArichHVMessage::VOLTAGE_LIMIT: ss << StringUtil::form("CH2=%04X", msg.getVoltageLimit()); break;
    case ArichHVMessage::CURRENT_LIMIT: ss << StringUtil::form("CH7=%04X", msg.getCurrentLimit()); break;
    case ArichHVMessage::VOLTAGE_MON: ss << StringUtil::form("MNH1=%04X", msg.getVoltageMon()); break;
    case ArichHVMessage::CURRENT_MON: ss << StringUtil::form("NMH2=%04X", msg.getCurrentMon()); break;
    default: break;
  }
  return ss.str();
}
