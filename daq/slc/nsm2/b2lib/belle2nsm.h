...
void* b2nsm_openmem_str(const char* filebuf, const char* dat, const char* fmt, int rev);
void* b2nsm_allocmem_str(const char* filebuf, const char* dat, const char* fmt, int rev, float cycle);
