...
void MonLabel::writeConfig(B2DAQ::Writer& writer)
...
void MonLabel::writeContents(B2DAQ::Writer& writer)
const throw(B2DAQ::IOException)
{
...
void MonLabel::readConfig(B2DAQ::Reader& reader)
...
void MonLabel::readContents(B2DAQ::Reader& reader)
throw(B2DAQ::IOException)
{
