...
{
  addPoint(B2DAQ::Time().getSecond(), data);
}
...
void TimedGraph1::readObject(B2DAQ::Reader& reader)
...
void TimedGraph1::readUpdate(B2DAQ::Reader& reader)
throw(B2DAQ::IOException)
{
...
void TimedGraph1::readConfig(B2DAQ::Reader& reader)
throw(B2DAQ::IOException)
{
...
void TimedGraph1::readContents(B2DAQ::Reader& reader)
throw(B2DAQ::IOException)
{
  _iter = reader.readInt();
  _time_v.readObject(reader);
...
void TimedGraph1::writeObject(B2DAQ::Writer& writer)
...
void TimedGraph1::writeUpdate(B2DAQ::Writer& writer)
const throw(B2DAQ::IOException)
{
...
void TimedGraph1::writeConfig(B2DAQ::Writer& writer)
const throw(B2DAQ::IOException)
{
...
void TimedGraph1::writeContents(B2DAQ::Writer& writer)
const throw(B2DAQ::IOException)
{
  writer.writeInt(_iter);
  _time_v.writeObject(writer);
