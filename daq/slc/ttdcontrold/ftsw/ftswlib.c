...
#define OPEN_TTXX      ftsw_open
#define CLOSE_TTXX     ftsw_close
#define READ_TTXX      ftsw_read
#define READFIFO_TTXX  ftsw_readfifo
#define WRITE_TTXX     ftsw_write
#define DEBUG_TTXX     ftsw_debug
...
/* ---------------------------------------------------------------------- *\
   sparc_mmap
\* ---------------------------------------------------------------------- */
unsigned* sparc_mmap(int baseadrs, int mapsize, int oflags)
{
...
static unsigned* linux_vmic_mmap(int baseadrs, int mapsize, int oflags,
