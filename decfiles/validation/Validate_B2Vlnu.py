...
basf2.set_random_seed('B+ => anti-D*0 e+ nu_e')
...
fillParticleListFromMC('anti-D*0:sig', '', addDaughters=True, path=path)
fillParticleListFromMC('e+:sig', '', path=path)
fillParticleListFromMC('nu_e:sig', '', path=path)
reconstructMCDecay('B+:sig -> anti-D*0:sig e+:sig nu_e:sig', '', path=path)
create_validation_histograms(
    path, 'Validate_B2Vlnu.root', 'B+:sig',
    [
        ('q2', 50, -0.5, 12, '', 'P. Urquijo <phillip.urquijo@unimelb.edu.au>',
