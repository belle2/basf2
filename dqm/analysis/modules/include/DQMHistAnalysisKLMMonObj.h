...
namespace Belle2 {
  ...
  private:
     ...
     * @param[in]  layerGlobalBin Global BKLM layer bin (1..240) on histogram X-axis
     ...
     */
    void CalculateKLMHitRate(auto* hist, int layerGlobalBin, Double_t totalEvents, Double_t layerArea,
