...
// update #hadronb2/#bhabha_all
      ...
      if (hist_hadronb2_over_bhabha_all) {
        ...
        if (hist_hadronb2_over_bhabha_all->GetBinContent(
              hist_hadronb2_over_bhabha_all->GetXaxis()->FindBin("accept_bhabha_all")) != 0) {
...
// update #mumu2trk/#bhabha_all
      ...
      if (hist_mumu2trk_over_bhabha_all) {
        ...
        if (hist_mumu2trk_over_bhabha_all->GetBinContent(
              hist_mumu2trk_over_bhabha_all->GetXaxis()->FindBin("accept_bhabha_all")) != 0) {
      ...
      if (hist_gammagamma_over_bhabha_all) {
        ...
        if (hist_gammagamma_over_bhabha_all->GetBinContent(
          ...
          gammagamma_over_bhabha_all = hist_gammagamma_over_bhabha_all->GetBinContent(
                                         hist_gammagamma_over_bhabha_all->GetXaxis()->FindBin("accept_gamma_gamma")) /
                                       hist_gammagamma_over_bhabha_all->GetBinContent(
