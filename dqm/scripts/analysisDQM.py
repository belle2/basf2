...
def add_analysis_dqm(path):
    ...
    ma.reconstructDecay('UpsilonE:physDQM -> e-:physDQM e+:physDQM', '9 < M < 12', 1, True, path)
    ...
    # bhabha,hadrons
    dqm.param('ePListName', 'e+:physDQM')
    dqm.param('UpsEPListName', 'UpsilonE:physDQM')
    dqm.param('HadbPListName', 'pi+:hadbphysDQM')
...
def add_mirabelle_dqm(path):
    ...
    MiraBelleBhabha = b2.register_module('PhysicsObjectsBhabhaMiraBelle')
    ...
    MiraBellehadronb = b2.register_module('PhysicsObjectsHadronMiraBelle')
