...
# Usage: basf2 run_ee5x5_algorithm_dPhi_mc.py "inputfiles*.root"
# or: bsub -q s -o logfile.txt 'basf2 run_ee5x5_algorithm_dPhi_mc.py "inputfiles*.root"'
...
# This scripts sets parameters to find payload ECLeedPhiMC using MC. Other scripts
# are available to obtain payloads "ECLCrystalEnergy5x5", "ECLExpee5x5E", or "ECLeedPhiData", or to
...
algo.setOutputName("algorithmOut/eclee5x5_algorithm_dPhi_mc.root")
algo.setMinEntries(15)
algo.setPayloadName("ECLeedPhiMC")
