...
# Usage: basf2 run_ee5x5_algorithm_expE.py "inputfiles*.root"
# or: bsub -q s -o logfile.txt 'basf2 run_ee5x5_algorithm_expE.py "inputfiles*.root"'
...
# This scripts sets parameters to find payload ECLExpee5x5E using MC. Other scripts
# are available to obtain payloads "ECLCrystalEnergy5x5", "ECLeedPhiData", or "ECLeedPhiMC", or to
...
algo.setOutputName("eclee5x5_algorithm_expE.root")
algo.setMinEntries(15)
algo.setPayloadName("ECLExpee5x5E")
