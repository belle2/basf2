...
# Usage: basf2 -i inputFile run_ee5x5_collector_data.py
# option: basf2 -i inputFile run_ee5x5_collector_data.py OutputFile.root
...
# This script sets parameters appropriate for data. Use run_ee5x5_collector_mc.py for MC
...
main = b2.create_path()
DR2 = '/hsm/belle2/bdata/Data/release-02-01-00/DB00000438/prod00000006/e0003/4S/r00529/all/cdst/sub00/*.root'
main.add_module('RootInput', inputFileNames=[DR2])

narg = len(sys.argv)
outputName = "ee5x5CollectorOutput_data.root"
if(narg >= 2):
...
eclee5x5.param('useCalDigits', False)
