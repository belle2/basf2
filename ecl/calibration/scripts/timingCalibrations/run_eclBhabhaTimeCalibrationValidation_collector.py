...
# which reads in the bhabha events to perform the bhabha
...
#   basf2 run_eclBhabhaTimeCalibrationValidation_collector.py -i "/path/to/input/files/*.root" -o collector_output.root
#
...
#   And then call
#   basf2 run_eclBhabhaTimeCalibrationValidation_collector.py
...
# == Output file
OUTPUT = "eclBhabhaTimeCalibrationValidationCollector.root"
...
ECLtimeCalibValidationCollectorInfo = main.add_module('eclBhabhaTimeCalibrationValidationCollector', timeAbsMax=TIME_ABS_MAX,
                                                      saveTree=SAVE_TREE)
