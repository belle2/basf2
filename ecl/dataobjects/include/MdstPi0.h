...
namespace Belle2 {
  ...
  public:
    ...
    MdstShower* m_aECLShower1;

    //! The method to set shower1 id
    void setShower1(MdstShower* aECLShower) { m_aECLShower1 = aECLShower;}

    //! The method to get shower1
    MdstShower* getShower1() {return m_aECLShower1; }

    //! The method to get shower1 id
    int getShower1Id() const { return  m_aECLShower1->GetShowerId(); }

    //! The shower point of this gamma2.
    MdstShower* m_aECLShower2;

    //! The method to set shower1 id
    void setShower2(MdstShower* aECLShower) { m_aECLShower2 = aECLShower;}

    //! The method to get shower1
    MdstShower* getShower2() {return m_aECLShower2; }
