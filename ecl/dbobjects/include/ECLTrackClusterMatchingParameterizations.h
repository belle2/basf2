...
namespace Belle2 {
  ...
  public:
    ...
    /** Constructor */
    ECLTrackClusterMatchingParameterizations(std::map<std::string, TF1> RMSParameterizationFunctions):
    ...
    std::map<std::string, TF1> getRMSParameterizations() const {return m_RMSParameterizationFunctions;};
