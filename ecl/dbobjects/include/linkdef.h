...
#pragma link C++ class Belle2::ECLTimeWalkCorrection+; // checksum=0xd21ebfc6, version=1
#pragma link C++ class Belle2::ECLClusteringParameters+; // , checksum=0x3d2c9379, version=1
