...
inputFile.param('inputFileName', '/hsm/belle2/bdata/users/cguenthe/LeptonIDWork/MDST/BGx0/pdg' + str(particle_type) +
...
eclchargedpid.param(
    'rootFileName',
    '/home/belle/cguenthe/B2Analysis/LeptonIDWork/InputRoot/BGx0/pdg' +
    str(particle_type) +
    '_mom' +
    str(p_min) +
    'to' +
