...
void eclEdgeCollectorModule::prepare()
{
  ...
  auto eclCrystalTheta = new TH1F("eclCrystalTheta", "theta of each crystal;cellID;theta (rad)", 8736, 1, 8737);
  registerObject<TH1F>("eclCrystalTheta", eclCrystalTheta);

  auto eclCrystalPhi = new TH1F("eclCrystalPhi", "phi of each crystal;cellID;phi (rad)", 8736, 1, 8737);
