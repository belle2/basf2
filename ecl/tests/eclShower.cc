...
namespace Belle2 {
  ...
  TEST_F(ECLShowerTest, Constructors)
  {
    ...
    EXPECT_EQ(myECLShower.getAbsZernike20(), 0);
    EXPECT_EQ(myECLShower.getAbsZernike40(), 0);
    EXPECT_EQ(myECLShower.getAbsZernike42(), 0);
    EXPECT_EQ(myECLShower.getAbsZernike51(), 0);
    EXPECT_EQ(myECLShower.getAbsZernike53(), 0);
  ...
  TEST_F(ECLShowerTest, SettersAndGetters)
  {
    ...
    const double absZernike20 = 3.3;
    const double absZernike40 = 3.4;
    const double absZernike42 = 3.5;
    const double absZernike51 = 3.6;
    const double absZernike53 = 3.7;
    ...
    myECLShower.setAbsZernike20(absZernike20);
    myECLShower.setAbsZernike40(absZernike40);
    myECLShower.setAbsZernike42(absZernike42);
    myECLShower.setAbsZernike51(absZernike51);
    myECLShower.setAbsZernike53(absZernike53);
    ...
    EXPECT_EQ(myECLShower.getAbsZernike20(), absZernike20);
    EXPECT_EQ(myECLShower.getAbsZernike40(), absZernike40);
    EXPECT_EQ(myECLShower.getAbsZernike42(), absZernike42);
    EXPECT_EQ(myECLShower.getAbsZernike51(), absZernike51);
    EXPECT_EQ(myECLShower.getAbsZernike53(), absZernike53);
