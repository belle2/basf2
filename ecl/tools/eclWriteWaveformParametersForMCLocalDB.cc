...
int main()
{
  ...
  double photonParameters[] = {27.7221, 0.5, 0.648324, 0.401711, 0.374167, 0.849417, 0.00144548, 4.70722, 0.815639, 0.555605, 0.2752};
  double hadronParameters[] = {29.5092, 0.542623, 0.929354, 0.556139, 0.446967, 0.140175, 0.0312971, 3.12842, 0.791012, 0.619416, 0.385621};
  double diodeParameters[] = {28.7801, 0.578214, 0.00451387, 0.663087, 0.501441, 0.12073, 0.029675, 3.0666, 0.643883, 0.756048, 0.509381};

  std::vector<double>  PhotonMCPar11;
  std::vector<double>  HadronMCPar11;
  std::vector<double>  DiodeMCPar11;
