...
def fit_kaon_eop(**kwargs):
    ...
    if kwargs["pmin"] < 3e3:
        eop_range = (0.0, 1.0)
        bifurgaus_mu_range = (0.065, 0.01, 0.15)
        bifurgaus_sigmaL_range = (0.01, 0.001, 0.05)
        bifurgaus_sigmaR_range = (0.02, 0.001, 0.1)
        bifurgaus_frac_range = (0.6, 1.0)
    ...
    if kwargs["pmin"] < 1e3:
        eop_range = (0.0, 1.2)
        bifurgaus_mu_range = (0.2, 0.1, 0.4)
        bifurgaus_sigmaL_range = (0.01, 0.001, 0.1)
        bifurgaus_sigmaR_range = (0.05, 0.001, 0.1)
        bifurgaus_frac_range = (0.5, 1.0)
        gaus0_mu_range = (0.5, 0.35, 0.65)
        gaus0_sigma_range = (0.1, 0.01, 0.2)
        gaus1_mu_range = (0.5, 0.35, 0.8)
        gaus1_sigma_range = (0.1, 0.01, 0.7)
        gaus1_frac_range = (0.0, 1.0)
    if kwargs["pmin"] < 0.75e3:
        # No more mid-E/p kink; now gaus0 describes the feature at low E/p
        eop_range = (0.0, 1.4)
        bifurgaus_mu_range = (0.35, 0.15, 0.5) if kwargs["charge"] > 0 else (0.5, 0.3, 0.7)
        bifurgaus_sigmaL_range = (0.1, 0.001, 0.2)
        bifurgaus_sigmaR_range = (0.1, 0.001, 0.2)
        bifurgaus_frac_range = (0.0, 1.0)
        gaus0_mu_range = (0.05, 0.0, 0.1)
        gaus0_sigma_range = (0.025, 0.0, 0.05)
        gaus1_mu_range = (0.8, 0.1, 1.0) if kwargs["charge"] > 0 else (1.0, 0.7, 1.4)
    ...
    if kwargs["pmin"] < 0.4e3:
        eop_range = (0.0, 1.5)
        bifurgaus_mu_range = (0.45, 0.15, 0.6) if kwargs["charge"] > 0 else (0.35, 0.2, 0.7)
        bifurgaus_sigmaL_range = (0.1, 0.001, 0.2)
        bifurgaus_sigmaR_range = (0.1, 0.001, 0.2)
        bifurgaus_frac_range = (0.0, 1.0)
        gaus0_mu_range = (0.05, 0.0, 0.2)
        gaus0_sigma_range = (0.025, 0.0, 0.05)
        gaus1_mu_range = (0.8, 0.1, 1.0)
        gaus1_sigma_range = (0.2, 0.01, 0.7)
        gaus1_frac_range = (0.0, 1.0)
    ...
    pdf.plotOn(frame1,
               ...
               ROOT.RooFit.LineColor(ROOT.kCyan - 3),
               ROOT.RooFit.LineWidth(2),
               ROOT.RooFit.MoveToBack())
