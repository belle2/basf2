...
/*
<header>
<input>ECLBkgOutput.root, ECLClusterOutputFWD.root, ECLClusterOutputBarrel.root, ECLClusterOutputBWD.root, ECLClusterOutputFWD_1000MeV.root, ECLClusterOutputBarrel_1000MeV.root, ECLClusterOutputBWD_1000MeV.root, ECLMuonOutput.root, ECLEvtGenOutput.root</input>
<output>ECLBkg.root, ECL2D.root, ECLMuon.root, ECLClusterFWD.root, ECLClusterBarrel.root, ECLClusterBWD.root, ECLClusterFWD_1000MeV.root, ECLClusterBarrel_1000MeV.root, ECLClusterBWD_1000MeV.root, ECLCalDigitFWD.root, ECLCalDigitBarrel.root, ECLCalDigitBWD.root, ECLClusterResoBWD.root, ECLGenericBBEvtGen.root</output>
...
void ECLClusterFWD_1000MeV(TTree* cluster_treeFWD);
void ECLClusterBarrel_1000MeV(TTree* cluster_treeBarrel);
void ECLClusterBWD_1000MeV(TTree* cluster_treeBWD);
...
void makeECLPlots() 
{
  ...
  if (TFile::Open("../ECLBkgOutput.root") != nullptr) {
    ...
    TTree* bkg_tree = static_cast<TTree*>(bkg_input->Get("m_tree"));
    ECL2D(bkg_tree);
    ECLBkg(bkg_tree);
  }
  if (TFile::Open("../ECLClusterOutputFWD.root") != nullptr) {
    TFile* cluster_inputFWD = TFile::Open("../ECLClusterOutputFWD.root");
    TTree* cluster_treeFWD = static_cast<TTree*>(cluster_inputFWD->Get("m_tree"));
  ...
  if (TFile::Open("../ECLClusterOutputFWD_1000MeV.root") != nullptr) {
    ...
    TTree* cluster_treeFWD_1000MeV = static_cast<TTree*>(cluster_inputFWD_1000MeV->Get("m_tree"));
    ECLClusterFWD_1000MeV(cluster_treeFWD_1000MeV);
  }
  if (TFile::Open("../ECLClusterOutputFWD.root") != nullptr) {
    TFile* clusterReso_inputFWD = TFile::Open("../ECLClusterOutputFWD.root");
    TTree* clusterReso_treeFWD = static_cast<TTree*>(clusterReso_inputFWD->Get("m_tree"));
    ECLClusterResoFWD(clusterReso_treeFWD);
  }
  if (TFile::Open("../ECLClusterOutputFWD.root") != nullptr) {
    TFile* cd_inputFWD = TFile::Open("../ECLClusterOutputFWD.root");
    TTree* cd_treeFWD = static_cast<TTree*>(cd_inputFWD->Get("m_tree"));
  ...
  if (TFile::Open("../ECLClusterOutputBarrel.root") != nullptr) {
    ...
    TTree* cluster_treeBarrel = static_cast<TTree*>(cluster_inputBarrel->Get("m_tree"));
  ...
  if (TFile::Open("../ECLClusterOutputBarrel_1000MeV.root") != nullptr) {
    ...
    TTree* cluster_treeBarrel_1000MeV = static_cast<TTree*>(cluster_inputBarrel_1000MeV->Get("m_tree"));
    ECLClusterBarrel_1000MeV(cluster_treeBarrel_1000MeV);
  } 
  if (TFile::Open("../ECLClusterOutputBarrel.root") != nullptr) {
    TFile* clusterReso_inputBarrel = TFile::Open("../ECLClusterOutputBarrel.root");
    TTree* clusterReso_treeBarrel = static_cast<TTree*>(clusterReso_inputBarrel->Get("m_tree"));
    ECLClusterResoBarrel(clusterReso_treeBarrel);
  }
  if (TFile::Open("../ECLClusterOutputBarrel.root") != nullptr) {
    TFile* cd_inputBarrel = TFile::Open("../ECLClusterOutputBarrel.root");
    TTree* cd_treeBarrel = static_cast<TTree*>(cd_inputBarrel->Get("m_tree"));
  ...
  if (TFile::Open("../ECLClusterOutputBWD.root") != nullptr) {
    ...
    TTree* cluster_treeBWD = static_cast<TTree*>(cluster_inputBWD->Get("m_tree"));
...
void ECLMuon(TTree* muon_tree)
{
  ...
  TH1F* hMuonsE = new TH1F("hMuonsE", "Reconstructed cluster energy for (0.5 - 3 GeV) muons, the typical energy is 0.2 GeV", 50, 0., 0.6);
  muon_tree->Draw("eclClusterEnergy>>hMuonsE","eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1&&(eclClusterToMCWeight1-eclClusterToBkgWeight)/eclClusterEnergy>0");
  ...
  hMuonsE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  hMuonsE->Write();
  ...
  muon_tree->Draw("(2*eclClusterIsTrack-1)>>hMuonsFake","eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1&&(eclClusterToMCWeight1-eclClusterToBkgWeight)>0");
  ...
  hMuonsFake->GetListOfFunctions()->Add(new TNamed("Contact", "priyanka.cheema@kit.edu")); 
  hMuonsFake->Write(); 

  TH1F* hMuonsFakeTheta = new TH1F("hMuonsFakeTheta","#theta distribution for fake (non-bkg) neutral clusters", 25, 0, 3.2);

  muon_tree->Draw("eclClusterTheta>>hMuonsFakeTheta","eclClusterToMC1==0&&eclClusterIsTrack==0&&eclClusterHasNPhotonHypothesis==1&&(eclClusterToMCWeight1-eclClusterToBkgWeight)>0");
  hMuonsFakeTheta->GetXaxis()->SetTitle("#theta (rad)");
  hMuonsFakeTheta->GetListOfFunctions()->Add(new TNamed("Description", "$\\theta$ distribution for fake gammas")); 
  ...
  hMuonsFakeTheta->GetListOfFunctions()->Add(new TNamed("Contact", "priyanka.cheema@kit.edu")); 
...
lem diagnosis when the number of fake cluster is unexpectedly high."));
  hMuonsFakePhi->GetListOfFunctions()->Add(new TNamed("Contact", "priyanka.cheema@kit.edu")); 
  hMuonsFakePhi->Write(); 
...
void ECLClusterFWD(TTree* cluster_treeFWD)
{
  ...
  cluster_treeFWD->SetBranchAddress("eclClusterHasNPhotonHypothesis", &eclClusterHasNPhotonHypothesis);
  ...
  for(int i=0; i<cluster_treeFWD->GetEntries();i++){
    ...
    int h=0;
    for(int j=0;j<eclClusterHasNPhotonHypothesis->size();j++){
      if (eclClusterHasNPhotonHypothesis->at(j) == 1)
  ...
  hMultip->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  hMultip->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hEnergy = new TH1F("hEnergy","Corrected Cluster Energy in FWD endcap", 50, 0., 0.2);
  cluster_treeFWD->Draw("eclClusterEnergy>>hEnergy","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hEnergy->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  hEnergy->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hEnDepSum = new TH1F("hEnDepSum","Reconstructed Cluster Energy in FWD endcap", 50, 0., 0.2);
  cluster_treeFWD->Draw("eclClusterEnergyDepSum>>hEnDepSum","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hEnDepSum->GetListOfFunctions()->Add(new TNamed("Contact", "priyanka.cheema@kit.edu"));

  TH1F* hECorr = new TH1F("hECorr","Cluster Energy correction in FWD endcap", 50, -0.01, 0.02);
  cluster_treeFWD->Draw("(eclClusterEnergy - eclClusterEnergyDepSum)>>hECorr","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hECorr->GetListOfFunctions()->Add(new TNamed("Contact", "priyanka.cheema@kit.edu"));

  TH1F* hHighestE = new TH1F("hHighestE","Highest Energy Deposit in FWD endcap", 50, 0., 0.14);
  cluster_treeFWD->Draw("eclClusterHighestE>>hHighestE","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hHighestE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hE9oE21 = new TH1F("hE9oE21","E9/E21 in FWD endcap", 50, 0., 1.2);
  cluster_treeFWD->Draw("eclClusterE9oE21>>hE9oE21","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hE1oE9 = new TH1F("hE1oE9","E1/E9 in FWD endcap", 50, 0., 1.2);
  cluster_treeFWD->Draw("eclClusterE1oE9>>hE1oE9","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hphi = new TH1F("hphi", "Reconstructed #phi Angle in FWD endcap",60, -3.2, 3.2);
  cluster_treeFWD->Draw("eclClusterPhi>>hphi","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hphi->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphi->GetXaxis()->SetTitle("#phi (rad)");
  hphi->SetMinimum(.0);
  hphi->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hEError = new TH1F("hEError", "Energy error in FWD endcap", 50, 0, 0.01);
  cluster_treeFWD->Draw("eclCluster Energy Error>>hEError","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hEError->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* htheta = new TH1F("htheta", "Reconstructed #theta Angle in FWD endcap", 30, 0.22, 0.55);
  cluster_treeFWD->Draw("eclClusterTheta>>htheta","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  htheta->SetMinimum(.0);
  htheta->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hthetaerror = new TH1F("hthetaerror", "Reconstructed #theta error in FWD endcap", 50, 0, 0.025);
  cluster_treeFWD->Draw("eclClusterThetaError>>hthetaerror","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hphierror = new TH1F("hphierror", "Reconstructed #phi error in FWD endcap", 50, 0, 0.025);
  cluster_treeFWD->Draw("eclClusterPhiError>>hphierror","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hphierror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hR = new TH1F("hR", "Reconstructed #R in FWD endcap", 50, 210, 250);
  cluster_treeFWD->Draw("eclClusterR>>hR","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hR->SetMinimum(.0);
  hR->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hTiming = new TH1F("hTiming", "Cluster Timing in FWD endcap", 50, -130, 130);
  cluster_treeFWD->Draw("eclClusterTiming>>hTiming","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hTiming->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  hTiming->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hLAT = new TH1F("hLAT", "Cluster LAT in FWD endcap", 50, 0, 1);
  cluster_treeFWD->Draw("eclClusterLAT>>hLAT","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hLAT->SetMinimum(.0);
  hLAT->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hNofCrystals = new TH1F("hNofCrystals", "Cluster NofCrystals in FWD endcap", 25, 0, 25);
  cluster_treeFWD->Draw("eclClusterNofCrystals>>hNofCrystals","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hIsTrack = new TH1F("hIsTrack", "Cluster IsTrack in FWD endcap", 2, 0, 1);
  cluster_treeFWD->Draw("eclClusterIsTrack>>hIsTrack","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hAbsZernike40 = new TH1F("hAbsZernike40", "Cluster AbsZernike40 in FWD endcap", 50, 0, 2);
  cluster_treeFWD->Draw("eclClusterAbsZernike40>>hAbsZernike40","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hAbsZernike51 = new TH1F("hAbsZernike51", "Cluster AbsZernike51 in FWD endcap", 50, 0, 1.2);
  cluster_treeFWD->Draw("eclClusterAbsZernike51>>hAbsZernike51","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hZernikeMVA = new TH1F("hZernikeMVA", "Cluster ZernikeMVA in FWD endcap", 50, 0, 1.2);
  cluster_treeFWD->Draw("eclClusterZernikeMVA>>hZernikeMVA","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hSecondMoment = new TH1F("hSecondMoment", "Cluster Second Moment in FWD endcap", 50, 0, 8);
  cluster_treeFWD->Draw("eclClusterSecondMoment>>hSecondMoment","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
...
void ECLClusterFWD_1000MeV(TTree* cluster_treeFWD)
{
  ...
  hMultip->GetListOfFunctions()->Add(new TNamed("Description", "Multiplicity of (true) reconstructed clusters for 1000 MeV/c single photons in FWD endcap"));
  hMultip->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape.")); 
  hMultip->GetXaxis()->SetTitle("Cluster multiplicity");
  hMultip->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  hMultip->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hEnergy = new TH1F("hEnergy","Corrected Cluster Energy in FWD endcap", 50, 0.7, 1.1);
  cluster_treeFWD->Draw("eclClusterEnergy>>hEnergy","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hHighestE = new TH1F("hHighestE","Highest Energy Deposit in FWD endcap", 50, 0., 0.14);
  cluster_treeFWD->Draw("eclClusterHighestE>>hHighestE","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hHighestE->GetListOfFunctions()->Add(new TNamed("Description", "Highest energy deposited in a crystal for 1000 MeV/c single photons in FWD endcap"));
  hHighestE->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hHighestE->GetXaxis()->SetTitle("Deposited Energy(GeV)");
  hHighestE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hE9oE21 = new TH1F("hE9oE21","E9/E21 in FWD endcap", 50, 0., 1.2);
  cluster_treeFWD->Draw("eclClusterE9oE21>>hE9oE21","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Description", "Energy deposited in 3x3 matrix around most energetic deposit over energy deposited in 5x5 matrix around most energetic deposit 1000 MeV/c single photons in FWD endcap"));
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hE9oE21->GetXaxis()->SetTitle("E9oE21");
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hE1oE9 = new TH1F("hE1oE9","E1/E9 in FWD endcap", 50, 0., 1.2);
  cluster_treeFWD->Draw("eclClusterE1oE9>>hE1oE9","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Description", "Energy deposited in 3x3 matrix around most energetic deposit over energy deposited in 5x5 matrix around most energetic deposit 1000 MeV/c single photons in FWD endcap"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hE1oE9->GetXaxis()->SetTitle("E1oE9");
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));
  ...
  TH1F* hphi = new TH1F("hphi", "Reconstructed #phi Angle in FWD endcap", 60, -3.2, 3.2);
  cluster_treeFWD->Draw("eclClusterPhi>>hphi","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hphi->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\phi$ angle of the cluster for 1000 MeV/c single photons in FWD endcap"));
  hphi->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphi->GetXaxis()->SetTitle("#phi (rad)");
  hphi->SetMinimum(.0);
  hphi->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hEError = new TH1F("hEError", "Energy error in FWD endcap", 50, 0, 0.01);
  cluster_treeFWD->Draw("eclCluster Energy Error>>hEError","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hEError->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed energy error of the cluster for 1000 MeV/c single photons in FWD endcap"));
  hEError->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hEError->GetXaxis()->SetTitle("Cluster energy error (GeV)");
  hEError->SetMinimum(.0);
  hEError->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* htheta = new TH1F("htheta", "Reconstructed #theta Angle in FWD endcap", 30, 0.22, 0.55);
  cluster_treeFWD->Draw("eclClusterTheta>>htheta","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  htheta->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\theta$ angle of the cluster for 1000 MeV/c single photons in FWD endcap"));
  htheta->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  htheta->GetXaxis()->SetTitle("#theta (rad)");
  htheta->SetMinimum(.0);
  htheta->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hthetaerror = new TH1F("hthetaerror", "Reconstructed #theta error in FWD endcap", 50, 0, 0.025);
  cluster_treeFWD->Draw("eclClusterThetaError>>hthetaerror","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\theta$ error of the cluster for 1000 MeV/c single photons in FWD endcap"));
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hthetaerror->GetXaxis()->SetTitle("#theta error (rad)");
  hthetaerror->SetMinimum(.0);
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hphierror = new TH1F("hphierror", "Reconstructed #phi error in FWD endcap", 50, 0, 0.025);
  cluster_treeFWD->Draw("eclClusterPhiError>>hphierror","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hphierror->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\phi$ error of the cluster for 1000 MeV/c single photons in FWD endcap"));
  hphierror->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphierror->GetXaxis()->SetTitle("#phi error (rad)");
  hphierror->SetMinimum(.0);
  hphierror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hR = new TH1F("hR", "Reconstructed #R in FWD endcap", 50, 210, 250);
  cluster_treeFWD->Draw("eclClusterR>>hR","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hR->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed R of the cluster for 1000 MeV/c single photons in FWD endcap"));
  hR->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hR->GetXaxis()->SetTitle("#R ");
  hR->SetMinimum(.0);
  hR->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hTiming = new TH1F("hTiming", "Cluster Timing in FWD endcap", 50, -130, 130);
  cluster_treeFWD->Draw("eclClusterTiming>>hTiming","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hTiming->GetListOfFunctions()->Add(new TNamed("Description", "Cluster timing for 1000 MeV/c single photons in FWD endcap"));
  hTiming->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hTiming->GetXaxis()->SetTitle("#Timing");
  hTiming->SetMinimum(.0);
  hTiming->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hLAT = new TH1F("hLAT", "Cluster LAT in FWD endcap", 50, 0, 1);
  cluster_treeFWD->Draw("eclClusterLAT>>hLAT","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hLAT->GetListOfFunctions()->Add(new TNamed("Description", "Cluster LAT for 1000 MeV/c single photons in FWD endcap"));
  hLAT->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hLAT->GetXaxis()->SetTitle("#LAT");
  hLAT->SetMinimum(.0);
  hLAT->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hNofCrystals = new TH1F("hNofCrystals", "Cluster NofCrystals in FWD endcap", 25, 0, 25);
  cluster_treeFWD->Draw("eclClusterNofCrystals>>hNofCrystals","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Description", "Number of crystal in the cluster for 1000 MeV/c single photons in FWD endcap"));
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hNofCrystals->GetXaxis()->SetTitle("#NofCrystals");
  hNofCrystals->SetMinimum(.0);
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hIsTrack = new TH1F("hIsTrack", "Cluster IsTrack in FWD endcap", 2, 0, 1);
  cluster_treeFWD->Draw("eclClusterIsTrack>>hIsTrack","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Description", "Number of clusters with a matched track for 1000 MeV/c single photons in FWD endcap"));
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hIsTrack->GetXaxis()->SetTitle("#IsTrack");
  hIsTrack->SetMinimum(.0);
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hAbsZernike40 = new TH1F("hAbsZernike40", "Cluster AbsZernike40 in FWD endcap", 50, 0, 2);
  cluster_treeFWD->Draw("eclClusterAbsZernike40>>hAbsZernike40","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Zernike40 for 1000 MeV/c single photons in FWD endcap"));
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hAbsZernike40->GetXaxis()->SetTitle("AbsZernike40");
  hAbsZernike40->SetMinimum(.0);
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hAbsZernike51 = new TH1F("hAbsZernike51", "Cluster AbsZernike51 in FWD endcap", 50, 0, 1.2);
  cluster_treeFWD->Draw("eclClusterAbsZernike51>>hAbsZernike51","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Zernike51 for 1000 MeV/c single photons in FWD endcap"));
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hAbsZernike51->GetXaxis()->SetTitle("AbsZernike51");
  hAbsZernike51->SetMinimum(.0);
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hZernikeMVA = new TH1F("hZernikeMVA", "Cluster ZernikeMVA in FWD endcap", 50, 0, 1.2);
  cluster_treeFWD->Draw("eclClusterZernikeMVA>>hZernikeMVA","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Description", "Cluster ZernikeMVA for 1000 MeV/c single photons in FWD endcap"));
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hZernikeMVA->GetXaxis()->SetTitle("ZernikeMVA");
  hZernikeMVA->SetMinimum(.0);
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hSecondMoment = new TH1F("hSecondMoment", "Cluster Second Moment in FWD endcap", 50, 0, 8);
  cluster_treeFWD->Draw("eclClusterSecondMoment>>hSecondMoment","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Second Moment for 1000 MeV/c single photons in FWD endcap"));
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hSecondMoment->GetXaxis()->SetTitle("SecondMoment");
  hSecondMoment->SetMinimum(.0);
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TFile* output = TFile::Open("ECLClusterFWD_1000MeV.root", "recreate");
  hMultip->Write();
  hEnergy->Write();
  hEnDepSum->Write();
  hHighestE->Write();
...
void ECLClusterBarrel(TTree* cluster_treeBarrel)
{
  ...
  std::vector<int>* eclClusterHasNPhotonHypothesis=0;
  cluster_treeBarrel->SetBranchAddress("eclClusterHasNPhotonHypothesis", &eclClusterHasNPhotonHypothesis);
  std::vector<int>* eclClusterToMC1=0;
  ...
  TH1F* hEnergy = new TH1F("hEnergy","Corrected Cluster Energy in Barrel", 50, 0., 0.2);
  cluster_treeBarrel->Draw("eclClusterEnergy>>hEnergy","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hEnDepSum = new TH1F("hEnDepSum","Reconstructed Cluster Energy in Barrel", 50, 0., 0.2);
  cluster_treeBarrel->Draw("eclClusterEnergyDepSum>>hEnDepSum","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  cluster_treeBarrel->Draw("(eclClusterEnergy - eclClusterEnergyDepSum)>>hECorr","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hECorr->GetListOfFunctions()->Add(new TNamed("Description", "Energy correction for 100 MeV/c single photons in barrel"));
  hECorr->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape.")); 
  hECorr->GetXaxis()->SetTitle("Energy correction (GeV)");
  hECorr->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hHighestE = new TH1F("hHighestE","Highest Energy Deposit in Barrel", 50, 0., 0.14);
  cluster_treeBarrel->Draw("eclClusterHighestE>>hHighestE","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hE9oE21 = new TH1F("hE9oE21","E9/E21 in Barrel", 50, 0., 1.2);
  cluster_treeBarrel->Draw("eclClusterE9oE21>>hE9oE21","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hE1oE9 = new TH1F("hE1oE9","E1/E9 in Barrel", 50, 0., 1.2);
  cluster_treeBarrel->Draw("eclClusterE1oE9>>hE1oE9","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hphi = new TH1F("hphi", "Reconstructed #phi Angle in Barrel", 60, -3.2, 3.2);
  cluster_treeBarrel->Draw("eclClusterPhi>>hphi","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hEError = new TH1F("hEError", "Energy error in Barrel", 50, 0, 0.01);
  cluster_treeBarrel->Draw("eclCluster Energy Error>>hEError","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* htheta = new TH1F("htheta", "Reconstructed #theta Angle in Barrel", 50, 0.5, 2.35);
  cluster_treeBarrel->Draw("eclClusterTheta>>htheta","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hthetaerror = new TH1F("hthetaerror", "Reconstructed #theta error in Barrel", 50, 0, 0.025);
  cluster_treeBarrel->Draw("eclClusterThetaError>>hthetaerror","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hphierror = new TH1F("hphierror", "Reconstructed #phi error in Barrel", 50, 0, 0.025);
  cluster_treeBarrel->Draw("eclClusterPhiError>>hphierror","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hR = new TH1F("hR", "Reconstructed #R in Barrel", 50, 130, 260);
  cluster_treeBarrel->Draw("eclClusterR>>hR","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hTiming = new TH1F("hTiming", "Cluster Timing in Barrel", 50, -130, 130);
  cluster_treeBarrel->Draw("eclClusterTiming>>hTiming","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hLAT = new TH1F("hLAT", "Cluster LAT in Barrel", 50, 0, 1);
  cluster_treeBarrel->Draw("eclClusterLAT>>hLAT","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  cluster_treeBarrel->Draw("eclClusterNofCrystals>>hNofCrystals","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  cluster_treeBarrel->Draw("eclClusterIsTrack>>hIsTrack","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hAbsZernike40 = new TH1F("hAbsZernike40", "Cluster AbsZernike40 in Barrel ", 50, 0, 2);
  cluster_treeBarrel->Draw("eclClusterAbsZernike40>>hAbsZernike40","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hAbsZernike51 = new TH1F("hAbsZernike51", "Cluster AbsZernike51 in Barrel ", 50, 0, 1.2);
  cluster_treeBarrel->Draw("eclClusterAbsZernike51>>hAbsZernike51","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hZernikeMVA = new TH1F("hZernikeMVA", "Cluster ZernikeMVA in Barrel ", 50, 0, 1.2);
  cluster_treeBarrel->Draw("eclClusterZernikeMVA>>hZernikeMVA","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hSecondMoment = new TH1F("hSecondMoment", "Cluster Second Moment in Barrel ", 50, 0, 8);
  cluster_treeBarrel->Draw("eclClusterSecondMoment>>hSecondMoment","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
...
void ECLClusterBarrel_1000MeV(TTree* cluster_treeBarrel)
{
  ...
  hMultip->GetListOfFunctions()->Add(new TNamed("Description", "Multiplicity of reconstructed clusters for 1000 MeV/c single photons in Barrel"));
  hMultip->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape.")); 
  hMultip->GetXaxis()->SetTitle("Cluster multiplicity");
  hMultip->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  hMultip->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hEnergy = new TH1F("hEnergy","Corrected Cluster Energy in Barrel", 50, 0.7, 1.1);
  cluster_treeBarrel->Draw("eclClusterEnergy>>hEnergy","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hEnDepSum = new TH1F("hEnDepSum","Reconstructed Cluster Energy in Barrel", 50, 0.7, 1.1);
  cluster_treeBarrel->Draw("eclClusterEnergyDepSum>>hEnDepSum","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hHighestE = new TH1F("hHighestE","Highest Energy Deposit in Barrel", 50, 0., 0.14);
  cluster_treeBarrel->Draw("eclClusterHighestE>>hHighestE","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hHighestE->GetListOfFunctions()->Add(new TNamed("Description", "Highest energy deposited in a crystal for 1000 MeV/c single photons in Barrel"));
  hHighestE->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hHighestE->GetXaxis()->SetTitle("Deposited energy(GeV)");
  hHighestE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hE9oE21 = new TH1F("hE9oE21","E9/E21 in Barrel", 50, 0., 1.2);
  cluster_treeBarrel->Draw("eclClusterE9oE21>>hE9oE21","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Description", "Energy deposited in 3x3 matrix around most energetic deposit over energy deposited in 5x5 matrix around most energetic deposit 1000 MeV/c single photons in Barrel"));
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hE9oE21->GetXaxis()->SetTitle("E9oE21");
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hE1oE9 = new TH1F("hE1oE9","E1/E9 in Barrel", 50, 0., 1.2);
  cluster_treeBarrel->Draw("eclClusterE1oE9>>hE1oE9","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Description", "Energy deposited in 3x3 matrix around most energetic deposit over energy deposited in 5x5 matrix around most energetic deposit 1000 MeV/c single photons in Barrel"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hE1oE9->GetXaxis()->SetTitle("E1oE9");
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));
  ...
  TH1F* hphi = new TH1F("hphi", "Reconstructed #phi Angle in Barrel", 60, -3.2, 3.2);
  cluster_treeBarrel->Draw("eclClusterPhi>>hphi","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hphi->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\phi$ angle of the cluster for 1000 MeV/c single photons in Barrel"));
  hphi->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphi->GetXaxis()->SetTitle("#phi (rad)");
  hphi->SetMinimum(.0);
  hphi->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hEError = new TH1F("hEError", "Energy error in Barrel", 50, 0, 0.01);
  cluster_treeBarrel->Draw("eclCluster Energy Error>>hEError","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hEError->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed energy error of the cluster for 1000 MeV/c single photons in Barrel"));
  hEError->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hEError->GetXaxis()->SetTitle("Cluster energy error (GeV)");
  hEError->SetMinimum(.0);
  hEError->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* htheta = new TH1F("htheta", "Reconstructed #theta Angle in Barrel", 50, 0.5, 2.35);
  cluster_treeBarrel->Draw("eclClusterTheta>>htheta","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  htheta->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\theta$ angle of the cluster for 1000 MeV/c single photons in Barrel"));
  htheta->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  htheta->GetXaxis()->SetTitle("#theta (rad)");
  htheta->SetMinimum(.0);
  htheta->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hthetaerror = new TH1F("hthetaerror", "Reconstructed #theta error in Barrel", 50, 0, 0.025);
  cluster_treeBarrel->Draw("eclClusterThetaError>>hthetaerror","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\theta$ error of the cluster for 1000 MeV/c single photons in Barrel"));
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hthetaerror->GetXaxis()->SetTitle("#theta error (rad)");
  hthetaerror->SetMinimum(.0);
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hphierror = new TH1F("hphierror", "Reconstructed #phi error in Barrel", 50, 0, 0.025);
  cluster_treeBarrel->Draw("eclClusterPhiError>>hphierror","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hphierror->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\phi$ error of the cluster for 1000 MeV/c single photons in Barrel"));
  hphierror->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphierror->GetXaxis()->SetTitle("#phi error (rad)");
  hphierror->SetMinimum(.0);
  hphierror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hR = new TH1F("hR", "Reconstructed #R in Barrel", 50, 130, 260);
  cluster_treeBarrel->Draw("eclClusterR>>hR","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hR->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed R of the cluster for 1000 MeV/c single photons in Barrel"));
  hR->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hR->GetXaxis()->SetTitle("#R ");
  hR->SetMinimum(.0);
  hR->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hTiming = new TH1F("hTiming", "Cluster Timing in Barrel", 50, -130, 130);
  cluster_treeBarrel->Draw("eclClusterTiming>>hTiming","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hTiming->GetListOfFunctions()->Add(new TNamed("Description", "Cluster timing for 1000 MeV/c single photons in Barrel"));
  hTiming->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hTiming->GetXaxis()->SetTitle("#Timing");
  hTiming->SetMinimum(.0);
  hTiming->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hLAT = new TH1F("hLAT", "Cluster LAT in Barrel", 50, 0, 1);
  cluster_treeBarrel->Draw("eclClusterLAT>>hLAT","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hLAT->GetListOfFunctions()->Add(new TNamed("Description", "Cluster LAT for 1000 MeV/c single photons in Barrel"));
  hLAT->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hLAT->GetXaxis()->SetTitle("#LAT");
  hLAT->SetMinimum(.0);
  hLAT->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hNofCrystals = new TH1F("hNofCrystals", "Cluster NofCrystals in Barrel", 25, 0, 25);
  cluster_treeBarrel->Draw("eclClusterNofCrystals>>hNofCrystals","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Description", "Number of crystal in the cluster for 1000 MeV/c single photons in Barrel"));
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hNofCrystals->GetXaxis()->SetTitle("#NofCrystals");
  hNofCrystals->SetMinimum(.0);
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hIsTrack = new TH1F("hIsTrack", "Cluster IsTrack in Barrel", 2, 0, 1);
  cluster_treeBarrel->Draw("eclClusterIsTrack>>hIsTrack","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Description", "Number of clusters with a matched track for 1000 MeV/c single photons in Barrel"));
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hIsTrack->GetXaxis()->SetTitle("#IsTrack");
  hIsTrack->SetMinimum(.0);
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hAbsZernike40 = new TH1F("hAbsZernike40", "Cluster AbsZernike40 in Barrel ", 50, 0, 2);
  cluster_treeBarrel->Draw("eclClusterAbsZernike40>>hAbsZernike40","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Zernike40 for 1000 MeV/c single photons in Barrel "));
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hAbsZernike40->GetXaxis()->SetTitle("AbsZernike40");
  hAbsZernike40->SetMinimum(.0);
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hAbsZernike51 = new TH1F("hAbsZernike51", "Cluster AbsZernike51 in Barrel ", 50, 0, 1.2);
  cluster_treeBarrel->Draw("eclClusterAbsZernike51>>hAbsZernike51","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Zernike51 for 1000 MeV/c single photons in Barrel "));
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hAbsZernike51->GetXaxis()->SetTitle("AbsZernike51");
  hAbsZernike51->SetMinimum(.0);
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hZernikeMVA = new TH1F("hZernikeMVA", "Cluster ZernikeMVA in Barrel ", 50, 0, 1.2);
  cluster_treeBarrel->Draw("eclClusterZernikeMVA>>hZernikeMVA","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Description", "Cluster ZernikeMVA for 1000 MeV/c single photons in Barrel "));
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hZernikeMVA->GetXaxis()->SetTitle("ZernikeMVA");
  hZernikeMVA->SetMinimum(.0);
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hSecondMoment = new TH1F("hSecondMoment", "Cluster Second Moment in Barrel ", 50, 0, 8);
  cluster_treeBarrel->Draw("eclClusterSecondMoment>>hSecondMoment","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Second Moment for 1000 MeV/c single photons in Barrel "));
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hSecondMoment->GetXaxis()->SetTitle("SecondMoment");
  hSecondMoment->SetMinimum(.0);
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TFile* output = TFile::Open("ECLClusterBarrel_1000MeV.root", "recreate");
  hMultip->Write();
  hEnergy->Write();
  hEnDepSum->Write();
  hHighestE->Write();
...
void ECLClusterBWD(TTree* cluster_treeBWD)
{
  ...
  std::vector<int>* eclClusterHasNPhotonHypothesis=0;
  cluster_treeBWD->SetBranchAddress("eclClusterHasNPhotonHypothesis", &eclClusterHasNPhotonHypothesis);
  std::vector<int>* eclClusterToMC1=0;
  ...
  TH1F* hEnergy = new TH1F("hEnergy","Corrected Cluster Energy in BWD endcap", 50, 0., 0.2);
  cluster_treeBWD->Draw("eclClusterEnergy>>hEnergy","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hEnDepSum = new TH1F("hEnDepSum","Reconstructed Cluster Energy in BWD endcap", 50, 0., 0.2);
  cluster_treeBWD->Draw("eclClusterEnergyDepSum>>hEnDepSum","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  cluster_treeBWD->Draw("(eclClusterEnergy - eclClusterEnergyDepSum)>>hECorr","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hECorr->GetListOfFunctions()->Add(new TNamed("Description", "Energy correction for 100 MeV/c single photons in BWD endcap"));
  hECorr->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape.")); 
  hECorr->GetXaxis()->SetTitle("Energy correction (GeV)");
  hECorr->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TH1F* hHighestE = new TH1F("hHighestE","Highest Energy Deposit in BWD endcap", 50, 0., 0.14);
  cluster_treeBWD->Draw("eclClusterHighestE>>hHighestE","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hE9oE21 = new TH1F("hE9oE21","E9/E21 in BWD endcap", 50, 0., 1.2);
  cluster_treeBWD->Draw("eclClusterE9oE21>>hE9oE21","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hE1oE9 = new TH1F("hE1oE9","E1/E9 in BWD endcap", 50, 0., 1.2);
  cluster_treeBWD->Draw("eclClusterE1oE9>>hE1oE9","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hphi = new TH1F("hphi", "Reconstructed #phi Angle in BWD endcap", 60, -3.2, 3.2);
  cluster_treeBWD->Draw("eclClusterPhi>>hphi","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hEError = new TH1F("hEError", "Energy error in BWD endcap", 50, 0, 0.015);
  cluster_treeBWD->Draw("eclCluster Energy Error>>hEError","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* htheta = new TH1F("htheta", "Reconstructed #theta Angle in BWD endcap", 30, 2.28, 2.7);
  cluster_treeBWD->Draw("eclClusterTheta>>htheta","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hthetaerror = new TH1F("hthetaerror", "Reconstructed #theta error in BWD endcap", 50, 0, 0.025);
  cluster_treeBWD->Draw("eclClusterThetaError>>hthetaerror","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hphierror = new TH1F("hphierror", "Reconstructed #phi error in BWD endcap", 50, 0, 0.025);
  cluster_treeBWD->Draw("eclClusterPhiError>>hphierror","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hR = new TH1F("hR", "Reconstructed #R in BWD endcap", 50, 120, 180);
  cluster_treeBWD->Draw("eclClusterR>>hR","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hTiming = new TH1F("hTiming", "Cluster Timing in BWD endcap", 50, -130, 130);
  cluster_treeBWD->Draw("eclClusterTiming>>hTiming","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hLAT = new TH1F("hLAT", "Cluster LAT in BWD endcap", 50, 0, 1);
  cluster_treeBWD->Draw("eclClusterLAT>>hLAT","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  cluster_treeBWD->Draw("eclClusterNofCrystals>>hNofCrystals","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  cluster_treeBWD->Draw("eclClusterIsTrack>>hIsTrack","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hAbsZernike40 = new TH1F("hAbsZernike40", "Cluster AbsZernike40 in BWD endcap", 50, 0, 2);
  cluster_treeBWD->Draw("eclClusterAbsZernike40>>hAbsZernike40","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hAbsZernike51 = new TH1F("hAbsZernike51", "Cluster AbsZernike51 in BWD endcap", 50, 0, 1.2);
  cluster_treeBWD->Draw("eclClusterAbsZernike51>>hAbsZernike51","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hZernikeMVA = new TH1F("hZernikeMVA", "Cluster ZernikeMVA in BWD endcap", 50, 0, 1.2);
  cluster_treeBWD->Draw("eclClusterZernikeMVA>>hZernikeMVA","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hSecondMoment = new TH1F("hSecondMoment", "Cluster Second Moment in BWD endcap", 50, 0, 8);
  cluster_treeBWD->Draw("eclClusterSecondMoment>>hSecondMoment","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
...
void ECLClusterBWD_1000MeV(TTree* cluster_treeBWD)
{
  ...
  hMultip->GetListOfFunctions()->Add(new TNamed("Description", "Multiplicity of reconstructed clusters for 1000 MeV/c single photons in BWD endcap"));
  hMultip->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape.")); 
  hMultip->GetXaxis()->SetTitle("Cluster multiplicity");
  hMultip->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  hMultip->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));

  TH1F* hEnergy = new TH1F("hEnergy","Corrected Cluster Energy in BWD endcap", 50, 0.7, 1.1);
  cluster_treeBWD->Draw("eclClusterEnergy>>hEnergy","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hEnDepSum = new TH1F("hEnDepSum","Reconstructed Cluster Energy in BWD endcap", 50, 0.7, 1.1);
  cluster_treeBWD->Draw("eclClusterEnergyDepSum>>hEnDepSum","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  ...
  TH1F* hHighestE = new TH1F("hHighestE","Highest Energy Deposit in BWD endcap", 50, 0., 0.14);
  cluster_treeBWD->Draw("eclClusterHighestE>>hHighestE","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hHighestE->GetListOfFunctions()->Add(new TNamed("Description", "Highest energy deposited in a crystal for 1000 MeV/c single photons in BWD endcap"));
  hHighestE->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hHighestE->GetXaxis()->SetTitle("Deposited energy(GeV)");
  hHighestE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hE9oE21 = new TH1F("hE9oE21","E9/E21 in BWD endcap", 50, 0., 1.2);
  cluster_treeBWD->Draw("eclClusterE9oE21>>hE9oE21","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Description", "Energy deposited in 3x3 matrix around most energetic deposit over energy deposited in 5x5 matrix around most energetic deposit 1000 MeV/c single photons in BWD endcap"));
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hE9oE21->GetXaxis()->SetTitle("E9oE21");
  hE9oE21->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hE1oE9 = new TH1F("hE1oE9","E1/E9 in BWD endcap", 50, 0., 1.2);
  cluster_treeBWD->Draw("eclClusterE1oE9>>hE1oE9","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Description", "Energy deposited in 3x3 matrix around most energetic deposit over energy deposited in 5x5 matrix around most energetic deposit 1000 MeV/c single photons in BWD endcap"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Check", "Consistent shape."));
  hE1oE9->GetXaxis()->SetTitle("E1oE9");
  hE1oE9->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  hE1oE9->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));
  ...
  TH1F* hphi = new TH1F("hphi", "Reconstructed #phi Angle in BWD endcap", 60, -3.2, 3.2);
  cluster_treeBWD->Draw("eclClusterPhi>>hphi","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hphi->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\phi$ angle of the cluster for 1000 MeV/c single photons in BWD endcap"));
  hphi->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphi->GetXaxis()->SetTitle("#phi (rad)");
  hphi->SetMinimum(.0);
  hphi->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hEError = new TH1F("hEError", "Energy error in BWD endcap", 50, 0, 0.015);
  cluster_treeBWD->Draw("eclCluster Energy Error>>hEError","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hEError->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed energy error of the cluster for 1000 MeV/c single photons in BWD endcap"));
  hEError->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hEError->GetXaxis()->SetTitle("Cluster energy error (GeV)");
  hEError->SetMinimum(.0);
  hEError->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* htheta = new TH1F("htheta", "Reconstructed #theta Angle in BWD endcap", 30, 2.28, 2.7);
  cluster_treeBWD->Draw("eclClusterTheta>>htheta","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  htheta->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\theta$ angle of the cluster for 1000 MeV/c single photons in BWD endcap"));
  htheta->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  htheta->GetXaxis()->SetTitle("#theta (rad)");
  htheta->SetMinimum(.0);
  htheta->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hthetaerror = new TH1F("hthetaerror", "Reconstructed #theta error in BWD endcap", 50, 0, 0.025);
  cluster_treeBWD->Draw("eclClusterThetaError>>hthetaerror","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\theta$ error of the cluster for 1000 MeV/c single photons in BWD endcap"));
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hthetaerror->GetXaxis()->SetTitle("#theta error (rad)");
  hthetaerror->SetMinimum(.0);
  hthetaerror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hphierror = new TH1F("hphierror", "Reconstructed #phi error in BWD endcap", 50, 0, 0.025);
  cluster_treeBWD->Draw("eclClusterPhiError>>hphierror","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hphierror->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed $\\phi$ error of the cluster for 1000 MeV/c single photons in BWD endcap"));
  hphierror->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hphierror->GetXaxis()->SetTitle("#phi error (rad)");
  hphierror->SetMinimum(.0);
  hphierror->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hR = new TH1F("hR", "Reconstructed #R in BWD endcap", 50, 120, 180);
  cluster_treeBWD->Draw("eclClusterR>>hR","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hR->GetListOfFunctions()->Add(new TNamed("Description", "Reconstructed R of the cluster for 1000 MeV/c single photons in BWD endcap"));
  hR->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hR->GetXaxis()->SetTitle("#R ");
  hR->SetMinimum(.0);
  hR->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hTiming = new TH1F("hTiming", "Cluster Timing in BWD endcap", 50, -130, 130);
  cluster_treeBWD->Draw("eclClusterTiming>>hTiming","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hTiming->GetListOfFunctions()->Add(new TNamed("Description", "Cluster timing for 1000 MeV/c single photons in BWD endcap"));
  hTiming->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hTiming->GetXaxis()->SetTitle("#Timing");
  hTiming->SetMinimum(.0);
  hTiming->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hLAT = new TH1F("hLAT", "Cluster LAT in BWD endcap", 50, 0, 1);
  cluster_treeBWD->Draw("eclClusterLAT>>hLAT","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hLAT->GetListOfFunctions()->Add(new TNamed("Description", "Cluster LAT for 1000 MeV/c single photons in BWD endcap"));
  hLAT->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hLAT->GetXaxis()->SetTitle("#LAT");
  hLAT->SetMinimum(.0);
  hLAT->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hNofCrystals = new TH1F("hNofCrystals", "Cluster NofCrystals in BWD endcap", 25, 0, 25);
  cluster_treeBWD->Draw("eclClusterNofCrystals>>hNofCrystals","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Description", "Number of crystal in the cluster for 1000 MeV/c single photons in BWD endcap"));
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hNofCrystals->GetXaxis()->SetTitle("#NofCrystals");
  hNofCrystals->SetMinimum(.0);
  hNofCrystals->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hIsTrack = new TH1F("hIsTrack", "Cluster IsTrack in BWD endcap", 2, 0, 1);
  cluster_treeBWD->Draw("eclClusterIsTrack>>hIsTrack","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Description", "Number of clusters with a matched track for 1000 MeV/c single photons in BWD endcap"));
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hIsTrack->GetXaxis()->SetTitle("#IsTrack");
  hIsTrack->SetMinimum(.0);
  hIsTrack->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hAbsZernike40 = new TH1F("hAbsZernike40", "Cluster AbsZernike40 in BWD endcap", 50, 0, 2);
  cluster_treeBWD->Draw("eclClusterAbsZernike40>>hAbsZernike40","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Zernike40 for 1000 MeV/c single photons in BWD endcap"));
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hAbsZernike40->GetXaxis()->SetTitle("AbsZernike40");
  hAbsZernike40->SetMinimum(.0);
  hAbsZernike40->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hAbsZernike51 = new TH1F("hAbsZernike51", "Cluster AbsZernike51 in BWD endcap", 50, 0, 1.2);
  cluster_treeBWD->Draw("eclClusterAbsZernike51>>hAbsZernike51","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Zernike51 for 1000 MeV/c single photons in BWD endcap"));
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hAbsZernike51->GetXaxis()->SetTitle("AbsZernike51");
  hAbsZernike51->SetMinimum(.0);
  hAbsZernike51->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hZernikeMVA = new TH1F("hZernikeMVA", "Cluster ZernikeMVA in BWD endcap", 50, 0, 1.2);
  cluster_treeBWD->Draw("eclClusterZernikeMVA>>hZernikeMVA","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Description", "Cluster ZernikeMVA for 1000 MeV/c single photons in BWD endcap"));
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hZernikeMVA->GetXaxis()->SetTitle("ZernikeMVA");
  hZernikeMVA->SetMinimum(.0);
  hZernikeMVA->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  TH1F* hSecondMoment = new TH1F("hSecondMoment", "Cluster Second Moment in BWD endcap", 50, 0, 8);
  cluster_treeBWD->Draw("eclClusterSecondMoment>>hSecondMoment","eclClusterTheta>131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1");
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Description", "Cluster Second Moment for 1000 MeV/c single photons in BWD endcap"));
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape"));
  hSecondMoment->GetXaxis()->SetTitle("SecondMoment");
  hSecondMoment->SetMinimum(.0);
  hSecondMoment->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));

  TFile* output = TFile::Open("ECLClusterBWD_1000MeV.root", "recreate");
  hMultip->Write();
  hEnergy->Write();
  hEnDepSum->Write();
  hHighestE->Write();
...
void ECLClusterResoFWD(TTree* clusterReso_treeFWD)
{
  ...
  clusterReso_treeFWD->Draw("(eclClusterEnergy-0.1)>>hEnergyReso","eclClusterTheta<31.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1&&eclClusterEnergy>0.05");
  ...
  hEnergyReso->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
...
void ECLClusterResoBarrel(TTree* clusterReso_treeBarrel)
{
  ...
  clusterReso_treeBarrel->Draw("(eclClusterEnergy-0.1)>>hEnergyReso","eclClusterTheta>31.5*TMath::DegToRad()&&eclClusterTheta<131.5*TMath::DegToRad()&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1&&eclClusterEnergy>0.05");
...
void ECLClusterResoBWD(TTree* clusterReso_treeBWD)
{
  ...
  clusterReso_treeBWD->Draw("(eclClusterEnergy-0.1)>>hEnergyReso","eclClusterTheta>131.5*(TMath::DegToRad())&&eclClusterToMC1==0&&eclClusterHasNPhotonHypothesis==1&&eclClusterEnergy>0.05");
...
void ECLCalDigitFWD(TTree* cd_treeFWD)
{
  ...
  TH1F* hAmp = new TH1F("hAmp","CalDigit Amplitude in FWD endcap", 50, 0., 0.04);
  ...
  hAmp->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  ...
  hTimeFit->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  ...
  hFitQuality->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  ...
  hCellId->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
...
void ECLCalDigitBarrel(TTree* cd_treeBarrel)
{
  ...
  TH1F* hAmp = new TH1F("hAmp","CalDigit Amplitude in Barrel", 50, 0., 0.04);
...
void ECLCalDigitBWD(TTree* cd_treeBWD)
{
  ...
  TH1F* hAmp = new TH1F("hAmp","CalDigit Amplitude in BWD endcap", 50, 0., 0.04);
...
void ECLBkg(TTree* bkg_tree)
{
  ...
  TH1F* bkgClusterE = new TH1F("bkgClusterE", "Cluster energy, bkg only", 50, 0., 0.2);
  bkg_tree->Draw("eclClusterEnergy>>bkgClusterE","eclClusterEnergy>0&&eclClusterHasNPhotonHypothesis==1");
  ...
  bkgClusterE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  bkgClusterE->GetListOfFunctions()->Add(new TNamed("MetaOptions", "shifter"));
  bkgClusterE->Write();
  ...
  bkgClusterTheta->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  ...
  bkgClusterPhi->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  ...
  bkgClusterMultip->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgClusterMultip->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  bkgOutOfTimeDigitsFWD->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgOutOfTimeDigitsFWD->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  bkgOutOfTimeDigitsBRL->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgOutOfTimeDigitsBRL->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  bkgOutOfTimeDigitsBWD->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgOutOfTimeDigitsBWD->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  bkgRejectedShowersFWD->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgRejectedShowersFWD->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  bkgRejectedShowersBRL->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgRejectedShowersBRL->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
  ...
  bkgRejectedShowersBWD->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  bkgRejectedShowersBWD->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
...
void ECL2D(TTree* bkg_tree)
{
  ...
  bkg_tree->Draw("(TMath::Tan(eclClusterTheta))*(1.9616):1.9616>>BDyz","TMath::Abs(eclClusterTheta)<31.36*(TMath::DegToRad())&&(eclClusterPhi<0)");
  bkg_tree->Draw("1.250:(1.250*(TMath::Cos(eclClusterTheta))/((TMath::Sin(eclClusterTheta))))>>BDyz2","(eclClusterTheta>32.20*(TMath::DegToRad()))&&eclClusterTheta<(180-51.28)*(TMath::DegToRad())&&(eclClusterPhi<0)");
  bkg_tree->Draw("(-TMath::Tan(eclClusterTheta))*(1.0216):-1.0216>>BDyz3","TMath::Abs(eclClusterTheta)>(180-48.5)*(TMath::DegToRad())&&eclClusterPhi<(0)");
  bkg_tree->Draw("(-(TMath::Tan(eclClusterTheta))*(1.9616)):1.9616>>BDyz4","TMath::Abs(eclClusterTheta)<31.36*(TMath::DegToRad())&&(eclClusterPhi>0)");
  bkg_tree->Draw("(-1.250):(1.250*(TMath::Cos(eclClusterTheta))/((TMath::Sin(eclClusterTheta))))>>BDyz5","(eclClusterTheta>32.20*(TMath::DegToRad()))&&eclClusterTheta<(180-51.28)*(TMath::DegToRad())&&(eclClusterPhi>0)");
  bkg_tree->Draw("((TMath::Tan(eclClusterTheta))*(1.0216)):-1.0216>>BDyz6","TMath::Abs(eclClusterTheta)>(180-48.5)*(TMath::DegToRad())&&(eclClusterPhi>0)");
  ...
  BDyz->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  BDyz->Write();
  ...
  bkg_tree->Draw("(2.402*TMath::Sin(eclClusterPhi)*TMath::Sin(eclClusterTheta)):(2.402*TMath::Cos(eclClusterPhi)*TMath::Sin(eclClusterTheta))>>BDyz7","TMath::Abs(eclClusterTheta)<31.36*(TMath::DegToRad())");
  BDyz7->Draw("colz");
  ...
  BDyz7->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  BDyz7->Write();

  bkg_tree->Draw("(1.669*TMath::Sin(eclClusterPhi)*TMath::Sin(eclClusterTheta)):(1.669*TMath::Cos(eclClusterPhi)*TMath::Sin(eclClusterTheta))>>BDyz8","TMath::Abs(eclClusterTheta)>(180-48.5)*(TMath::DegToRad())");
  BDyz8->Draw("colz");
  ...
  BDyz8->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  BDyz8->Write();

  TH2F* BDyz9 = new TH2F("BDyz9", "Cluster position barrel (xy-plane)", 200, -2, 2, 200, -1.5, 1.5);
  bkg_tree->Draw("(1.250*TMath::Sin(eclClusterPhi)):(1.250*TMath::Cos(eclClusterPhi))>>BDyz9","(32.20*(TMath::DegToRad()))<eclClusterTheta<(180-51.28)*(TMath::DegToRad())");
  BDyz9->Draw("colz");
  ...
  BDyz9->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  BDyz9->Write();
...
void ECLEvtGen(TTree* genericBB_tree)
{
  ...
  genericBB_tree->Draw("eclClusterEnergy>>genericBBClusterE","eclClusterToMCWeight1>(eclClusterEnergy/2)&&eclClusterToMC1>-1&&eclClusterEnergy>0&&eclClusterHasNPhotonHypothesis==1");
  ...
  genericBBClusterE->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  ...
  genericBBClusterTheta->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  genericBBClusterTheta->Write();

  TH1F* genericBBClusterPhi = new TH1F("genericBBClusterPhi", "Cluster phi, genericBB only", 50, -3.6, 3.6);
  genericBB_tree->Draw("eclClusterPhi>>genericBBClusterPhi","eclClusterToMCWeight1>(eclClusterEnergy/2)&&eclClusterToMC1>-1&&eclClusterEnergy>0&&eclClusterHasNPhotonHypothesis==1");
  ...
  genericBBClusterPhi->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu")); 
  genericBBClusterPhi->Write();

  std::vector<int>* eclClusterHasNPhotonHypothesis=0;
  genericBB_tree->SetBranchAddress("eclClusterHasNPhotonHypothesis", &eclClusterHasNPhotonHypothesis);
  std::vector<int>* eclClusterToMC1=0;
  ...
  for(int i=0; i<genericBB_tree->GetEntries();i++){
    ...
    int h=0;
    for(int j=0;j<eclClusterHasNPhotonHypothesis->size();j++){
      if (eclClusterHasNPhotonHypothesis->at(j)==1&&eclClusterToMC1->at(j)>-1&&(eclClusterToMCWeight1->at(j)>(eclClusterEnergy->at(j)/2)))
	  h++;
    }
  ...
  genericBBClusterMultip->GetListOfFunctions()->Add(new TNamed("Check","Consistent shape."));
  genericBBClusterMultip->GetListOfFunctions()->Add(new TNamed("Contact","priyanka.cheema@kit.edu"));
...
// cppcheck-suppress constParameterPointer ; TF1 fit functions cannot have const parameters
Double_t Novosibirsk(Double_t *xp,Double_t *par) {
