#ifndef EKLMDIGITALIZERMODULE_H
#define EKLMDIGITALIZERMODULE_H
...
namespace Belle2 {
  ...
  //! Module EKLMDigitalizerModule
  /*!
    Simple module for reading EKLM hits
  */
  class EKLMDigitalizerModule : public Module {
