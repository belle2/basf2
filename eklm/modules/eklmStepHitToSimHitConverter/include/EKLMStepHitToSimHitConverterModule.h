...
namespace Belle2 {
  ...
  //! Module EKLMStepHitToSimHitConverterModule
  /*!
    Simple module for reading EKLM hits
  */
  class EKLMStepHitToSimHitConverterModule : public Module {
  ...
  public:
    ...
    /*!
      ...
      otherwise false.
    */
    EKLMStepHitToSimHitConverterModule();

    //! Destructor
    /*!
      Use the destructor to release the memory you allocated in the constructor.
    */
    virtual ~EKLMStepHitToSimHitConverterModule();
