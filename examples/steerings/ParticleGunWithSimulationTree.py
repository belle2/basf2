...
simulationtree = register_module('makeSimulationTree')
...
# Set parameters for simulationtree:
# simpleoutput creates a root files with a tree that contains
# for each generated and simulated track the MCParticle information
# and the hit information for PXD and SVD hits.
simulationtree.param('outputFileName', 'ParticleGunTree.root')
...
main.add_module(simulationtree)  # put the information from datastore to root file
