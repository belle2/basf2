...
namespace Belle2 {
  ...
  public:
    ...
    /** Set if the run is for cosmics data or not. */
    void setIsCosmics(bool isCosmics) { m_isCosmics = isCosmics; }
    /** Is the run for cosmics data? */
    bool isCosmics() const { return m_isCosmics; }
  ...
  private:
    ...
    bool m_isCosmics; /**< Flag which tells if the run is for cosmics data or not. */
