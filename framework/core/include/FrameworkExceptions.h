...
#define BELLE2_DEFINE_EXCEPTION(ClassName, Message) \
  ...
  public: \
    ClassName(): std::runtime_error(Message), m_arg1(""), m_arg2(""), m_arg3("") { } \
    ClassName(std::string arg1, std::string arg2 = "", std::string arg3 = ""): std::runtime_error(Message), m_arg1(arg1), m_arg2(arg2), m_arg3(arg3) { } \
    ~ClassName() throw() {} \
    virtual const char * what() const throw() { \
      ...
      return (boost::format(Message) %m_arg1 %m_arg2 %m_arg3).str().c_str();\
    }\
  private:\
    std::string m_arg1;\
    std::string m_arg2;\
