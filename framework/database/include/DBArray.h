...
namespace Belle2 {
  ...
  public:
     ...
     */
    explicit DBArray(const std::string& name = "", bool required = true, const EventMetaData* event = nullptr):
      DBAccessorBase(DBStore::arrayName<T>(name), T::Class(), true, required, event) {}
