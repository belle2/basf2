...
namespace Belle2 {
  ...
  public:
     ...
     */
    MagneticFieldComponentConstant(const ROOT::Math::XYZVector& field, float minR, float maxR, float minZ,
    ...
    explicit MagneticFieldComponentConstant(const ROOT::Math::XYZVector& field): MagneticFieldComponentConstant(field, 0,
    ...
    ROOT::Math::XYZVector getField(__attribute((unused)) const ROOT::Math::XYZVector& pos) const override { return m_field; }
  private:
