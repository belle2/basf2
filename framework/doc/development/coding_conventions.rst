...
*DET***Digitizer**      class that creates digits from simulated hits
*DET***Clusterizer**    class that creates hits from digits
*DET***Reconstructer**  class that does the reconstruction of a detector
*DET***Trigger***Xyz*   classes for detector related triggers
*Xyz***Collection**     a class for an array of objects of class *Xyz*
