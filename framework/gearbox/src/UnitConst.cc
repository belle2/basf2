...
std::string Const::parseDetectors(EDetector det)
{
  ...
  else if (det == Const::VTX)   return "VTX";
...
std::string Const::DetectorSet::__repr__() const
{
  ...
  std::string detectorNames[] = {"invalidDetector", "PXD", "SVD", "CDC", "TOP", "ARICH", "ECL", "KLM", "IR", "TRG", "DAQ", "BEAST", "TEST", "VTX"};
  for (size_t index = 1; index <= Const::VTX; index++) {
...
const Const::DetectorSet Const::VXDDetectors::c_set = Const::PXD + Const::SVD + Const::VTX;

const Const::DetectorSet Const::TrackingDetectors::c_set = Const::PXD + Const::SVD + Const::VTX + Const::CDC;
...
const Const::DetectorSet Const::allDetectors = Const::IR + Const::PXD + Const::SVD + Const::CDC +
                                               ...
                                               Const::TRG + Const::DAQ + Const::BEAST + Const::TEST + Const::VTX;
