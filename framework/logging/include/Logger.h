 ...
 * For performance reasons normal B2DEBUG messages are ignored if the log level is not c_Debug, even if a LogModRealm is used. This optimization is not done for B2DEBUG_MODIFIABLE. So only use B2DEBUG_MODIFIABLE in conjunction with LogModRealm.
 */
