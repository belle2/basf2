#include <framework/pcore/zeromq/ZeroMQRxSeqRootOutputModule.h>
...
REG_MODULE(ZeroMQRxSeqRootOutput)

void ZeroMQRxSeqRootOutputModule::writeStreamerInfo()
{
  //
...
void ZeroMQRxSeqRootOutputModule::writeEvent(const std::unique_ptr<ZeroMQMessage>& message)
{
