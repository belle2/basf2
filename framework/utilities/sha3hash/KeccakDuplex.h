...
/**
  ...
  * @return Zero if successful, 1 otherwise.
  */
int Keccak_Duplexing(Keccak_DuplexInstance* duplexInstance, const unsigned char* sigmaBegin, unsigned int sigmaBeginByteLen,
                     unsigned char* Z, unsigned int ZByteLen, unsigned char delimitedSigmaEnd);
...
/** Function that has the same behavior as repeatedly calling
  ...
  *         shall return zero.
  */
size_t Keccak_DuplexingFBWLAbsorb(Keccak_DuplexInstance* duplexInstance, const unsigned char* dataIn, size_t dataByteLen,
...
/** Function that has the same behavior as repeatedly calling
  ...
  *         shall return zero.
  */
size_t Keccak_DuplexingFBWLWrap(Keccak_DuplexInstance* duplexInstance, const unsigned char* dataIn, unsigned char* dataOut,
...
/** Function that has the same behavior as repeatedly calling
  ...
  *         shall return zero.
  */
size_t Keccak_DuplexingFBWLUnwrap(Keccak_DuplexInstance* duplexInstance, const unsigned char* dataIn, unsigned char* dataOut,
                                  size_t dataByteLen, unsigned char trailingBits);
