...
/** Function that has the same behavior as repeatedly calling
  ...
  */
size_t SnP_FBWL_Absorb(void* state, unsigned int laneCount, const unsigned char* data, size_t dataByteLen,
...
/** Function that has the same behavior as repeatedly calling
  ...
  * @pre    0 < @a laneCount < SnP_laneCount
  */
size_t SnP_FBWL_Wrap(void* state, unsigned int laneCount, const unsigned char* dataIn, unsigned char* dataOut, size_t dataByteLen,
                     unsigned char trailingBits);
...
/** Function that has the same behavior as repeatedly calling
  ...
  * @pre    0 < @a laneCount < SnP_laneCount
  */
size_t SnP_FBWL_Unwrap(void* state, unsigned int laneCount, const unsigned char* dataIn, unsigned char* dataOut, size_t dataByteLen,
                       unsigned char trailingBits);
