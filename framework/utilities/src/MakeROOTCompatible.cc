...
std::map<std::string, std::string> MakeROOTCompatible::getSubstitutionMap()
{
...
std::string MakeROOTCompatible::makeROOTCompatible(std::string str)
{
...
std::string MakeROOTCompatible::invertMakeROOTCompatible(std::string str)
{
  auto replace = getSubstitutionMap();
  for (auto& pair : replace) {
