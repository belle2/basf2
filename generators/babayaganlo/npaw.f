*** storage routines NOT for PAW ntuple
      subroutine ninitstorage(storfile)
...
c
      subroutine ninit_chtags(chtags,n)
! written by CMCC, last modified 12/1/2006 (from HORACE)
      integer n
...
*
      subroutine nsortmomenta(ng,qm)
      implicit double precision (a-h,o-z)
      dimension pa(0:3),pb(0:3),qm(40,0:3),q1(0:3),q2(0:3),qmord(40,0:3)
      if (ng.eq.0) return
      ngl = ng
      call norderinverseqm(ngl,qm,qmord)
...
***
      subroutine nmixandsortmomenta(ng,pa,pb,qm)
      implicit double precision (a-h,o-z)
      dimension pa(0:3),pb(0:3),qm(40,0:3),q1(0:3),q2(0:3),qmord(40,0:3)
...
c
      subroutine norderinverseqm(nph,qm,qmord)
      implicit double precision (a-h,o-z)
      parameter (nmax = 40)
      ...
      do k = 1,nph
         en(k) = qm(k,0)
      enddo
      call nsort_vector_inverse(en,sen,indexes,nph)
      do k = 1,nph
      ...
      subroutine nsort_vector(v,sv,iold,n)
! pensare quick sort!!
      implicit double precision (a-h,o-z)
      dimension iold(n)
      dimension v(n),sv(n)
      ...
      subroutine nsort_vector_inverse(v,sv,iold,n)
! pensare quick sort!!
      implicit double precision (a-h,o-z)
      dimension iold(n)
      dimension v(n),sv(n)
...
c      return
      ...
      subroutine ntwomostenergetic(q,q1,q2,i1,i2)
...
*
      subroutine neventstorage(p3,p4,qph)
! written by CMCC, last modified 12/1/2006 (from HORACE)
      implicit double precision (a-h,o-z)
