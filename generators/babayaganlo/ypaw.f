*** storage routines for PAW ntuple
      subroutine yinitstorage(storfile)
...
c      parameter (nsize_event = 16)
      ...
      call yinit_chtags(chtags,nsize_event)
      call hlimit(nwpawc)
      iquest(10)=256000
      call hropen(1,'ntuple',storfile,'nqe',1024,istat)
      call hbookn(10,'ntuple',nsize_event,'ntuple',50000,chtags)
      return
      end
c
      subroutine yinit_chtags(chtags,n)
! written by CMCC, last modified 12/1/2006 (from HORACE)
      integer n
...
*
      subroutine ysortmomenta(ng,qm)
      implicit double precision (a-h,o-z)
      dimension pa(0:3),pb(0:3),qm(40,0:3),q1(0:3),q2(0:3),qmord(40,0:3)
      if (ng.eq.0) return
      ngl = ng
      call yorderinverseqm(ngl,qm,qmord)
...
***
      subroutine ymixandsortmomenta(ng,pa,pb,qm)
      implicit double precision (a-h,o-z)
      dimension pa(0:3),pb(0:3),qm(40,0:3),q1(0:3),q2(0:3),qmord(40,0:3)
...
c
      subroutine yorderinverseqm(nph,qm,qmord)
      implicit double precision (a-h,o-z)
      parameter (nmax = 40)
      ...
      do k = 1,nph
         en(k) = qm(k,0)
      enddo
      call ysort_vector_inverse(en,sen,indexes,nph)
      do k = 1,nph
      ...
      subroutine ysort_vector(v,sv,iold,n)
! pensare quick sort!!
      implicit double precision (a-h,o-z)
      dimension iold(n)
      dimension v(n),sv(n)
      ...
      subroutine ysort_vector_inverse(v,sv,iold,n)
! pensare quick sort!!
      implicit double precision (a-h,o-z)
      dimension iold(n)
      dimension v(n),sv(n)
...
c      return
      ...
      subroutine ytwomostenergetic(q,q1,q2,i1,i2)
...
*
      subroutine yeventstorage(p3,p4,qph)
! written by CMCC, last modified 12/1/2006 (from HORACE)
      implicit double precision (a-h,o-z)
