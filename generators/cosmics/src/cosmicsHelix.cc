...
//  const double
//  cosmicsHelix::m_BFIELD = 15.0;            // KG
//  const double
//  cosmicsHelix::m_ALPHA = 222.376063;       // = 10000. / 2.99792458 / BFIELD
  ...
  const double
  cosmicsHelix::ConstantAlpha = 222.376063;

  const std::string cosmicsHelix::invalidhelix("Invalid cosmicsHelix");
  CLHEP::HepVector cosmicsHelix::ms_amin(5, 0), cosmicsHelix::ms_amax(5, 0);
  bool cosmicsHelix::ms_check_range(false);
  bool cosmicsHelix::ms_throw_exception(false);
  bool cosmicsHelix::ms_print_debug(false);

  bool cosmicsHelix::set_exception(bool t)
  {
    return ms_throw_exception = t;
  }

  bool cosmicsHelix::set_print(bool t)
  {
    return ms_print_debug = t;
  }


  void cosmicsHelix::set_limits(const CLHEP::HepVector& a_min, const CLHEP::HepVector& a_max)
  {
  ...
  cosmicsHelix::cosmicsHelix(const HepGeom::Point3D<double>&   pivot,
  ...
  cosmicsHelix::cosmicsHelix(const HepGeom::Point3D<double>&   position,
  ...
  cosmicsHelix::~cosmicsHelix()
  {
  }

  HepGeom::Point3D<double>
  cosmicsHelix::x(double phi) const
  {
    //
  ...
  double*
  cosmicsHelix::x(double phi, double p[3]) const
  {
    //
    // Calculate position (x,y,z) along helix.
    //
  ...
  HepGeom::Point3D<double>
  cosmicsHelix::x(double phi, CLHEP::HepSymMatrix& Ex) const
  {
  ...
  CLHEP::Hep3Vector
  cosmicsHelix::momentum(double phi) const
  {
    //
    // Calculate momentum.
    //
  ...
  CLHEP::Hep3Vector
  cosmicsHelix::momentum(double phi, CLHEP::HepSymMatrix& Em) const
  {
    //
    // Calculate momentum.
    //
  ...
  cosmicsHelix::momentum(double phi, double mass) const
  {
    //
    // Calculate momentum.
    //
  ...
  CLHEP::HepLorentzVector
  cosmicsHelix::momentum(double phi, double mass, CLHEP::HepSymMatrix& Em) const
  {
    //
    // Calculate momentum.
    //
  ...
  CLHEP::HepLorentzVector
  cosmicsHelix::momentum(double phi,
                         double mass,
  ...
  cosmicsHelix::pivot(const HepGeom::Point3D<double>&   newPivot)
  {
  ...
  void
  cosmicsHelix::set(const HepGeom::Point3D<double>&   pivot,
                    const CLHEP::HepVector& a,
                    const CLHEP::HepSymMatrix& Ea)
  {
    m_pivot = pivot;
  ...
  cosmicsHelix&
  cosmicsHelix::operator = (const cosmicsHelix& i)
  {
...
#endif
      //
      //   Calculate cosmicsHelix center( xc, yc ).
      //
  ...
  CLHEP::HepMatrix
  cosmicsHelix::delApDelA(const CLHEP::HepVector& ap) const
  {
    //
...
//cnv    double tnlp  = ap[4];
  ...
  CLHEP::HepMatrix
  cosmicsHelix::delXDelA(double phi) const
  {
    //
...
//cnv    const double & dz      = m_ac[3];
  ...
  CLHEP::HepMatrix
  cosmicsHelix::delMDelA(double phi) const
  {
    //
  ...
  CLHEP::HepMatrix
  cosmicsHelix::del4MDelA(double phi, double mass) const
  {
  ...
  CLHEP::HepMatrix
  cosmicsHelix::del4MXDelA(double phi, double mass) const
  {
...
//cnv    const double & dz      = m_ac[3];
  ...
  void
  cosmicsHelix::ignoreErrorMatrix(void)
  {
    m_matrixValid = false;
    m_Ea *= 0.;
  }
  ...
  void
  cosmicsHelix::debugPrint(void) const
  {
    ...
    if (ms_print_debug) {
      std::cout << "cosmicsHelix::dr = " << dr << " phi0 = " << phi0 << " cpa = " << cpa
