...
# generation of radiative Bhabha scattering.
#
# 10000 radiative Bhabha events are generated using the
# BHWide Fortran generator and some plots are shown
# at the end.
#
...
## Register the event meta generator and set the number of events to 10000
...
# Set the logging level for the BHWide module to INFO in order to see the total cross section
