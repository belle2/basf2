...
kkgeninput.param('tauinputFile', b2.find_file('kkmc_tautauDS_gg_100MeV.dat'))
...
kkgeninput.param('kkmcoutputfilename', 'kkmc_tautauDS_gg_100MeV.txt')

# run
main.add_module("Progress")
main.add_module(kkgeninput)
main.add_module("RootOutput", outputFileName="kkmc_tautauDS_gg_100MeV.root")
# main.add_module("HepMCOutput", OutputFilename='kkmc_tautauDS_gg_100MeV.hepmc', StoreVirtualParticles=True)
