...
# Add new dark scalar particle (1000 MeV)
pdg.add_particle(name='ds', pdgCode=53, mass=1.0, width=0, charge=0, spin=0, max_width=0, lifetime=0, pythiaID=53)

# to run the framework the used modules need to be registered
kkgeninput = b2.register_module('KKGenInput')
kkgeninput.param('tauinputFile', b2.find_file('kkmc_tautauDS_mm_1000MeV.dat'))
...
kkgeninput.param('kkmcoutputfilename', 'kkmc_tautauDS_mm_1000MeV.txt')

# run
main.add_module("Progress")
main.add_module(kkgeninput)
main.add_module("RootOutput", outputFileName="kkmc_tautauDS_mm_1000MeV.root")
# main.add_module("HepMCOutput", OutputFilename='kkmc_tautauDS_mm_1000MeV.hepmc', StoreVirtualParticles=True)
