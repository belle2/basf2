...
# should be kept: particlegun.param('pdgCodes',[11]) there is no limit on how
# many codes can be given the particle gun will select randomly amongst the
# PDGcodes using a uniform distribution if nTracks>0, otherwise there will be
# one particle for each code in the list default is [-11, 11]
...
# one pion per event. particlegun.param('pdgCodes', [11,11,211])
...
# distribution around the value of nTracks. Only valid if nTracks>0 default is
# False
...
# with a width of 0.5 GeV particlegun.param('momentumGeneration', "normalPt")
...
# width of 5 degrees particlegun.param('thetaGeneration', "normal")
# particlegun.param('thetaParams', [90,5])
#
# or we could create a theta angle between 17 and 150 degree where the
# cos(theta) distribution is flat particlegun.param('thetaGeneration',
# "normal") particlegun.param('thetaParams', [90,5])
#
# ============================================================================
...
# width of 5 degrees particlegun.param('phiGeneration', "normal")
