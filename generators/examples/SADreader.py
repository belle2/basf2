...
# simulation of background events fed from SAD input files.
#
# Please note:
# The SAD input file contains weighted particles, in
...
# the background for your subdetector, you have
# two possibilities:
#
...
# Set the accelerator ring with which the SAD input has been generated.
# 0 = LER
# 1 = HER.
sadinput.param('AccRing', 0)

# Set the readout time for your subdetector in [ns].
# Please note: The value given here corresponds to the
#              readout time of the PXD !
...
# set the logging output of the Input module to DEBUG.
