* File am_11.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
*     9(1): - pe5 tau
*     9(2): - pe6 tau
      call smffs(lextrn,lextrn,ew6,ew5,amta,amta,cyta,
     &           ce6,ce5,ps6,ps5,lt9,av9)
...
*     8(1): - pe8 tau
*     8(2): - pe6 tau
      call smffs(lextrn,lintrn,ew6,ew8,amta,amta,chta,
...
*     8(1): - pe8 tau
*     8(2): - pe6 tau
      call smffs(lextrn,lintrn,ew6,ew8,amta,amta,cyta,
     &           ce6,ce8,ps6,ps8,lt8,av8)

*     9(0): - pe9 chi-3
*     9(1): - pe5 tau
*     9(2): - pe4 tau
      call smffs(lextrn,lextrn,ew4,ew5,amta,amta,cyta,
     &           ce4,ce5,ps4,ps5,lt9,av9)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amta**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,6) + amta**2 + amta**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe6 tau
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew6,ew3,amta,amta,cata,
...
*     9(1): - pe6 tau
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew3,amta,amta,czta,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     8(1): - pe5 tau
*     8(2): + pe8 tau
      call smffs(lintrn,lextrn,ew8,ew5,amta,amta,chta,
     &           ce8,ce5,ps8,ps5,lt8,av8)

*     9(0): - pe9 higgs
*     9(1): - pe3 tau
*     9(2): - pe6 tau
      call smffs(lextrn,lextrn,ew6,ew3,amta,amta,chta,
...
*     8(1): - pe5 tau
*     8(2): + pe8 tau
      call smffs(lintrn,lextrn,ew8,ew5,amta,amta,cyta,
     &           ce8,ce5,ps8,ps5,lt8,av8)

*     9(0): - pe9 chi-3
*     9(1): - pe3 tau
*     9(2): - pe6 tau
      call smffs(lextrn,lextrn,ew6,ew3,amta,amta,cyta,
     &           ce6,ce3,ps6,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,6) + amta**2 + amta**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(4,5) + amta**2 + amta**2
  209 continue
