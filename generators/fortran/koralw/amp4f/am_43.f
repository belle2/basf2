* File am_43.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
* Denominators of propagators
  ...
  207 continue
     ...
     &       + amdq**2 + amdq**2 + amta**2
  208 continue
      call smprpd(aprop,vm8,amta**2,0.0d0)
      vm9 =  + 2.0d0*prod(5,6) + amdq**2 + amdq**2
  209 continue
...
*     9(1): - pe6 d
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew6,ew5,amdq,amdq,cadq,
...
*     9(1): - pe6 d
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew5,amdq,amdq,czdq,
     &           ce6,ce5,ps6,ps5,ep9,lt9,av9)
...
*     9(1): - pe5 d
*     9(2): - pe6 d
      call smffs(lextrn,lextrn,ew6,ew5,amdq,amdq,chdq,
...
*     9(1): - pe5 d
*     9(2): - pe6 d
      call smffs(lextrn,lextrn,ew6,ew5,amdq,amdq,cydq,
     &           ce6,ce5,ps6,ps5,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
     ...
     &       + amta**2 + amta**2 + amdq**2
  208 continue
      call smprpd(aprop,vm8,amdq**2,0.0d0)
...
* Internal momenta
      ...
      call smintf(amdq,pe8, vm8, ew8, ps8, ce8)
      if(jtgamm .eq. 0 .or. vm9 .gt. 0.0d0 ) then
          call smintv(lepina,ama,pe9,ep9,ew9,vm9,igauab)
      else
          call smintp(lepina,ama,pe9,ep9,ew9,vm9,igauab)
...
*     7(1): + pe8 d
*     7(2): - pe7 photon
      call smffv(lintrn,lextrn,lepina,ew8,ew5,amdq,amdq,cadq,
     &           ce8,ce5,ps8,ps5,ep7,lt7,av7)

*     8(0): - pe8 d
*     8(1): - pe6 d
*     8(2): + pe9 photon
      call smffv(lextrn,lintrn,lepina,ew6,ew8,amdq,amdq,cadq,
...
*     8(1): - pe6 d
*     8(2): + pe9 z
      call smffv(lextrn,lintrn,lepinz,ew6,ew8,amdq,amdq,czdq,
     &           ce6,ce8,ps6,ps8,ep9,lt8,av8)
...
*     8(1): - pe8 d
*     8(2): - pe6 d
      call smffs(lextrn,lintrn,ew6,ew8,amdq,amdq,chdq,
...
*     8(1): - pe8 d
*     8(2): - pe6 d
      call smffs(lextrn,lintrn,ew6,ew8,amdq,amdq,cydq,
     &           ce6,ce8,ps6,ps8,lt8,av8)
...
*     7(1): + pe8 d
*     7(2): - pe7 z
      call smffv(lintrn,lextrn,lepinz,ew8,ew5,amdq,amdq,czdq,
     &           ce8,ce5,ps8,ps5,ep7,lt7,av7)
...
*     8(1): - pe5 d
*     8(2): + pe8 d
      call smffs(lintrn,lextrn,ew8,ew5,amdq,amdq,chdq,
...
*     8(1): - pe5 d
*     8(2): + pe8 d
      call smffs(lintrn,lextrn,ew8,ew5,amdq,amdq,cydq,
     &           ce8,ce5,ps8,ps5,lt8,av8)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(5,6) + amdq**2 + amdq**2
  208 continue
      call smprpd(aprop,vm8,ama**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,4) + amta**2 + amta**2
  209 continue
