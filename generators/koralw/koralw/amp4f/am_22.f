* File am_22.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amnm**2,0.0d0)
      vm9 =  + 2.0d0*prod(4,5) + amnm**2 + amnm**2
  209 continue
      call smprpd(aprop,vm9,amz**2,amz*agz)
...
*     9(1): - pe4 nu-mu
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew5,amnm,amnm,cznm,
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(4,5) + amnm**2 + amnm**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(3,6) + amnm**2 + amnm**2
  209 continue
