* File am_23.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
* Denominators of propagators
  ...
  208 continue
      ...
      vm9 =  + 2.0d0*prod(5,6) + amnt**2 + amnt**2
  209 continue
...
*     9(1): - pe6 nu-tau
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew5,amnt,amnt,cznt,
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amnt**2,0.0d0)
      vm9 =  + 2.0d0*prod(4,5) + amnt**2 + amnt**2
  209 continue
      call smprpd(aprop,vm9,amz**2,amz*agz)
...
*     9(1): - pe4 nu-tau
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew5,amnt,amnt,cznt,
...
*     8(1): + pe8 nu-tau
*     8(2): + pe9 z
      call smffv(lintrn,lextrn,lepinz,ew8,ew5,amnt,amnt,cznt,
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(4,5) + amnt**2 + amnt**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(3,6) + amnt**2 + amnt**2
  209 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(5,6) + amnt**2 + amnt**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(3,4) + amnt**2 + amnt**2
  209 continue
