* File am_39.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
*     7(1): + pe8 tau
*     7(2): - pe7 photon
      call smffv(lintrn,lextrn,lepina,ew8,ew3,amta,amta,cata,
     &           ce8,ce3,ps8,ps3,ep7,lt7,av7)

*     8(0): - pe8 tau
*     8(1): - pe4 tau
*     8(2): + pe9 photon
      call smffv(lextrn,lintrn,lepina,ew4,ew8,amta,amta,cata,
...
*     8(1): - pe4 tau
*     8(2): + pe9 z
      call smffv(lextrn,lintrn,lepinz,ew4,ew8,amta,amta,czta,
     &           ce4,ce8,ps4,ps8,ep9,lt8,av8)
...
*     8(1): - pe8 tau
*     8(2): - pe4 tau
      call smffs(lextrn,lintrn,ew4,ew8,amta,amta,chta,
...
*     8(1): - pe8 tau
*     8(2): - pe4 tau
      call smffs(lextrn,lintrn,ew4,ew8,amta,amta,cyta,
     &           ce4,ce8,ps4,ps8,lt8,av8)
...
*     7(1): + pe8 tau
*     7(2): - pe7 z
      call smffv(lintrn,lextrn,lepinz,ew8,ew3,amta,amta,czta,
     &           ce8,ce3,ps8,ps3,ep7,lt7,av7)
...
*     8(1): - pe3 tau
*     8(2): + pe8 tau
      call smffs(lintrn,lextrn,ew8,ew3,amta,amta,chta,
...
*     8(1): - pe3 tau
*     8(2): + pe8 tau
      call smffs(lintrn,lextrn,ew8,ew3,amta,amta,cyta,
     &           ce8,ce3,ps8,ps3,lt8,av8)
...
* Denominators of propagators
  ...
  207 continue
     ...
     &       + amta**2 + amta**2 + amcq**2
  208 continue
      call smprpd(aprop,vm8,amcq**2,amcq*agcq)
      vm9 =  + 2.0d0*prod(3,4) + amta**2 + amta**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe4 tau
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew4,ew3,amta,amta,cata,
...
*     9(1): - pe4 tau
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew3,amta,amta,czta,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 tau
*     9(2): - pe4 tau
      call smffs(lextrn,lextrn,ew4,ew3,amta,amta,chta,
...
*     9(1): - pe3 tau
*     9(2): - pe4 tau
      call smffs(lextrn,lextrn,ew4,ew3,amta,amta,cyta,
     &           ce4,ce3,ps4,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,4) + amta**2 + amta**2
  208 continue
