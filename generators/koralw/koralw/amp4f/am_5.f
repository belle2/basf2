* File am_5.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
*     8(1): - pe4 tau
*     8(2): + pe9 w-plus
      call smffv(lextrn,lintrn,lepinw,ew4,ew8,amta,amnt,cwta,
     &           ce4,ce8,ps4,ps8,ep9,lt8,av8)

*     9(0): - pe5 tau
*     9(1): - pe6 nu-tau
*     9(2): - pe9 w-plus
      call smffv(lextrn,lextrn,lepinw,ew6,ew5,amnt,amta,cwnt,
...
*     8(1): - pe8 nu-tau
*     8(2): - pe4 tau
      call smffs(lextrn,lintrn,ew4,ew8,amta,amnt,cpta,
     &           ce4,ce8,ps4,ps8,lt8,av8)

*     9(0): - pe9 chi-plus
*     9(1): - pe5 tau
*     9(2): - pe6 nu-tau
      call smffs(lextrn,lextrn,ew6,ew5,amnt,amta,cmta,
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amnt**2,0.0d0)
      vm9 =  + 2.0d0*prod(4,5) + amta**2 + amta**2
  209 continue
...
*     8(1): - pe6 nu-tau
*     8(2): + pe9 z
      call smffv(lextrn,lintrn,lepinz,ew6,ew8,amnt,amnt,cznt,
     &           ce6,ce8,ps6,ps8,ep9,lt8,av8)

*     9(0): - pe5 tau
*     9(1): - pe4 tau
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew5,amta,amta,czta,
...
*     8(1): + pe8 tau
*     8(2): + pe9 w-plus
      call smffv(lintrn,lextrn,lepinw,ew8,ew3,amta,amnt,cwta,
...
*     8(1): - pe3 nu-tau
*     8(2): + pe8 tau
      call smffs(lintrn,lextrn,ew8,ew3,amta,amnt,cpta,
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amta**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,6) + amnt**2 + amnt**2
  209 continue
      call smprpd(aprop,vm9,amz**2,amz*agz)
...
*     9(1): - pe6 nu-tau
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew3,amnt,amnt,cznt,
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amta**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,4) + amnt**2 + amta**2
  209 continue
      call smprpd(aprop,vm9,amw**2,amw*agw)
...
*     8(1): - pe6 nu-tau
*     8(2): - pe9 w-plus
      call smffv(lextrn,lintrn,lepinw,ew6,ew8,amnt,amta,cwnt,
     &           ce6,ce8,ps6,ps8,ep9,lt8,av8)

*     9(0): - pe3 nu-tau
*     9(1): - pe4 tau
*     9(2): + pe9 w-plus
      call smffv(lextrn,lextrn,lepinw,ew4,ew3,amta,amnt,cwta,
...
*     8(1): - pe8 tau
*     8(2): - pe6 nu-tau
      call smffs(lextrn,lintrn,ew6,ew8,amnt,amta,cmta,
     &           ce6,ce8,ps6,ps8,lt8,av8)

*     9(0): + pe9 chi-plus
*     9(1): - pe3 nu-tau
*     9(2): - pe4 tau
      call smffs(lextrn,lextrn,ew4,ew3,amta,amnt,cpta,
...
*     8(1): + pe8 nu-tau
*     8(2): - pe9 w-plus
      call smffv(lintrn,lextrn,lepinw,ew8,ew5,amnt,amta,cwnt,
     &           ce8,ce5,ps8,ps5,ep9,lt8,av8)
...
*     8(1): - pe5 tau
*     8(2): + pe8 nu-tau
      call smffs(lintrn,lextrn,ew8,ew5,amnt,amta,cmta,
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,ama**2,0.0d0)
      vm8 =  + 2.0d0*prod(3,4) + amnt**2 + amta**2
  208 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,6) + amnt**2 + amnt**2
  208 continue
...
*     9(1): - pe5 tau
*     9(2): - pe4 tau
      call smffs(lextrn,lextrn,ew4,ew5,amta,amta,chta,
...
*     9(1): - pe4 tau
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew4,ew5,amta,amta,cata,
     &           ce4,ce5,ps4,ps5,ep9,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(4,5) + amta**2 + amta**2
  208 continue
...
* Denominators of propagators
     ...
     &       + amel**2 + amnt**2 + amta**2
  207 continue
      call smprpd(aprop,vm7,amne**2,0.0d0)
      vm8 =  + 2.0d0*prod(5,6) + amta**2 + amnt**2
  208 continue
      call smprpd(aprop,vm8,amw**2,amw*agw)
      vm9 =  + 2.0d0*prod(3,4) + amnt**2 + amta**2
  209 continue
