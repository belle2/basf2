* File am_66.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
*     7(1): + pe8 d
*     7(2): - pe7 photon
      call smffv(lintrn,lextrn,lepina,ew8,ew3,amdq,amdq,cadq,
...
*     9(1): - pe6 d
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew6,ew5,amdq,amdq,cgdq,
     &           ce6,ce5,ps6,ps5,ep9,lt9,av9)
...
*     7(1): + pe8 d
*     7(2): - pe7 z
      call smffv(lintrn,lextrn,lepinz,ew8,ew3,amdq,amdq,czdq,
     &           ce8,ce3,ps8,ps3,ep7,lt7,av7)
...
*     8(1): - pe6 d
*     8(2): + pe9 gluon
      call smffv(lextrn,lintrn,leping,ew6,ew8,amdq,amdq,cgdq,
     &           ce6,ce8,ps6,ps8,ep9,lt8,av8)
...
*     8(1): + pe8 d
*     8(2): + pe9 gluon
      call smffv(lintrn,lextrn,leping,ew8,ew3,amdq,amdq,cgdq,
     &           ce8,ce3,ps8,ps3,ep9,lt8,av8)
...
*     8(1): - pe3 d
*     8(2): + pe8 d
      call smffs(lintrn,lextrn,ew8,ew3,amdq,amdq,chdq,
...
*     8(1): - pe3 d
*     8(2): + pe8 d
      call smffs(lintrn,lextrn,ew8,ew3,amdq,amdq,cydq,
     &           ce8,ce3,ps8,ps3,lt8,av8)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amdq**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,6) + amdq**2 + amdq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe6 d
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew6,ew3,amdq,amdq,cadq,
...
*     9(1): - pe6 d
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew3,amdq,amdq,czdq,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     9(1): - pe6 d
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew6,ew3,amdq,amdq,cgdq,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 d
*     9(2): - pe6 d
      call smffs(lextrn,lextrn,ew6,ew3,amdq,amdq,chdq,
...
*     9(1): - pe3 d
*     9(2): - pe6 d
      call smffs(lextrn,lextrn,ew6,ew3,amdq,amdq,cydq,
     &           ce6,ce3,ps6,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amdq**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,4) + amdq**2 + amdq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe4 d
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew4,ew3,amdq,amdq,cadq,
...
*     9(1): - pe4 d
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew3,amdq,amdq,czdq,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe4 d
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew4,ew3,amdq,amdq,cgdq,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 d
*     9(2): - pe4 d
      call smffs(lextrn,lextrn,ew4,ew3,amdq,amdq,chdq,
...
*     9(1): - pe3 d
*     9(2): - pe4 d
      call smffs(lextrn,lextrn,ew4,ew3,amdq,amdq,cydq,
     &           ce4,ce3,ps4,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,4) + amdq**2 + amdq**2
  208 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,6) + amdq**2 + amdq**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(4,5) + amdq**2 + amdq**2
  209 continue
