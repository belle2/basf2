* File am_67.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
* Denominators of propagators
  ...
  208 continue
      ...
      vm9 =  + 2.0d0*prod(5,6) + amsq**2 + amsq**2
  209 continue
...
*     7(1): + pe8 s
*     7(2): - pe7 photon
      call smffv(lintrn,lextrn,lepina,ew8,ew3,amsq,amsq,casq,
...
*     9(1): - pe6 s
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew6,ew5,amsq,amsq,casq,
...
*     9(1): - pe6 s
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew5,amsq,amsq,czsq,
     &           ce6,ce5,ps6,ps5,ep9,lt9,av9)
...
*     9(1): - pe6 s
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew6,ew5,amsq,amsq,cgsq,
     &           ce6,ce5,ps6,ps5,ep9,lt9,av9)
...
*     9(1): - pe5 s
*     9(2): - pe6 s
      call smffs(lextrn,lextrn,ew6,ew5,amsq,amsq,chsq,
...
*     9(1): - pe5 s
*     9(2): - pe6 s
      call smffs(lextrn,lextrn,ew6,ew5,amsq,amsq,cysq,
     &           ce6,ce5,ps6,ps5,lt9,av9)
...
*     7(1): + pe8 s
*     7(2): - pe7 z
      call smffv(lintrn,lextrn,lepinz,ew8,ew3,amsq,amsq,czsq,
     &           ce8,ce3,ps8,ps3,ep7,lt7,av7)
...
*     8(1): - pe6 s
*     8(2): + pe9 photon
      call smffv(lextrn,lintrn,lepina,ew6,ew8,amsq,amsq,casq,
...
*     8(1): - pe6 s
*     8(2): + pe9 z
      call smffv(lextrn,lintrn,lepinz,ew6,ew8,amsq,amsq,czsq,
     &           ce6,ce8,ps6,ps8,ep9,lt8,av8)
...
*     8(1): - pe6 s
*     8(2): + pe9 gluon
      call smffv(lextrn,lintrn,leping,ew6,ew8,amsq,amsq,cgsq,
     &           ce6,ce8,ps6,ps8,ep9,lt8,av8)
...
*     8(1): - pe8 s
*     8(2): - pe6 s
      call smffs(lextrn,lintrn,ew6,ew8,amsq,amsq,chsq,
...
*     8(1): - pe8 s
*     8(2): - pe6 s
      call smffs(lextrn,lintrn,ew6,ew8,amsq,amsq,cysq,
     &           ce6,ce8,ps6,ps8,lt8,av8)
...
*     8(1): + pe8 s
*     8(2): + pe9 gluon
      call smffv(lintrn,lextrn,leping,ew8,ew3,amsq,amsq,cgsq,
     &           ce8,ce3,ps8,ps3,ep9,lt8,av8)
...
*     8(1): - pe3 s
*     8(2): + pe8 s
      call smffs(lintrn,lextrn,ew8,ew3,amsq,amsq,chsq,
...
*     8(1): - pe3 s
*     8(2): + pe8 s
      call smffs(lintrn,lextrn,ew8,ew3,amsq,amsq,cysq,
     &           ce8,ce3,ps8,ps3,lt8,av8)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amsq**2,amsq*agsq)
      vm9 =  + 2.0d0*prod(3,6) + amsq**2 + amsq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe6 s
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew6,ew3,amsq,amsq,casq,
...
*     9(1): - pe6 s
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew3,amsq,amsq,czsq,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     9(1): - pe6 s
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew6,ew3,amsq,amsq,cgsq,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 s
*     9(2): - pe6 s
      call smffs(lextrn,lextrn,ew6,ew3,amsq,amsq,chsq,
...
*     9(1): - pe3 s
*     9(2): - pe6 s
      call smffs(lextrn,lextrn,ew6,ew3,amsq,amsq,cysq,
     &           ce6,ce3,ps6,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,amsq**2,amsq*agsq)
      vm9 =  + 2.0d0*prod(3,4) + amsq**2 + amsq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe4 s
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew4,ew3,amsq,amsq,casq,
...
*     9(1): - pe4 s
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew3,amsq,amsq,czsq,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe4 s
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew4,ew3,amsq,amsq,cgsq,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 s
*     9(2): - pe4 s
      call smffs(lextrn,lextrn,ew4,ew3,amsq,amsq,chsq,
...
*     9(1): - pe3 s
*     9(2): - pe4 s
      call smffs(lextrn,lextrn,ew4,ew3,amsq,amsq,cysq,
     &           ce4,ce3,ps4,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,4) + amsq**2 + amsq**2
  208 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,6) + amsq**2 + amsq**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(4,5) + amsq**2 + amsq**2
  209 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(5,6) + amsq**2 + amsq**2
  208 continue
      call smprpd(aprop,vm8,ama**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,4) + amsq**2 + amsq**2
  209 continue
