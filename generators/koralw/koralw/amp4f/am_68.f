* File am_68.f generated by GRACE Ver. 2.00(37)        1996/05/14/12:00
* 
...
*     7(1): + pe8 b
*     7(2): - pe7 photon
      call smffv(lintrn,lextrn,lepina,ew8,ew3,ambq,ambq,cabq,
     &           ce8,ce3,ps8,ps3,ep7,lt7,av7)

*     8(0): - pe8 b
*     8(1): - pe4 b
*     8(2): + pe9 photon
      call smffv(lextrn,lintrn,lepina,ew4,ew8,ambq,ambq,cabq,
...
*     8(1): - pe4 b
*     8(2): + pe9 z
      call smffv(lextrn,lintrn,lepinz,ew4,ew8,ambq,ambq,czbq,
     &           ce4,ce8,ps4,ps8,ep9,lt8,av8)
...
*     8(1): - pe4 b
*     8(2): + pe9 gluon
      call smffv(lextrn,lintrn,leping,ew4,ew8,ambq,ambq,cgbq,
     &           ce4,ce8,ps4,ps8,ep9,lt8,av8)
...
*     8(1): - pe8 b
*     8(2): - pe4 b
      call smffs(lextrn,lintrn,ew4,ew8,ambq,ambq,chbq,
...
*     8(1): - pe8 b
*     8(2): - pe4 b
      call smffs(lextrn,lintrn,ew4,ew8,ambq,ambq,cybq,
     &           ce4,ce8,ps4,ps8,lt8,av8)
...
*     7(1): + pe8 b
*     7(2): - pe7 z
      call smffv(lintrn,lextrn,lepinz,ew8,ew3,ambq,ambq,czbq,
     &           ce8,ce3,ps8,ps3,ep7,lt7,av7)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,ambq**2,ambq*agbq)
      vm9 =  + 2.0d0*prod(4,5) + ambq**2 + ambq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe4 b
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew4,ew5,ambq,ambq,cabq,
...
*     9(1): - pe4 b
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew5,ambq,ambq,czbq,
     &           ce4,ce5,ps4,ps5,ep9,lt9,av9)
...
*     9(1): - pe4 b
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew4,ew5,ambq,ambq,cgbq,
     &           ce4,ce5,ps4,ps5,ep9,lt9,av9)
...
*     9(1): - pe5 b
*     9(2): - pe4 b
      call smffs(lextrn,lextrn,ew4,ew5,ambq,ambq,chbq,
...
*     9(1): - pe5 b
*     9(2): - pe4 b
      call smffs(lextrn,lextrn,ew4,ew5,ambq,ambq,cybq,
     &           ce4,ce5,ps4,ps5,lt9,av9)
...
*     8(1): + pe8 b
*     8(2): + pe9 gluon
      call smffv(lintrn,lextrn,leping,ew8,ew3,ambq,ambq,cgbq,
     &           ce8,ce3,ps8,ps3,ep9,lt8,av8)
...
*     8(1): - pe3 b
*     8(2): + pe8 b
      call smffs(lintrn,lextrn,ew8,ew3,ambq,ambq,chbq,
...
*     8(1): - pe3 b
*     8(2): + pe8 b
      call smffs(lintrn,lextrn,ew8,ew3,ambq,ambq,cybq,
     &           ce8,ce3,ps8,ps3,lt8,av8)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,ambq**2,ambq*agbq)
      vm9 =  + 2.0d0*prod(3,6) + ambq**2 + ambq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe6 b
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew6,ew3,ambq,ambq,cabq,
...
*     9(1): - pe6 b
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew6,ew3,ambq,ambq,czbq,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     9(1): - pe6 b
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew6,ew3,ambq,ambq,cgbq,
     &           ce6,ce3,ps6,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 b
*     9(2): - pe6 b
      call smffs(lextrn,lextrn,ew6,ew3,ambq,ambq,chbq,
...
*     9(1): - pe3 b
*     9(2): - pe6 b
      call smffs(lextrn,lextrn,ew6,ew3,ambq,ambq,cybq,
     &           ce6,ce3,ps6,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  208 continue
      call smprpd(aprop,vm8,ambq**2,ambq*agbq)
      vm9 =  + 2.0d0*prod(3,4) + ambq**2 + ambq**2
  209 continue
      call smprpd(aprop,vm9,ama**2,0.0d0)
...
*     9(1): - pe4 b
*     9(2): - pe9 photon
      call smffv(lextrn,lextrn,lepina,ew4,ew3,ambq,ambq,cabq,
...
*     9(1): - pe4 b
*     9(2): - pe9 z
      call smffv(lextrn,lextrn,lepinz,ew4,ew3,ambq,ambq,czbq,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe4 b
*     9(2): - pe9 gluon
      call smffv(lextrn,lextrn,leping,ew4,ew3,ambq,ambq,cgbq,
     &           ce4,ce3,ps4,ps3,ep9,lt9,av9)
...
*     9(1): - pe3 b
*     9(2): - pe4 b
      call smffs(lextrn,lextrn,ew4,ew3,ambq,ambq,chbq,
...
*     9(1): - pe3 b
*     9(2): - pe4 b
      call smffs(lextrn,lextrn,ew4,ew3,ambq,ambq,cybq,
     &           ce4,ce3,ps4,ps3,lt9,av9)
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,4) + ambq**2 + ambq**2
  208 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amz**2,amz*agz)
      vm8 =  + 2.0d0*prod(3,6) + ambq**2 + ambq**2
  208 continue
      call smprpd(aprop,vm8,amz**2,amz*agz)
      vm9 =  + 2.0d0*prod(4,5) + ambq**2 + ambq**2
  209 continue
...
* Denominators of propagators
  ...
  207 continue
      call smprpd(aprop,vm7,amel**2,0.0d0)
      vm8 =  + 2.0d0*prod(4,5) + ambq**2 + ambq**2
  208 continue
      call smprpd(aprop,vm8,ama**2,0.0d0)
      vm9 =  + 2.0d0*prod(3,6) + ambq**2 + ambq**2
  209 continue
