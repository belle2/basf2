...
namespace Belle2 {
  ...
  private:
    ...
    double m_angleXHER;  /**< horizontal theta angle of the High Energy Ring */
    double m_angleYHER;  /**< vertical theta angle of the High Energy Ring */
    std::vector<double> m_covHER; /**< Covariance matrix for the High Energy Ring */
    double m_energyLER;  /**< Energy of the Low Energy Ring */
    double m_angleXLER;  /**< horizontal theta angle of the Low Energy Ring */
    double m_angleYLER;  /**< vertical theta angle of the Low Energy Ring */
