...
!
! Wrapper function for eemmgsqampisrfsr, do channel crossing, etc
!
!  to get phokhara 'amplit' as in amplit = Matrix(Leptonic,Hadronic)
!  do the following:
!       call eemmgloopisrfsr(loop,tree,p1,p2,p3,p4,p5,mle2,mlm2,mu2,eps)
...
!
      subroutine eemmgloopisrfsr(loop,tree,q1,q2,q3,q4,q5,mle2,mlm2,
     #mu2,eps)
      implicit none
...
!     p1(e-)=-q1(e+), p2(e+)=-q1(e-), p3=q4(mu-), p4=q5(gamma), p5=q3(mu+)
      ...
      call eemmgsqampisrfsr(amp1,amp0,p1,p2,p3,p4,p5,mle2,mlm2,mu2,
     #eps)
