       subroutine Pentabox_full_isrHelSum(ME,MU,p1,p2,p3,p4,p5,psi_p5_
     -   ME,barpsi_p2_ME,mup1,musq,comp,result,resultn,resultb)
c ************************************************************************************
c Author: Francisco Campanario
c E-mail: francam@particle.uni-karlsruhe.de
c Date: 17/2/2010
c Modified:12/7/2017
c ************************************************************************************
...
c************************************************************************************
     ...
     -   ),Cij345I(4,2)
       ...
       Complex*32 D01234q,D01235q,D01245q,D01345q,D02345q
       Complex*32 EE0
     ...
     -            ,SC2rc_QUAD,SC3rcc_QUAD,SC3rrc_QUAD
       Integer comp,ii,ll
       common/Pentabox_full_isrHelSumFfunctionsmm/F,P
       SAVE/Pentabox_full_isrHelSumFfunctionsmm/
      Complex*32 Fs,Fq
       common/fsfq/fs,fq
c************************************************************************************
c************************************************************************************
...
c       print*, 's45=',s45
c       print*, ''
c       print*,'S=',2.d0*ME**2+2.d0*dotrr_QUAD(p2,p5)
c       print*, 'T=',ME**2+MU**2-2.d0*dotrr_QUAD(p2,p3)
c       print*, 'U=',ME**2+MU**2-2.d0*dotrr_QUAD(p5,p3)
c       print*, 'S34=',2.d0*MU**2+2.d0*dotrr_QUAD(p3,p4)
c       print*, 'T14=',ME**2+MU**2-2.d0*dotrr_QUAD(p2,p4)

c       print*, 'p1sqd=',p1sqd
c       print*, 'p2sqd=',p2sqd
c       print*, 'p3sqd=',p3sqd
c c      print*, 'p4sqd=',p4sqd
c      print*, 'p5sqd=',p5sqd   
c       print*, 's12d=',s12d
c       print*, 's13d=',s13d
c       print*, 's14d=',s14d
...
c       D01245q=D0finG1_QUAD(MU,ME,s15,s45,s23,musq)!D0finG(ME,ME,MU,0d0,s45,s15,p1sq,s23,p4sq,p5sq,musq)
       D01245=qlI4(p1sqd,s23d,p4sqd,p5sqd,s45d,s15d,MESQd,MESQd,
     1 MU2SQd,0.d0,musqd,0)
...
c double qcdloop
c       write(80,151) 'B012=',B012
c       write(80,151) 'B013=',B013
c       write(80,151) 'B014=',B014
c       write(80,151) 'B015=',B015
c       write(80,151) 'B023=',B023
c       write(80,151) 'B024=',B024
c       write(80,151) 'B025=',B025
c       write(80,151) 'B034=',B034
c       write(80,151) 'B035=',B035
c       write(80,151) 'B045=',B045
c       write(80,151) 'C0123=',C0123
c       write(80,151) 'C0124=',C0124
c       write(80,151) 'C0125=',C0125
c       write(80,151) 'C0134=',C0134
c       write(80,151) 'C0135=',C0135
c       write(80,151) 'C0145=',C0145
c       write(80,151) 'C0234=',C0234
c       write(80,151) 'C0235=',C0235
c       write(80,151) 'C0245=',C0245
c       write(80,151) 'C0345=',C0345
c       write(80,151) 'D01234=',D01234
c       write(80,151) 'D01235=',D01235
c       write(80,151) 'D01245=',D01245
c       write(80,151) 'D01345=',D01345
c       write(80,151) 'D02345=',D02345
c       write(80,151) 'EE0=',EE0
c  151 FORMAT('',A10,2G25.16E3)


c quad paco
c       write(81,*) 'B012=',B012q
c       write(81,*) 'B013=',B013q
c       write(81,*) 'B014=',B014q
c       write(81,*) 'B015=',B015q
c       write(81,*) 'B023=',B023q
c       write(81,*) 'B024=',B024q
c       write(81,*) 'B025=',B025q
c       write(81,*) 'B034=',B034q
c       write(81,*) 'B035=',B035q
c       write(81,*) 'B045=',B045q
c       write(81,*) 'C0123=',C0123q
c       write(81,*) 'C0124=',C0124q
c       write(81,*) 'C0125=',C0125q
c       write(81,*) 'C0134=',C0134q
c       write(81,*) 'C0135=',C0135q
c       write(81,*) 'C0145=',C0145q
c       write(81,*) 'C0234=',C0234q
c       write(81,*) 'C0235=',C0235q
c       write(81,*) 'C0245=',C0245q
c       write(81,*) 'C0345=',C0345q
c       write(81,*) 'D01234=',D01234q
c       write(81,*) 'D01235=',D01235q
c       write(81,*) 'D01245=',D01245q
c       write(81,*) 'D01345=',D01345q
c       write(81,*) 'D02345=',D02345q
...
c************************************************************************************
       ...
       P(28) = MESQ+MU2SQ-s23
       P(29) = MESQ-s23
       FR(2) = Invs15M*(2*C0235R*P(1)-P(3)*(C0345R+Cij345R(1,1)-2*(MU
     -   2SQ*Dij2345R(3,1)-D02345R*P(28)-Dij2345R(2,1)*P(29))))
       FI(2) = Invs15M*(2*C0235I*P(1)-P(3)*(C0345I+Cij345I(1,1)-2*(MU
     -   2SQ*Dij2345I(3,1)-D02345I*P(28)-Dij2345I(2,1)*P(29))))
...
c************************************************************************************
     ...
     -   s15+s23-s45))
       hel(4) = (-4*Fq*INVs12M)/s34+(4*Fs)/((2*MESQ-s12-s15+s34)*(-MES
     -   Q+s12+s23-s45))
       hel(5) = (-4*Fq*INVs12M)/s34+(4*Fs)/((2*MESQ-s12-s15+s34)*(-MES
     -   Q+s12+s23-s45))
       hel(6) = (4*Fs*(-2*MESQ+s12+s15))/((2*MESQ-s12-s15+s34)*(MESQ-s
     -   15+s23-s45)*(MESQ-s12-s23+s45))
       hel(7) = (4*Fq*INVs15M)/s34+(4*Fs)/((2*MESQ-s12-s15+s34)*(-MESQ
     -   +s12+s23-s45))
