       subroutine cross_FSRHelSum(ME,MU,p1,p2,p3,p4,p5,psi_p5_ME,barps
     -   i_p1_ME,mup3,musq,comp,result,resultn,resultb)
c ************************************************************************************
...
c************************************************************************************
     ...
     -            ,SC2rc_QUAD,SC3rcc_QUAD,SC3rrc_QUAD
       Integer comp 
       common/cross_FSRHelSumFfunctionsmm/F,P
       SAVE/cross_FSRHelSumFfunctionsmm/
      Complex*32 Fs,Fq
       common/fsfq/fs,fq
c************************************************************************************
c************************************************************************************
...
c       D01245=D0finG2(MU,ME,s15,s45,s23,musq)!D0finG(ME,0d0,MU,0d0,s45,s15,p1sq,s23,p4sq,p5sq,musq)
       D01245=qlI4(p1sqd,s23d,p4sqd,p5sqd,s45d,s15d,MESQd,0.d0,MU2SQd,
     1 0.d0,musqd,0)
...
c       D01235=D0finG2(MU,ME,s15,s12,s34,musq)!D0finG(ME,0d0,MU,0d0,s12,s15,p1sq,p2sq,s34,p5sq,musq)
       D01235=qlI4(p1sqd,p2sqd,s34d,p5sqd,s12d,s15d,MESQd,0.d0,MU2SQd,
     1 0.d0,musqd,0)
...
c************************************************************************************
     ...
     -   Dij1245I(2,1)-MU2SQ*Dij1245I(3,1)+Dij1245I(1,1)*P(9))
       ...
       P(12) = s15-s23-s34
       FR(9) = 4*ME*(EE0R+EijR(1,1)+2*(EijR(3,1)-EijR(4,1)+EijR(6,2)-E
     -   ijR(7,2)))*P(12)
       FI(9) = 4*ME*(EE0I+EijI(1,1)+2*(EijI(3,1)-EijI(4,1)+EijI(6,2)-E
     -   ijI(7,2)))*P(12)
       F(9)=COMPLEX(FR(9),FI(9))
       FR(10) = -4*ME*(EE0R+3*EijR(1,1)-2*(-EijR(1,2)+EijR(3,1)+EijR(6
     -   ,2)))*P(12)
       FI(10) = -4*ME*(EE0I+3*EijI(1,1)-2*(-EijI(1,2)+EijI(3,1)+EijI(6
     -   ,2)))*P(12)
       F(10)=COMPLEX(FR(10),FI(10))
       FR(11) = -4*ME*(EE0R+EijR(1,1)+2*(EijR(2,1)-EijR(3,1)+EijR(5,2)
     -   -EijR(6,2)))*P(12)
       FI(11) = -4*ME*(EE0I+EijI(1,1)+2*(EijI(2,1)-EijI(3,1)+EijI(5,2)
     -   -EijI(6,2)))*P(12)
       F(11)=COMPLEX(FR(11),FI(11))
       FR(12) = 4*ME*(EE0R+EijR(1,1)+2*(EijR(3,1)+EijR(6,2)))*P(12)
       FI(12) = 4*ME*(EE0I+EijI(1,1)+2*(EijI(3,1)+EijI(6,2)))*P(12)
       F(12)=COMPLEX(FR(12),FI(12))
       FR(13) = 2*(Dij2345R(7,2)+4*EijR(11,2)*P(12))
       FI(13) = 2*(Dij2345I(7,2)+4*EijI(11,2)*P(12))
       F(13)=COMPLEX(FR(13),FI(13))
       FR(14) = 5*(Dij2345R(1,1)-Dij2345R(2,1))+2*(D02345R+Dij2345R(1,
     -   2)+Dij2345R(2,2)-2*(Dij2345R(4,2)+MU2SQ*(EijR(4,1)+2*(EijR(9
     -   ,2)-EijR(10,2)))+(EijR(3,1)-2*(EijR(3,2)-EijR(8,2)))*P(7)))
       FI(14) = 5*(Dij2345I(1,1)-Dij2345I(2,1))+2*(D02345I+Dij2345I(1,
     -   2)+Dij2345I(2,2)-2*(Dij2345I(4,2)+MU2SQ*(EijI(4,1)+2*(EijI(9
     -   ,2)-EijI(10,2)))+(EijI(3,1)-2*(EijI(3,2)-EijI(8,2)))*P(7)))
       F(14)=COMPLEX(FR(14),FI(14))
       FR(15) = -Dij2345R(1,1)-3*Dij2345R(2,1)-2*(D02345R-Dij2345R(2,2
     -   )+Dij2345R(4,2)+2*(MU2SQ*(EijR(4,1)+2*(EijR(7,2)-EijR(10,2))
     -   )+(EijR(3,1)-2*(EijR(3,2)-EijR(6,2)))*P(7)))
       FI(15) = -Dij2345I(1,1)-3*Dij2345I(2,1)-2*(D02345I-Dij2345I(2,2
     -   )+Dij2345I(4,2)+2*(MU2SQ*(EijI(4,1)+2*(EijI(7,2)-EijI(10,2))
     -   )+(EijI(3,1)-2*(EijI(3,2)-EijI(6,2)))*P(7)))
     ...
     -   *(MU2SQ*EijI(4,2)-EijI(10,2)*P(13))))
       F(16)=COMPLEX(FR(16),FI(16))
       FR(17) = -Dij2345R(1,1)-3*Dij2345R(2,1)-2*(D02345R-Dij2345R(2,2
     -   )+Dij2345R(4,2))+8*MU2SQ*EijR(10,2)+4*(MU2SQ*EijR(4,1)+(EijR
     -   (3,1)+2*EijR(3,2))*P(7))
       FI(17) = -Dij2345I(1,1)-3*Dij2345I(2,1)-2*(D02345I-Dij2345I(2,2
     -   )+Dij2345I(4,2))+8*MU2SQ*EijI(10,2)+4*(MU2SQ*EijI(4,1)+(EijI
     -   (3,1)+2*EijI(3,2))*P(7))
       F(17)=COMPLEX(FR(17),FI(17))
       P(14) = MU2SQ+2*P(1)
       P(15) = MESQ+MU2SQ-s12+s23
       P(16) = MESQ+MU2SQ-s12-s23
       P(17) = -s15+s23+s34
       P(18) = -MESQ-2*MU2SQ+s12+s23
       FR(18) = 8*(Dij1345R(1,1)-Dij1345R(2,1))-4*(D01245R-D01345R+Dij
     -   2345R(1,1))+3*Dij2345R(2,1)+Dij2345R(3,1)-2*(D02345R-Dij2345
     -   R(2,2)+Dij2345R(4,2)-Dij2345R(5,2)+Dij2345R(6,2)+2*(EE0R*P(1
     -   0)+EijR(2,1)*P(14)-EijR(3,1)*P(15)+(EijR(4,1)+2*(EijR(9,2)-E
     -   ijR(10,2)))*P(17))-4*(MU2SQ*EijR(2,2)+2*EijR(11,2)+EijR(3,2)
     -   *P(16)+EijR(8,2)*P(18)))
       FI(18) = 8*(Dij1345I(1,1)-Dij1345I(2,1))-4*(D01245I-D01345I+Dij
     -   2345I(1,1))+3*Dij2345I(2,1)+Dij2345I(3,1)-2*(D02345I-Dij2345
     -   I(2,2)+Dij2345I(4,2)-Dij2345I(5,2)+Dij2345I(6,2)+2*(EE0I*P(1
     -   0)+EijI(2,1)*P(14)-EijI(3,1)*P(15)+(EijI(4,1)+2*(EijI(9,2)-E
     -   ijI(10,2)))*P(17))-4*(MU2SQ*EijI(2,2)+2*EijI(11,2)+EijI(3,2)
     -   *P(16)+EijI(8,2)*P(18)))
       F(18)=COMPLEX(FR(18),FI(18))
       P(19) = -MESQ-MU2SQ+s12+s23
       FR(19) = -4*(D01245R-D01345R)-8*(Dij1245R(1,1)-Dij1245R(2,1)-Di
     -   j1345R(1,1)+Dij1345R(2,1))+5*Dij2345R(2,1)-Dij2345R(3,1)+2*(
     -   D02345R+Dij2345R(2,2)-Dij2345R(6,2)+2*(MU2SQ*(EijR(2,1)+2*(E
     -   ijR(5,2)-EijR(8,2)))-(EE0R+2*EijR(1,1))*P(10)+EijR(3,1)*P(15
     -   )-(EijR(4,1)+2*(EijR(7,2)-EijR(10,2)))*P(17)+2*(EijR(3,2)*P(
     -   16)+EijR(6,2)*P(19))))
       FI(19) = -4*(D01245I-D01345I)-8*(Dij1245I(1,1)-Dij1245I(2,1)-Di
     -   j1345I(1,1)+Dij1345I(2,1))+5*Dij2345I(2,1)-Dij2345I(3,1)+2*(
     -   D02345I+Dij2345I(2,2)-Dij2345I(6,2)+2*(MU2SQ*(EijI(2,1)+2*(E
     -   ijI(5,2)-EijI(8,2)))-(EE0I+2*EijI(1,1))*P(10)+EijI(3,1)*P(15
     -   )-(EijI(4,1)+2*(EijI(7,2)-EijI(10,2)))*P(17)+2*(EijI(3,2)*P(
     -   16)+EijI(6,2)*P(19))))
       F(19)=COMPLEX(FR(19),FI(19))
       P(20) = -s23+3*P(10)
       P(21) = -s15+s23+s34-2*P(10)
       P(22) = MESQ+MU2SQ-s12+s15-2*s23-s34
       FR(20) = 4*(D01245R-D01345R)+8*(Dij1245R(2,1)-Dij1245R(3,1)-Dij
     -   1345R(2,1)+Dij1345R(3,1))+5*(Dij2345R(2,1)-Dij2345R(3,1))+2*
     -   (D02345R+Dij2345R(2,2)+Dij2345R(3,2)+2*(-Dij2345R(6,2)-MU2SQ
     -   *(EijR(2,1)+2*(EijR(8,2)-EijR(9,2)))+EE0R*P(10)+EijR(3,1)*P(
     -   20)+EijR(4,1)*P(21)+2*(EijR(3,2)*P(16)-EijR(4,2)*P(17)-EijR(
     -   10,2)*P(22))))
       FI(20) = 4*(D01245I-D01345I)+8*(Dij1245I(2,1)-Dij1245I(3,1)-Dij
     -   1345I(2,1)+Dij1345I(3,1))+5*(Dij2345I(2,1)-Dij2345I(3,1))+2*
     -   (D02345I+Dij2345I(2,2)+Dij2345I(3,2)+2*(-Dij2345I(6,2)-MU2SQ
     -   *(EijI(2,1)+2*(EijI(8,2)-EijI(9,2)))+EE0I*P(10)+EijI(3,1)*P(
     -   20)+EijI(4,1)*P(21)+2*(EijI(3,2)*P(16)-EijI(4,2)*P(17)-EijI(
     -   10,2)*P(22))))
       F(20)=COMPLEX(FR(20),FI(20))
       FR(21) = 4*(D01245R-D01345R)+8*(Dij1245R(2,1)-Dij1345R(2,1))+5*
     -   Dij2345R(2,1)-Dij2345R(3,1)+2*(D02345R+Dij2345R(2,2)-Dij2345
     -   R(6,2)+2*(-(MU2SQ*(EijR(2,1)+2*EijR(8,2)))+EE0R*P(10)+2*EijR
     -   (3,2)*P(16)+(EijR(4,1)+2*EijR(10,2))*P(17)+EijR(3,1)*P(20)))
       FI(21) = 4*(D01245I-D01345I)+8*(Dij1245I(2,1)-Dij1345I(2,1))+5*
     -   Dij2345I(2,1)-Dij2345I(3,1)+2*(D02345I+Dij2345I(2,2)-Dij2345
     -   I(6,2)+2*(-(MU2SQ*(EijI(2,1)+2*EijI(8,2)))+EE0I*P(10)+2*EijI
     -   (3,2)*P(16)+(EijI(4,1)+2*EijI(10,2))*P(17)+EijI(3,1)*P(20)))
       F(21)=COMPLEX(FR(21),FI(21))
       FR(22) = -4*ME*(EE0R+EijR(1,1)+2*(EijR(3,1)-EijR(4,1)+EijR(6,2)
     -   -EijR(7,2)))
       FI(22) = -4*ME*(EE0I+EijI(1,1)+2*(EijI(3,1)-EijI(4,1)+EijI(6,2)
     -   -EijI(7,2)))
       F(22)=COMPLEX(FR(22),FI(22))
       FR(23) = 4*ME*(EE0R+3*EijR(1,1)-2*(-EijR(1,2)+EijR(3,1)+EijR(6,
     -   2)))
       FI(23) = 4*ME*(EE0I+3*EijI(1,1)-2*(-EijI(1,2)+EijI(3,1)+EijI(6,
     -   2)))
       F(23)=COMPLEX(FR(23),FI(23))
       FR(24) = 4*ME*(EE0R+EijR(1,1)+2*(EijR(2,1)-EijR(3,1)+EijR(5,2)-
     -   EijR(6,2)))
       FI(24) = 4*ME*(EE0I+EijI(1,1)+2*(EijI(2,1)-EijI(3,1)+EijI(5,2)-
     -   EijI(6,2)))
       ...
       FR(28) = -2*C0245R+4*(MU2SQ*Dij1245R(3,1)+Dij1245R(2,1)*P(7))
       FI(28) = -2*C0245I+4*(MU2SQ*Dij1245I(3,1)+Dij1245I(2,1)*P(7))
       ...
       FR(31) = -2*(C0235R+2*(C0125R-C0135R-MU2SQ*Dij1235R(2,1)+D01235
     -   R*P(10)+Dij1235R(3,1)*P(11)))
       FI(31) = -2*(C0235I+2*(C0125I-C0135I-MU2SQ*Dij1235I(2,1)+D01235
     -   I*P(10)+Dij1235I(3,1)*P(11)))
...
c************************************************************************************
       ...
       hel(1) = (2*Fs+Fq*Invs24*s15*(Invs35mmesq*(2*MESQ+MU2SQ-s12-2*s
     -   15+2*s23+s34-s45)+Invs13mmesq*(2*MESQ+MU2SQ-s12-2*s15+s23+2*
     -   s34-s45)))/s15
       hel(2) = 2*Fq*Invs24*(Invs13mmesq+Invs35mmesq)
       hel(3) = 4*(Fq*Invs13mmesq*Invs24+(Fs*Invs34mu)/s15)
       hel(4) = -4*Fq*Invs13mmesq*Invs24+(4*Fs*Invs23mu)/s15
     ...
     -   *s15+s23+s34-2*s45)-(s15-s23-s34)*(s12+2*s15-s23-s34+s45))
       ssav(1) = 2*MESQ+MU2SQ-2*s12-s15+s34
       ssav(2) = 2*MESQ+MU2SQ-s15+s23-2*s45
       ssav(3) = s15-s23-s34
       ssav(4) = -MU4SQ+MU2SQ*(2*s12+s23)+2*MESQ*(-MU2SQ-s15+s23+s34)+
     -   (s15-s23-s34)*(s15-s23+2*s45)
       ssav(5) = -s15+s23+s34
       ssav(6) = Invs34MU*(-2*ME*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG(F(
     -   1))+2*ME*(2*MESQ+MU2SQ-2*s12-s15+s34)*CONJG(F(2))+2*((MESQ-s
     -   12)*(MESQ+MU2SQ-s12-s15)+(MESQ+MU2SQ-s12)*s34)*CONJG(F(3))-(
     -   2*ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*
     -   s15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s45))*CONJ
     -   G(F(4)))
       ssav(7) = Invs34MU*(2*ME*(-MU4SQ+MU2SQ*(2*s12+s23)+2*MESQ*(-MU2
     -   SQ-s15+s23+s34)+(s15-s23-s34)*(s15-s23+2*s45))*CONJG(F(1))+2
     -   *ME*(-((s15-s23)*(s12+s15-s34))+MESQ*(2*s15-s23-s34)+(-s15+s
     -   34)*s45+MU2SQ*(-s12+s15-s23+s45))*CONJG(F(2))+(-(MU4SQ*s12)+
     -   ME4SQ*(2*s15-s23-s34)+MU2SQ*(s12**2-s12*(2*s15-2*s23+s45)+2*
     -   s34*(s15-s23+s45))+s12*(2*s15**2+s12*(s15-s23)+s34*(s23-s45)
     -   +s15*(-2*(s23+s34)+s45))+MESQ*(MU4SQ-2*s15**2+2*s15*s23+2*s1
     -   5*s34-s23*s34+s12*(-3*s15+2*s23+s34)-s15*s45+s34*s45+MU2SQ*(
     -   -s12+2*s15-2*(s23+s34)+s45)))*CONJG(F(3))-(2*ME4SQ*(MU2SQ+s1
     -   5-s23-s34)+MU4SQ*(-2*s12+s15-s23+s34)+MU2SQ*(s12*(2*s12+s15+
     -   s23-s34)+(-s15+s23+s34)*s45)+(s15-s23-s34)*(s23*s34+(s15-s34
     -   )*s45+s12*(s15-s23+2*s45))+MESQ*(2*MU4SQ-2*MU2SQ*(2*s12+s23)
     -   -(s15-s23-s34)*(2*s12+2*s15-s23-s34+2*s45)))*CONJG(F(4)))
       ssav(8) = Invs34MU*(2*ME*MU2SQ*(2*MESQ+MU2SQ-2*s12-s15+s34)*CON
     -   JG(F(1))-ME*(MU2SQ+s34)*(2*MESQ+MU2SQ-2*s12-s15+s34)*CONJG(F
     -   (2))-(MU2SQ+s34)*((MESQ-s12)*(MESQ+MU2SQ-s12-s15)+(MESQ+MU2S
     -   Q-s12)*s34)*CONJG(F(3))+2*MU2SQ*((MESQ-s12)*(MESQ+MU2SQ-s12-
     -   s15)+(MESQ+MU2SQ-s12)*s34)*CONJG(F(4)))
       ssav(9) = (Invs34MU*(2*ME*(-s15+s23+s34)*(2*MESQ+MU2SQ-s15+s23-
     -   2*s45)*CONJG(F(1))-2*ME*(MU2SQ-s15+s34)*(2*MESQ+MU2SQ-s15+s2
     -   3-2*s45)*CONJG(F(2))-(MU2SQ-s15+s34)*(2*ME4SQ+MU4SQ+s12*s15-
     -   s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)+(2*
     -   s12+s15-s34)*s45-MU2SQ*(s12+s45))*CONJG(F(3))-(s15-s23-s34)*
     -   (2*ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2
     -   *s15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s45))*CON
     -   JG(F(4))))/2q0
       ssav(10) = Invs23MU*(-2*ME*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG(F
     -   (5))+2*ME*(2*MESQ+MU2SQ-2*s12-s15+s34)*CONJG(F(6))-(2*ME4SQ+
     -   MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*s15+s23+
     -   s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s45))*CONJG(F(7))+
     -   2*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s45)+MU2SQ*(s23-s45)+s45*(s15
     -   -s23+s45))*CONJG(F(8)))
       ssav(11) = Invs23MU*(2*ME*((s12+s23)*(MU2SQ-s15+s23)+MESQ*(s23+
     -   s34)-(MU2SQ-s15+2*s23+s34)*s45)*CONJG(F(5))-2*ME*MU2SQ*(2*ME
     -   SQ+MU2SQ-s15+s23-2*s45)*CONJG(F(6))+2*MU2SQ*(ME4SQ+MESQ*(MU2
     -   SQ-s15+s23-2*s45)+MU2SQ*(s23-s45)+s45*(s15-s23+s45))*CONJG(F
     -   (7))-(-MU6SQ+MU4SQ*(s12+s15+s23)+ME4SQ*(s23+s34)+MESQ*(-MU4S
     -   Q-s12*s15+s12*s23-s15*s23+s23**2-s15*s34+MU2SQ*(s12+3*s23+s3
     -   4-s45)+(s15-3*s23-2*s34)*s45)+(s15-s23+s45)*(s12*(s15-s23)+s
     -   23*s34+(-s15+2*s23+s34)*s45)+MU2SQ*((s23-s45)*(-2*s15+2*s23+
     -   s34-s45)-s12*(2*s15+s45)))*CONJG(F(8)))
       ssav(12) = (Invs23MU*(2*ME*(MU2SQ-s15+s23)*(2*MESQ+MU2SQ-2*s12-
     -   s15+s34)*CONJG(F(5))+2*ME*(s15-s23-s34)*(2*MESQ+MU2SQ-2*s12-
     -   s15+s34)*CONJG(F(6))-(s15-s23-s34)*(2*ME4SQ+MU4SQ+s12*s15-s1
     -   2*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)+(2*s1
     -   2+s15-s34)*s45-MU2SQ*(s12+s45))*CONJG(F(7))-(MU2SQ-s15+s23)*
     -   (2*ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2
     -   *s15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s45))*CON
     -   JG(F(8))))/2q0
       ssav(13) = Invs23MU*(ME*(MU2SQ+s23)*(2*MESQ+MU2SQ-s15+s23-2*s45
     -   )*CONJG(F(5))-2*ME*MU2SQ*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG(
     -   F(6))+2*MU2SQ*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s45)+MU2SQ*(s23-s
     -   45)+s45*(s15-s23+s45))*CONJG(F(7))-(MU2SQ+s23)*(ME4SQ+MESQ*(
     -   MU2SQ-s15+s23-2*s45)+MU2SQ*(s23-s45)+s45*(s15-s23+s45))*CONJ
     -   G(F(8)))
     ...
     -   s45))*CONJG(F(30))
       ssav(18) = -2*ME*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG(F(9))+(-8*M
     -   E3SQ+2*ME*s15)*CONJG(F(10))+2*ME*(2*MESQ+MU2SQ-2*s12-s15+s34
     -   )*CONJG(F(11))+(8*ME3SQ-2*ME*s15)*CONJG(F(12))+4*(2*MESQ+s15
     -   )*CONJG(F(13))+(2*(MESQ-s12)*(MESQ+MU2SQ-s12-s15)+2*(MESQ+MU
     -   2SQ-s12)*s34)*CONJG(F(14))-2*MESQ*(2*MESQ+MU2SQ-2*s12-s15+s3
     -   4)*CONJG(F(15))+(-2*ME4SQ-MU4SQ-s12*s15+s12*s23-s23*s34-MESQ
     -   *(2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)-2*s12*s45-s15*s45+s34*s
     -   45+MU2SQ*(s12+s45))*CONJG(F(16))+2*MESQ*(2*MESQ+MU2SQ-2*s12-
     -   s15+s34)*CONJG(F(17))+(-2*ME4SQ-MU4SQ-s12*s15+s12*s23-s23*s3
     -   4-MESQ*(2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)-2*s12*s45-s15*s45
     -   +s34*s45+MU2SQ*(s12+s45))*CONJG(F(18))+2*MESQ*(2*MESQ+MU2SQ-
     -   s15+s23-2*s45)*CONJG(F(19))+2*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s
     -   45)+MU2SQ*(s23-s45)+s45*(s15-s23+s45))*CONJG(F(20))-2*MESQ*(
     -   2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG(F(21))-2*ME*(MU4SQ+MU2SQ*(
     -   s15-s34)+(s15-s23-s34)*(MESQ-s15+s23-s45))*CONJG(F(22))+ME*(
     -   -MU4SQ+s12*s15+2*s15**2-s12*s23-2*s15*s23-2*s15*s34+s23*s34+
     -   MESQ*(-2*MU2SQ-6*s15+5*(s23+s34))+s15*s45-s34*s45+MU2SQ*(s12
     -   +s45))*CONJG(F(23))+2*ME*(MU4SQ+MU2SQ*(s15-s23)+(s15-s23-s34
     -   )*(MESQ-s12-s15+s34))*CONJG(F(24))+ME*(MU4SQ-s12*s15-2*s15**
     ...
     -   G(F(26))
       ssav(19) = 2*ME*(-MU4SQ+MU2SQ*(2*s12+s23)+2*MESQ*(-MU2SQ-s15+s2
     -   3+s34)+(s15-s23-s34)*(s15-s23+2*s45))*CONJG(F(9))+ME*(MU4SQ-
     -   s12*s15+s12*s23-s23*s34+MESQ*(2*MU2SQ-2*s15+3*(s23+s34))-s15
     -   *s45+s34*s45-MU2SQ*(s12+s45))*CONJG(F(10))-2*ME*MU2SQ*(2*MES
     -   Q+MU2SQ-s15+s23-2*s45)*CONJG(F(11))+ME*(MU4SQ-s12*s15-2*s15*
     -   *2+s12*s23+2*s15*s23+2*s15*s34-s23*s34+MESQ*(2*MU2SQ+6*s15-5
     -   *(s23+s34))-s15*s45+s34*s45-MU2SQ*(s12+s45))*CONJG(F(12))-2*
     -   (MU4SQ-s12*s15-2*s15**2+s12*s23+2*s15*s23+2*s15*s34-s23*s34+
     -   MESQ*(2*MU2SQ+s23+s34)-s15*s45+s34*s45-MU2SQ*(s12+s45))*CONJ
     -   G(F(13))-MU2SQ*(2*ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(
     -   2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ
     -   *(s12+s45))*CONJG(F(14))+(MU6SQ+ME4SQ*(2*MU2SQ+s23+s34)-MU4S
     -   Q*(2*s12+s45)+MU2SQ*(s12**2-s12*s15+s12*s23+2*s15*s34-s23*s3
     -   4+(s12+s15+s34)*s45)+MESQ*(MU4SQ-2*s15*s34+s23*s34+2*s34**2-
     -   s12*(s15+s34)-s15*s45+s34*s45-MU2SQ*(3*s12+2*s15-s23+s34+s45
     -   ))+s12*(2*s15**2+s12*(s15-s23)+s34*(s23-s45)+s15*(-2*(s23+s3
     -   4)+s45)))*CONJG(F(15))+(MU4SQ*(2*s12-s15+s23-s34)+2*ME4SQ*(-
     -   MU2SQ-s15+s23+s34)-MU2SQ*(s12*(2*s12+s15+s23-s34)+(-s15+s23+
     -   s34)*s45)-(s15-s23-s34)*(s23*s34+(s15-s34)*s45+s12*(s15-s23+
     -   2*s45))+MESQ*(-2*MU4SQ+2*MU2SQ*(2*s12+s23)+(s15-s23-s34)*(2*
     -   s12+2*s15-s23-s34+2*s45)))*CONJG(F(16))+2*MESQ*(MU4SQ+MU2SQ*
     -   (s15-s23)+(s15-s23-s34)*(MESQ-s12-s15+s34))*CONJG(F(17))+2*M
     -   U2SQ*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s45)+MU2SQ*(s23-s45)+s45*(
     -   s15-s23+s45))*CONJG(F(18))+(-(ME4SQ*(2*MU2SQ+s23+s34))-MU4SQ
     -   *(s15+s23-s45)-(s15-s23+s45)*(s12*(s15-s23)+s23*s34+(s15-s34
     -   )*s45)+MU2SQ*(s12*(s15+s23-s45)-s45*(s15-s23+s45))+MESQ*(MU4
     -   SQ+s12*s15-s12*s23+s15*s23-s23**2+s15*s34+(s15+s23)*s45+MU2S
     -   Q*(s12+2*s15-2*(s23+s34)+3*s45)))*CONJG(F(19))+(MU6SQ+2*ME4S
     -   Q*(MU2SQ+s15-s23-s34)-MU4SQ*(s12+s45)+2*(s15-s23-s34)*s45*(s
     -   15-s23+s45)+MU2SQ*(-((2*s23+s34)*(s23-s45))+s15*(2*s23-s45)+
     -   s12*(s15-s23+2*s45))+MESQ*(2*MU4SQ-2*(s15-s23-s34)*(s15-s23+
     -   2*s45)-MU2SQ*(2*s12+s23+s34+2*s45)))*CONJG(F(20))-2*MESQ*(MU
     -   4SQ+MU2SQ*(s15-s34)+(s15-s23-s34)*(MESQ-s15+s23-s45))*CONJG(
     -   F(21))-2*ME*(MU6SQ+MU4SQ*(2*s15-2*s23-s34)+MU2SQ*(MESQ-s12)*
     -   (s15-s23-s34)+(-s15+s23+s34)**2*(MESQ-s15+s23-s45))*CONJG(F(
     -   22))+2*ME*(MU6SQ+MU4SQ*(-2*s12+s15)+ME4SQ*(2*MU2SQ+s15-s23-s
     -   34)+s12*(s15-s23-s34)*(s15-s23+s45)+MU2SQ*(s12**2+(s15-s23+s
     -   45)*(s34+s45))-MESQ*(2*MU4SQ+(s15-s23-s34)*(s12+s15-s23+s45)
     -   +MU2SQ*(2*s12+s15-s23+s34+2*s45)))*CONJG(F(23))-2*ME*MU2SQ*(
     -   MU4SQ+MU2SQ*(s15-s34)+(s15-s23-s34)*(MESQ-s15+s23-s45))*CONJ
     ...
     -   *s15-s23-s34+s45)))*CONJG(F(26))
       ssav(20) = 2*ME*MU2SQ*(2*MESQ+MU2SQ-2*s12-s15+s34)*CONJG(F(9))+
     -   ME*(2*MESQ+MU2SQ-2*s12-s15+s34)*(MESQ-s15+s23-s45)*CONJG(F(1
     -   0))+ME*(s15-s23-s34)*(2*MESQ+MU2SQ-2*s12-s15+s34)*CONJG(F(11
     -   ))-ME*(2*MESQ+MU2SQ-2*s12-s15+s34)*(MESQ+MU2SQ-s45)*CONJG(F(
     -   12))+(-2*ME4SQ-MU4SQ-s12*s15+s12*s23-s23*s34-MESQ*(2*MU2SQ-2
     -   *s12-2*s15+s23+s34-2*s45)-2*s12*s45-s15*s45+s34*s45+MU2SQ*(s
     -   12+s45))*CONJG(F(13))+(-s15+s23+s34)*(-((MESQ-s12)*(MESQ+MU2
     -   SQ-s12-s15))-(MESQ+MU2SQ-s12)*s34)*CONJG(F(14))+((MESQ-s12)*
     -   (MESQ+MU2SQ-s12-s15)+(MESQ+MU2SQ-s12)*s34)*(MESQ-s15+s23-s45
     -   )*CONJG(F(15))+2*MU2SQ*((MESQ-s12)*(MESQ+MU2SQ-s12-s15)+(MES
     -   Q+MU2SQ-s12)*s34)*CONJG(F(16))-((MESQ-s12)*(MESQ+MU2SQ-s12-s
     -   15)+(MESQ+MU2SQ-s12)*s34)*(MESQ+MU2SQ-s45)*CONJG(F(17))-((s1
     -   5-s23-s34)*(2*ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU
     -   2SQ-2*s12-2*s15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s1
     -   2+s45))*CONJG(F(18)))/2q0-((MESQ-s15+s23-s45)*(2*ME4SQ+MU4SQ
     -   +s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*s15+s23+s34-2
     -   *s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s45))*CONJG(F(19)))/2q0
     -   -MU2SQ*(2*ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-
     -   2*s12-2*s15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s4
     -   5))*CONJG(F(20))+((MESQ+MU2SQ-s45)*(2*ME4SQ+MU4SQ+s12*s15-s1
     -   2*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)+(2*s1
     -   2+s15-s34)*s45-MU2SQ*(s12+s45))*CONJG(F(21)))/2q0+2*ME*MU2SQ
     -   *(MU4SQ+MU2SQ*(s15-s23)+(s15-s23-s34)*(MESQ-s12-s15+s34))*CO
     -   NJG(F(22))+ME*(-MU4SQ+MU2SQ*(-s15+s23)+(-MESQ+s12+s15-s34)*(
     -   s15-s23-s34))*(-MESQ+s15-s23+s45)*CONJG(F(23))+ME*(-MU4SQ+MU
     -   2SQ*(-s15+s23)+(-MESQ+s12+s15-s34)*(s15-s23-s34))*(-s15+s23+
     -   s34)*CONJG(F(24))+ME*(-MU4SQ+MU2SQ*(-s15+s23)+(-MESQ+s12+s15
     ...
     -   G(F(26))
       ssav(21) = ME*(-s15+s23+s34)*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG
     -   (F(9))+ME*(MESQ+MU2SQ-s12)*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJ
     -   G(F(10))-2*ME*MU2SQ*(2*MESQ+MU2SQ-s15+s23-2*s45)*CONJG(F(11)
     ...
     -   (s12+s45))*CONJG(F(13))-MU2SQ*(2*ME4SQ+MU4SQ+s12*s15-s12*s23
     -   +s23*s34+MESQ*(2*MU2SQ-2*s12-2*s15+s23+s34-2*s45)+(2*s12+s15
     -   -s34)*s45-MU2SQ*(s12+s45))*CONJG(F(14))+((MESQ+MU2SQ-s12)*(2
     -   *ME4SQ+MU4SQ+s12*s15-s12*s23+s23*s34+MESQ*(2*MU2SQ-2*s12-2*s
     -   15+s23+s34-2*s45)+(2*s12+s15-s34)*s45-MU2SQ*(s12+s45))*CONJG
     -   (F(15)))/2q0-((s15-s23-s34)*(2*ME4SQ+MU4SQ+s12*s15-s12*s23+s
     ...
     -   CONJG(F(17)))/2q0+2*MU2SQ*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s45)+
     -   MU2SQ*(s23-s45)+s45*(s15-s23+s45))*CONJG(F(18))-(MESQ+MU2SQ-
     -   s12)*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s45)+MU2SQ*(s23-s45)+s45*(
     -   s15-s23+s45))*CONJG(F(19))+(s15-s23-s34)*(ME4SQ+MESQ*(MU2SQ-
     -   s15+s23-2*s45)+MU2SQ*(s23-s45)+s45*(s15-s23+s45))*CONJG(F(20
     -   ))+(MESQ-s12-s15+s34)*(ME4SQ+MESQ*(MU2SQ-s15+s23-2*s45)+MU2S
     -   Q*(s23-s45)+s45*(s15-s23+s45))*CONJG(F(21))+ME*(-s15+s23+s34
     -   )*(MU4SQ+MU2SQ*(s15-s34)+(s15-s23-s34)*(MESQ-s15+s23-s45))*C
     -   ONJG(F(22))+ME*(MESQ+MU2SQ-s12)*(MU4SQ+MU2SQ*(s15-s34)+(s15-
     -   s23-s34)*(MESQ-s15+s23-s45))*CONJG(F(23))-2*ME*MU2SQ*(MU4SQ+
     ...
     -   l(4)*ssav(25)
       resultn(6) = 2*Invs23MU*ME*CONJG(F(34))*hel(1)*ssav(1)-2*Invs23
     -   MU*ME*MU**2*CONJG(F(34))*hel(2)*ssav(2)-2*Invs23MU*ME*MU**2*
     -   CONJG(F(34))*hel(4)*ssav(2)+Invs23MU*ME*CONJG(F(34))*hel(3)*
     -   ssav(1)*ssav(3)
       resultn(7) = 2*Invs34MU*ME*MU**2*CONJG(F(35))*hel(3)*ssav(1)-2*
     -   Invs34MU*ME*CONJG(F(35))*hel(1)*ssav(2)+2*Invs34MU*ME*CONJG(
     -   F(35))*hel(2)*ssav(4)+Invs34MU*ME*CONJG(F(35))*hel(4)*ssav(2
     -   )*ssav(5)
       result = 2*Invs23MU*ME*CONJG(F(34))*hel(1)*ssav(1)+2*Invs34MU*M
     -   E*MU**2*CONJG(F(35))*hel(3)*ssav(1)-2*Invs34MU*ME*CONJG(F(35
     -   ))*hel(1)*ssav(2)-2*Invs23MU*ME*MU**2*CONJG(F(34))*hel(2)*ss
     -   av(2)-2*Invs23MU*ME*MU**2*CONJG(F(34))*hel(4)*ssav(2)+Invs23
     -   MU*ME*CONJG(F(34))*hel(3)*ssav(1)*ssav(3)+2*Invs34MU*ME*CONJ
     -   G(F(35))*hel(2)*ssav(4)+Invs34MU*ME*CONJG(F(35))*hel(4)*ssav
     -   (2)*ssav(5)+hel(1)*ssav(6)+hel(2)*ssav(7)+hel(3)*ssav(8)+hel
     -   (4)*ssav(9)+hel(1)*ssav(10)+hel(2)*ssav(11)+hel(3)*ssav(12)+
     -   hel(4)*ssav(13)+hel(1)*ssav(14)+hel(2)*ssav(15)+hel(3)*ssav(
     -   16)+hel(4)*ssav(17)+hel(1)*ssav(18)+hel(2)*ssav(19)+hel(3)*s
     -   sav(20)+hel(4)*ssav(21)+hel(1)*ssav(22)+hel(2)*ssav(23)+hel(
