       subroutine tens_red3_new_Re_Com_G(m0,m1,m2,p1sq,p2sq,s12,
...
c
      ...
      real*8 m0,m0sq,m1,m1sq,m2,m2sq
      real*8 deter,detAbs,ratio
      Logical Singular
      COMMON Singular
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      Cijr(4,2) = ( B0r_23 +2d0*m0sq*C0r + Cijr(1,1)*r1r0 +
     1 Cijr(2,1)*r2r1 +1.d0)*0.25d0
      CijI(4,2) = ( B0I_23 +2d0*m0sq*C0I + CijI(1,1)*r1r0 +
     1 CijI(2,1)*r2r1)*0.25d0    
c 3-5
       PRr(1) = (B1r_13 + B0r_23 - Cijr(1,1)*r1r0 - Cijr(4,2)*2.d0)
       ...
       PRI(1) = (B1I_13 + B0I_23 - CijI(1,1)*r1r0 - CijI(4,2)*2.d0)
