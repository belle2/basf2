c FC %       subroutine ten_red_D_LU_decom_G(m0,m1,m2,m3,p1sq,p2sq,p3sq,p1p2,p1p3,p2p3, 
        subroutine tens_red4_new_Re_Com_G_QUAD(m0,m1,m2,m3,p1sq,p2sq,
     &                     p3sq,p1p2,p1p3,p2p3, 
...
c
        ...
        complex*32 D0
        real*16  r2r1, r3r2, det,Iv,Ivv
        real*16 z11,z12,z13,z21,z22,z23,z31,z32,z33
        real*16 iz11,iz22,iz33,piv
        real*16 PRr(1:3), PRI(1:3)
        real*16 Rr(1:3), RI(1:3)
        real*16 C0r_234, C0r_134, C0r_124, C0r_123
        real*16 Cijr_234(4,2),Cijr_134(4,2),Cijr_124(4,2),Cijr_123(4,2)
        real*16 C0I_234, C0I_134, C0I_124, C0I_123
        real*16 CijI_234(4,2),CijI_134(4,2),CijI_124(4,2),CijI_123(4,2)
        real*16 D0r, Dijr(13,3)
        real*16 D0I, DijI(13,3)
...
!       Common/DDecide/tempjj,tempkl,IX,Zmax,jjinit
        REAL*16 TEMPJJ,TEMPKL,ix,zMAX
        INTEGER JJINIT
        real*16 para
c New variables to compare       
        real*16 DijR1(13,3),DijI1(13,3),D0R1,D0I1
        real*16 DijR2(13,3),DijI2(13,3),D0R2,D0I2
        Integer index(3)
        real*16 tempG1(3),tempG2(3),ratio
        real*16 tempM1(3),tempM2(3)       
        Integer I2
        Complex*32 Dij_QUAD(13,3)
        real*16 D0Rtemp,D0Itemp
        real*16 det1,det2,det3,det4,det5,detMax,xsub
        External B0fin
        complex*32 B0fin
!       real*16 Z11,Z12,Z13,Z22,Z23,Z33
        complex*32 B023,B013,B024,B034,C0234,C0134,C0124,C0123
        complex*32 ten3,tentest3,ten2,tentest2,ten3Dble,ten2Dble
        real*16 s23,tenI3,tenR3,tenI2,tenR2
c Added for the General case
        real*16 m0,m1,m2,m3,m0sq,m1sq,m2sq,m3sq,r1r0
...
CCCCCC CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      Dijr(7,2) = (C0r_234+ 2q0*m0sq*D0r+Dijr(1,1)*r1r0+Dijr(2,1)*r2r1
     &     +Dijr(3,1)*r3r2)*0.5q0

      DijI(7,2) = (C0I_234+2q0*m0sq*D0I+DijI(1,1)*r1r0 + DijI(2,1)*r2r1
     &     +DijI(3,1)*r3r2)*0.5q0
...
c      
       PRr(1) = (Cijr_134(1,1)+C0r_234-Dijr(1,1)*r1r0 - Dijr(7,2)*2.q0)
...
c       
       ...
       Dijr(5,2) = Rr(3)
c       
       PRI(1) = (CijI_134(1,1) +C0I_234 -DijI(1,1)*r1r0-DijI(7,2)*2.q0)
...
c 36-3 7-38
       ...
       PRr(3) = (       -Cijr_124(2,1) -Dijr(3,1)*r3r2 -Dijr(7,2)*2.q0)
...
c       Dijr(6,2) = Rr(2)
       ...
       PRI(3) = (       - CijI_124(2,1) -DijI(3,1)*r3r2 -DijI(7,2)*2.q0)
...
CCCCCC CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
       ...
       Dijr(11,3)=0.25q0*(-C0r_234+2q0*m0sq*Dijr(1,1)+Dijr(1,2)*r1r0
     &    +Dijr(4,2)*r2r1   +Dijr(5,2)*r3r2)
       
       Dijr(12,3)=0.25q0*(Cijr_234(1,1)+2q0*m0sq*Dijr(2,1)
     &          +Dijr(4,2)*r1r0+Dijr(2,2)*r2r1+Dijr(6,2)*r3r2)
       Dijr(13,3)=0.25q0*(Cijr_234(2,1)+2q0*m0sq*Dijr(3,1)
     &           +Dijr(5,2)*r1r0 + Dijr(6,2)*r2r1 + Dijr(3,2)*r3r2)
       
        DijI(11,3)=0.25q0*(-C0I_234+2q0*m0sq*DijI(1,1)+DijI(1,2)*r1r0
     &   +DijI(4,2)*r2r1+DijI(5,2)*r3r2)
       
       DijI(12,3)=0.25q0*(CijI_234(1,1)+2q0*m0sq*DijI(2,1)
     &    +DijI(4,2)*r1r0+DijI(2,2)*r2r1+DijI(6,2)*r3r2)
       DijI(13,3)=0.25q0*(CijI_234(2,1)+2q0*m0sq*DijI(3,1)
...
c 41-4 2-43
       ...
       PRr(1) =(Cijr_134(1,2) - C0r_234-Dijr(1,2)*r1r0-Dijr(11,3)*4.q0)
       ...
       PRI(1) =(CijI_134(1,2) - C0I_234-DijI(1,2)*r1r0-DijI(11,3)*4.q0)
...
c      
       ...
       PRr(3) = (     -Cijr_124(2,2) - Dijr(3,2)*r3r2 - Dijr(13,3)*4.q0)
c       
...
c      
       ...
       PRI(3) = (     -CijI_124(2,2) - DijI(3,2)*r3r2 - DijI(13,3)*4.q0)
c      
