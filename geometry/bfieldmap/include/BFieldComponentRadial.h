...
namespace Belle2 {
  ...
  public:
    ...
    /**
     * Sets the size of the magnetic field map.
     * @param minZ The left (min) border of the magnetic field map region in z.
     * @param maxZ The right (max) border of the magnetic field map region in z.
     * @param offset The offset in z which is required because the accelerator group defines the Belle center as zero.
     */
    void setMapRegionZ(double minZ, double maxZ, double offset) { m_mapRegionZ[0] = minZ; m_mapRegionZ[1] = maxZ; m_mapOffset = offset; }

    /**
     * Sets the size of the magnetic field map.
     * @param minR The left (min) border of the magnetic field map region in r.
     * @param maxR The right (max) border of the magnetic field map region in r.
     */
