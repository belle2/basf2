...
namespace Belle2 {
  ...
  class BFieldFrameworkInterface: public BFieldComponent {
  public:
    /** this component is exclusive: ignore all others */
    BFieldFrameworkInterface(): BFieldComponent(true) {}
    /** everything is inside this component */
    virtual bool inside(const B2Vector3D&) final override { return true; }
    /** and we return the values from the exsiting BFieldMap */
    virtual B2Vector3D getField(const B2Vector3D& position) final override
    {
