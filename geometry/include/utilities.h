...
namespace Belle2 {
  ...
  namespace geometry {
     ...
     * This function will set the visualization color of a logical volume
     * from a string representation of the color.
     * Recognized formats for the color are:
     *  - "#rgb" where r,g,b are hexadecimal values from 0 to f representing
     *    the color values for red, green and blue respectively
     ...
     *  - "#rrggbbaa" where rr,gg,bb,aa are hexadecimal values from 00 to ff
     ...
     * @param[in]  innerPoints  List of inner points.
     * @param[in]  outerPoints  List of outer points.
     * @param[in]  minPhi       Minimum phi angle.
     * @param[in]  maxPhi       Maximum phi angle.
     * @param[out] minZ         Minimum z coordinate.
     * @param[out] maxZ         Maximum z coordinate.
     */
