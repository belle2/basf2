...
TGeoMaterial* GeoReader::readMaterial(GearDir& gearDir)
{
...
TGeoElement* GeoReader::readElementSection(GearDir& elementContent, double& weight)
{
  weight = GearReader::readWeightAttribute(elementContent);
  string matName = GearReader::readNameAttribute(elementContent);
...
TGeoMaterial* GeoReader::readMaterialSection(GearDir& materialContent, double& weight)
{
  weight = GearReader::readWeightAttribute(materialContent);
  string matName = GearReader::readNameAttribute(materialContent);
...
TGeoMixture* GeoReader::readMixtureSection(GearDir& mixtureContent, double& weight)
{
  weight = GearReader::readWeightAttribute(mixtureContent);
  string matName = GearReader::readNameAttribute(mixtureContent);
