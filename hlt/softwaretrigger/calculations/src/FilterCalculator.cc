...
void FilterCalculator::doCalculation(SoftwareTriggerObject& calculationResult)
{
  ...
  /* Actual trigger: to go into database
  int itrig = 0;
  passBeforePrescale[itrig] = nTrkLoose>=3 and nTrkTight>=1 and !ee2leg;

  itrig = 1;
  passBeforePrescale[itrig] = nElow>=3 and nEmedium>=1 and nEhigh==0;

  itrig = 2;
  passBeforePrescale[itrig] = nTrkLoose==2 and nTrkTight>=1 and netChargeLoose==0 and maximumPCMS<0.8 and !eexx;

  itrig = 3;
  passBeforePrescale[itrig] = nTrkLoose==2 and maximumPCMS>0.8 and maximumPCMS<4.5 and !ee2leg and !ee1leg1trk and !eexx;

  itrig = 4;
  passBeforePrescale[itrig] = nTrkLoose==2 and maximumPCMS>4.5 and !ee2leg and !ee1leg1trk and !ee1leg1e and !eeBrem and !muonPairV;

  itrig = 5;
  passBeforePrescale[itrig] = n2GeVNeutBarrel>=1 and !gg2clst and !ee1leg1clst and !ee1leg1trk and !eeBrem;

  itrig = 6;
  passBeforePrescale[itrig] = n2GeVNeutEndcap>=1  and !gg2clst and !ee2clst and !ee1leg and !eeBrem;

  itrig = 7;
  passBeforePrescale[itrig] = nEsinglePhotonBarrel==1 and nVetoClust<=1;

  itrig = 8;
  passBeforePrescale[itrig] = nEsingleElectronBarrel==1 and nVetoClust<=1;

  itrig = 9;
  passBeforePrescale[itrig] = nEsinglePhotonEndcap==1 and nVetoClust<=1;

  itrig = 10;
  passBeforePrescale[itrig] = nEsingleClust==1 and nEmedium==1;

  itrig = 11;
  passBeforePrescale[itrig] = ee2leg;

  itrig = 12;
  passBeforePrescale[itrig] = ee1leg1trk;

  itrig = 13;
  passBeforePrescale[itrig] = ee1leg1clst;

  itrig = 14;
  passBeforePrescale[itrig] = ee1leg;

  itrig = 15;
  passBeforePrescale[itrig] = ee1leg1e;

  itrig = 16;
  passBeforePrescale[itrig] = eexxSelect;

  itrig = 17;
  passBeforePrescale[itrig] = false;

  itrig = 18;
  passBeforePrescale[itrig] = selectee1leg1trk;

  itrig = 19;
  passBeforePrescale[itrig] = selectee1leg1clst;

  itrig = 20;
  for(int iflat = 0; iflat<9; iflat++) {passBeforePrescale[itrig+iflat] = eeFlat[iflat];}

  itrig = 29;
  passBeforePrescale[itrig] = selectee;

  itrig = 30;
  passBeforePrescale[itrig] = ee2clst;

  itrig = 31;
  passBeforePrescale[itrig] = nEhigh>=1;

  itrig = 32;
  passBeforePrescale[itrig] = gg2clst;

  itrig = 33;
  passBeforePrescale[itrig] = n2GeVChrg>=1  and !gg2clst and !ee2clst and !ee1leg;

  itrig = 34;
  passBeforePrescale[itrig] = ggBarrelLoose;

  itrig = 35;
  passBeforePrescale[itrig] = ggEndcapLoose;

  itrig = 36;
  passBeforePrescale[itrig] = n2GeVPhotonBarrel>=1;

  itrig = 37;
  passBeforePrescale[itrig] = n2GeVPhotonEndcap>=1;

  itrig = 38;
  passBeforePrescale[itrig] = radBhabha;

  itrig = 39;
  passBeforePrescale[itrig] = eexx;

  itrig = 40;
  passBeforePrescale[itrig] = eeBrem;

  itrig = 41;
  passBeforePrescale[itrig] = muonPairV;

  itrig = 42;
  passBeforePrescale[itrig] = selectmumu;

  itrig = 43;
  passBeforePrescale[itrig] = singleMuon;

  itrig = 44;
  passBeforePrescale[itrig] = nTrkTight>=1;

  itrig = 45;
  passBeforePrescale[itrig] = nTrkLoose==2 and maximumPCMS<0.8 and !eexx;

  itrig = 46;
  passBeforePrescale[itrig] = nTrkLoose==2 and maximumPCMS>0.8 and maximumPCMS<4.5;

  itrig = 47;
  passBeforePrescale[itrig] = nTrkLoose==2 and maximumPCMS>4.5;

  itrig = 48;
  passBeforePrescale[itrig] = true;

  itrig = 49;
  passBeforePrescale[itrig] = muonPairECL;*/
}
