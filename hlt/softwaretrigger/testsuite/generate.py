...
import generators
from softwaretrigger.path_functions import RAW_SAVE_STORE_ARRAYS, ALWAYS_SAVE_OBJECTS, DEFAULT_HLT_COMPONENTS
...
def main():
    ...
    path.add_module("RootOutput",
                    branchNames=["PXDDigits"] + RAW_SAVE_STORE_ARRAYS + ALWAYS_SAVE_OBJECTS,
