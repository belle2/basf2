...
class InputStuffCreator(basf2.Module):
    ...
    def initialize(self):
        ...
        self.chunk_data = Belle2.PyStoreObj(Belle2.SoftwareTrigger.TestChunkData.Class())
        self.chunk_data.registerInDataStore()

    def event(self):
        """Create some random data"""
        self.chunk_data.assign(Belle2.SoftwareTrigger.TestChunkData(self.size))
...
def test_reconstruction(n_events,
    ...
    basf2.set_nprocesses(n_processes)
