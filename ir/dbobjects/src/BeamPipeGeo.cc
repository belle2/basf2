...
void BeamPipeGeo::initialize(const GearDir& content)
{
  ...
  std::vector<std::string> names = {"Lv1SUS", "Lv2OutTi", "Lv2OutBe", "Lv2InBe", "Lv2Paraf1", "Lv2Paraf2", "Lv2Vacuum", "Lv3AuCoat", "Lv1TaFwd", "HMS", "Lv2VacFwd", "Lv1TaBwd", "Lv2VacBwd", "Flange", "AreaTubeFwd", "Lv1TaLERUp", "Lv1SUSLERUp", "Lv2VacLERUp", "Lv1TaHERDwn", "Lv1SUSHERDwn", "Lv2VacHERDwn", "AreaTubeBwd", "Lv1TaHERUp", "Lv1SUSHERUp", "Lv2VacHERUp", "Lv1TaLERDwn", "Lv1SUSLERDwn", "Lv2VacLERDwn", "PXDMountFwd", "PXDMountBwd", "PXDMountFixtureFwd", "PXDMountFixtureBwd", "Lv2AuCoat",
                                    "IPChamber_FWD", "IPChamber_BWD", "IPBeamPipe_FWD", "VacFWD", "BellowsPipe_FWD", "AdditionalShield_FWD", "BellowsShield_FWD",
                                    "IPBeamPipe_BWD", "VacBWD", "BellowsPipe_BWD", "AdditionalShield_BWD", "BellowsShield_BWD"
                                   };
