...
namespace Belle2 {
  ...
  namespace ir {
    ...
    void GeoCryostatCreator::create(const GearDir& content, G4LogicalVolume& topVolume, GeometryTypes)
    {
      ...
      //get parameters from .xml file
      GearDir cC1wal2(content, "C1wal2/");

      const int C1wal2_num = atoi(cC1wal2.getString("N").c_str());

      double C1wal2_Z[C1wal2_num];
      double C1wal2_R[C1wal2_num];
      double C1wal2_r[C1wal2_num];

      for (int i = 0; i < C1wal2_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C1wal2_Z[i] = cC1wal2.getLength(ossZID.str()) * unitFactor;
        C1wal2_R[i] = cC1wal2.getLength(ossRID.str()) * unitFactor;
        C1wal2_r[i] = cC1wal2.getLength(ossrID.str()) * unitFactor;
      }

      //define geometry
      G4Polycone* geo_C1wal2xx = new G4Polycone("geo_C1wal2xx_name", 0, 2 * M_PI, C1wal2_num, C1wal2_Z, C1wal2_r, C1wal2_R);
      G4SubtractionSolid* geo_C1wal2x = new G4SubtractionSolid("geo_C1wal2x_name", geo_C1wal2xx, geo_A1spc1, transform_HER);
      G4SubtractionSolid* geo_C1wal2 = new G4SubtractionSolid("geo_C1wal2_name", geo_C1wal2x, geo_B1spc1, transform_LER);
      ...
      setVisibility(*logi_C1wal2, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C1wal2, "phys_C1wal2_name", &topVolume, false, 0);
      ...
      //get parameters from .xml file
      GearDir cC3wal1(content, "C3wal1/");

      const int C3wal1_num = atoi(cC3wal1.getString("N").c_str());

      double C3wal1_Z[C3wal1_num];
      double C3wal1_R[C3wal1_num];
      double C3wal1_r[C3wal1_num];

      for (int i = 0; i < C3wal1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C3wal1_Z[i] = cC3wal1.getLength(ossZID.str()) * unitFactor;
        C3wal1_R[i] = cC3wal1.getLength(ossRID.str()) * unitFactor;
        C3wal1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C3wal1xx = new G4Polycone("geo_C3wal1xx_name", 0, 2 * M_PI, C3wal1_num, C3wal1_Z, C3wal1_r, C3wal1_R);
      G4IntersectionSolid* geo_C3wal1 = new G4IntersectionSolid("geo_C3wal1_name", geo_C3wal1xx, geo_C1wal1);

      string strMat_C3wal1 = cC3wal1.getString("Material");
      G4Material* mat_C3wal1 = Materials::get(strMat_C3wal1);
      G4LogicalVolume* logi_C3wal1 = new G4LogicalVolume(geo_C3wal1, mat_C3wal1, "logi_C3wal1_name");

      //put volume
      setColor(*logi_C3wal1, cC3wal1.getString("Color", "#CC0000"));
      setVisibility(*logi_C3wal1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C3wal1, "phys_C3wal1_name", logi_C2spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C3wal2, "phys_C3wal2_name", logi_C2spc2, false, 0);
      ...
      //get parameters from .xml file
      GearDir cC4spc1(content, "C4spc1/");

      const int C4spc1_num = atoi(cC4spc1.getString("N").c_str());

      double C4spc1_Z[C4spc1_num];
      double C4spc1_R[C4spc1_num];
      double C4spc1_r[C4spc1_num];

      for (int i = 0; i < C4spc1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C4spc1_Z[i] = cC4spc1.getLength(ossZID.str()) * unitFactor;
        C4spc1_R[i] = cC4spc1.getLength(ossRID.str()) * unitFactor;
        C4spc1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C4spc1xx = new G4Polycone("geo_C4spc1xx_name", 0, 2 * M_PI, C4spc1_num, C4spc1_Z, C4spc1_r, C4spc1_R);
      G4IntersectionSolid* geo_C4spc1 = new G4IntersectionSolid("geo_C4spc1_name", geo_C4spc1xx, geo_C1wal1);

      string strMat_C4spc1 = cC4spc1.getString("Material");
      G4Material* mat_C4spc1 = Materials::get(strMat_C4spc1);
      G4LogicalVolume* logi_C4spc1 = new G4LogicalVolume(geo_C4spc1, mat_C4spc1, "logi_C4spc1_name");

      //put volume
      setColor(*logi_C4spc1, cC4spc1.getString("Color", "#CCCCCC"));
      setVisibility(*logi_C4spc1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C4spc1, "phys_C4spc1_name", logi_C3wal1, false, 0);
      ...
      //get parameters from .xml file
      GearDir cC5wal1(content, "C5wal1/");

      const int C5wal1_num = atoi(cC5wal1.getString("N").c_str());

      double C5wal1_Z[C5wal1_num];
      double C5wal1_R[C5wal1_num];
      double C5wal1_r[C5wal1_num];

      for (int i = 0; i < C5wal1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C5wal1_Z[i] = cC5wal1.getLength(ossZID.str()) * unitFactor;
        C5wal1_R[i] = cC5wal1.getLength(ossRID.str()) * unitFactor;
        C5wal1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C5wal1x = new G4Polycone("geo_C5wal1x_name", 0, 2 * M_PI, C5wal1_num, C5wal1_Z, C5wal1_r, C5wal1_R);
      G4IntersectionSolid* geo_C5wal1 = new G4IntersectionSolid("geo_C5wal1_name", geo_C5wal1x, geo_C1wal1);

      string strMat_C5wal1 = cC5wal1.getString("Material");
      G4Material* mat_C5wal1 = Materials::get(strMat_C5wal1);
      G4LogicalVolume* logi_C5wal1 = new G4LogicalVolume(geo_C5wal1, mat_C5wal1, "logi_C5wal1_name");

      //put volume
      setColor(*logi_C5wal1, cC5wal1.getString("Color", "#CC0000"));
      setVisibility(*logi_C5wal1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C5wal1, "phys_C5wal1_name", logi_C4spc1, false, 0);

      //--------------
      //-   C5wal2

      //get parameters from .xml file
      GearDir cC5wal2(content, "C5wal2/");

      const int C5wal2_num = atoi(cC5wal2.getString("N").c_str());

      double C5wal2_Z[C5wal2_num];
      double C5wal2_R[C5wal2_num];
      double C5wal2_r[C5wal2_num];

      for (int i = 0; i < C5wal2_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C5wal2_Z[i] = cC5wal2.getLength(ossZID.str()) * unitFactor;
        C5wal2_R[i] = cC5wal2.getLength(ossRID.str()) * unitFactor;
        C5wal2_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C5wal2x = new G4Polycone("geo_C5wal2x_name", 0, 2 * M_PI, C5wal2_num, C5wal2_Z, C5wal2_r, C5wal2_R);
      G4IntersectionSolid* geo_C5wal2 = new G4IntersectionSolid("geo_C5wal2_name", geo_C5wal2x, geo_C1wal1);

      string strMat_C5wal2 = cC5wal2.getString("Material");
      G4Material* mat_C5wal2 = Materials::get(strMat_C5wal2);
      G4LogicalVolume* logi_C5wal2 = new G4LogicalVolume(geo_C5wal2, mat_C5wal2, "logi_C5wal2_name");

      //put volume
      setColor(*logi_C5wal2, cC5wal2.getString("Color", "#CC0000"));
      setVisibility(*logi_C5wal2, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C5wal2, "phys_C5wal2_name", logi_C4spc2, false, 0);

      //--------------
      //-   C6spc1

      //get parameters from .xml file
      GearDir cC6spc1(content, "C6spc1/");

      const int C6spc1_num = atoi(cC6spc1.getString("N").c_str());

      double C6spc1_Z[C6spc1_num];
      double C6spc1_R[C6spc1_num];
      double C6spc1_r[C6spc1_num];

      for (int i = 0; i < C6spc1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C6spc1_Z[i] = cC6spc1.getLength(ossZID.str()) * unitFactor;
        C6spc1_R[i] = cC6spc1.getLength(ossRID.str()) * unitFactor;
        C6spc1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C6spc1x = new G4Polycone("geo_C6spc1x_name", 0, 2 * M_PI, C6spc1_num, C6spc1_Z, C6spc1_r, C6spc1_R);
      G4IntersectionSolid* geo_C6spc1 = new G4IntersectionSolid("geo_C6spc1_name", geo_C6spc1x, geo_C1wal1);

      string strMat_C6spc1 = cC6spc1.getString("Material");
      G4Material* mat_C6spc1 = Materials::get(strMat_C6spc1);
      G4LogicalVolume* logi_C6spc1 = new G4LogicalVolume(geo_C6spc1, mat_C6spc1, "logi_C6spc1_name");

      //put volume
      setColor(*logi_C6spc1, cC6spc1.getString("Color", "#CC0000"));
      setVisibility(*logi_C6spc1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C6spc1, "phys_C6spc1_name", logi_C5wal1, false, 0);

      //--------------
      //-   C6spc2

      //get parameters from .xml file
      GearDir cC6spc2(content, "C6spc2/");

      const int C6spc2_num = atoi(cC6spc2.getString("N").c_str());

      double C6spc2_Z[C6spc2_num];
      double C6spc2_R[C6spc2_num];
      double C6spc2_r[C6spc2_num];

      for (int i = 0; i < C6spc2_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C6spc2_Z[i] = cC6spc2.getLength(ossZID.str()) * unitFactor;
        C6spc2_R[i] = cC6spc2.getLength(ossRID.str()) * unitFactor;
        C6spc2_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C6spc2x = new G4Polycone("geo_C6spc2x_name", 0, 2 * M_PI, C6spc2_num, C6spc2_Z, C6spc2_r, C6spc2_R);
      G4IntersectionSolid* geo_C6spc2 = new G4IntersectionSolid("geo_C6spc2_name", geo_C6spc2x, geo_C1wal1);

      string strMat_C6spc2 = cC6spc2.getString("Material");
      G4Material* mat_C6spc2 = Materials::get(strMat_C6spc2);
      G4LogicalVolume* logi_C6spc2 = new G4LogicalVolume(geo_C6spc2, mat_C6spc2, "logi_C6spc2_name");

      //put volume
      setColor(*logi_C6spc2, cC6spc2.getString("Color", "#CC0000"));
      setVisibility(*logi_C6spc2, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C6spc2, "phys_C6spc2_name", logi_C5wal2, false, 0);

      //--------------
      //-   C7wal1

      //get parameters from .xml file
      GearDir cC7wal1(content, "C7wal1/");

      const int C7wal1_num = atoi(cC7wal1.getString("N").c_str());

      double C7wal1_Z[C7wal1_num];
      double C7wal1_R[C7wal1_num];
      double C7wal1_r[C7wal1_num];

      for (int i = 0; i < C7wal1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        C7wal1_Z[i] = cC7wal1.getLength(ossZID.str()) * unitFactor;
        C7wal1_R[i] = cC7wal1.getLength(ossRID.str()) * unitFactor;
        C7wal1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_C7wal1x = new G4Polycone("geo_C7wal1x_name", 0, 2 * M_PI, C7wal1_num, C7wal1_Z, C7wal1_r, C7wal1_R);
      G4IntersectionSolid* geo_C7wal1 = new G4IntersectionSolid("geo_C7wal1_name", geo_C7wal1x, geo_C1wal1);

      string strMat_C7wal1 = cC7wal1.getString("Material");
      G4Material* mat_C7wal1 = Materials::get(strMat_C7wal1);
      G4LogicalVolume* logi_C7wal1 = new G4LogicalVolume(geo_C7wal1, mat_C7wal1, "logi_C7wal1_name");

      //put volume
      setColor(*logi_C7wal1, cC7wal1.getString("Color", "#CC0000"));
      setVisibility(*logi_C7wal1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C7wal1, "phys_C7wal1_name", logi_C6spc2, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C7lyr1, "phys_C7lyr1_name", logi_C6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C7lyr2, "phys_C7lyr2_name", logi_C6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C7lyr3, "phys_C7lyr3_name", logi_C6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C7lyr4, "phys_C7lyr4_name", logi_C6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_C7lyr5, "phys_C7lyr5_name", logi_C6spc1, false, 0);
      ...
      //get parameters from .xml file
      GearDir cF3wal1(content, "F3wal1/");

      const int F3wal1_num = atoi(cF3wal1.getString("N").c_str());

      double F3wal1_Z[F3wal1_num];
      double F3wal1_R[F3wal1_num];
      double F3wal1_r[F3wal1_num];

      for (int i = 0; i < F3wal1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        F3wal1_Z[i] = cF3wal1.getLength(ossZID.str()) * unitFactor;
        F3wal1_R[i] = cF3wal1.getLength(ossRID.str()) * unitFactor;
        F3wal1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_F3wal1xx = new G4Polycone("geo_F3wal1xx_name", 0, 2 * M_PI, F3wal1_num, F3wal1_Z, F3wal1_r, F3wal1_R);
      G4IntersectionSolid* geo_F3wal1 = new G4IntersectionSolid("geo_F3wal1_name", geo_F3wal1xx, geo_F1wal1);

      string strMat_F3wal1 = cF3wal1.getString("Material");
      G4Material* mat_F3wal1 = Materials::get(strMat_F3wal1);
      G4LogicalVolume* logi_F3wal1 = new G4LogicalVolume(geo_F3wal1, mat_F3wal1, "logi_F3wal1_name");

      //put volume
      setColor(*logi_F3wal1, cF3wal1.getString("Color", "#CC0000"));
      setVisibility(*logi_F3wal1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F3wal1, "phys_F3wal1_name", logi_F2spc1, false, 0);
      ...
      //get parameters from .xml file
      GearDir cF4spc1(content, "F4spc1/");

      const int F4spc1_num = atoi(cF4spc1.getString("N").c_str());

      double F4spc1_Z[F4spc1_num];
      double F4spc1_R[F4spc1_num];
      double F4spc1_r[F4spc1_num];

      for (int i = 0; i < F4spc1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        F4spc1_Z[i] = cF4spc1.getLength(ossZID.str()) * unitFactor;
        F4spc1_R[i] = cF4spc1.getLength(ossRID.str()) * unitFactor;
        F4spc1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_F4spc1xx = new G4Polycone("geo_F4spc1xx_name", 0, 2 * M_PI, F4spc1_num, F4spc1_Z, F4spc1_r, F4spc1_R);
      G4IntersectionSolid* geo_F4spc1 = new G4IntersectionSolid("geo_F4spc1_name", geo_F4spc1xx, geo_F1wal1);

      string strMat_F4spc1 = cF4spc1.getString("Material");
      G4Material* mat_F4spc1 = Materials::get(strMat_F4spc1);
      G4LogicalVolume* logi_F4spc1 = new G4LogicalVolume(geo_F4spc1, mat_F4spc1, "logi_F4spc1_name");

      //put volume
      setColor(*logi_F4spc1, cF4spc1.getString("Color", "#CC0000"));
      setVisibility(*logi_F4spc1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F4spc1, "phys_F4spc1_name", logi_F3wal1, false, 0);

      //--------------
      //-   F5wal1

      //get parameters from .xml file
      GearDir cF5wal1(content, "F5wal1/");

      const int F5wal1_num = atoi(cF5wal1.getString("N").c_str());

      double F5wal1_Z[F5wal1_num];
      double F5wal1_R[F5wal1_num];
      double F5wal1_r[F5wal1_num];

      for (int i = 0; i < F5wal1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        F5wal1_Z[i] = cF5wal1.getLength(ossZID.str()) * unitFactor;
        F5wal1_R[i] = cF5wal1.getLength(ossRID.str()) * unitFactor;
        F5wal1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_F5wal1xx = new G4Polycone("geo_F5wal1xx_name", 0, 2 * M_PI, F5wal1_num, F5wal1_Z, F5wal1_r, F5wal1_R);
      G4IntersectionSolid* geo_F5wal1 = new G4IntersectionSolid("geo_F5wal1_name", geo_F5wal1xx, geo_F1wal1);

      string strMat_F5wal1 = cF5wal1.getString("Material");
      G4Material* mat_F5wal1 = Materials::get(strMat_F5wal1);
      G4LogicalVolume* logi_F5wal1 = new G4LogicalVolume(geo_F5wal1, mat_F5wal1, "logi_F5wal1_name");

      //put volume
      setColor(*logi_F5wal1, cF5wal1.getString("Color", "#CC0000"));
      setVisibility(*logi_F5wal1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F5wal1, "phys_F5wal1_name", logi_F4spc1, false, 0);

      //--------------
      //-   F6spc1

      //get parameters from .xml file
      GearDir cF6spc1(content, "F6spc1/");

      const int F6spc1_num = atoi(cF6spc1.getString("N").c_str());

      double F6spc1_Z[F6spc1_num];
      double F6spc1_R[F6spc1_num];
      double F6spc1_r[F6spc1_num];

      for (int i = 0; i < F6spc1_num; ++i) {
        ostringstream ossZID;
        ossZID << "Z" << i;
        ...
        F6spc1_Z[i] = cF6spc1.getLength(ossZID.str()) * unitFactor;
        F6spc1_R[i] = cF6spc1.getLength(ossRID.str()) * unitFactor;
        F6spc1_r[i] = 0.0;
      }

      //define geometry
      G4Polycone* geo_F6spc1xx = new G4Polycone("geo_F6spc1xx_name", 0, 2 * M_PI, F6spc1_num, F6spc1_Z, F6spc1_r, F6spc1_R);
      G4IntersectionSolid* geo_F6spc1 = new G4IntersectionSolid("geo_F6spc1_name", geo_F6spc1xx, geo_F1wal1);

      string strMat_F6spc1 = cF6spc1.getString("Material");
      G4Material* mat_F6spc1 = Materials::get(strMat_F6spc1);
      G4LogicalVolume* logi_F6spc1 = new G4LogicalVolume(geo_F6spc1, mat_F6spc1, "logi_F6spc1_name");

      //put volume
      setColor(*logi_F6spc1, cF6spc1.getString("Color", "#CC0000"));
      setVisibility(*logi_F6spc1, false);
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F6spc1, "phys_F6spc1_name", logi_F5wal1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F7lyr1, "phys_F7lyr1_name", logi_F6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F7lyr2, "phys_F7lyr2_name", logi_F6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F7lyr3, "phys_F7lyr3_name", logi_F6spc1, false, 0);
      ...
      new G4PVPlacement(0, G4ThreeVector(0, 0, 0), logi_F7lyr4, "phys_F7lyr4_name", logi_F6spc1, false, 0);
