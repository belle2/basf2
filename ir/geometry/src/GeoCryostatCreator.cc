...
namespace Belle2 {
  ...
  namespace ir {
    ...
    void GeoCryostatCreator::create(const GearDir& content, G4LogicalVolume& topVolume, GeometryTypes type)
    {
      ...
      //define geometry
      G4Polycone* geo_A1wal1pcon = new G4Polycone("geo_A1wal1pcon_name", 0, 2*M_PI, A1wal1_num, A1wal1_Z, A1wal1_rI, A1wal1_rO);
      ...
      //define geometry
      G4Polycone* geo_A2spc1pcon = new G4Polycone("geo_A2spc1pcon_name", 0, 2*M_PI, A1wal1_num, A1wal1_Z, A1wal1_rI, A2spc1_rO);
      ...
      //define geometry
      G4Polycone* geo_B1wal1pcon = new G4Polycone("geo_B1wal1pcon_name", 0, 2*M_PI, B1wal1_num, B1wal1_Z, B1wal1_rI, B1wal1_rO);
      ...
      //define geometry
      G4Polycone* geo_B2spc1pcon = new G4Polycone("geo_B2spc1pcon_name", 0, 2*M_PI, B1wal1_num, B1wal1_Z, B1wal1_rI, B2spc1_rO);
      ...
      //define geometry
      G4Polycone* geo_C1wal1pcon = new G4Polycone("geo_C1wal1pcon_name", 0, 2*M_PI, C1wal1_num, C1wal1_Z, C1wal1_rI, C1wal1_rO);
      ...
      //define geometry
      G4Polycone* geo_C2spc1pcon = new G4Polycone("geo_C2spc1pcon_name", 0, 2*M_PI, C2spc1_num, C2spc1_Z, C2spc1_rI, C2spc1_rO);
      ...
      //define geometry
      G4Polycone* geo_C3wal2pcon = new G4Polycone("geo_C3wal2pcon_name", 0, 2*M_PI, C3wal2_num, C3wal2_Z, C3wal2_rI, C3wal2_rO);
      ...
      //define geometry
      G4Polycone* geo_C4spc2pcon = new G4Polycone("geo_C4spc2pcon_name", 0, 2*M_PI, C4spc2_num, C4spc2_Z, C4spc2_rI, C4spc2_rO);
      ...
      //define geometry
      G4Polycone* geo_C5wal3pcon = new G4Polycone("geo_C5wal3pcon_name", 0, 2*M_PI, C5wal3_num, C5wal3_Z, C5wal3_rI, C5wal3_rO);
      ...
      //define geometry
      G4Polycone* geo_C5wal5pcon = new G4Polycone("geo_C5wal5pcon_name", 0, 2*M_PI, C5wal5_num, C5wal5_Z, C5wal5_rI, C5wal5_rO);
      ...
      //define geometry
      G4Polycone* geo_C6spc4pcon = new G4Polycone("geo_C6spc4pcon_name", 0, 2*M_PI, C6spc4_num, C6spc4_Z, C6spc4_rI, C6spc4_rO);
      ...
      //define geometry
      G4Polycone* geo_C6spc5pcon = new G4Polycone("geo_C6spc5pcon_name", 0, 2*M_PI, C6spc5_num, C6spc5_Z, C6spc5_rI, C6spc5_rO);
      ...
      //define geometry
      G4Polycone* geo_C6spc7pcon = new G4Polycone("geo_C6spc7pcon_name", 0, 2*M_PI, C6spc7_num, C6spc7_Z, C6spc7_rI, C6spc7_rO);
      ...
      //define geometry
      G4Polycone* geo_C6spc8pcon = new G4Polycone("geo_C6spc8pcon_name", 0, 2*M_PI, C6spc8_num, C6spc8_Z, C6spc8_rI, C6spc8_rO);
      ...
      //define geometry
      G4Polycone* geo_C6tnl1pcon = new G4Polycone("geo_C6tnl1pcon_name", 0, 2*M_PI, C6tnl1_num, C6tnl1_Z, C6tnl1_rI, C6tnl1_rO);
      ...
      //define geometry
      G4Polycone* geo_C6tnl2pcon = new G4Polycone("geo_C6tnl2pcon_name", 0, 2*M_PI, C6tnl2_num, C6tnl2_Z, C6tnl2_rI, C6tnl2_rO);

      //define geometry
      G4Polycone* geo_C6spc3pcon = new G4Polycone("geo_C6spc3pcon_name", 0, 2*M_PI, C6spc3_num, C6spc3_Z, C6spc3_rI, C6spc3_rO);
      ...
      //define geometry
      G4Polycone* geo_C6tnl3pcon = new G4Polycone("geo_C6tnl3pcon_name", 0, 2*M_PI, C6tnl3_num, C6tnl3_Z, C6tnl3_rI, C6tnl3_rO);
      ...
      //define geometry
      G4Polycone* geo_C6tnl4pcon = new G4Polycone("geo_C6tnl4pcon_name", 0, 2*M_PI, C6tnl4_num, C6tnl4_Z, C6tnl4_rI, C6tnl4_rO);

      //define geometry
      G4Polycone* geo_C6spc6pcon = new G4Polycone("geo_C6spc6pcon_name", 0, 2*M_PI, C6spc6_num, C6spc6_Z, C6spc6_rI, C6spc6_rO);
      ...
      //define geometry
      G4Polycone* geo_C7mag1pcon = new G4Polycone("geo_C7mag1pcon_name", 0, 2*M_PI, C7mag1_num, C7mag1_Z, C7mag1_rI, C7mag1_rO);
      G4IntersectionSolid* geo_C7mag1 = new G4IntersectionSolid("", geo_C7mag1pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7mag2pcon = new G4Polycone("geo_C7mag2pcon_name", 0, 2*M_PI, C7mag2_num, C7mag2_Z, C7mag2_rI, C7mag2_rO);
      G4IntersectionSolid* geo_C7mag2 = new G4IntersectionSolid("", geo_C7mag2pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7mag3pcon = new G4Polycone("geo_C7mag3pcon_name", 0, 2*M_PI, C7mag3_num, C7mag3_Z, C7mag3_rI, C7mag3_rO);
      G4IntersectionSolid* geo_C7mag3 = new G4IntersectionSolid("", geo_C7mag3pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7mag4pcon = new G4Polycone("geo_C7mag4pcon_name", 0, 2*M_PI, C7mag4_num, C7mag4_Z, C7mag4_rI, C7mag4_rO);
      G4IntersectionSolid* geo_C7mag4 = new G4IntersectionSolid("", geo_C7mag4pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7mag5pcon = new G4Polycone("geo_C7mag5pcon_name", 0, 2*M_PI, C7mag5_num, C7mag5_Z, C7mag5_rI, C7mag5_rO);
      G4IntersectionSolid* geo_C7mag5 = new G4IntersectionSolid("", geo_C7mag5pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7mag6pcon = new G4Polycone("geo_C7mag6pcon_name", 0, 2*M_PI, C7mag6_num, C7mag6_Z, C7mag6_rI, C7mag6_rO);
      G4IntersectionSolid* geo_C7mag6 = new G4IntersectionSolid("", geo_C7mag6pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7mag7pcon = new G4Polycone("geo_C7mag7pcon_name", 0, 2*M_PI, C7mag7_num, C7mag7_Z, C7mag7_rI, C7mag7_rO);
      G4IntersectionSolid* geo_C7mag7 = new G4IntersectionSolid("", geo_C7mag7pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7hld1pcon = new G4Polycone("geo_C7hld1pcon_name", 0, 2*M_PI, C7hld1_num, C7hld1_Z, C7hld1_rI, C7hld1_rO);
      G4IntersectionSolid* geo_C7hld1 = new G4IntersectionSolid("", geo_C7hld1pcon, geo_C6spc3);
      ...
      //define geometry
      G4Polycone* geo_C7cil1pcon = new G4Polycone("geo_C7cil1pcon_name", 0, 2*M_PI, C7hld1_num, C7hld1_Z, C7hld1_rI, C7cil1_rO);
      G4SubtractionSolid* geo_C7cil1_sub = new G4SubtractionSolid("", geo_C7cil1pcon, geo_C7hld1);
      G4IntersectionSolid* geo_C7cil1 = new G4IntersectionSolid("", geo_C7cil1_sub, geo_C6spc3);
      G4LogicalVolume *logi_C7cil1 = new G4LogicalVolume(geo_C7cil1, mat_C7cil1, "logi_C7cil1_name");

      //-   put volume
      setColor(*logi_C7cil1, cC7cil1.getString("Color", "#CC0000"));
      ...
      */
      ...
      //define geometry
      G4Polycone* geo_D1wal1pcon = new G4Polycone("geo_D1wal1pcon_name", 0, 2*M_PI, D1wal1_num, D1wal1_Z, D1wal1_rI, D1wal1_rO);
      G4LogicalVolume *logi_D1wal1 = new G4LogicalVolume(geo_D1wal1pcon, mat_D1wal1, "logi_D1wal1_name");
      ...
      //define geometry
      G4Polycone* geo_D2spc1pcon = new G4Polycone("geo_D2spc1pcon_name", 0, 2*M_PI, D1wal1_num, D1wal1_Z, D1wal1_rI, D2spc1_rO);
      G4IntersectionSolid* geo_D2spc1 = new G4IntersectionSolid("", geo_D2spc1pcon, geo_D1wal1pcon);
      ...
      //define geometry
      G4Polycone* geo_E1wal1pcon = new G4Polycone("geo_E1wal1pcon_name", 0, 2*M_PI, E1wal1_num, E1wal1_Z, E1wal1_rI, E1wal1_rO);
      G4LogicalVolume *logi_E1wal1 = new G4LogicalVolume(geo_E1wal1pcon, mat_E1wal1, "logi_E1wal1_name");
      ...
      //define geometry
      G4Polycone* geo_E2spc1pcon = new G4Polycone("geo_E2spc1pcon_name", 0, 2*M_PI, E1wal1_num, E1wal1_Z, E1wal1_rI, E2spc1_rO);
      G4IntersectionSolid* geo_E2spc1 = new G4IntersectionSolid("", geo_E2spc1pcon, geo_E1wal1pcon);
      ...
      //define geometry
      G4Polycone* geo_F1wal1pcon = new G4Polycone("geo_F1wal1pcon_name", 0, 2*M_PI, F1wal1_num, F1wal1_Z, F1wal1_rI, F1wal1_rO);
      G4SubtractionSolid* geo_F1wal1 = new G4SubtractionSolid("", geo_F1wal1pcon, geo_D1wal1pcon, transform_D1wal1);
      geo_F1wal1 = new G4SubtractionSolid("", geo_F1wal1pcon, geo_E1wal1pcon, transform_E1wal1);
      ...
      F2spc1_Z[0] = DistanceR - cF2spc1.getLength("D1") / Unit::mm;
      ...
      //define geometry
      G4Polycone* geo_F2spc1pcon = new G4Polycone("geo_F2spc1pcon_name", 0, 2*M_PI, F2spc1_num, F2spc1_Z, F2spc1_rI, F2spc1_rO);
      G4SubtractionSolid* geo_F2spc1 = new G4SubtractionSolid("", geo_F2spc1pcon, geo_D1wal1pcon, transform_D1wal1);
      geo_F2spc1 = new G4SubtractionSolid("", geo_F2spc1pcon, geo_E1wal1pcon, transform_E1wal1);
