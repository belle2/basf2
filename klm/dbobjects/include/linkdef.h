...
#pragma link C++ class Belle2::KLMEventT0HitResolution+; // checksum=0x6012d7c6, version=1
...
#pragma link C++ class Belle2::KLMScintillatorFirmware+; // checksum=0xad3e43b1, version=1
...
#pragma link C++ class Belle2::KLMTimeResolution+; // checksum=0xf349648b, version=1
