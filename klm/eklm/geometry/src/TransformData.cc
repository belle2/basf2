...
const HepGeom::Transform3D*
EKLM::TransformData::getStripLocalToGlobal(const KLMDigit* hit) const
{
...
const HepGeom::Transform3D*
EKLM::TransformData::getStripGlobalToLocal(const KLMDigit* hit) const
{
...
bool EKLM::TransformData::intersection(const KLMDigit* hit1, const KLMDigit* hit2,
...
int EKLM::TransformData::getSectorByPosition(
  int section, const HepGeom::Point3D<double>& position)
{
  int sector;
  double x;
  if (section == 1) {
