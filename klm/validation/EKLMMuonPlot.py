...
eklm_digits_tres = ROOT.TH1F('eklm_digits_tres', 'EKLM muon 2d hits time resolution',
                             250, -25, 25)
...
functions.Add(TNamed('Description', 'Flag indicating if a muon hit
                     is in backward(1) or forward(2) EKLM'))
functions.Add(TNamed('Check', ''))
functions.Add(TNamed('Contact', contact))
functions.Add(TNamed('MetaOptions', 'shifter'))
...
functions.Add(TNamed('Description', 'Number of generated
                     photoelectrons in EKLM'))
functions.Add(TNamed('Check', ''))
functions.Add(TNamed('Contact', contact))
functions.Add(TNamed('MetaOptions', 'shifter'))
