...
mdst_dataobjects = [
    DataStorePrinter("EventMetaData", [
        ...
        "getProduction", "getTime", "getGeneratedWeight",  # getParentLfn: not printed in release-00-09-03
    ], array=False),
    DataStorePrinter("Track", ["getNumberOfFittedHypotheses"], {
        "getTrackFitResult": [Belle2.Const.pion],  # const_stable: behavior changed for non-pion tracks
    ...
    DataStorePrinter("SoftwareTriggerResult", ["getResults"], array=False),  # getTotalResult: removed
...
if __name__ == "__main__":
    ...
    # now run the test
    print_file("mdst/tests/mdst-v00-09-03.root")
