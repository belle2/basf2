...
"""
Test backwards compatibility for an mdst file produced with release-08-00-00.

See https://xwiki.desy.de/xwiki/rest/p/0a372 if this test fails.

CHANGES since release-08-00-00:
...
if __name__ == "__main__":
    ...
    set_random_seed(1)
    main = create_path()
    main.add_module("RootInput", inputFileName=find_file("mdst/tests/mdst-v08-00-00.root"))
