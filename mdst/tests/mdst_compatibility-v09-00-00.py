...
"""
Test backwards compatibility for an mdst file produced with release-09-00-00.
...
if __name__ == "__main__":
    ...
    set_random_seed(1)
    main = create_path()
    main.add_module("RootInput", inputFileName=find_file("mdst/tests/mdst-v09-00-00.root"))
