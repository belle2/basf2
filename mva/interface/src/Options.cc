...
namespace Belle2 {
  namespace MVA {
    ...
    po::options_description GeneralOptions::getDescription()
    {
      ...
      ("datafile", po::value<std::string>(&m_datafile)->required(), "ROOT file containing the training dataset")
    ...
    void GeneralOptions::load(const boost::property_tree::ptree& pt)
    {
      ...
      m_datafile = pt.get<std::string>("datafile");
    ...
    po::options_description MetaOptions::getDescription()
    {
      ...
      ("splot_mc_file", po::value<std::string>(&m_splot_mc_file),
       "Monte carlo file containing the discriminant variable with the mc truth")
    ...
    void MetaOptions::load(const boost::property_tree::ptree& pt)
    {
      ...
      m_splot_mc_file = pt.get<std::string>("splot_mc_file");
    ...
    void MetaOptions::save(boost::property_tree::ptree& pt) const
    {
      ...
      pt.put("splot_mc_file", m_splot_mc_file);
