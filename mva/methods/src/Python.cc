...
namespace Belle2 {
  namespace MVA {
    ...
    Weightfile PythonTeacher::train(Dataset& training_data) const
    {
      ...
      long dimensions_X[2] = {training_batch_size, numberOfFeatures};
      long dimensions_y[1] = {training_batch_size};
      long dimensions_w[1] = {training_batch_size};
      ...
      long dimensions_X_v[2] = {validation_batch_size, numberOfFeatures};
      long dimensions_y_v[1] = {validation_batch_size};
      long dimensions_w_v[1] = {validation_batch_size};
    ...
    std::vector<float> PythonExpert::apply(Dataset& test_data) const
    {
      ...
      long dimensions_X[2] = {numberOfEvents, numberOfFeatures};
