...
If you are working with ntuples, the recommended way is to use the ``VariablesToTable`` module to write out particle lists directly to ``parquet``  or ``hdf5`` format.
