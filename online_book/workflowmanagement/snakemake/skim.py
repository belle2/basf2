...
ma.inputMdstList(environmentType="default", filelist=gbasf2_dataset, path=mypath, entrySequences=['0:10'])

ma.fillParticleList(decayString='K+:1%',  cut="dr < 0.5 and abs(dz) < 3 and thetaInCDCAcceptance and kaonID > 0.01", path=mypath)
