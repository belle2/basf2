...
namespace Belle2 {
   ...
   */
  class PXDNeutronFluxEvent : public RelationsObject  {

  public:

    /** default constructor for ROOT */
    PXDNeutronFluxEvent(): m_layer(0), m_ladder(0), m_sensor(0),
     ...
     */
    PXDNeutronFluxEvent(unsigned short layer, unsigned short ladder, unsigned short sensor,
