...
#
# basf2 create_mcrun.py -- --expNo=3 --runNo=3360 --setNo=0
#
...
# Default GT for phase2 data production GT
reset_database()
...
parser.add_argument('--bg', default='/home/benjamin/BeamRun18/phase_bg_campaign15', type=str, help='Path to mixer sets')
