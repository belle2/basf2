//+
// File : PXDReadRawDHH.h
// Description : Module to Load Raw PXD Data from DHH BonnDAQ dump file and store it as RawDHH in Data Store
...
#ifndef PXDREADRAWDHH_H
#define PXDREADRAWDHH_H
...
#define MAXEVTSIZE (4*1024*1024)
    ...
    class PXDReadRawDHHModule : public Module {
