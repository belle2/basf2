...
#ifndef PRERAWCOPPERFORMAT_V0_H
#define PRERAWCOPPERFORMAT_V0_H
...
namespace Belle2 {
   ...
   */
  class PreRawCOPPERFormat_v0 : public RawCOPPERFormat {
  public:
    //! Default constructor
    PreRawCOPPERFormat_v0();

    //! Constructor using existing pointer to raw data buffer
    //PreRawCOPPERFormat_v0(int* bufin, int nwords);
    //! Destructor
    virtual ~PreRawCOPPERFormat_v0();
    ...
    //
    // Get information from "PreRawCOPPERFormat_v0 header" attached by DAQ software
    //
    ...
    RawCOPPERFormat_v0 m_reduced_rawcpr; //! not record

  protected :
    ///ver.2 Change FEE format as presented at B2GM in Nov.2013 ( Nov.20, 2013)
    ClassDef(PreRawCOPPERFormat_v0, 2);

  };



  inline int* PreRawCOPPERFormat_v0::GetRawHdrBufPtr(int n)
  {
    int pos_nwords = GetBufferPos(n);
    return &(m_buffer[ pos_nwords ]);
  }

  inline int* PreRawCOPPERFormat_v0::GetRawTrlBufPtr(int n)
  {
    int pos_nwords;
  ...
  inline unsigned int PreRawCOPPERFormat_v0::GetDriverChkSum(int n)
  {
  ...
  inline int PreRawCOPPERFormat_v0::GetCOPPERNodeId(int n)
  {
  ...
  inline int PreRawCOPPERFormat_v0::GetExpNo(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetExpNo();
  }

  inline int PreRawCOPPERFormat_v0::GetRunNo(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
  ...
  inline int PreRawCOPPERFormat_v0::GetSubRunNo(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetSubRunNo();
  }

  inline int PreRawCOPPERFormat_v0::GetRunNoSubRunNo(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetRunNoSubRunNo();
  }

  inline unsigned int PreRawCOPPERFormat_v0::GetEveNo(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
  ...
  inline int PreRawCOPPERFormat_v0::GetSubsysId(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
  ...
  inline int PreRawCOPPERFormat_v0::GetDataType(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetDataType();
  }

  inline int PreRawCOPPERFormat_v0::GetTruncMask(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
  ...
  inline unsigned int PreRawCOPPERFormat_v0::GetCOPPERCounter(int n)
  {
  ...
  inline int PreRawCOPPERFormat_v0::Get1stDetectorNwords(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
  ...
  inline int PreRawCOPPERFormat_v0::Get2ndDetectorNwords(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int PreRawCOPPERFormat_v0::Get3rdDetectorNwords(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int PreRawCOPPERFormat_v0::Get4thDetectorNwords(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int PreRawCOPPERFormat_v0::GetOffset1stFINESSE(int n)
  {
    int pos_nwords = GetBufferPos(n) + tmp_header.RAWHEADER_NWORDS + SIZE_COPPER_HEADER;
    return pos_nwords;
  }

  inline int PreRawCOPPERFormat_v0::GetOffset2ndFINESSE(int n)
  {
    return GetOffset1stFINESSE(n) + Get1stFINESSENwords(n);
  }

  inline int PreRawCOPPERFormat_v0::GetOffset3rdFINESSE(int n)
  {
    return GetOffset2ndFINESSE(n) + Get2ndFINESSENwords(n);
  }

  inline int PreRawCOPPERFormat_v0::GetOffset4thFINESSE(int n)
  {
  ...
  inline int* PreRawCOPPERFormat_v0::Get1stFINESSEBuffer(int n)
  {
  ...
  inline int* PreRawCOPPERFormat_v0::Get2ndFINESSEBuffer(int n)
  {
  ...
  inline int* PreRawCOPPERFormat_v0::Get3rdFINESSEBuffer(int n)
  {
  ...
  inline int* PreRawCOPPERFormat_v0::Get4thFINESSEBuffer(int n)
  {
  ...
  inline int* PreRawCOPPERFormat_v0::Get1stDetectorBuffer(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int* PreRawCOPPERFormat_v0::Get2ndDetectorBuffer(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int* PreRawCOPPERFormat_v0::Get3rdDetectorBuffer(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int* PreRawCOPPERFormat_v0::Get4thDetectorBuffer(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline int* PreRawCOPPERFormat_v0::GetExpRunBuf(int n)
  {
#ifdef USE_B2LFEE_FORMAT_BOTH_VER1_AND_2
    CheckB2LFEEHeaderVersion(n);
#endif
  ...
  inline unsigned int PreRawCOPPERFormat_v0::GetMagicDriverHeader(int n)
  {
    int pos_nwords = GetBufferPos(n) + tmp_header.RAWHEADER_NWORDS + POS_MAGIC_COPPER_1;
    return (unsigned int)(m_buffer[ pos_nwords ]);
  }

  inline unsigned int PreRawCOPPERFormat_v0::GetMagicFPGAHeader(int n)
  {
    int pos_nwords = GetBufferPos(n) + tmp_header.RAWHEADER_NWORDS + POS_MAGIC_COPPER_2;
    return (unsigned int)(m_buffer[ pos_nwords ]);
  }

  inline unsigned int PreRawCOPPERFormat_v0::GetMagicFPGATrailer(int n)
  {
  ...
  inline unsigned int PreRawCOPPERFormat_v0::GetMagicDriverTrailer(int n)
  {
    int pos_nwords = GetBufferPos(n) + GetBlockNwords(n) - tmp_trailer.GetTrlNwords() - 1;
    return (unsigned int)(m_buffer[ pos_nwords ]);
  }

  inline unsigned int PreRawCOPPERFormat_v0::GetTrailerChksum(int  n)
  {
  ...
  inline unsigned int PreRawCOPPERFormat_v0::GetTTCtimeTRGType(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetTTCtimeTRGType();
  }

  inline unsigned int PreRawCOPPERFormat_v0::GetTTUtime(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetTTUtime();
  }

  inline int PreRawCOPPERFormat_v0::GetTTCtime(int n)
  {
    tmp_header.SetBuffer(GetBuffer(n));
    return tmp_header.GetTTCtime();
  }

  inline void PreRawCOPPERFormat_v0::GetTTTimeVal(int n, struct timeval* tv)
  {
    tmp_header.SetBuffer(GetBuffer(n));
