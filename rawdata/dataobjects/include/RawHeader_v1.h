...
// Set info.
//
  inline void RawHeader_v1::Initialize()
  {
    CheckSetBuffer();
  ...
  /*   inline void RawHeader_v1::SetMagicWordEntireHeader() */
  /*   { */
...
//
  ...
  inline int RawHeader_v1::GetRunNoSubRunNo()
  {
    CheckGetBuffer();
  ...
  inline unsigned int RawHeader_v1::GetExpRunNumberWord()
  {
    CheckGetBuffer();
    return ((unsigned int)(m_buffer[ POS_EXP_RUN_NO ]));
  }
