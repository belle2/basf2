...
int RawCOPPERFormat_v0::GetBufferPos(int n)
{
...
int RawCOPPERFormat_v0::GetOffsetFINESSE(int n, int finesse_num)
{
  switch (finesse_num) {
    case 0 :
...
int* RawCOPPERFormat_v0::GetFINESSEBuffer(int n, int finesse_num)
{
  switch (finesse_num) {
    case 0 :
...
int* RawCOPPERFormat_v0::GetDetectorBuffer(int n, int finesse_num)
{
  switch (finesse_num) {
    case 0 :
...
unsigned int  RawCOPPERFormat_v0::CalcXORChecksum(int* buf, int nwords)
{
...
unsigned int RawCOPPERFormat_v0::GetB2LHeaderWord(int n, int finesse_buffer_pos)
{
  unsigned int word[4];
