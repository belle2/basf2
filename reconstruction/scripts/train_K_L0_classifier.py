...
try:
    ...
    identifier = "KLM_fBDT_50xbkg1.xml"
...
--variable "KLMnLayer" "KLMnInnermostlayer" "KLMglobalZ" "KLMtime" "KLMdistToNextCl" "KLMenergy" "KLMTrackSepDist"
...
--target_variable isSignal - -method FastBDT - -nTrees 400 - -nCutLevels 8 - -nLevels 4'.format(
    data_path=data_path,
...
# "upload" to localdb
os.system(
    'basf2_mva_upload --identifier {identifier} --db_identifier {identifier_db} --begin_experiment {ex_b}'
    '--end_experiment {ex_e} --begin_run {run_b} --end_run {run_e}'.format(
        identifier=identifier,
