...
if __name__ == "__main__":
    ...
    # Generate and simulate few events without MC information for exp. 1004
    steering = b2.find_file(os.path.join('reconstruction', 'tests', 'prepare', 'evtgen_no_mc.py_noexec'))
    output_file = os.path.join(prepare_path, 'test_standalone_reco_no_mc_bbbar_exp1004.root')
