...
if __name__ == "__main__":
    ...
    # Reconstruct few events for exp. 1003
    steering = b2.find_file(os.path.join('reconstruction', 'tests', 'reco.py_noexec'))
    input_file = b2.find_file(os.path.join(prepare_path, 'test_standalone_reco_no_mc_bbbar_exp1003.root'))
    output_file = 'output_no_mc_exp1003.root'
