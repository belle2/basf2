...
def BsigToDhTohhList(path=mypath):
    """
    ...
    **Additional Cuts**:
    ...
    for chID, channel in enumerate(BsigChannels):
        reconstructDecay('B+:BtoDh' + str(chID) + ' -> ' + channel, Bcuts, chID, path=mypath)
...
def loadD0bar(path=mypath):
    ...
    for chID, channel in enumerate(D0barChannels):
        reconstructDecay('anti-D0:D0Bar' + str(chID) + ' -> ' + channel, Dcuts, chID, path=mypath)
        D0barList.append('anti-D0:D0Bar' + str(chID))
        copyLists('anti-D0:hh', D0barList, path=mypath)
    return D0barList


def BsigToDhToKshhList(path=mypath):
    """
    **Skim Author**: M. Nayak
    ...
    **Additional Cuts**:
    ...
    BsigList = []
    for chID, channel in enumerate(BsigChannels):
        reconstructDecay('B-:BtoDhkshh' + str(chID) + ' -> ' + channel, Bcuts, chID, path=mypath)
...
def loadDkshh(path=mypath):
    ...
    for chID, channel in enumerate(D0_Channels):
        reconstructDecay('D0:Kshh' + str(chID) + ' -> ' + channel, Dcuts, chID, path=mypath)
        D0List.append('D0:Kshh' + str(chID))
        copyLists('D0:Kshh', D0List, path=mypath)
    return D0List


def BsigToDhToKspi0List(path=mypath):
    """
    **Skim Author**: M. Nayak
    ...
    **Additional Cuts**:
    ...
    BsigList = []
    for chID, channel in enumerate(BsigChannels):
        reconstructDecay('B-:BtoDhkspi0' + str(chID) + ' -> ' + channel, Bcuts, chID, path=mypath)
...
def loadDkspi0(path=mypath):
    ...
    D0List = []
    for chID, channel in enumerate(D0_Channels):
        reconstructDecay('D0:Kspi0' + str(chID) + ' -> ' + channel, Dcuts, chID, path=mypath)
        D0List.append('D0:Kspi0' + str(chID))
        copyLists('D0:Kspi0', D0List, path=mypath)
    return D0List


def BsigToDhToKspipipi0List(path=mypath):
    """
    **Skim Author**: N. Rout
    ...
    **Additional Cuts**:
    ...
    BsigList = []
    for chID, channel in enumerate(BsigChannels):
        reconstructDecay('B-:BtoDhkspipipi0' + str(chID) + ' -> ' + channel, Bcuts, chID, path=mypath)
...
def loadDkspipipi0(path=mypath):
    Dcuts = '1.8 < M < 1.9'
    ...
    D0List = []
    for chID, channel in enumerate(D0_Channels):
        reconstructDecay('D0:Kspipipi0' + str(chID) + ' -> ' + channel, Dcuts, chID, path=mypath)
        D0List.append('D0:Kspipipi0' + str(chID))
        copyLists('D0:Kspipipi0', D0List, path=mypath)
    return D0List


def DoubleCharmList(path=mypath):
    ...
    for chID, channel in enumerate(B0_Channels):
        reconstructDecay('B0:DC' + str(chID) + ' -> ' + channel, Bcuts, chID, path=mypath)
