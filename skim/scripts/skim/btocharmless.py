...
from skim.standardlists.charmless import loadStdPi0ForBToCharmless, loadStdVeryLooseKstarPlus, loadStdVeryLooseKstarPlusPi0
...
def BtoHad4TracksRho(BaseSkim):
    ...
    * ``abs(deltaE) < 0.3``
    ...
    def build_lists(self, path):
        ...
        channels = {
                    'B0:Charmless_b2rhorho': 'rho0:veryLoose rho0:veryLoose'  # 1
                    }
...
def BtoHad5Tracks(BaseSkim):
    ...
    * ``abs(deltaE) < 0.3``
    ...
    """
    __authors__ = ["Fernando Abudinen", "Riccardo Manfredi", "Sebastiano Raiz", "Benedikt Wach"]
    __description__ = "Skim list definitions for all neutral B to charmless modes with 5 tracks."
    __contact__ = __liaison__
    __category__ = "physics, hadronic B to charmless"
...
def BtoHad1Track1Pi0(BaseSkim):
    ...
    * ``abs(deltaE) < 0.3``
    ...
    """
    __authors__ = ["Fernando Abudinen", "Riccardo Manfredi", "Sebastiano Raiz", "Benedikt Wach"]
    __description__ = "Skim list definitions for all neutral B to charmless modes with 1 track and 1 pi0."
    __contact__ = __liaison__
...
def BtoHad2Tracks1Pi0(BaseSkim):
    ...
    * ``abs(deltaE) < 0.3``
    ...
    """
    __authors__ = ["Fernando Abudinen", "Riccardo Manfredi", "Sebastiano Raiz", "Benedikt Wach"]
    __description__ = "Skim list definitions for all neutral B to charmless modes with 2 tracks and 1 pi0 modes."
    __contact__ = __liaison__
    __category__ = "physics, hadronic B to charm"
...
def BtoHad3Tracks1Pi0(BaseSkim):
    ...
    * ``abs(deltaE) < 0.3``
    ...
    """
    __authors__ = ["Fernando Abudinen", "Riccardo Manfredi", "Sebastiano Raiz", "Benedikt Wach"]
    __description__ = "Skim list definitions for all neutral B to charmless modes with 3 tracks and 1 Pi0."
    __contact__ = __liaison__
    __category__ = "physics, hadronic B to charmless"
