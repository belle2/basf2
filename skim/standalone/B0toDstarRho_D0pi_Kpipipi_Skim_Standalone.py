...
skimCode = sef.encodeSkimName('B0toDstarRho_D0pi_Kpipipi')
...
# B0 -> D*-( -> D0(-> Kpipipi) pi-) rho+
from skim.btocharm import B0toDstarRho_KpipipiList
...
B0toDstarRho_D0pi_Kpipipi_list = B0toDstarRho_KpipipiList(path=path)
sef.skimOutputUdst(skimCode, B0toDstarRho_D0pi_Kpipipi_list, path=path)
ma.summaryOfLists(B0toDstarRho_D0pi_Kpipipi_list, path=path)
