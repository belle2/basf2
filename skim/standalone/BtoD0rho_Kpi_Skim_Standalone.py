...
#####################################################################
#
# B+ -> anti-D0 (-> Kpi) rho+, anti-D*0( -> D0(-> Kpi) pi0) rho+ skim
# Fernando Abudinen
#
#####################################################################
...
skimCode = sef.encodeSkimName('BtoD0rho_Kpi')
...
BtoD0rho_Kpi_list = BtoD0rho_KpiList(path=path)
sef.skimOutputUdst(skimCode, BtoD0rho_Kpi_list, path=path)
ma.summaryOfLists(BtoD0rho_Kpi_list, path=path)
