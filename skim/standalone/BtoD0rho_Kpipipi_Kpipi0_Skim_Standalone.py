...
skimCode = sef.encodeSkimName('BtoD0rho_Kpipipi_Kpipi0')
...
BtoD0rho_Kpipipi_Kpipi0list = BtoD0rho_Kpipipi_Kpipi0List(path=path)
sef.skimOutputUdst(skimCode, BtoD0rho_Kpipipi_Kpipi0list, path=path)
ma.summaryOfLists(BtoD0rho_Kpipipi_Kpipi0list, path=path)
