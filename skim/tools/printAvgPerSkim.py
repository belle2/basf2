...
skims += 'feiSLB0  feiSLBplus  feiHadronicB0 feiHadronicBplus '
skims += '  BtoDh_Kspi0  BtoDh_hh TauGeneric  PRsemileptonicUntagged SLUntagged LeptonicUntagged TCPV'
skims += ' DstToD0Pi_D0ToRare BtoXll BtoXgamma  TauLFV Charm3BodyHadroni3 DstToD0Pi_D0ToHpJmPi0'
skims += ' DstToD0Pi_D0ToHpHmPi0 DstToD0Pi_D0ToHpJmPi02    DstToD0Pi_D0ToNeutrals XToD0_D0ToNeutrals'
