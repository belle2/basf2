...
all_skims = [
    ...
    "feiSLB0WithOneLep", "feiSLBplusWithOneLep", "feiHadronicB0",
    ...
    "BtoDh_Kshh", "PRsemileptonicUntagged", "SLUntagged", "Charm2BodyHadronicD0",
    "LeptonicUntagged", "TCPV", "CharmRare", "BtoXll", "BtoXgamma", "TauLFV",
    "CharmlessHad2Body", "CharmlessHad3Body", "SystematicsEELL"
]
MC11types = {
