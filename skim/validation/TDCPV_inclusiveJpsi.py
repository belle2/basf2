...
"""
<header>
    <output>TDCPV_inclusiveJpsi_validation.root</output>
    <contact>nbrenny@iastate.edu</contact>
</header>
"""
...
from skim.WGs.tdcpv import TDCPV_inclusiveJpsi

path = b2.Path()
skim = TDCPV_inclusiveJpsi(
    validation=True,
    udstOutput=False,
)
