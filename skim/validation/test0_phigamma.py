...
########################################################
# Radiative events ee->KK gamma(ISR) are generated
# generator
#
...
phigamma_path.add_module(eventinfosetter)

# Register the PHOKHARA module
phokhara = b2.register_module('PhokharaInput')
# Set the logging level for the PHOKHARA module to INFO in order to see the cross sections etc.
phokhara.set_log_level(b2.LogLevel.INFO)
...
phokhara.param('ScatteringAngleRangePhoton', [5., 175.])
...
phigamma_path.add_module("Progress")
phigamma_path.add_module(phokhara)
