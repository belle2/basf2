...
"""
<header>
  <input>../TwoTrackMuMu.dst.root</input>
  <output>../TwoTrackMuMu.udst.root</output>
...
ma.inputMdst('default', '../TwoTrackMuMu.dst.root', path=TwoTrackEEMuMu_path)

TwoTrackEEMuMu_list = dark.TwoTrackEEMuMuList(path=TwoTrackEEMuMu_path)
expert.skimOutputUdst('../TwoTrackMuMu.udst.root', TwoTrackEEMuMu_list, path=TwoTrackEEMuMu_path)
