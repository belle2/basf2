...
create_validation_histograms(
    ...
    variables_1d=[
        ...
        ('deltaE', 100, -0.2, 0.2, 'deltaE', myEmail,
         '\\Delta E of event', 'Peak around zero', '#Delta E', 'Candidates'),
        ('Mbc', 100, 5.2, 5.3, 'Mbc', myEmail,
         'Beam-constrained mass of event', 'Peaking around B mass (5.28 GeV)', 'M_{bc}', 'Candidates')],
