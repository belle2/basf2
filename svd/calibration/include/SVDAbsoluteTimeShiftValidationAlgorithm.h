...
namespace Belle2 {
   ...
   */
  class SVDAbsoluteTimeShiftValidationAlgorithm : public CalibrationAlgorithm {
  public:

    /** Constructor set the prefix to SVDTimeCalibrationCollector*/
    explicit SVDAbsoluteTimeShiftValidationAlgorithm();

    /** Destructor*/
    virtual ~SVDAbsoluteTimeShiftValidationAlgorithm() {}
