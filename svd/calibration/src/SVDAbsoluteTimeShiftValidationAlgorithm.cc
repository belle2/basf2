 ...
 **************************************************************************/
#include <svd/calibration/SVDAbsoluteTimeShiftValidationAlgorithm.h>
...
SVDAbsoluteTimeShiftValidationAlgorithm::SVDAbsoluteTimeShiftValidationAlgorithm() :
  CalibrationAlgorithm("SVDAbsoluteTimeShiftValidationCollector")
{
  setDescription("SVDAbsoluteTimeShiftValidation calibration algorithm");
}

CalibrationAlgorithm::EResult SVDAbsoluteTimeShiftValidationAlgorithm::calibrate()
{
