...
namespace Belle2 {
  ...
  public:
    ...
    SVDNeutronFluxEvent():
      m_time(0.0), m_u(0.0), m_v(0.0),
      m_kineticEnergy(0.0), m_stepLength(0.0), m_nielFactor(0.0), m_rawFlux(0.0),
      m_nielFlux(0.0), m_pdg(0), m_layer(0), m_ladder(0), m_sensor(0)
    {
    ...
    SVDNeutronFluxEvent(unsigned short layer, unsigned short ladder, unsigned short sensor,
      ...
      m_time(time), m_u(u), m_v(v), m_kineticEnergy(kineticEnergy),
      m_stepLength(stepLength), m_nielFactor(nielFactor), m_rawFlux(rawFlux),
      m_nielFlux(nielFlux), m_pdg(pdg), m_layer(layer), m_ladder(ladder), m_sensor(sensor)
    {
    ...
    ClassDef(SVDNeutronFluxEvent, 2)
  };
