...
#pragma link C++ class Belle2::SVDCalibrationsBase< Belle2::SVDCalibrationsScalar< Belle2::SVDPosErrScaleFactors>> +;
#pragma link C++ class Belle2::SVDCalibrationsScalar< Belle2::SVDPosErrScaleFactors> +;
