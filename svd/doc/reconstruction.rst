...
| Process                        | Descrition                                                                                                                                                                                                                                                                                                                                                               |
+================================+==========================================================================================================================================================================================================================================================================================================================================================================+
| Preparing Histogram            | Creating a 1D histogram of given range **[a, b]** ns and bin-width of 1/**[c]** ns.                                                                                                                                                                                                                                                                                      |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Filling Cluster Time           | For each cluster, a normalized Gaussian is filled in the above histogram, centered at the cluster-time. The width of the Gaussian is pursed depending on the side of the sensor and then number of strips in the cluster. To save time, only the bins within **[d]** σ of the center is calculated and filled.                                                           |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Finding Peaks                  | Once all the Gaussian are filled, the correlated-clusters form a big Gaussian (which will be called **group** hereafter). The group-finding is performed in the following method.                                                                                                                                                                                        |
|                                |                                                                                                                                                                                                                                                                                                                                                                          |
|                                | * Maximum bin is found and a Gaussian is fitted in the range of **[-e, e]** ns keeping the bin as center.                                                                                                                                                                                                                                                                |
|                                | * The group info (prominence, center, width) is stored.                                                                                                                                                                                                                                                                                                                  |
|                                | * The peak is removed from the histogram. To save time, value of the Gaussian for the bins only within **[f]** σ are calculated and subtracted from those bins.                                                                                                                                                                                                          |
|                                | * Maximum bin is found again and checked whether this peak is above threshold ( > **[g]** :math:`\times` firstGroup).                                                                                                                                                                                                                                                    |
|                                | * If above threshold, then the process is repeated again.                                                                                                                                                                                                                                                                                                                |
|                                | * Search is stopped if **[h]** number of groups are found.                                                                                                                                                                                                                                                                                                               |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Creating Dummy Groups          | If the number of groups found is less than **[h]** then, dummy groups are inserted to increase the size to **[h]**. This helps in the sorting process in the following.                                                                                                                                                                                                  |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                | * Background:                                                                                                                                                                                                                                                                                                                                                            |
|                                |                                                                                                                                                                                                                                                                                                                                                                          |
|                                |   * All the groups with centers outside the signal range **[i, j]**, are moved towards the end of the queue.                                                                                                                                                                                                                                                             |
|                                |   * These groups are then sorted in reverse, that means, the biggest group occupy the last position.                                                                                                                                                                                                                                                                     |
|                                |                                                                                                                                                                                                                                                                                                                                                                          |
|                                | * Signal groups are naturally sorted as per their prominence at this point. But sometimes a group, near signal and not involved in trigger decision, may be higher than the signal group. Now the probability of finding a signal group near **[k]** is larger than far from **[k]**. So the signal groups are sorted with an exponential weight with width **[-l]** ns. |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Signal Group Selection         | Depending on the type of study, we may choose first **[m]** groups to be accepted for space-point-creation.                                                                                                                                                                                                                                                              |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Form Super Group               | If this flag is enabled, all the groups are given same groupId. This is useful for SVD time calibration.                                                                                                                                                                                                                                                                 |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Assign GroupId to SVD-Clusters | All the clusters are now compared against the surviving groups. All the clusters within **[n]** σ of a group center are then assigned that groupId and groupInfo. Hence, one cluster shared between two groups can have two groupId.                                                                                                                                     |
+--------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

Parameters
^^^^^^^^^^
In the :b2:mod:`SVDTimeGrouping`, the parameters are defined in the following. Also, the values assigned in the following table are to be used for CoG3 calibrated cluster time.

+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| Item | Name                 | Current Value | Description                                               | Coment                             |
+======+======================+===============+===========================================================+====================================+
| a    | tRangeLow            | -160          | full range                                                |                                    |
+------+----------------------+---------------+                                                           +------------------------------------+
| b    | tRangeHight          | 160           |                                                           |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| c    | factor               | 2             | histogram bin division                                    | Making it zero disables the module |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| d    | fillSigmaN           | 3             | compute bins up to 3 sigma                                |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| e    | timeSpread           | 5             | fitting peak in range [-5,5]                              |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| f    | calSigmaN            | 5             | subtract peak up to 5 sigma                               |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| g    | fracThreshold        | 0.05          | threshold of peak finding                                 |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| h    | maxGroups            | 20            | maximum 20 groups are found                               |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| i    | signalRangeLow       | -50           | Expected signal location                                  |                                    |
+------+----------------------+---------------+                                                           +------------------------------------+
| j    | signalRangeHigh      | 50            |                                                           |                                    |
+------+----------------------+---------------+                                                           +------------------------------------+
| k    | expSignalLoc         | 0             |                                                           |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| l    | exponentialSort      | 30            | sorting groups with exponential weight                    | Making it zero disables the sort   |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| m    | signalGroupSelection | 1             | Number of groups accepted after sort                      |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
|      | formSuperGroup       | False         | if true, assign same group number to all groups           |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+
| n    | accSigmaN            | 5             | Assign group ID to clusters up to 5 sigma of group center |                                    |
+------+----------------------+---------------+-----------------------------------------------------------+------------------------------------+

Parameters to be changed during CoG3 Calibration (RawTime)
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
| i    | signalRangeLow       | 70            |
+------+----------------------+---------------+
| j    | signalRangeHigh      | 130           |
+------+----------------------+---------------+
| k    | expSignalLoc         | 100           |
+------+----------------------+---------------+
| m    | signalGroupSelection | 4             |
+------+----------------------+---------------+
|      | formSuperGroup       | True          |
+------+----------------------+---------------+
| n    | accSigmaN            | 3             |
