...
+------+----------------------+---------------+------------------------------------+
| Item | Name                 | Current Value | Coment                             |
+======+======================+===============+====================================+
| a    | tRangeLow            | -160          |                                    |
+------+----------------------+---------------+------------------------------------+
| b    | tRangeHight          | 160           |                                    |
+------+----------------------+---------------+------------------------------------+
| c    | factor               | 2             | Making it zero disables the module |
+------+----------------------+---------------+------------------------------------+
| d    | fillSigmaN           | 3             |                                    |
+------+----------------------+---------------+------------------------------------+
| e    | timeSpread           | 5             |                                    |
...
| k    | expSignalLoc         | 0             |                                    |
+------+----------------------+---------------+------------------------------------+
| l    | exponentialSort      | 30            | Making it zero disables the sort   |
+------+----------------------+---------------+------------------------------------+
| m    | signalGroupSelection | 20            | Same as maxGroups                  |
+------+----------------------+---------------+------------------------------------+
| n    | formSuperGroup       | False         |                                    |
+------+----------------------+---------------+------------------------------------+
...
| k    | expSignalLoc         | 100           |
+------+----------------------+---------------+
| m    | signalGroupSelection | 5             |
+------+----------------------+---------------+
| n    | formSuperGroup       | True          |
+------+----------------------+---------------+
...
Parameters to be changed during ELS3 Calibration (RawTime)
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
