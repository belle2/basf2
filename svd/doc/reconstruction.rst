...
--------------------
Clusters are grouped based on their time. Clusters created by charged particles coming to the same e+e- collision are near in time, and will be grouped together.
...
| Process                        | Descrition                                                                                                                                                                                                                                                                                                                                                                      |
+================================+=================================================================================================================================================================================================================================================================================================================================================================================+
| Preparing Histogram            | Creating a 1D histogram of given range **[tRangeLow, tRangeHigh]** ns and bin-width of **1/rebinningFactor** ns.                                                                                                                                                                                                                                                                |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Filling Cluster Time           | For each cluster, a normalized Gaussian is filled in the above histogram, centered at the cluster-time. The width of the Gaussian is pursed depending on the side of the sensor and the number of strips in the cluster. To save time, only the bins within **fillSigmaN** sigma of the center is calculated and filled.                                                        |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                |                                                                                                                                                                                                                                                                                                                                                                                 |
|                                | * Maximum bin is found and a Gaussian is fitted in the range of **[-timeSpread, timeSpread]** ns keeping the bin as center.                                                                                                                                                                                                                                                     |
|                                | * The group info (prominence, center, width) is stored.                                                                                                                                                                                                                                                                                                                         |
|                                | * The peak is removed from the histogram. To save time, value of the Gaussian for the bins only within **removeSigmaN** sigma are calculated and subtracted from those bins.                                                                                                                                                                                                    |
|                                | * Maximum bin is found again and checked whether this peak is above threshold ( > **fracThreshold** x firstGroup).                                                                                                                                                                                                                                                              |
|                                | * If above threshold, then the process is repeated again.                                                                                                                                                                                                                                                                                                                       |
|                                | * Search is stopped if **maxGroups** number of groups are found.                                                                                                                                                                                                                                                                                                                |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Creating Dummy Groups          | If the number of groups found is less than **maxGroups** then, dummy groups are inserted to increase the total groups to **maxGroups**. This helps in the sorting process in the following.                                                                                                                                                                                     |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                                | * Background:                                                                                                                                                                                                                                                                                                                                                                   |
|                                |                                                                                                                                                                                                                                                                                                                                                                                 |
|                                |     * All the groups with centers outside the signal range **[signalRangeLow, signalRangeHigh]**, are moved towards the end of the queue.                                                                                                                                                                                                                                       |
|                                |     * These groups are then sorted in reverse, that means, the biggest group occupy the last position.                                                                                                                                                                                                                                                                          |
|                                |                                                                                                                                                                                                                                                                                                                                                                                 |
|                                | * Signal groups are naturally sorted as per their prominence at this point. But sometimes a group, near signal and not involved in trigger decision, may be higher than the signal group. Now the probability of finding a signal group near **expSignalLoc** is larger than far. So the signal groups are sorted with an exponential weight with width **exponentialSort** ns. |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Signal Group Selection         | Depending on the type of study, we may choose first **signalGroupSelection** groups to be accepted for space-point-creation.                                                                                                                                                                                                                                                    |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Form Super Group               | If this flag is enabled, all the groups are given same groupId.                                                                                                                                                                                                                                                                                                                 |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Assign GroupId to SVD-Clusters | All the clusters are now compared against the surviving groups. The clusters within **acceptSigmaN** sigma of a group center are then assigned that groupId and groupInfo. Hence, one cluster shared between two groups can have two groupId.                                                                                                                                   |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
