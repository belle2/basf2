...
|                                |                                                                                                                                                                                                                                                                                                                                                                                 |
|                                | * Maximum bin is found and a Gaussian is fitted in the range of **[-fitRangeHalfWidth, fitRangeHalfWidth]** ns keeping the bin as center.                                                                                                                                                                                                                                       |
...
|                                | * Background:                                                                                                                                                                                                                                                                                                                                                                   |
|                                |                                                                                                                                                                                                                                                                                                                                                                                 |
|                                |     * All the groups with centers outside the signal range **[expectedSignalTimeMin, expectedSignalTimeMax]**, are moved towards the end of the queue.                                                                                                                                                                                                                          |
...
|                                | * Signal:                                                                                                                                                                                                                                                                                                                                                                       |
|                                |                                                                                                                                                                                                                                                                                                                                                                                 |
|                                | * Signal groups are naturally sorted based on integral at this point. But sometimes a background group, near signal may be higher than the signal group. Now the probability of finding a signal group near **expectedSignalTimeCenter** is larger than far. So the signal groups are sorted with an exponential weight with width **signalLifetime** ns.                       |
|                                | * So, the probability of being signal is max at groupID = 0 and decreases with group number increasing.                                                                                                                                                                                                                                                                         |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Signal Group Selection         | Depending on the type of study, we may choose first **numberOfSignalGroups** groups to be accepted for space-point-creation.                                                                                                                                                                                                                                                    |
+--------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
