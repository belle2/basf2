...
add_simulation(main, components=['MagneticField', 'SVD'], bkgfiles=bkgFiles, usePXDDataReduction=False, bkgOverlay=False)

add_svd_reconstruction(main, isROIsimulation=False)
...
clseval.param('outputFileName', "ClusterEvaluation_Y4S_mixer.root")
