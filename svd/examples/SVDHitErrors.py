...
class SVDHitErrors(Module):
    ...
    def beginRun(self):
        ...
        self.file.write('truehit_u truehit_v truehit_time_ns charge_GeV theta_u theta_v ')
            ...
            for truehit_index in cluster_truehits:
                ...
                if cluster.isUCluster():
                    ...
                    cluster_pull = (cluster.getPosition() - truehit.getV()) \
                        / cluster.getPositionSigma()
                s_cl = '{isU} {uvC:10.5f} {uvCErr:10.5f} {tC:10.2f} {eC:10.1f} '.format(
                ...
                if cluster.getSize() == 2:
                    if cluster.isUCluster():
                        self.h_pull_u.Fill((cluster.getPosition() - truehit.getU()) / cluster.getPositionSigma())
                    else:
                        self.h_pull_v.Fill((cluster.getPosition() - truehit.getV()) / cluster.getPositionSigma())
