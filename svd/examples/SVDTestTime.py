...
# Set output filename
output.param('outputFileName', 'SVDTestTimeOutput.root')
...
# SVDCLUST parameters
SVDCLUST.set_log_level(LogLevel.INFO)
SVDCLUST.param('digitsSorted', True)
SVDCLUST.param('UseTimeFitter', True)
SVDCLUST.param('RejectionLevel', 0.05)
