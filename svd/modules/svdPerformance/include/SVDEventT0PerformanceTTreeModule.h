...
namespace Belle2 {
  ...
  private:
    ...
    float m_svdOnlineEventT0    = std::numeric_limits<float>::quiet_NaN(); /**< SVD online event T0 error */
    ...
    float m_cdcOnlineEventT0    = std::numeric_limits<float>::quiet_NaN(); /**< CDC online event T0 error */
    float m_cdcOnlineEventT0Err = std::numeric_limits<float>::quiet_NaN(); /**< CDC online event T0 error */
    float m_topEventT0          = std::numeric_limits<float>::quiet_NaN(); /**< TOP event T0 error */
    float m_topEventT0Err       = std::numeric_limits<float>::quiet_NaN(); /**< TOP event T0 error */
    float m_topOnlineEventT0    = std::numeric_limits<float>::quiet_NaN(); /**< TOP online event T0 error */
    ...
    float m_eclOnlineEventT0    = std::numeric_limits<float>::quiet_NaN(); /**< ECL online event T0 error */
