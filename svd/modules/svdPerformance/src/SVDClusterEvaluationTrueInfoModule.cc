...
SVDClusterEvaluationTrueInfoModule::~SVDClusterEvaluationTrueInfoModule()
{
}


void SVDClusterEvaluationTrueInfoModule::initialize()
{
...
void SVDClusterEvaluationTrueInfoModule::endRun()
{
...
TH1F* SVDClusterEvaluationTrueInfoModule::createHistogram1D(const char* name, const char* title,
...
TH2F* SVDClusterEvaluationTrueInfoModule::createHistogram2D(const char* name, const char* title,
...
int SVDClusterEvaluationTrueInfoModule::indexFromLayerSensorSide(int LayerNumber, int SensorNumber, int UVNumber)
{
  int Index;
...
TString SVDClusterEvaluationTrueInfoModule::IntExtFromIndex(int idx)
{
  TString name = "";
...
TString SVDClusterEvaluationTrueInfoModule::FWFromIndex(int idx)
{
  TString name = "";
...
TString SVDClusterEvaluationTrueInfoModule::UVFromIndex(int idx)
{
  TString name = "";
...
void SVDClusterEvaluationTrueInfoModule::createArbitraryGraphErrorChooser(const char* name, const char* title, float x[m_Nsets],
...
void SVDClusterEvaluationTrueInfoModule::createArbitraryGraphError_Std(const char* name, const char* title, float x[m_Nsets],
...
void SVDClusterEvaluationTrueInfoModule::createArbitraryGraphError_Red(const char* name, const char* title, float x[m_NsetsRed],
