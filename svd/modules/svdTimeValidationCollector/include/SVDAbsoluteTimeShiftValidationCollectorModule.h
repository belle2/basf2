...
namespace Belle2 {
   ...
   */
  class SVDAbsoluteTimeShiftValidationCollectorModule : public CalibrationCollectorModule {

  public:
    /**
     * Constructor
     */
    SVDAbsoluteTimeShiftValidationCollectorModule();
  ...
  private:
    ...
    /** time alorithms */
    std::vector<std::string> m_timeAlgorithms = {"CoG3", "ELS3", "CoG6"}; /**< List of time algorithms to validate. */
