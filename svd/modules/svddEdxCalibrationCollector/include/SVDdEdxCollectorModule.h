...
namespace Belle2 {
  ...
  private:
    ...
    // double m_piondEdxTrackdx[m_pionLambdadEdxTrackNHits];       /**<   dx (path length) for the pion from the Lambda, taken from the VXDDedxTrack */
    // int m_piondEdxTrackdE[m_pionLambdadEdxTrackNHits];       /**<   dE (ADC counts) for the pion from the Lambda, taken from the VXDDedxTrack */
    ...
    // double m_kaondEdxTrackdx[m_kaondEdxTrackNHits];       /**<   dx (path length) for the kaon from the D0, taken from the VXDDedxTrack */
    // int m_kaondEdxTrackdE[m_kaondEdxTrackNHits];       /**<   dE (ADC counts) for the kaon from the D0, taken from the VXDDedxTrack */
    ...
    // double m_pionDdEdxTrackdx[m_pionDdEdxTrackNHits];       /**<   dx (path length) for the pion from the D0, taken from the VXDDedxTrack */
    // int m_pionDdEdxTrackdE[m_pionDdEdxTrackNHits];       /**<   dE (ADC counts) for the pion from the D0, taken from the VXDDedxTrack */
    ...
    // double m_slowPiondEdxTrackdx[m_slowPiondEdxTrackNHits];       /**<   dx (path length) for the pion from the Dstar, taken from the VXDDedxTrack */
    // int m_slowPiondEdxTrackdE[m_slowPiondEdxTrackNHits];       /**<   dE (ADC counts) for the pion from the Dstar, taken from the VXDDedxTrack */
    ...
    // double m_firstElectrondEdxTrackdx[m_firstElectrondEdxTrackNHits];       /**<   dx (path length) for the first electron, taken from the VXDDedxTrack */
    // int m_firstElectrondEdxTrackdE[m_firstElectrondEdxTrackNHits];       /**<   dE (ADC counts) for the first electron, taken from the VXDDedxTrack */
    ...
    // double m_secondElectrondEdxTrackdx[m_secondElectrondEdxTrackNHits];       /**<   dx (path length) for the second electron, taken from the VXDDedxTrack */
    // int m_secondElectrondEdxTrackdE[m_secondElectrondEdxTrackNHits];       /**<   dE (ADC counts) for the second electron, taken from the VXDDedxTrack */
