                ...
                for sensor in geoCache.getSensors(ladder):
                    ...
                    for side in range(2):
                        for tb in range(4):
                            ...
                            cogRAWmean = cog.GetMean()
                            TCOGMEAN += n * (m * self.sumCOGList[li][ldi][si][side][tb] / n + q) / NTOT

                            print("li: " + str(li))
                            print("ldi: " + str(ldi))
                            print("si: " + str(si))
                            print("side: " + str(side))
                            print("tb: " + str(tb) + " n: " + str(n) + " NTOT: " + str(NTOT) +
                                  " m: " + str(m) + " q:" + str(q) + "mean: " + str(cogRAWmean))

                        T0MEAN = self.EventT0Hist.GetMean()
                        print("SUMCOG: " + str(TCOGMEAN) + " T0MEAN: " + str(T0MEAN))
