...
fitterZS3.param('Correction_StripCalPeakTime', True)
fitterZS3.param('Correction_TBTimeWindow', True)
fitterZS3.param('Correction_ShiftMeanToZero', False)
fitterZS3.param('Correction_ShiftMeanToZeroTBDep', False)
...
fitterZS5.param('Correction_StripCalPeakTime', True)
fitterZS5.param('Correction_TBTimeWindow', True)
fitterZS5.param('Correction_ShiftMeanToZero', False)
fitterZS5.param('Correction_ShiftMeanToZeroTBDep', False)
