...
#pragma link C++ options=version(2) class Belle2::Helix+; // checksum=0xc11c13b7, version=2
...
#pragma link C++ options=nostreamer,nomap class Belle2::BackgroundMetaData; // checksum=0x60d78a20, version=4
#pragma link C++ options=evolution class Belle2::BackgroundInfo; // checksum=0x6eb1ad8, version=4
