...
use_local_database(Belle2.FileSystem.findFile('/user/b2daq/hlt/data/database.txt'), "", True)
...
roiprod_debug1.set_name('ROIGenerator_L1')
param_roiGen1 = {'ROIListName': 'debugROIs', 'TrigDivider': 2,
                 'nROIs': 1, 'Layer': 1, 'Ladder': 1, 'Sensor': 2
                 #                 'MinU': 0, 'MaxU' : 63, 'MinV' : 0, 'MaxV' : 3
                 }
roiprod_debug1.param(param_roiGen1)

# Dummy RoIs Generator, Sensor 2:1:2
roiprod_debug2 = register_module('ROIGenerator')
roiprod_debug2.set_name('ROIGenerator_L2')
param_roiGen2 = {'ROIListName': 'debugROIs', 'TrigDivider': 2,
                 'nROIs': 1, 'Layer': 2, 'Ladder': 1, 'Sensor': 2
                 #                 'MinU': 0, 'MaxU' : 63, 'MinV' : 4, 'MaxV' : 7
                 }
...
# set_streamobjs ( ['EventMetaData', 'RawSVDs', 'RawFTSWs', 'ROIpayload', 'ROIs', 'debugROIs'] )
...
set_streamobjs(['EventMetaData', 'RawSVDs', 'SVDClusters', 'RawFTSWs', 'ProcessStatistics',
                'caTracks', 'caTracksTogfTracks', 'gfTracks', 'ROIpayload', 'debugROIs',
                'PXDIntercepts', 'PXDInterceptsTodebugROIs', 'gfTracksToPXDIntercepts'])
