...
#pragma once
#ifndef TESTBEAM_VXD_DATAOBJECTS_TELSIMHIT_H
#define TESTBEAM_VXD_DATAOBJECTS_TELSIMHIT_H

#include <vxd/dataobjects/VXDSimHit.h>

namespace Belle2 {
  /** Class TelSimHit - Geant4 simulated hit for the Tel.
   *
   ...
   * _local_ information.
   */
  class TelSimHit : public VXDSimHit {
  public:
     ...
     */
    TelSimHit(VxdID sensorID, int pdg, float globalTime, const float* posIn,
              const float* posOut): VXDSimHit(sensorID, pdg, globalTime, posIn, posOut)
    {}

  private:
    ClassDef(TelSimHit, 3)
  };
