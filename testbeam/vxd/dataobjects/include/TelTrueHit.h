...
#pragma once
#ifndef TESTBEAM_VXD_DATAOBJECTS_TRUEHIT_H
#define TESTBEAM_VXD_DATAOBJECTS_TRUEHIT_H

#include <vxd/dataobjects/VXDTrueHit.h>

namespace Belle2 {
  /**
    * Class TelTrueHit - Records of tracks that either enter or leave
    ...
    * information.
    */
  class TelTrueHit : public VXDTrueHit {
  public:
    /** Default constructor for ROOT IO */
    TelTrueHit(): VXDTrueHit() {}
     ...
     */
    TelTrueHit(VxdID sensorID, float* posEntry, float* posMidPoint, float* posExit,
