...
def add_unpackers(path, svd_only=False):
    if not svd_only:
        path.add_module('PXDTriggerShifter')
...
def add_merger(path):
    ...
    param_telmerger = {
        ...
        'bufferSize': 10000,
        #        'inputFileName': '/work1/ulf/rawdata/DESY_April16/eudaq/run000359.raw',
        'inputFileName': '/work1/ulf/rawdata/DESY_April16/eudaq/run000486.raw',
    }
...
if args.dqm:
    if not args.svd_only:
        ...
        main.add_module("VXDTelDQMOffLine")
