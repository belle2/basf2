...
namespace Belle2 {
  ...
  private:
    ...
    */
    ...
    int m_SaveOtherHistos = 1;       /**< flag <0,1> for removing of 1D correlation plots from output */
  ...
  inline const SVD::SensorInfo& SVDDQM3Module::getInfo(int index, int sensor) const
  {
