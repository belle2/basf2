...
namespace Belle2 {
   ...
   */
  class TrackFinderMCVXDTBModule : public Module {
  ...
  private:
    ...
    bool m_useTelHits;                                          /**< Boolean to select if TelHits should be used*/
    ...
    int m_minTelHits;                                           /**< Minimum number of Telescope hits per track to allow track candidate creation*/
