...
#ifndef TEL_ClusterProjection_H
#define TEL_ClusterProjection_H
...
namespace Belle2 {
  ...
  namespace TEL {
    ...
    public:
       ...
       */
      void add(unsigned int cell, float position);
    ...
    inline void ClusterProjection::add(unsigned int cell, float position)
    {
