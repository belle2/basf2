...
#ifndef TEL_NOISEMAP_H
#define TEL_NOISEMAP_H
...
namespace Belle2 {
  ...
  namespace TEL {
    ...
    public:
      ...
      float getSignificance(const Pixel& px) const { return 1.0 / getNoise(px); }
