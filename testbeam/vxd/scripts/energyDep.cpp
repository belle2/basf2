...

{
    ...
    double pxd_height = 0.0001;
    double svd_height = 0.00032;
    ...
    tree->Draw("VXDHits.m_energyDep>>Hp",cond1.c_str());    
    ...
    tree->Draw("VXDHits.m_energyDep>>Hs",cond2.c_str());    
    ...
    tree->Draw("VXDHits.m_energyDep>>Ha",cond3.c_str());    
