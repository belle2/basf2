...
namespace Belle2 {
  ...
  public:
     ...
     */
    void importSampleTimeCalibration(std::string fileNames, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     * @param fileNames file names separated by space (since vector doesn't work!)
     */
    void importLocalT0Calibration(std::string fileNames, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     */
    void importModuleT0Calibration(std::string fileName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     */
    void importOfflineCommonT0Calibration(std::string fileName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     */
    void generateFakeChannelMask(double fractionDead, double fractionHot, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     */
    void importPmtQEData(std::string fileName, std::string treeName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     * @param treeName : name of the tree containing relevant data
     */
    void importPmtGainData(std::string fileName, std::string treeName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     * @param treeName : name of the tree containing relevant data
     */
    void importPmtInstallationData(std::string fileName, std::string treeName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     * @param treeName : name of the tree containing relevant data
     */
    void importPmtObsoleteData(std::string fileName, std::string treeName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     * @param treeName : name of the tree containing relevant data
     */
    void importPmtTTSPar(std::string fileName, std::string treeName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     * @param treeName : name of the tree containing relevant data
     */
    void importPmtTTSHisto(std::string fileName, std::string treeName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     */
    void importPmtPulseHeightFitResult(std::string fileName, int firstExp, int firstRun, int lastExp, int lastRun);
     ...
     */
    void importDummyCalModuleAlignment(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalCalModuleT0 DB objects
     */
    void importDummyCalModuleT0(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalChannelT0 DB objects
     */
    void importDummyCalChannelT0(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalTimebase DB objects
     */
    void importDummyCalTimebase(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalChannelNoise DB objects
     */
    void importDummyCalChannelNoise(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalChannelPulseHeight DB objects
     */
    void importDummyCalChannelPulseHeight(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalChannelRQE DB objects
     */
    void importDummyCalChannelRQE(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalChannelThresholdEff DB objects
     */
    void importDummyCalChannelThresholdEff(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalChannelThreshold DB objects
     */
    void importDummyCalChannelThreshold(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalCommonT0 DB objects
     */
    void importDummyCalCommonT0(int firstExp, int firstRun, int lastExp, int lastRun);

    /**
     * import a dummy payload of TOPCalIntegratedCharge DB objects
     */
    void importDummyCalIntegratedCharge(int firstExp, int firstRun, int lastExp, int lastRun);
