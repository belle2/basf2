#ifndef MY_TOPINTERIMFEANAMODULE_H
#define MY_TOPINTERIMFEANAMODULE_H
...
namespace Belle2 {
  ...
  class MY_TOPInterimFEAnaModule : public HistoModule {

    // Public functions
  public:
    //! Constructor / Destructor
    MY_TOPInterimFEAnaModule();
    virtual ~MY_TOPInterimFEAnaModule();
