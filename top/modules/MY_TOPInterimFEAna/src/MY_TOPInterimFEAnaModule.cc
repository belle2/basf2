...
#include <top/modules/MY_TOPInterimFEAna/MY_TOPInterimFEAnaModule.h>
...
REG_MODULE(MY_TOPInterimFEAna)


MY_TOPInterimFEAnaModule::MY_TOPInterimFEAnaModule() : HistoModule()
{
...
MY_TOPInterimFEAnaModule::~MY_TOPInterimFEAnaModule() {}

void MY_TOPInterimFEAnaModule::initialize()
{
  REG_HISTOGRAM;
}

void MY_TOPInterimFEAnaModule::defineHisto()
{
...
void MY_TOPInterimFEAnaModule::beginRun() {}

void MY_TOPInterimFEAnaModule::event()
{
...
void MY_TOPInterimFEAnaModule::endRun() {}

void MY_TOPInterimFEAnaModule::terminate() {}

Bool_t MY_TOPInterimFEAnaModule::IsCalCh(Short_t PixelId)
{
