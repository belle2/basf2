...
{
  h->SetAxisRange(m_xmin, m_xmax);
  TF1* func = new TF1("fcnCB", fcnCB, m_xmin, m_xmax, 5);
...
// double Crystal Ball fit
TF1* LaserCalibratorFit::makeCB2Fit(TH1F* h, int pixelID, bool sall)
{
  h->SetAxisRange(m_xmin, m_xmax);
  TF1* func = new TF1("fcnCB2", fcnCB2, m_xmin, m_xmax, 8);
