...
namespace Belle2 {
  namespace TOP {
    ...
    public:
      ...
      /**
       * Full constructor
       * @param pdfConstructor reconstruction object
       * @param binSize approximate bin size (use getBinSize() to get the actual one)
       * @param timeWindow full time window size
       */
       ...
       * @return number of delta-ray photons
       */
      double getExpectedDeltaPhotons() const {return m_expectedDelta;}
    ...
    private:
      ...
      double m_expectedDelta = 0; /**< expected number of delta-ray photons */
