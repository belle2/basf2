...
foreach file (`\ls -1 $hitFilePath`) 
    ...
    if ( $type == 'laser'  && $thisSlot == $slot && $thisRun <= $stopRun && $thisRun >= $startRun )  then
	echo $thisRun
        ${BELLE2_LOCAL_DIR}/bin/Linux_x86_64/opt/analyzeHits_AsicByAsic $hitFilePath$file   $outFolder/$file"_out.root"              
