...
REG_MODULE(DoubleCalPulseCalib);
...
DoubleCalPulseCalibModule::~DoubleCalPulseCalibModule() {}

//void DoubleCalPulseCalibModule::defineHisto()
//{
//  m_occupancy = new TH2F("WaveFormOccupancy", "WaveFormOccupancy", 64, 1, 65, 8, 1, 9);
//}

void DoubleCalPulseCalibModule::initialize()
{

}

void DoubleCalPulseCalibModule::beginRun()
{

}


void DoubleCalPulseCalibModule::event()
{

  //Get Waveform from datastore
  StoreArray<TOPCAFDigitCalib> digit_ptr;
...
void DoubleCalPulseCalibModule::terminate()
{
