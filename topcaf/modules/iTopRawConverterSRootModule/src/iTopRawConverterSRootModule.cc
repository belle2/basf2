...
// Module function //
/////////////////////
void iTopRawConverterSRootModule::initialize()
{
  //output
...
void iTopRawConverterSRootModule::beginRun()
{
...
void iTopRawConverterSRootModule::terminate()
{
}

void iTopRawConverterSRootModule::event()
{
...
EventHeaderPacket* iTopRawConverterSRootModule::GetEvtHeaderPacket()
{
  EventHeaderPacket* ret = new EventHeaderPacket(*m_EvtPacket);
  return ret;
}

EventWaveformPacket* iTopRawConverterSRootModule::GetWaveformPacket()
{
  EventWaveformPacket* ret = new EventWaveformPacket(*m_WfPacket);
  return ret;
}

iTopRawConverterSRootModule::packet_word_t iTopRawConverterSRootModule::readWordUnique(packet_word_t prev_word)
{
...
iTopRawConverterSRootModule::packet_word_t iTopRawConverterSRootModule::swap_endianess(packet_word_t x)
{
