...
namespace Belle2 {
  namespace TrackFinderCDCLegendre {
    ...
    public:
       ...
       */
      double fitTrackCandidateFast(std::vector<TrackHit*>& hits, std::pair<double, double>& track_par, std::pair<double, double>& ref_point, bool with_drift_time = false);

      /**
       * Perform fast circular fitting
       */
      void fitTrackCandidateFast(std::pair<std::vector<TrackHit*>, std::pair<double, double> >* track, std::pair<double, double>& ref_point, double& chi2, bool with_drift_time = false);

      /**
       * Perform fast circular fitting
       */
      void fitTrackCandidateFast(TrackCandidate* track, std::pair<double, double>& ref_point, bool with_drift_time = false);

      /**
       * Perform fast circular fitting
       */
      void fitTrackCandidateFast(TrackCandidate* track, bool with_drift_time = false);
       ...
       */
      void fitTrackCandidateStepped(std::pair<std::vector<TrackHit*>, std::pair<double, double> >* track);

      /**
       * Correct estimation of chi2
       */
      double estimateChi2(std::vector<TrackHit*>& hits, std::pair<double, double>& track_par, std::pair<double, double>& ref_point);
