...
# svgdisplay_reassignment.draw_segments_firstNPassedSuperLayers = True
# svgdisplay_reassignment.draw_segments_lastNPassedSuperLayers = True
# svgdisplay_reassignment.draw_segments_firstInTrackId = True
