...
namespace Belle2 {
  namespace CDCLocalTracking {
    ...
    public:
      ...
      { return isValidILayer(iLayer + 2) ? &(getWireLayer(iLayer + 2).getWireSave(iWire - 1)) : nullptr;  }
      ...
      { return isValidILayer(iLayer - 2) ? &(getWireLayer(iLayer - 2).getWireSave(iWire)) : nullptr;  }
