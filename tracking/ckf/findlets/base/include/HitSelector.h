...
namespace Belle2 {
  ...
  private:
    ...
    /// Subfindlet: Filter 1
    LimitedFilter<LayerToggledFilter<AFilterFactory>> m_firstFilter;
    /// Subfindlet: Filter 2
    LimitedFilter<LayerToggledFilter<AFilterFactory>> m_secondFilter;
    /// Subfindlet: Filter 3
    LimitedFilter<LayerToggledFilter<AFilterFactory>> m_thirdFilter;
    /// Subfindlet: Advancer
