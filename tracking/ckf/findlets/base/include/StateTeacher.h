...
namespace Belle2 {
  ...
  class StateTeacher : public TrackFindingCDC::Findlet<CKFState<ASeed, AHitObject>*> {
  public:
    /// The parent class
    using Super = TrackFindingCDC::Findlet<CKFState<ASeed, AHitObject>*>;
    /// The state class
    using State = CKFState<ASeed, AHitObject>;
