...
namespace Belle2 {
  ...
  class WireHitTagger : public TrackFindingCDC::Findlet<const CKFResultObject<ASeed, AHitObject>> {
  public:
    ...
    void apply(const std::vector<CKFResultObject<ASeed, AHitObject>>& results) override
    {
