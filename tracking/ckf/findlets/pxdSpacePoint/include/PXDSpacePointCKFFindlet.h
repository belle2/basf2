...
namespace Belle2 {
   ...
   */
  class PXDSpacePointCKFFindlet : public TrackFindingCDC::Findlet<> {
    /// Parent class
    using Super = TrackFindingCDC::Findlet<>;

  public:
    /// Constructor, for setting module description and parameters.
    PXDSpacePointCKFFindlet();
  ...
  private:
    ...
    TreeSearchFindlet<RecoTrack, SpacePoint, PXDSpacePointMatcher, CKFCDCToSpacePointStateObjectFilterFactory, 4> m_treeSearchFindlet;
    ...
    SpacePointTagger<RecoTrack, SpacePoint, PXDCluster> m_spacePointTagger;
