...
namespace Belle2 {
  ...
  extern template class LayerToggledApplier<CKFToPXDState,
                                            LimitedOnStateApplier<CKFToPXDState, TrackingUtilities::ChooseableFilter<PXDStateFilterFactory>>>;
                                            /// Alias to apply the () operator to all items filtered by CKF PXD layer states
                                            using ChooseableOnPXDStateApplier =
                                              LayerToggledApplier<CKFToPXDState, LimitedOnStateApplier<CKFToPXDState, TrackingUtilities::ChooseableFilter<PXDStateFilterFactory>>>;
}
