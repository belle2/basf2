...
namespace Belle2 {
  ...
  constexpr
  static char const* const pxdStateVarNames[] = {
    "seed_cdc_hits",
    "seed_pxd_hits",
    "seed_lowest_pxd_layer",
  ...
  class PXDStateVarNames : public TrackFindingCDC::VarNames<BasePXDStateFilter::Object> {

  public:
    /// Number of variables to be generated.
    static const size_t nVars = TrackFindingCDC::size(pxdStateVarNames);

    /// Get the name of the column.
    constexpr
    static char const* getName(int iName)
    {
      return pxdStateVarNames[iName];
    }
  };
   ...
   */
  class PXDStateVarSet : public TrackFindingCDC::VarSet<PXDStateVarNames> {

  public:
    /// Generate and assign the variables from the VXD-CDC object.
    virtual bool extract(const BasePXDStateFilter::Object* object) override;
