...
namespace Belle2 {
  ...
  class SVDPairFilterFactory : public TrackingUtilities::FilterFactory<BaseSVDPairFilter> {

  private:
    /// Type of the base class
    using Super = TrackingUtilities::FilterFactory<BaseSVDPairFilter>;
