...
namespace Belle2 {
  ...
  class Chi2SVDResultFilter : public TrackFindingCDC::ChoosableFromVarSetFilter<SVDResultVarSet> {
  public:
    Chi2SVDResultFilter() : TrackFindingCDC::ChoosableFromVarSetFilter<SVDResultVarSet>("chi2")
    {
