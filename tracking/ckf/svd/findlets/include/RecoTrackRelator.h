...
namespace Belle2 {
  ...
  class RecoTrackRelator : public TrackFindingCDC::Findlet<const CKFToSVDResult,
    TrackFindingCDC::WeightedRelationPointerComparison<const RecoTrack, const RecoTrack>> {
  public:
    /// The parent findlet
    ...
    void apply(const std::vector<CKFToSVDResult>& results,
               std::vector<TrackFindingCDC::WeightedRelationPointerComparison<const RecoTrack, const RecoTrack>>& relationsCDCToSVD) final;
