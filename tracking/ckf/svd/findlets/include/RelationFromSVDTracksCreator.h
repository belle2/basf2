...
namespace Belle2 {
  ...
  class RelationFromSVDTracksCreator : public TrackFindingCDC::Findlet<CKFToSVDState, CKFToSVDState,
    TrackFindingCDC::WeightedRelationPointerComparison<CKFToSVDState>> {
  public:
    /// The parent findlet
    ...
    void apply(std::vector<CKFToSVDState>& seedStates, std::vector<CKFToSVDState>& states,
               std::vector<TrackFindingCDC::WeightedRelationPointerComparison<CKFToSVDState>>& relations) final;
