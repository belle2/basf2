...
void ResidualVTXStateFilter::exposeParameters(ModuleParamList* moduleParamList, const std::string& prefix)
{
...
Weight ResidualVTXStateFilter::operator()(const BaseVTXStateFilter::Object& pair)
{
