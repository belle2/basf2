...
constexpr const SimpleVTXStateFilter::MaximalValueArray SimpleVTXStateFilter::m_param_maximumHelixDistanceXY;
constexpr const SimpleVTXStateFilter::MaximalValueArray SimpleVTXStateFilter::m_param_maximumResidual;
constexpr const SimpleVTXStateFilter::MaximalValueArray SimpleVTXStateFilter::m_param_maximumChi2;
...
void SimpleVTXStateFilter::beginRun()
{
  ...
  B2WARNING("The cuts in this class (SimpleVTXStateFilter) have not yet been optimized on MC. "
            ...
            "or optimize these cuts based on MC using the records described in the VTXStateFilterFactory.");
}
