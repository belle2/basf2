...
namespace Belle2 {
   ...
   */
  class CKFToVTXSeedFindlet : public TrackingUtilities::Findlet<> {
    /// Parent class
  ...
  private:
    ...
    std::vector<TrackingUtilities::WeightedRelation<const RecoTrack, const RecoTrack>> m_relationsCDCToVTX;
  };
}
