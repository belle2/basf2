...
namespace Belle2 {
  /**
   * This class stores additional information to every CDC/SVD/PXD/VTX hit stored in a RecoTrack.
  ...
  public:
    ...
    /** Define, use of clusters or true hits for VTX. */
    typedef VTXCluster UsedVTXHit;
  ...
  public:
    ...
    /**
     * Create hit information for a VTX hit with the given information. Adds the relation to the hit automatically.
     * @param vtxHit The hit to create this information for.
     * @param foundByTrackFinder Which track finder has found this hit?
     * @param sortingParameter The sorting parameter of this hit.
     */
    RecoHitInformation(const UsedVTXHit* vtxHit, OriginTrackFinder foundByTrackFinder,
                       unsigned int sortingParameter) :
      RecoHitInformation(vtxHit, RecoHitDetector::c_VTX, RightLeftInformation::c_invalidRightLeftInformation,
                         foundByTrackFinder, sortingParameter)
    {
    }
  ...
  private:
    ...
    ClassDef(RecoHitInformation, 7); /**< This class implements additional information for hits */
  };
}
