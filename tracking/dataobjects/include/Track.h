...
namespace Belle2 {
  ...
  /*! Track parameters. */
  /*! This Track class is inspired by the lcio track implementation ( see http://lcio.desy.de/v01-51/doc/doxygen_api/html/classIMPL_1_1TrackImpl.html )
      \author <a href="mailto:martin.heck@kit.edu?subject=Track">Martin Heck</a>
  */
  ...
  private:
    ...
    */
    ...
    /*! Signed curvature of the track.
        The curvature is 1/(2R) where R is the radius of the track measured in cm.
