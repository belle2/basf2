...
//    */
//   static double calcAvgDistanceXY(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit, const B2Vector3D& circleCenter)
//   {
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getAngle3D(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getAngle3DSimple(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D outerVector = oHit - cHit;
//     B2Vector3D innerVector = cHit - iHit;
//
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getAngleRZ(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D outerVector = oHit - cHit;
//     B2Vector3D innerVector = cHit - iHit;
//
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getAngleRZSimple(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D outerVector = oHit - cHit;
//     B2Vector3D innerVector = cHit - iHit;
//
...
//
//
//   /** calculates the angle between the hits/vectors (XY), returning unit: angle in radian
//    * @param oHit: first point for which the distance is evaluated
//    * @param cHit: second point for which the distance is evaluated
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getAngleXY(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D outerVector = oHit - cHit;
//     B2Vector3D innerVector = cHit - iHit;
//
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static B2Vector3D getCircleCenterXY(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     // calculates the intersection point using Cramer's rule.
//     // x_1+s*n_1==x_2+t*n_2 --> n_1 *s - n_2 *t == x_2 - x_1 --> http://en.wikipedia.org/wiki/Cramer%27s_rule
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getCircleDistanceIP(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getCircleRadius(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D circleCenter = getCircleCenterXY(oHit, cHit, iHit);
//     if (circleCenter.Perp2() > 1e30) {
//       return NAN;
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getCosAngleXY(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D outerVector = oHit - cHit;
//     B2Vector3D innerVector = cHit - iHit;
//
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getDeltaSlopeRZ(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getDeltaSlopeZoverS(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D circleCenter = getCircleCenterXY(oHit, cHit, iHit);
//     if (circleCenter.Perp2() > 1e30) {
//       return NAN;
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getDeltaSoverZ(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D circleCenter = getCircleCenterXY(oHit, cHit, iHit);
//     if (circleCenter.Perp2() > 1e30) {
//       return NAN;
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double performHelixParamterFit(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D circleCenter = getCircleCenterXY(oHit, cHit, iHit);
//     if (circleCenter.Perp2() > 1e30) {
//       return NAN;
...
//    * @param iHit: third point for which the distance is evaluated
//    */
//   static double getSimplePTEstimate(const B2Vector3D& oHit, const B2Vector3D& cHit, const B2Vector3D& iHit)
//   {
//     B2Vector3D circleCenter = getCircleCenterXY(oHit, cHit, iHit);
//     if (circleCenter.Perp2() > 1e30) {
//       return NAN;
