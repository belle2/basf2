...
ThreeHitQIFilter::operator()(const BasePathFilter::Object& pair)
{
...
void ThreeHitQIFilter::exposeParameters(ModuleParamList* moduleParamList, const std::string& prefix)
{
