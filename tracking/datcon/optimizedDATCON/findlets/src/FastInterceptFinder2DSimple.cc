...
FastInterceptFinder2DSimple::FastInterceptFinder2DSimple() : Super()
{
}

void FastInterceptFinder2DSimple::exposeParameters(ModuleParamList* moduleParamList, const std::string& prefix)
{
...
void FastInterceptFinder2DSimple::initialize()
{
  Super::initialize();
...
void FastInterceptFinder2DSimple::apply(std::vector<HitData>& hits, std::vector<std::vector<HitData*>>& rawTrackCandidates)
{
...
void FastInterceptFinder2DSimple::fastInterceptFinder2d(const std::vector<HitData*>& hits, uint xmin, uint xmax, uint ymin,
...
void FastInterceptFinder2DSimple::FindHoughSpaceCluster()
{
  m_clusterCount = 1;
...
void FastInterceptFinder2DSimple::DepthFirstSearch(uint lastIndexX, uint lastIndexY)
{
