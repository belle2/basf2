...
void MultiHoughSpaceFastInterceptFinder::apply(std::vector<HitData>& hits, std::vector<std::vector<HitData*>>& rawTrackCandidates)
{
...
void MultiHoughSpaceFastInterceptFinder::fastInterceptFinder2d(const std::vector<HitData*>& hits, uint xmin, uint xmax, uint ymin,
...
void MultiHoughSpaceFastInterceptFinder::gnuplotoutput(const std::vector<HitData*>& hits)
{
