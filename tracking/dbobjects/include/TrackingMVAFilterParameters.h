...
namespace Belle2 {
  ...
  class TrackingMVAFilterParameters : public TObject {
  public:
    /** Default constructor */
    TrackingMVAFilterParameters() : m_cutValue(-1.), m_weightFileIdentifier("") {}
  ...
  private:
    ...
    ClassDef(TrackingMVAFilterParameters, 1);  /**< ClassDef, necessary for ROOT */
  };
}