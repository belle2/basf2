...
#pragma link C++ class Belle2::BaseTrackingMVAFilterParameters+; // checksum=0x1a3b9ae4, version=1
#pragma link C++ class Belle2::TrackQualityEstimatorPayload+; // checksum=0x396d44c4, version=1
