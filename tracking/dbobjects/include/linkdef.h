...
#pragma link C++ class Belle2::DAFParameters+; // checksum=0xd293f774, version=1
#pragma link C++ class Belle2::DAFConfiguration+; // checksum=0x711507a9, version=1
...
#pragma link C++ class Belle2::VXDQualityEstimatorParameters+; // checksum=0xf261303d, version=1
