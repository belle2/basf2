...
/// Copy the parameters
void FullGridDriftLengthTrackTimeExtractor::exposeParameters(ModuleParamList* moduleParamList, const std::string& prefix)
{
...
void FullGridDriftLengthTrackTimeExtractor::apply(std::vector<RecoTrack*>& recoTracks)
{
