...
if args.ExperimentType not in [1, 2]:
    import sys
    print("Parameter experiment-type must be either 1 (Run 1, early phase 3) "
...
if (args.ExperimentType == 1):
    # the experiment number for Run 1 (early phase3) MC has to be 1003, otherwise the wrong payloads for this faze are loaded
