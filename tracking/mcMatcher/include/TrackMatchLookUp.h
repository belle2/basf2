...
namespace Belle2 {
  ...
  public:
    /// Container struct to encapsulate the matching categories of the Monte Carlo tracks.
    struct MCToPR {
    public:
    ...
    /// Container struct to encapsulate the matching categories of the pattern recognition tracks.
    struct PRToMC {
    public:
  ...
  private:
    ...
    MCToPR::MatchInfo extractMCToPRMatchInfo(const RecoTrack* prTrackCand, const float& efficiency);
    ...
    PRToMC::MatchInfo extractPRToMCMatchInfo(const RecoTrack& prTrackCand, const RecoTrack* mcTrackCand,
                                             const float& purity);
  ...
  public:
    ...
    const RecoTrack* getMatchedMCTrackCand(const RecoTrack& prTrackCand);
    ...
    const RecoTrack* getMatchedPRTrackCand(const RecoTrack& mcTrackCand);
  ...
  public:
     ...
     */
    float getMatchedPurity(const RecoTrack& trackCand);
     ...
     *  If no exact match is assoziated with the track return NAN.
     */
    float getMatchedEfficiency(const RecoTrack& trackCand);

    /// Gets the matching category of Monte Carlo track. Is one of PRToMC::MATCHED, MERGED, MISSING, INVALID.
    MCToPR::MatchInfo getMCToPRMatchInfo(const RecoTrack& mcTrackCand)
    {
      float efficiency = NAN;
      const RecoTrack* prTrackCand = getRelatedPRTrackCand(mcTrackCand, efficiency);
  ...
  public:
    ...
    bool isMatchedPRTrackCand(const RecoTrack& prTrackCand)
    ...
    bool isClonePRTrackCand(const RecoTrack& prTrackCand)
    ...
    bool isBackgroundPRTrackCand(const RecoTrack& prTrackCand)
    ...
    bool isGhostPRTrackCand(const RecoTrack& prTrackCand)
  ...
  public:
    ...
    PRToMC::MatchInfo getPRToMCMatchInfo(const RecoTrack& prTrackCand)
    {
      float purity = NAN;
      const RecoTrack* mcTrackCand = getRelatedMCTrackCand(prTrackCand, purity);
    ...
    bool isMatchedMCTrackCand(const RecoTrack& mcTrackCand)
    ...
    bool isMergedMCTrackCand(const RecoTrack& mcTrackCand)
    ...
    bool isMissingMCTrackCand(const RecoTrack& mcTrackCand)
  ...
  public:
    ...
    const RecoTrack* getRelatedPRTrackCand(const RecoTrack& mcTrackCand);
  ...
  public:
     ...
     */
    float getRelatedPurity(const RecoTrack& prTrackCand);
  ...
  public:
    ...
    const RecoTrack* getRelatedMCTrackCand(const RecoTrack& prTrackCand, float& purity);
    ...
    const RecoTrack* getRelatedPRTrackCand(const RecoTrack& mcTrackCand, float& efficiency);
