...
#ifndef SVDHoughClusterCand_H
#define SVDHoughClusterCand_H
 ...
 */
class SVDHoughClusterCand {
public:
  /** Constructor for hough candidates */
  SVDHoughClusterCand(unsigned int _size = 0, TVector2 _center = TVector2(0.0, 0.0), TVector2 _pitch = TVector2(0.0,
