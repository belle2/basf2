...
filename = '/home/belle2/fdattola/DESY_start/OverlapAlignStudies/simulatedCR/MC_test_1/MC_CR_100k_NoBfield_NoParam.root'
...
for j in range(1, 7):
    ...
    if j == 1:
        ...
        for i in range(1, 3):
            ...
            l_Lyr1[i - 1].SaveAs('MC_test_1/c_Layer:Sensor_' + str(j) + str(i) + '.root')
            l_Fit_Lyr1[i - 1].SaveAs('MC_test_1/c_Fit_Layer:Sensor_' + str(j) + str(i) + '.root')
    ...
    if j == 2:
        ...
        for i in range(1, 3):
            ...
            l_Lyr2[i - 1].SaveAs('MC_test_1/c_Layer:Sensor_' + str(j) + str(i) + '.root')
            l_Fit_Lyr2[i - 1].SaveAs('MC_test_1/c_Fit_Layer:Sensor_' + str(j) + str(i) + '.root')
    ...
    if j == 3:
        ...
        for i in range(1, 3):
            ...
            l_Lyr3[i - 1].SaveAs('MC_test_1/c_Layer:Sensor_' + str(j) + str(i) + '.root')
            l_Fit_Lyr3[i - 1].SaveAs('MC_test_1/c_Fit_Layer:Sensor_' + str(j) + str(i) + '.root')
    ...
    if j == 4:
        ...
        for i in range(1, 4):
            ...
            l_Lyr4[i - 1].SaveAs('MC_test_1/c_Layer:Sensor_' + str(j) + str(i) + '.root')
            l_Fit_Lyr4[i - 1].SaveAs('MC_test_1/c_Fit_Layer:Sensor_' + str(j) + str(i) + '.root')
    ...
    if j == 5:
        ...
        for i in range(1, 5):
            ...
            l_Lyr5[i - 1].SaveAs('MC_test_1/c_Layer:Sensor_' + str(j) + str(i) + '.root')
            l_Fit_Lyr5[i - 1].SaveAs('MC_test_1/c_Fit_Layer:Sensor_' + str(j) + str(i) + '.root')
    ...
    if j == 6:
        ...
        for i in range(1, 6):
            ...
            l_Lyr6[i - 1].SaveAs('MC_test_1/c_Layer:Sensor_' + str(j) + str(i) + '.root')
            l_Fit_Lyr6[i - 1].SaveAs('MC_test_1/c_Fit_Layer:Sensor_' + str(j) + str(i) + '.root')
