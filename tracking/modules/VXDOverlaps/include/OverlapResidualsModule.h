...
namespace Belle2 {
  ...
  private:
    ...
    std::vector<float> svdStripCharge_U_int,     /**< U internal charge of the strips of the cluster*/
        svdStrip6Samples_U_int,   /**< U internal 6 samples of the strips of the cluster. For the nth strip of a given cluster the samples are the 6 elements of indices 6*n to (6*n)+5 */
        ...
        svdStrip6Samples_U_ext,   /**<U external 6 samples of the strips of the cluster. For the nth strip of a given cluster the samples are the 6 elements of indices 6*n to (6*n)+5 */
    ...
    std::vector<float> svdStripCharge_V_int,     /**< V internal charge of the strips of the cluster*/
        svdStrip6Samples_V_int,   /**< V internal 6 samples of the strips of the cluster. For the nth strip of a given cluster the samples are the 6 elements of indices 6*n to (6*n)+5 */
        ...
        svdStrip6Samples_V_ext,   /**< V external 6 samples of the strips of the cluster. For the nth strip of a given cluster the samples are the 6 elements of indices 6*n to (6*n)+5 */
