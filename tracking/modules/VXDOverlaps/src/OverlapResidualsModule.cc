...
void OverlapResidualsModule::defineHisto()
{
  ...
  if (m_ExpertLevel) {
    ...
    t_SVD_U->Branch("int", &intBranch_SVD_U,
                    "deltaRes/F:svdRes/F:svdClPos/F:svdClPosErr/F:svdClPhi/F:svdClZ/F:svdStripPosition:svdTrkPos/F:svdTrkPosErr/F:svdTrkQoP/F:svdTrkPrime/F:svdLayer/i:svdLadder/i:svdSize/i");
    t_SVD_U->Branch("ext", &extBranch_SVD_U,
                    "deltaRes/F:svdRes/F:svdClPos/F:svdClPosErr/F:svdClPhi/F:svdClZ/F:svdStripPosition:svdTrkPos/F:svdTrkPosErr/F:svdTrkQoP/F:svdTrkPrime/F:svdLayer/i:svdLadder/i:svdSize/i");
    ...
    // t_SVD_U->Branch("intStripPosition", &intStripPosition_SVD_U, "intStripPosition/F");
    ...
    // t_SVD_U->Branch("extStripPosition", &extStripPosition_SVD_U, "extStripPosition/F");
    ...
    t_SVD_V->Branch("int", &intBranch_SVD_V,
                    "deltaRes/F:svdRes/F:svdClPos/F:svdClPosErr/F:svdClPhi/F:svdClZ/F:svdStripPosition:svdTrkPos/F:svdTrkPosErr/F:svdTrkQoP/F:svdTrkPrime/F:svdLayer/i:svdLadder/i:svdSize/i");
    t_SVD_V->Branch("ext", &extBranch_SVD_V,
                    "deltaRes/F:svdRes/F:svdClPos/F:svdClPosErr/F:svdClPhi/F:svdClZ/F:svdStripPosition:svdTrkPos/F:svdTrkPosErr/F:svdTrkQoP/F:svdTrkPrime/F:svdLayer/i:svdLadder/i:svdSize/i");
    ...
    // t_SVD_V->Branch("intStripPosition", &intStripPosition_SVD_V, "intStripPosition/F");
    ...
    // t_SVD_V->Branch("extStripPosition", &extStripPosition_SVD_V, "extStripPosition/F");
      ...
      for (unsigned int l = i + 1; l < svdClusters.size(); l++) {
        ...
        if (svd_Layer_1 == svd_Layer_2 && ((svd_Ladder_2 - svd_Ladder_1) == 1.0 || (svd_Ladder_2 - svd_Ladder_1) == -6.0
          ...
          if (svd_1->isUCluster() == true && svd_2->isUCluster() == true) {
            ...
            if (m_ExpertLevel) {
              intBranch_SVD_U.deltaRes = over_U_SVD;
              intBranch_SVD_U.svdRes = res_U_1;
              intBranch_SVD_U.svdClPos = svd_1->getPosition();
              intBranch_SVD_U.svdClPosErr = svd_1->getPositionSigma();
              if (isMC && trueHit_1.size() > 0)
                intBranch_SVD_U.svdTruePos = trueHit_1[0]->getU();
              else
                intBranch_SVD_U.svdTruePos = -99;
              intBranch_SVD_U.svdClPhi = svdPhi_1;
              intBranch_SVD_U.svdClZ = svdZ_1;
              intBranch_SVD_U.svdStripPosition = {0., 0., 0.};
              intBranch_SVD_U.svdTrkPos = svd_predIntersect_1[3];
              intBranch_SVD_U.svdTrkPosErr = sqrt(covMatrix_1[3][3]);
              intBranch_SVD_U.svdTrkQoP = svd_predIntersect_1[0];
              intBranch_SVD_U.svdTrkPrime = svd_predIntersect_1[1];
              intBranch_SVD_U.svdLayer = svd_Layer_1;
              intBranch_SVD_U.svdLadder = svd_Ladder_1;
              intBranch_SVD_U.svdSensor = svd_Sensor_1;
              intBranch_SVD_U.svdSize = strips_1;
              extBranch_SVD_U.deltaRes = over_U_SVD;
              extBranch_SVD_U.svdRes = res_U_2;
              extBranch_SVD_U.svdClPos = svd_2->getPosition();
              extBranch_SVD_U.svdClPosErr = svd_2->getPositionSigma();
              if (isMC && trueHit_2.size() > 0)
                extBranch_SVD_U.svdTruePos = trueHit_2[0]->getU();
              else
                extBranch_SVD_U.svdTruePos = -99;
              extBranch_SVD_U.svdClPhi = svdPhi_2;
              extBranch_SVD_U.svdClZ = svdZ_2;
              extBranch_SVD_U.svdStripPosition = {0., 0., 0.};
              extBranch_SVD_U.svdTrkPos = svd_predIntersect_2[3];
              extBranch_SVD_U.svdTrkPosErr = sqrt(covMatrix_2[3][3]);
              extBranch_SVD_U.svdTrkQoP = svd_predIntersect_2[0];
              extBranch_SVD_U.svdTrkPrime = svd_predIntersect_2[1];
              extBranch_SVD_U.svdLayer = svd_Layer_2;
              extBranch_SVD_U.svdLadder = svd_Ladder_2;
              extBranch_SVD_U.svdSensor = svd_Sensor_2;
              extBranch_SVD_U.svdSize = strips_2;
              t_SVD_U->Fill();
            }
          ...
          if (svd_1->isUCluster() != true && svd_2->isUCluster() != true) {
            ...
            if (m_ExpertLevel) {
              intBranch_SVD_V.deltaRes = over_V_SVD;
              intBranch_SVD_V.svdRes = res_V_1;
              intBranch_SVD_V.svdClPos = svd_1->getPosition();
              intBranch_SVD_V.svdClPosErr = svd_1->getPositionSigma();
              if (isMC && trueHit_1.size() > 0)
                intBranch_SVD_V.svdTruePos = trueHit_1[0]->getV();
              else
                intBranch_SVD_V.svdTruePos = -99;
              intBranch_SVD_V.svdClPhi = svdPhi_1;
              intBranch_SVD_V.svdClZ = svdZ_1;
              intBranch_SVD_V.svdStripPosition = {0., 0., 0.};
              intBranch_SVD_V.svdTrkPos = svd_predIntersect_1[3];
              intBranch_SVD_V.svdTrkPosErr = sqrt(covMatrix_1[3][3]);
              intBranch_SVD_V.svdTrkQoP = svd_predIntersect_1[0];
              intBranch_SVD_V.svdTrkPrime = svd_predIntersect_1[1];
              intBranch_SVD_V.svdLayer = svd_Layer_1;
              intBranch_SVD_V.svdLadder = svd_Ladder_1;
              intBranch_SVD_V.svdSensor = svd_Sensor_1;
              intBranch_SVD_V.svdSize = strips_1;
              extBranch_SVD_V.deltaRes = over_V_SVD;
              extBranch_SVD_V.svdRes = res_V_2;
              extBranch_SVD_V.svdClPos = svd_2->getPosition();
              extBranch_SVD_V.svdClPosErr = svd_2->getPositionSigma();
              if (isMC && trueHit_2.size() > 0)
                extBranch_SVD_V.svdTruePos = trueHit_2[0]->getV();
              else
                extBranch_SVD_V.svdTruePos = -99;
              extBranch_SVD_V.svdClPhi = svdPhi_2;
              extBranch_SVD_V.svdClZ = svdZ_2;
              extBranch_SVD_V.svdStripPosition = {0., 0., 0.};
              extBranch_SVD_V.svdTrkPos = svd_predIntersect_2[3];
              extBranch_SVD_V.svdTrkPosErr = sqrt(covMatrix_2[3][3]);
              extBranch_SVD_V.svdTrkQoP = svd_predIntersect_2[0];
              extBranch_SVD_V.svdTrkPrime = svd_predIntersect_2[1];
              extBranch_SVD_V.svdLayer = svd_Layer_2;
              extBranch_SVD_V.svdLadder = svd_Ladder_2;
              extBranch_SVD_V.svdSensor = svd_Sensor_2;
              extBranch_SVD_V.svdSize = strips_2;
              t_SVD_V->Fill();
            }
