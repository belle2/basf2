...
/// /// /// /// /// /// /// /// CONSTRUCTOR /// /// /// /// /// /// /// ///
SecMapTrainerBaseModule::SecMapTrainerBaseModule() : Module()
{
  InitializeVariables();
...
void SecMapTrainerBaseModule::initialize()
{
  if (int(m_PARAMsetOrigin.size()) != 3) {
    B2WARNING("SecMapTrainerBaseModule::initialize: origin is set wrong, please set only 3 values (x,y,z). Rejecting user defined value and reset to (0,0,0)!")
  ...
  if (m_PARAMminTrackletLength < 2) {
    B2ERROR("SecMapTrainerBaseModule::initialize: minTrackletLength is set to " << m_PARAMminTrackletLength <<
  ...
  if (int(m_PARAMacceptedRegionForSensors.size()) != 2) {
    B2ERROR("SecMapTrainerBaseModule::initialize: acceptedRegionForSensor-parameter has got " << m_PARAMacceptedRegionForSensors.size()
  ...
  if (m_PARAMtestBeam < 0 or m_PARAMtestBeam > 2) {
    B2ERROR("SecMapTrainerBaseModule::initialize: testbeam-parameter set to " << m_PARAMtestBeam <<
