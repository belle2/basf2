...
namespace Belle2 {
  /** The TFRedesignModule is a low momentum Si-only trackfinder.
   *
   ...
   */
  class TFRedesignModule : public Module {
  ...
  public:
    ...
    /** used by TFRedesignModule::greedy, recursive function which takes tc with highest QI and kills all its rivals. After that, TC gets removed and process is repeated with shrinking list of TCs until no TCs alive has got rivals alive */
...
//                                                       TVector3 sensorSize,
    ...
    /// TFRedesignModule::SectorNameAndPointerPair searchSector4Hit(VxdID aVxdID, FIXME alternative version needed?
