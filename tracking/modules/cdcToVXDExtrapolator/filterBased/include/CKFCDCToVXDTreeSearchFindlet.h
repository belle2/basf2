...
namespace Belle2 {
  ...
  private:
    TrackFindingCDC::SortedVectorRange<const SpacePoint*> getMatchingHits(Super::StateIterator currentState) final {
      ...
      if (currentNumber == CKFCDCToVXDStateObject::N or currentState->isOnOverlapLayer())
      {
        ...
        if (not lastAddedSpacePoint)
        {
          ...
          return TrackFindingCDC::SortedVectorRange<const SpacePoint*>();
        }
        ...
        return TrackFindingCDC::SortedVectorRange<const SpacePoint*>(first, last);
      }
    ...
    void initializeEventCache(std::vector<RecoTrack*>& seedsVector,
      ...
      m_cachedHitMap.emplace(2, TrackFindingCDC::SortedVectorRange<const SpacePoint*>());
      m_cachedHitMap.emplace(1, TrackFindingCDC::SortedVectorRange<const SpacePoint*>());
    }
