...
namespace Belle2 {
  /*!
   *  This module compares tracks generated by some pattern recognition algorithm for PXD, SVD, VTX and CDC to ideal Monte Carlo tracks
   ...
   *  to specific subdetectors by switching of the appropriate usePXDHits, useSVDHits, useVTXHits or useCDCHits parameters.
   *
  ...
  private: //Parameters
    ...
    //! Parameter : Switch whether VTXHits should be used in the matching
    bool m_param_useVTXHits;
