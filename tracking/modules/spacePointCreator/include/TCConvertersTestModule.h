...
namespace Belle2 {
  ...
  protected:
    ...
    int m_failedHitLevel; /**< Counter for failed conversions, on the TrackCandHit level. A more detailed analysis why it failed is stored in the following ints */
