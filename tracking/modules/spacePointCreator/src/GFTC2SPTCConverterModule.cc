...
GFTC2SPTCConverterModule::createSpacePointTC(const genfit::TrackCand* genfitTC)
{
...
GFTC2SPTCConverterModule::processTrackCandHit(genfit::TrackCandHit* hit, std::vector<flaggedPair<int> >& flaggedHitIDs, int iHit)
{
