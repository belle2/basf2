...
namespace Belle2 {
  ...
  protected:
    ...
    /// Parameter: String that states the desired segment orientation. Valid orientations are "none" (as generated), "symmetric", "outwards", "downwards".
    ...
    /// Encoded desired segment orientation. Valid orientations are "c_None" (as generated), "c_Symmetric", "c_Outwards", "c_downwards.
