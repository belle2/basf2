...
namespace Belle2 {
  ...
  public:
    ...
    virtual void generate(std::vector<Belle2::TrackFindingCDC::CDCTrack>& tracks) override final;
  ...
  private:
    ...
    /// Parameter: Map of super layer ids to minimum hit number for which left over segments shall be forwarded as tracks if the exceed the minimal hit requirement. Default empty.
    std::map<TrackFindingCDC::ISuperLayerType, size_t> m_minimalHitsForSingleSegmentTrackBySuperLayerId;

  }; // end class TrackFinderCDCFromSegmentsModule
