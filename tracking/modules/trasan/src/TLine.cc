//-----------------------------------------------------------------------------
// $Id: TLine.cc 10305 2007-12-05 05:19:24Z yiwasaki $
//-----------------------------------------------------------------------------
// Filename : TLine.cc
// Section  : Tracking
...
//-----------------------------------------------------------------------------
// $Log$
// Revision 1.26  2003/12/25 12:03:33  yiwasaki
...
//
// Revision 1.25  2001/12/23 09:58:47  katayama
// removed Strings.h
//
// Revision 1.24  2001/12/19 02:59:46  katayama
// Uss find,istring
//
// Revision 1.23  2001/04/11 01:09:10  yiwasaki
// Trasan 3.00 RC2.1 : bugs in RC2 fixed
//
// Revision 1.22  2000/10/05 23:54:23  yiwasaki
// Trasan 2.09 : TLink has drift time info.
//
// Revision 1.21  2000/04/11 13:05:44  katayama
// Added std:: to cout, cerr, endl etc.
//
// Revision 1.20  2000/01/28 06:30:23  yiwasaki
// Trasan 1.67h : new conf modified
//
// Revision 1.19  2000/01/08 09:44:37  yiwasaki
...
// std::cout << "    TLine::fit ... det=" << _det << std::endl;
//  #endif
//      if(_det == 0. && n != 2){
//    return -1;
//      }else if(_det == 0. && n == 2){
