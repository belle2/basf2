...
namespace Belle2 {
  ...
  protected:
    ...
    std::string m_param_vtxHitsStoreArrayName; /**< StoreArray name of VTXhits. Related to RecoTracks. */
    ...
    std::string m_param_vtxClustersName; /**< StoreArray name of VTXClusters. Related to SpacePoints. */
