...
def add_vxd_standalone_cosmics_finder(path, reco_tracks="RecoTracks", quality_cut=0.0001, min_sps=3, max_rejected_sps=5):
    """
    ...
    track_finder.param('SpacePoints', ['PXDSpacePoints', 'SVDSpacePoints'])
