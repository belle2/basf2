...
class EventInfoHarvester(harvesting.HarvestingModule):
    ...
    def __init__(self,
                 ...
                 vtx_reco_tracks_name="VTXRecoTracks",
        ...
        #: cached value of the VTXClusters StoreArray
        self.vtx_clusters_name = vtx_clusters_name
        #: cached value of the VTXSpacePoints StoreArray
        self.vtx_spacepoints_name = vtx_spacepoints_name
        ...
        #: cached value of the VTXRecoTracks StoreArray
        self.vtx_reco_tracks_name = vtx_reco_tracks_name
        #: cached value of the SVDCDCRecoTracks StoreArray
        self.vtx_cdc_reco_tracks_name = vtx_cdc_reco_tracks_name
    ...
    def peel(self, event_meta_data):
        ...
        number_of_hits = dict(
            ...
            **peelers.peel_store_array_size(self.vtx_clusters_name),
            **peelers.peel_store_array_size(self.vtx_spacepoints_name),
        ...
        number_of_tracks = dict(
            ...
            **peelers.peel_store_array_size(self.vtx_reco_tracks_name),
            **peelers.peel_store_array_size(self.vtx_cdc_reco_tracks_name),
        )
...
class TrackInfoHarvester(harvesting.HarvestingModule):
    ...
    def __init__(self, output_file_name,
                 ...
                 vtx_cdc_reco_tracks_name="VTXCDCRecoTracks",
                 vtx_reco_tracks_name="VTXRecoTracks",
                 vtx_sp_track_cands_name="VTXSPTrackCands"
                 ):
        ...
        #: cached value of the SVDRecoTracks StoreArray
        self.vtx_reco_tracks_name = vtx_reco_tracks_name
        #: cached value of the VTX SPTrackCands StoreArray
        self.vtx_sp_track_cands_name = vtx_sp_track_cands_name
    ...
    def peel(self, reco_track):
        ...
        vtx_vxdtf2_was_involved = False
        vtx_cdc_reco_track = reco_track.getRelated(self.vtx_cdc_reco_tracks_name)
        if vtx_cdc_reco_track:
            vtx_reco_track = vtx_cdc_reco_track.getRelated(self.vtx_reco_tracks_name)
            if vtx_reco_track:
                vtx_sptcs = vtx_reco_track.getRelated(self.vtx_sp_track_cands_name)
                if vtx_sptcs:
                    vtx_vxdtf2_was_involved = True
        ...
        return dict(**reco_track_hit_content,
                    ...
                    **store_array_info,
                    ...
                    vtx_vxdtf2_was_involved=vtx_vxdtf2_was_involved,
                    **event_crops,
                    )
