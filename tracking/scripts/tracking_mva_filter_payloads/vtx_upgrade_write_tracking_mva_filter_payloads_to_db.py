...
if __name__ == "__main__":
    ...
    for iov in validIoVs:
        ...
        write_tracking_mva_filter_payloads_to_db("ckf_ToVTXStateFilter_1_Parameters",
                                                 iov, "ckf_ToVTXStateFilter_1", 0.1)
        write_tracking_mva_filter_payloads_to_db("ckf_ToVTXStateFilter_2_Parameters",
                                                 iov, "ckf_ToVTXStateFilter_2", 0.1)
        write_tracking_mva_filter_payloads_to_db("ckf_ToVTXStateFilter_3_Parameters",
                                                 iov, "ckf_ToVTXStateFilter_3", 0.1)
        write_tracking_mva_filter_payloads_to_db("ckf_ToVTXResultFilter_Parameters",
                                                 iov, "ckf_ToVTXResultFilter", 0.01)
