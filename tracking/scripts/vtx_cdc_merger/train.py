...
n_train = 1800
n_valid = 200
checkpoint = "/home/benjamin/vxt_cdc_merger_checkpoints"
input_dir = "/home/benjamin/vtx_cdc_merger_data"
...
def main():
    ...
    train_data_loader, valid_data_loader = get_data_loaders(input_dir=input_dir, batch_size=1, n_train=n_train, n_valid=n_valid)
