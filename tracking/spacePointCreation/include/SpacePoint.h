...
namespace Belle2 {
  ...
  public:
    ...
    /** Constructor SpacePoint from one VTX Hit.
     *
     *  @param vtxCluster   Pointer to VTXCluster (typically owned by the DataStore).
     *  @param aSensorInfo  Only for testing purposes.
     */
    explicit SpacePoint(const VTXCluster* vtxCluster,
                        const VXD::SensorInfoBase* aSensorInfo = nullptr);
