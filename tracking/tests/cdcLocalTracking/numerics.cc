...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_isIncreasing)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_getIPeriodFromIHalfPeriod)
{
  Index iHalfPeriod = -1;
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeRootInInterval_simple)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeRootInInterval_const)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeRootInInterval_complex)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeRootLargerThanExtemumInHalfPeriod_simple)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeRootLargerThanExtemumInHalfPeriod)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeSmallestPositiveRoot)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeSmallestPositiveRoot_largeSlope)
{
...
TEST_F(CDCLocalTrackingTest, numerics_SinEqLine_computeRootForLargeSlope)
{
  // Setup a line that is a
  FloatType rootX = 150.0 * Unit::deg;
  Line2D line = Line2D::fromSlopeIntercept(2.0, 1.0 / 2.0);
