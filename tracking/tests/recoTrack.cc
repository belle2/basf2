...
namespace Belle2 {
  ...
  protected:
    ...
    void SetUp() override
    {
      ...
      /// Name of the VTX hits store array.
      m_storeArrayNameOfVTXHits = "VTXisNewBoyInTown";
      ...
      StoreArray<VTXCluster> vtxHits(m_storeArrayNameOfVTXHits);
      vtxHits.registerInDataStore();
      ...
      m_recoTrack = recoTracks.appendNew(position, momentum, charge,
                                         m_storeArrayNameOfPXDHits, m_storeArrayNameOfSVDHits, m_storeArrayNameOfVTXHits, m_storeArrayNameOfCDCHits,
    ...
    std::string m_storeArrayNameOfVTXHits; /**< name of storeArray with VTX hits */
