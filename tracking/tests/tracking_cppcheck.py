...
"""
Perform code quality cppchecks for every commit to the tracking package.
"""
...
if __name__ == "__main__":
    ...
    ignoreme = "^((?!tracking\/).)*$|knownConditionTrueFalse"
    check_error_free("b2code-cppcheck", "cppcheck", "tracking",
