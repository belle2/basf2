...
namespace Belle2 {
  ...
  /** This class extends the capabilities of the GFTrackCandHit to store
   *  how the left right ambiguity of CDC hits should be resolved.
   *
   *  Track finder that can determine this information should use this class
   *  and give it to the GFTrackCand. The information will then be extracted
  ...
  public:
    /** Constructor.
     *
     *  First 4 arguments are identical GFTrackCandHit's constructor.
     *  5th argument tells how to resolve the ambiguity
     */
