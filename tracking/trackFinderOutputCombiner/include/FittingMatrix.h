...
namespace Belle2 {
  ...
  public:
     ...
     */
    void calculateMatrices(const std::vector<TrackFindingCDC::CDCRecoSegment2D>& recoSegments,
    ...
    static SegmentStatus calculateSegmentStatus(const TrackFindingCDC::CDCRecoSegment2D& segment,
