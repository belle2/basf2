...
namespace Belle2 {
  ...
  public:
    /* Enum for the desired output orientation of tracks to be generated.
     *
     * Depending on the finder algorithm tracks can be generated forward or backward to
     * the direction of travel at random. This enum presents the options for
     * some simple heuristics which direction of travel is prefered to be choosen by
