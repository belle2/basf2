...
namespace Belle2 {
  ...
  namespace TrackFindingCDC {
    ...
    using SegmentColorMapping = Mapping<const TrackingUtilities::CDCSegment2D>;

    /// Color mapping using the default color cycle list
    using SegmentListColorsColorMap = DefaultColorCycleMapping<const TrackingUtilities::CDCSegment2D>;
