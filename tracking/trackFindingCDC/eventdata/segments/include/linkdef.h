...
#pragma link C++ class Belle2::TrackingUtilities::Relation<const Belle2::TrackFindingCDC::CDCSegment2D>+; // checksum=0x8c4555e2, implicit, version=-1
#pragma link C++ class std::vector<Belle2::TrackingUtilities::Relation<const Belle2::TrackFindingCDC::CDCSegment2D> >+; // checksum=0xe5c13901, implicit, version=6

#pragma link C++ class Belle2::TrackingUtilities::WeightedRelation<const Belle2::TrackFindingCDC::CDCSegment2D>+; // checksum=0x88751cac, implicit, version=-1
#pragma link C++ class std::vector<Belle2::TrackingUtilities::WeightedRelation<const Belle2::TrackFindingCDC::CDCSegment2D> >+; // checksum=0xe50b62da, implicit, version=6
...
#pragma link C++ class Belle2::TrackingUtilities::StoreWrapper<std::vector<Belle2::TrackFindingCDC::CDCWireHitCluster> >+; // checksum=0x2382cd6d, implicit, version=1

#pragma link C++ class Belle2::TrackingUtilities::StoreWrapper<std::vector<Belle2::TrackFindingCDC::CDCSegment2D> >+; // checksum=0x98bfbfd1, implicit, version=1
#pragma link C++ class Belle2::TrackingUtilities::StoreWrapper<std::vector<Belle2::TrackingUtilities::WeightedRelation<const Belle2::TrackFindingCDC::CDCSegment2D> > >+; // checksum=0x8909f6f1, implicit, version=1
