...
namespace Belle2 {
  ...
  namespace TrackFindingCDC {
    ...
    struct FitlessAxialSegmentPairVarNames : public TrackingUtilities::VarNames<TrackingUtilities::CDCAxialSegmentPair> {

      /// Number of variables to be generated
      // we shouldn't use public member variables but we do want to rewrite all related code using setters/getters
      // at least tell cppcheck that everything is fine
      // cppcheck-suppress duplInheritedMember
      static const size_t nVars = TrackingUtilities::size(fitlessAxialSegmentPairVarNames);
     ...
     */
    class FitlessAxialSegmentPairVarSet : public TrackingUtilities::VarSet<FitlessAxialSegmentPairVarNames> {
