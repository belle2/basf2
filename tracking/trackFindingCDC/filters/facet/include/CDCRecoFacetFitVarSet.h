...
#include "CDCRecoFacetFitlessVarSet.h"
...
namespace Belle2 {
  namespace TrackFindingCDC {
     ...
     */
    class CDCRecoFacetFitVarNames : public VarNames<CDCRecoFacet> {
    ...
    public:
      ...
      typedef CDCRecoFacetFitlessVarSet NestedVarSet;
    };

    /** Class that computes floating point variables from a facet.
     *  that can be forwarded to a flat TNtuple or a TMVA method
     */
    class CDCRecoFacetFitVarSet : public VarSet<CDCRecoFacetFitVarNames> {

    public:
      /// Construct the varset and take an optional prefix to be prepended to all variable names.
      CDCRecoFacetFitVarSet(const std::string& prefix = "");
