...
namespace Belle2 {
  namespace TrackFindingCDC {
     ...
     */
    class CDCRecoFacetFitlessVarNames : public VarNames<CDCRecoFacet> {
     ...
     */
    class CDCRecoFacetFitlessVarSet : public VarSet<CDCRecoFacetFitlessVarNames> {

    public:
      /// Construct the varset and take an optional prefix to be prepended to all variable names.
      CDCRecoFacetFitlessVarSet(const std::string& prefix = "");
