...
template class TrackingUtilities::FilterFactory<BaseFacetFilter>;
...
std::map<std::string, std::string> FacetFilterFactory::getValidFilterNamesAndDescriptions() const
{
  return {
    ...
    {"feasible", "only checking the feasibility of right left passage information"},
    {"simple", "mc free with simple criteria"},
    {"realistic", "mc free with realistic criteria"},
    {"realistic_loss", "mc with realistic criteria but looser cut"},
