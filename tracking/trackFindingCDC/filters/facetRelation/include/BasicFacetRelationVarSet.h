...
namespace Belle2 {
  namespace TrackFindingCDC {
    ...
    struct BasicFacetRelationVarNames : public TrackingUtilities::VarNames<TrackingUtilities::Relation<const CDCFacet>> {

      /// Number of variables to be generated
      // we shouldn't use public member variables but we do want to rewrite all related code using setters/getters
      // at least tell cppcheck that everything is fine
      // cppcheck-suppress duplInheritedMember
      static const size_t nVars = TrackingUtilities::size(basicFacetRelationVarNames);
     ...
     */
    class BasicFacetRelationVarSet : public TrackingUtilities::VarSet<BasicFacetRelationVarNames> {
