...
namespace Belle2 {
  namespace TrackFindingCDC {
    ...
    struct AdvancedSegmentVarNames : public TrackingUtilities::VarNames<CDCSegment2D> {
     ...
     */
    class AdvancedSegmentVarSet : public TrackingUtilities::VarSet<AdvancedSegmentVarNames> {
