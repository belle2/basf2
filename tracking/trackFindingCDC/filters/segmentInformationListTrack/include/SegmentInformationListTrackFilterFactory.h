...
namespace Belle2 {
  ...
  namespace TrackFindingCDC {
    ...
    private:
      ...
      typedef FilterFactory<BaseSegmentInformationListTrackFilter> Super;
    ...
    public:
      ...
      virtual std::unique_ptr<BaseSegmentInformationListTrackFilter> create(const std::string& name) const override;
