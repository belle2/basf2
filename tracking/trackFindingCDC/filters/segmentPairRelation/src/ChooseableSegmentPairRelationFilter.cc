...
template class TrackingUtilities::Chooseable<BaseSegmentPairRelationFilter>;
template class TrackingUtilities::ChooseableFilter<SegmentPairRelationFilterFactory>;
