...
namespace Belle2 {
  namespace TrackFindingCDC {
    ...
    struct FitlessSegmentRelationVarNames : public TrackingUtilities::VarNames<TrackingUtilities::Relation<const CDCSegment2D> > {

      /// Number of variables to be generated
      // we shouldn't use public member variables but we do want to rewrite all related code using setters/getters
      // at least tell cppcheck that everything is fine
      // cppcheck-suppress duplInheritedMember
      static const size_t nVars = TrackingUtilities::size(fitlessSegmentRelationVarNames);
     ...
     */
    class FitlessSegmentRelationVarSet : public TrackingUtilities::VarSet<FitlessSegmentRelationVarNames> {

    public:
      /// Generate and assign the contained variables
      bool extract(const TrackingUtilities::Relation<const CDCSegment2D>* ptrSegmentRelation) override;
    };
  }
}
