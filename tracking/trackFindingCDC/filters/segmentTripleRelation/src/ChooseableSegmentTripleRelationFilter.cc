...
template class TrackingUtilities::Chooseable<BaseSegmentTripleRelationFilter>;
template class TrackingUtilities::ChooseableFilter<SegmentTripleRelationFilterFactory>;
