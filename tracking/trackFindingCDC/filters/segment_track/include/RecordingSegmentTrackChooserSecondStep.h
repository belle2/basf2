...
namespace Belle2 {
  namespace TrackFindingCDC {
    ...
    class RecordingSegmentTrackChooserSecondStep: public RecordingFilter<SegmentTrackTruthVarSet> {

    public:
      /// Constructor initialising the RecordingFilter with standard root file name for this filter.
      RecordingSegmentTrackChooserSecondStep() :
        RecordingFilter<SegmentTrackTruthVarSet>("SegmentTrackChooserSecondStep.root")
      {;}
