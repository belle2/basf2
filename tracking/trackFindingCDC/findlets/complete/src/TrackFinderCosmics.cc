...
{
  return "Performs pattern recognition in the CDC based on local hit following and application of a cellular automaton in two stages - version suitable for cosmics.";
}
