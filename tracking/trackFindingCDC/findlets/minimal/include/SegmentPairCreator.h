...
namespace Belle2 {
  namespace TrackFindingCDC {
    ...
    class SegmentPairCreator : public Findlet<const CDCRecoSegment2D, CDCSegmentPair> {
    ...
    private:
      /// Creates segment pairs from a combination of start segment, middle segments and end segments.
