...
namespace Belle2 {
  ...
  namespace TrackFindingCDC {
    ...
    private:
      ...
      /// Parameter: Switch to append exported RecoTracks to an existing Store Array instead of creating a new one.
      bool m_param_exportIntoExistingStoreArray = false;
