...
namespace Belle2 {
  namespace TrackFindingCDC {
    ...
    template <class AFitMethod>
    TrackingUtilities::CDCTrajectory2D CDCFitter2D<AFitMethod>::fit(const CDCObservations2D& observations2D) const
    {
      return fit(CDCObservations2D(observations2D));
    }

    template <class AFitMethod>
    TrackingUtilities::CDCTrajectory2D CDCFitter2D<AFitMethod>::fit(CDCObservations2D&& observations2D) const
    {
    ...
    template <class AFitMethod>
    void CDCFitter2D<AFitMethod>::update(TrackingUtilities::CDCTrajectory2D& trajectory2D, CDCObservations2D&& observations2D) const
    {
      AFitMethod::update(trajectory2D, observations2D);
    }

    template <class AFitMethod>
    TrackingUtilities::CDCTrajectory2D CDCFitter2D<AFitMethod>::fit(const TrackingUtilities::CDCTrack& track) const
    {
    ...
    template <class AFitMethod>
    TrackingUtilities::CDCTrajectory2D CDCFitter2D<AFitMethod>::fit(const std::vector<const TrackingUtilities::CDCWireHit*>& wireHits)
    const
    {
    ...
    TrackingUtilities::CDCTrajectory2D CDCFitter2D<AFitMethod>::fitGeneric(const AHits& hits) const
    {
      TrackingUtilities::CDCTrajectory2D result;
    ...
    TrackingUtilities::CDCTrajectory2D
    ...
    template <class AFitMethod>
    template <class AStartHits, class AEndHits>
    void CDCFitter2D<AFitMethod>::updateGeneric(TrackingUtilities::CDCTrajectory2D& trajectory2D,
    ...
    template <class AHits>
    void
    CDCFitter2D<AFitMethod>::updateGeneric(TrackingUtilities::CDCTrajectory2D& trajectory2D, const AHits& hits) const
    {
      CDCObservations2D observations2D;
      observations2D.setFitVariance(m_fitVariance);
