...
{
  {
    ...
    Vector2D upper = Vector2D::Phi(PI);

    Vector2D test = Vector2D::Phi(PI / 2);
    Vector2D test2 = Vector2D::Phi(3 * PI / 2);
  ...
  {
    Vector2D lower = Vector2D::Phi(-PI / 4);
    Vector2D upper = Vector2D::Phi(PI);

    Vector2D test = Vector2D::Phi(0);
    Vector2D test2 = Vector2D::Phi(PI / 2);
