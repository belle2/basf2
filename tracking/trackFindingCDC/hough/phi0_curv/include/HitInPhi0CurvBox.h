...
namespace Belle2 {
  namespace TrackFindingCDC {
     ...
     */
    class HitInPhi0CurvBox : public StereoHitContained< OffOrigin<Phi0Sweeped<CurvSweepedXLine > > > {
    ...
    public:
      ...
      explicit HitInPhi0CurvBox(float curlCurv = NAN, float rlWeightGain = 0) :
        StereoHitContained< OffOrigin<Phi0Sweeped<CurvSweepedXLine > > >(fabs(curlCurv))
