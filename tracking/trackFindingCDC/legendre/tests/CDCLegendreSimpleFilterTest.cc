...
TrackCandidate* createTestTrackCandidate()
{
...
TrackCandidate* createOtherTestTrackCandidate()
{
  std::vector<TrackHit*> emptyHitList;
  TrackCandidate* resultTrackCandidate = new TrackCandidate(0, 0, 1, emptyHitList);
...
TEST(TrackFindingCDCTest, legendre_SimpleFilterAssignmentProbabilityTest)
{
  TrackCandidate* trackCandidate = createTestTrackCandidate();
  TrackCandidate* otherTrackCandidate = createOtherTestTrackCandidate();
  ...
  deleteTrackCandidate(otherTrackCandidate);
}

TEST(TrackFindingCDCTest, legendre_SimpleFilterAppendUnusedHitsTest)
{
  TrackCandidate* trackCandidate = createTestTrackCandidate();
  TrackCandidate* otherTrackCandidate = createOtherTestTrackCandidate();
...
TEST(TrackFindingCDCTest, legendre_SimpleFilterDeleteAllMarkedHitsTest)
{
  TrackCandidate* trackCandidate = createTestTrackCandidate();
...
TEST(TrackFindingCDCTest, legendre_SimpleFilterDeleteWrongHitsOfTrackTest)
{
  TrackCandidate* trackCandidate = createTestTrackCandidate();
  TrackCandidate* otherTrackCandidate = createOtherTestTrackCandidate();
...
TEST(TrackFindingCDCTest, legendre_SimpleFilterReassignHitsFromOtherTracksTest)
{
  TrackCandidate* trackCandidate = createTestTrackCandidate();
  TrackCandidate* otherTrackCandidate = createOtherTestTrackCandidate();
