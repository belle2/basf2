...
trackfindingcdc_teacher "train_feasible_generic_const_b_10000.root" --truth=truth_positive --identifier FeasibleSegmentPairFilter.weights.xml
mv FeasibleSegmentPairFilter.weights.xml $BELLE2_LOCAL_DIR/tracking/data/FeasibleSegmentPairFilter.weights.xml
