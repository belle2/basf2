...
class CDCSegmentRelationRecordingRun(RecordingRun):
    """Run for recording segment relations encountered at the filter"""
    ...
    def root_output_file_name(self):
        ...
        if self.root_input_file:
            ...
            if file_name:
                ...
                return "CDCSegmentRelationTruthRecords.root"

    recording_filter_parameter_name = "SegmentRelationFilterParameters"
...
def main():
    """Execute the segment relation recording"""
    run = CDCSegmentRelationRecordingRun()
