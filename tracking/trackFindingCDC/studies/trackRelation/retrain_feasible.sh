...
trackfindingcdc_teacher "train_feasible_generic_const_b_10000.root" --truth=truth_positive --identifier FeasibleTrackRelationFilter.weights.xml
mv FeasibleTrackRelationFilter.weights.xml $BELLE2_LOCAL_DIR/tracking/data/FeasibleTrackRelationFilter.weights.xml
