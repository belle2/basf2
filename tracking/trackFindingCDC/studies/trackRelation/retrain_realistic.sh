...
trackfindingcdc_teacher "train_realistic_generic_const_b_10000.root" --truth=truth_positive --identifier RealisticTrackRelationFilter.weights.xml
mv RealisticTrackRelationFilter.weights.xml $BELLE2_LOCAL_DIR/tracking/data/RealisticTrackRelationFilter.weights.xml
