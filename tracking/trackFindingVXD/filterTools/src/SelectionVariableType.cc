...
std::map<Belle2::SelectionVariableType::Type, std::string> Belle2::SelectionVariableType::s_fromTypeToString = {
  ...
  {Belle2::SelectionVariableType::Distance1DZTemplate, std::string("Distance1DZTemplate")},
  ...
  {Belle2::SelectionVariableType::AngleXYSimpleHighOccupancy, std::string("AngleXYSimpleHighOccupancy")},
  ...
  {Belle2::SelectionVariableType::AngleXYSimple, std::string("AngleXYSimple")},
...
std::map<std::string, Belle2::SelectionVariableType::Type> Belle2::SelectionVariableType::s_fromStringToType = {
  ...
  {std::string("Distance1DZTemplate"), Belle2::SelectionVariableType::Distance1DZTemplate},
  ...
  {std::string("AngleXYSimpleHighOccupancy"), Belle2::SelectionVariableType::AngleXYSimpleHighOccupancy},
  ...
  {std::string("AngleXYSimple"), Belle2::SelectionVariableType::AngleXYSimple},
