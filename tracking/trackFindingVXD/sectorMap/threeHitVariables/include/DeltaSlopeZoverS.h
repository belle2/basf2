...
#include <tracking/trackFindingVXD/sectorMap/threeHitVariables/CircleCenterXY.h>
#include <tracking/trackFindingVXD/sectorMap/threeHitVariables/CircleRadius.h>
#include <tracking/trackFindingVXD/sectorMap/twoHitVariables/CosDirectionXY.h>
...
namespace Belle2 {
  ...
  class DELTASLOPEZOVERS_NAME : public SelectionVariable< PointType , double > {
  public:
