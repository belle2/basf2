...
#include <tracking/trackFitting/measurementCreator/factories/VTXMeasurementCreatorFactory.h>
...
namespace Belle2 {
  ...
  private:
    ...
    /// The name of the store array for the VTX hits.
    std::string m_param_storeArrayNameOfVTXHits = "";
    ...
    /// Internal storage of the VTX measurement creators.
    std::vector<std::shared_ptr<VTXBaseMeasurementCreator>> m_vtxMeasurementCreators;
