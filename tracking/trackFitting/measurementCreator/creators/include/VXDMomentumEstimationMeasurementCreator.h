...
namespace Belle2 {
  ...
  /// Momentum measurement creator for the VTX.
  using VTXMomentumMeasurementCreator = VXDMomentumEstimationMeasurementCreator<RecoHitInformation::UsedVTXHit, Const::VTX>;
}
