...
#pragma link C++ class Belle2::TrackingUtilities::CDCRLWireHitPair+; // checksum=0xe3059323, version=-1
#pragma link C++ class Belle2::TrackingUtilities::CDCTangent+; // checksum=0x805ed0cf, version=-1

#pragma link C++ class Belle2::TrackingUtilities::CDCRLWireHitTriple+; // checksum=0xee3a349a, version=-1
#pragma link C++ class Belle2::TrackingUtilities::CDCFacet+; // checksum=0x205d9864, version=-1
...
#pragma link C++ class std::vector<Belle2::TrackingUtilities::CDCTangent>+; // checksum=0x7e849460, version=6
#pragma link C++ class std::vector<Belle2::TrackingUtilities::CDCFacet>+; // checksum=0x2a80738e, version=6
#pragma link C++ class std::pair<const Belle2::TrackingUtilities::CDCFacet*,double>+; // checksum=0x1e93ebd6, version=-1
#pragma link C++ class std::pair<std::pair<const Belle2::TrackingUtilities::CDCFacet*,double>,const Belle2::TrackingUtilities::CDCFacet*>+; // checksum=0xd0b61c8a, version=-1
...
#pragma link C++ class Belle2::TrackingUtilities::WeightedRelation<const Belle2::TrackingUtilities::CDCFacet>+; // checksum=0xf098c6bc, implicit, version=-1
#pragma link C++ class std::vector<Belle2::TrackingUtilities::WeightedRelation<const Belle2::TrackingUtilities::CDCFacet> >+; // checksum=0x6f468866, implicit, version=6
...
#pragma link C++ class Belle2::TrackingUtilities::StoreWrapper<std::vector<Belle2::TrackingUtilities::CDCFacet> >+; // checksum=0xcd93ecd9, implicit, version=1
#pragma link C++ class Belle2::TrackingUtilities::StoreWrapper<std::vector<Belle2::TrackingUtilities::WeightedRelation<const Belle2::TrackingUtilities::CDCFacet> > >+; // checksum=0x51ba98e1, implicit, version=1
