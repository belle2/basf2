...
namespace Belle2 {
  ...
  namespace TrackingUtilities {
    ...
    {
      return getClassMnemomicParameterName(static_cast<T*>(nullptr)) + "Relation";
    }
    ...
    {
      return getClassMnemomicParameterDescription(static_cast<T*>(nullptr)) + " relation";
    }
    ...
    {
      return prefixed(getClassMnemomicParameterName(static_cast<From*>(nullptr)) + "To",
                      getClassMnemomicParameterName(static_cast<To*>(nullptr)) + "Relation");
    }
    ...
    {
      return getClassMnemomicParameterDescription(static_cast<From*>(nullptr)) + " to " +
             getClassMnemomicParameterDescription(static_cast<To*>(nullptr)) + " relation";
    }
