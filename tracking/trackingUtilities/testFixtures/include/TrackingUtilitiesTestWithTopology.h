...
namespace Belle2 {
  namespace TrackingUtilities {
    ...
    /// Equivalent to \sa TrackingUtilitiesTestWithTopology for disabled tests.
    class DISABLED_Long_TrackingUtilitiesTestWithTopology : public TrackingUtilitiesTestWithTopology {};
  }
