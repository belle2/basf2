...
"""
<header>
    <input>VTX_trackingEfficiency_pt_0.05GeV.root,
    VTX_trackingEfficiency_pt_0.10GeV.root,VTX_trackingEfficiency_pt_0.25GeV.root,
    VTX_trackingEfficiency_pt_0.40GeV.root,VTX_trackingEfficiency_pt_0.60GeV.root,
    VTX_trackingEfficiency_pt_1.00GeV.root,VTX_trackingEfficiency_pt_1.50GeV.root,
    VTX_trackingEfficiency_pt_2.00GeV.root,VTX_trackingEfficiency_pt_3.00GeV.root,
    VTX_trackingEfficiency_pt_4.00GeV.root</input>
    <output>VTX_TrackingValidation.root</output>
...
def draw_hit_counts(data_tree, pt_values):
    ...
    for track in data_tree:
        if not track.pValue == -999:
            ...
            hists['VTX'].Fill(track.pt_gen, track.nVTXhits)
