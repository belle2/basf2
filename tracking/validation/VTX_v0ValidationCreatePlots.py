...
<header>
  ...
  <input>VTX_V0ValidationHarvested.root</input>
  <description>This module creates efficiency plots for the V0 validation for Belle II w/ VTX.</description>
</header>
"""
...
class V0ValidationPlots:
    ...
    def __init__(self, input_file='../VTX_V0ValidationHarvested.root', output_file='VTX_V0Validation.root'):
