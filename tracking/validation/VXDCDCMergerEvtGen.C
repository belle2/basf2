...
void VXDCDCMergerEvtGen(){
 ...
 /////////////SCANS//////////////
  ...
  h22->Sumw2();
  TH1F *eff_ptEG = new TH1F("eff_pth","Eff vs Pt EvtGen VXDTF+Trasan",100,0.,3.);
  tree->Draw("TMath::Sqrt((Px*Px+Py*Py))>>eff_pth","TruthTag==1&&GoodTag==1");
  eff_ptEG->SetMaximum(1.1);
  eff_ptEG->Sumw2();
  gPad->RedrawAxis();
  //eff_pth->Divide(h22);
  //eff_pth->GetYaxis()->SetRange(0,2);
  //eff_pth->Draw("E");
