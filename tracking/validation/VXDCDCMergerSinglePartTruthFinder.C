...
void VXDCDCMergerSinglePartTruthFinder(){
  ...
  TH1F *h1 = new TH1F("h1","Merged Tracks",10,0,10);
  ...
  TH1F *h2 = new TH1F("h2","True Matched Tracks",10,0,10);
 ...
 /////////////SCANS//////////////
  ...
  TH1F *h22 = new TH1F("h22","Eff vs Pt",100,0.,5.);
  h22->SetMaximum(1.1);
  ...
  //h23->Draw("E");
  TH1F *eff_pt = new TH1F("eff_pt", "Eff vs Pt",100,0.,5.);
  ...
  TH1F *h24 = new TH1F("h24","Eff vs Theta",50, -1, 1.);
  h24->SetMaximum(1.1);
  tree->Draw("(Pz/(P))>>h24","TruthTag==1");
  h24->Sumw2();
  TH1F *h25 = new TH1F("h25","Eff vs Theta",50, -1, 1.);
  h25->SetMaximum(1.1);
  ...
  //h25->Draw("E");
  TH1F *eff_theta = new TH1F("eff_theta", "Eff vs Theta", 50, -1, 1.);
