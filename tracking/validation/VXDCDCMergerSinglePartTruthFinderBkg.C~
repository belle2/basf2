...
void VXDCDCMergerSinglePartTruthFinder(){
  ...
  TFile* inputFile = TFile::Open("../VXDCDCMergerSinglePartTruthFinder.root");
  TTree* tree = (TTree*) inputFile->Get("Stats");

  // write output file for the validation histograms
  TFile* output = TFile::Open("VXDCDCMergerSinglePartTruthFinderHist.root", "recreate");
 ...
 /////////////SCANS//////////////
  ...
  h22->Sumw2();
  TH1F *eff_ptsptt = new TH1F("eff_ptsptt","Eff vs Pt Truth Track Finder Single Muon",100,0.,5.);
  ...
  //eff_ptsptt->Draw("E");
  TH1F *eff_pt = new TH1F("eff_pt", "Eff vs Pt Truth Track Finder Single Muon",100,0.,5.);
  ...
  h24->Sumw2();
  TH1F *eff_thetasptt = new TH1F("eff_thetasptt","Eff vs Theta Truth Track Finder Single Muon",50, -1, 1.);
