...
# elif process =='BBBAR':
#    N_EVENTS=1000
VALIDATION_OUTPUT_FILE = 'ftv_reco_qi_N' + str(N_EVENTS) + '_' + process + '_novxd_cdcQi' + str(int(cut*100)).zfill(3) + '.root'
...
class Full(TrackingValidationRun):
    ...
    root_input_file = 'generated_mc_N' + str(N_EVENTS) + '_' + process + '_test.root'
