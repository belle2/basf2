...
VALIDATION_OUTPUT_FILE = 'ftv_reco_qi_N1000_' + process + '_novxd_cdcQi' + str(int(cut*100)).zfill(3) + '_extended.root'
...
class Full(TrackingValidationRun):
    ...
    root_input_file = 'generated_mc_N1000_' + process + '_test.root'
