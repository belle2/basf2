...
VALIDATION_OUTPUT_FILE = 'toCDCfromEclCKFTrackingValidation_afterCDC_SVD_expert_nobg.root'
N_EVENTS = 10000
ACTIVE = True
...
class toCDCfromEclCKF(TrackingValidationRun):
    ...
    root_input_file = '/nfs/dust/belle2/user/kurzsimo/evtSamples/BhabhaSim_nobg_03-01-04.root'
