...
param_filterCalcSVDStd = {
    ...
    'rootFileName': [setupFileNamesvdStd, 'UPDATE'],
...
param_filterCalcVXDStd = {
    ...
    'secMapWriteToRoot': 1,
    'secMapWriteToAscii': 0,
    'rootFileName': [setupFileNamevxdStd, 'UPDATE'],
...
filterCalcSVDStd.logging.debug_level = 10
filterCalcSVDStd.param(param_filterCalcSVDStd)

filterCalcVXDStd = register_module('FilterCalculator')
filterCalcVXDStd.logging.log_level = LogLevel.INFO
filterCalcVXDStd.logging.debug_level = 10
filterCalcVXDStd.param(param_filterCalcVXDStd)


filterCalcVXDStdNew = register_module('SecMapTrainerBase')
...
filterCalcSVDStdNew = register_module('SecMapTrainerBase')
