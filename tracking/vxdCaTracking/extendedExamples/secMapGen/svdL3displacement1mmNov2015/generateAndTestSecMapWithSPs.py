...
if generateSecMap is False:
    secSetupSVD = ['shiftedL3IssueTestSVDStd-moreThan400MeV_SVD',
                   'shiftedL3IssueTestSVDStd-100to400MeV_SVD',
                   'shiftedL3IssueTestSVDStd-25to100MeV_SVD']
    secSetupVXD = ['shiftedL3IssueTestVXDStd-moreThan400MeV_PXDSVD',
...
if useL3Shift:
    gearbox.param('fileName',
                  '../tracking/vxdCaTracking/extendedExamples/secMapGen/svdL3displacement1mmNov2015/Belle2L3Shifted.xml')
...
mctrackfinderSVD = register_module('TrackFinderMCTruth')
...
param_mctrackfinderSVD = {
    ...
    'GFTrackCandidatesColName': 'mcTracksSVD',
}
mctrackfinderSVD.param(param_mctrackfinderSVD)

mctrackfinderVXD = register_module('TrackFinderMCTruth')
...
param_mctrackfinderVXD = {
    ...
    'MinimalNDF': 6,
    'WhichParticles': ['primary'],
    'GFTrackCandidatesColName': 'mcTracksVXD',
}
