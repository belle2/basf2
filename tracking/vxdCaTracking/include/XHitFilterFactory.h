...
namespace Belle2 {
  ...
  public:
    ...
    XHitFilterFactory(double x, double y, double z, double mField = 1.5) :
      m_virtualIP(x, y, z)
    {
    ...
    /// TODO WARNING INFO TODO: 3- and 4-hits, tests.
...
//  {
//    XHitFilterType varType = FilterID::getTypeEnum(variableName);
//    return getResult3Hit(varType, outerHit, centerHit, innerHit);
//  }
//
//
//
...
//  {
//    XHitFilterType varType = FilterID::getTypeEnum(variableName);
//    return getResult4Hit(varType, outerHit, outerCenterHit, innerCenterHit, innerHit);
//  }
//
//
//
