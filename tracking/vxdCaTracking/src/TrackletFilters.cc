...
std::pair<double, TVector3> TrackletFilters::tripletFit(const std::vector<PositionInfo*>* hits, bool useBackwards)
{
  if (hits == NULL) { B2FATAL(" TrackletFilters::tripletFit hits not set, therefore no calculation possible - please check that!"); }
