...
cdctrg.param('TRGCDCDataInputMode', 2)
...
readB2LMain.add_module(geobuilder)
readB2LMain.add_module(cdcdigitizer)
readB2LMain.add_module(evtmetainfo)
readB2LMain.add_module(cdctrg)
