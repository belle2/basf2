...
#ifndef CDCTriggerWireHit_FLAG_
#define CDCTriggerWireHit_FLAG_

#include <string>
#include "CLHEP/Geometry/Point3D.h"

#ifdef CDCTRIGGER_SHORT_NAMES
#define CTWHit CDCTriggerWireHit
#endif
...
class CDCTriggerWireHit {
  ...
  public:
    /// Constructor.
    CDCTriggerWireHit(const CDCTriggerWire &,
		float driftLeft,
...
//  const CDCTriggerWire * const wire(void) const;
    ...
    /// returns a pointer to CDCTriggerWireHitMC.
    const CDCTriggerWireHitMC * const mc(void) const;
  ...
  public:// Modifiers
    ...
    /// sets a pointer to CDCTriggerWireHitMC.
    const CDCTriggerWireHitMC * const mc(CDCTriggerWireHitMC *);

    /// sets sequential length in one segment : this parameter is used in TCurlFinder now.
    unsigned sequence(unsigned) const;

  public:// Static utility functions
    static int sortByWireId(const CDCTriggerWireHit ** a, const CDCTriggerWireHit ** b);
...
#ifdef CDCTriggerWireHit_NO_INLINE
#define inline
#else
#undef inline
#define CDCTriggerWireHit_INLINE_DEFINE_HERE
#endif
...
inline
unsigned
CDCTriggerWireHit::state(void) const {
    return _state;
}

inline
float
CDCTriggerWireHit::drift(unsigned i) const {
...
inline
float
CDCTriggerWireHit::dDrift(unsigned i) const {
...
inline
float
CDCTriggerWireHit::drift(void) const {
    return (_drift[0] + _drift[1]) / 2.;
}

inline
float
CDCTriggerWireHit::dDrift(void) const {
    return (_driftError[0] + _driftError[1]) / 2.;
}

inline
const HepGeom::Point3D<double>  &
CDCTriggerWireHit::xyPosition(void) const {
    return _xyPosition;
}

inline
unsigned
CDCTriggerWireHit::state(unsigned i) {
    return _state = i;
}

inline
unsigned
CDCTriggerWireHit::state(unsigned i) const {
    return _state = i;
}

inline
const void * const
CDCTriggerWireHit::track(void) const {
    return _track;
}

inline
const void * const
CDCTriggerWireHit::track(const void * a) {
    return _track = a;
}

inline
const void * const
CDCTriggerWireHit::track(const void * a) const {
    return _track = a;
}

inline
const CDCTriggerWireHitMC * const
CDCTriggerWireHit::mc(void) const {
    return _mc;
}

inline
const CDCTriggerWireHitMC * const
CDCTriggerWireHit::mc(CDCTriggerWireHitMC * a) {
    return _mc = a;
}

inline
unsigned
CDCTriggerWireHit::sequence(void) const {
    return _sequentialLength;
}

inline
unsigned
CDCTriggerWireHit::sequence(unsigned a) const {
