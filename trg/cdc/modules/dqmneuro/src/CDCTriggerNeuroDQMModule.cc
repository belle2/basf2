      ...
      if (!foundValidRep) {
        ...
        if (!m_limitedoutput) {
          ...
          if (neuroSWTSSW2DTrack) {
            ...
            /* print out event number for outlier z values*/
            cout << endl << endl ;
            cout << "Dump Event " << eventMetaData->getEvent() << endl ;
            cout << " Reco Track:    cosTh " << setw(10) << cosThetaTarget << ", Phi " << setw(10) << phi0Target << ", pt " << setw(
                   10) << invptTarget << ", zTarget = " << setw(10) << zTarget << endl ;
            cout << " Neuro all SW2D cosTh " << setw(10) << cosTh << ", Phi " << setw(10) << phiNeuro << ", pt " << setw(
                   10) << invptNeuro <<  ",  zNeuro = " << setw(10) << neuroSWTSSW2DTrack->getZ0() << endl ;
            if (nhwmatched > 0) {
              cout << " Neuro HW     cosTh " << setw(10) << neuroHWcosTh << ", Phi " << setw(10) << neuroHWPhi0 << ", pt " << setw(
                     10) << neuroHWPt <<  ",  zNeuro = " << setw(10) << neuroSWZ << endl ;
            }
            if (nswmatched > 0) {
              cout << " Neuro SW     cosTh " << setw(10) << neuroSWcosTh << ", Phi " << setw(10) << neuroSWPhi0 << ", pt " << setw(
                     10) << neuroSWPt <<  ",  zNeuro = " << setw(10) << neuroSWZ << endl ;
            }
            if (std::abs(zTarget - neuroSWTSSW2DTrack->getZ0()) > 20.0) {
              cout << " Outlier z from network: zReco = " << zTarget << ", zNeuro = " << neuroSWTSSW2DTrack->getZ0() << endl << endl ;
            }
        ...
        if (finderTrack) {
          ...
          if (neuroSimTrack) {
            ...
            if (nsameTS >= 0) {
              ...
              cout << "Sim Selected TS (SL, quadrant, segment id, relative id in SL,  priority position, left right, priority time, found time, raw Tracker ID)"
                   << endl;
              ...
              /*
              cout << "HW  Selected TS (SL, quadrant, segment id, relative id in SL,  priority position, left right, priority time, found time, raw Tracker ID)"
                   << endl;
