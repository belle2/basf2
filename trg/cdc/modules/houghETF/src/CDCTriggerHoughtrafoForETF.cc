...
unsigned short
CDCTriggerHoughETFModule::countSL(bool* layer)
{
...
bool
CDCTriggerHoughETFModule::shortTrack(bool* layer)
{
  unsigned short lcnt = 0;
...
*/
int
CDCTriggerHoughETFModule::fastInterceptFinder(cdcMap& hits,
...
*/
void
CDCTriggerHoughETFModule::connectedRegions()
{
...
void
CDCTriggerHoughETFModule::addNeighbors(const CDCTriggerHoughCand& center,
...
bool
CDCTriggerHoughETFModule::inList(const CDCTriggerHoughCand& a,
...
bool
CDCTriggerHoughETFModule::connected(const CDCTriggerHoughCand& a,
...
*/
void
CDCTriggerHoughETFModule::mergeIdList(std::vector<unsigned>& merged,
...
void
CDCTriggerHoughETFModule::findAllCrossingHits(std::vector<unsigned>& list,
                                              double x1, double x2,
                                              double y1, double y2,
 ...
 */
void
CDCTriggerHoughETFModule::selectHits(std::vector<unsigned>& list,
...
*/
bool
CDCTriggerHoughETFModule::patternClustering(const cdcMap& inputMap)
{
...
bool
CDCTriggerHoughETFModule::connectedUD(unsigned patternD, unsigned patternU)
{
  // connected if
  // . .      . .
  // x .      . x
...
bool
CDCTriggerHoughETFModule::connectedDiag(unsigned patternLD, unsigned patternRU)
{
...
unsigned
CDCTriggerHoughETFModule::topRightSquare(vector<unsigned>& pattern)
{
...
unsigned
CDCTriggerHoughETFModule::topRightCorner(unsigned pattern)
{
...
unsigned
CDCTriggerHoughETFModule::bottomLeftCorner(unsigned pattern)
{
