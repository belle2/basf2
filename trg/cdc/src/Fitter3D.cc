...
int zz_3_lut[1024];
int iz0den_lut[8192];
int intnum2,numbit2;	//For signed bits for myphi0
int intnum3,numbit3;	//For signed bits for rho
int intnum5,numbit5;	//For signed bits for zz
int intnum6,numbit6;	//For signed bits for rr
int intnum7,numbit7;	//For signed bits for iezz2
int intnum8,numbit8;	//For unsigned iz0den
int intnum9,numbit9;	//For unsigned z0den
int intnum10,numbit10;	//For unsinged z0num_p1
int intnum11,numbit11;	//For unsigned z0num_p2
int kkk;
...
TRGCDCFitter3D::callLUT(){
    ...
    string first,second;
    ifstream f_lut00;
    f_lut00.open("trg/cdc/src/lut00.coe");
    while(1){
    ...
    lutindex=0;
    ifstream f_lut01;
    f_lut01.open("trg/cdc/src/lut01.coe");
    while(1){
	if (lutindex == 4097) break;
    ...
    lutindex=0;
    ifstream f_lut02;
    f_lut02.open("trg/cdc/src/lut02.coe");
    while(1){
	if (lutindex == 4097) break;
    ...
    lutindex=0;
    ifstream f_lut03;
    f_lut03.open("trg/cdc/src/lut03.coe");
    while(1){
	if (lutindex == 4097) break;
    ...
    lutindex=0;
    ifstream f_zz_0_lut;
    f_zz_0_lut.open("trg/cdc/src/zz_0_lut.coe");
    while(1){
    ...
    lutindex=0;
    ifstream f_zz_1_lut;
    f_zz_1_lut.open("trg/cdc/src/zz_1_lut.coe");
    while(1){
	if (lutindex == 1025) break;
    ...
    lutindex=0;
    ifstream f_zz_2_lut;
    f_zz_2_lut.open("trg/cdc/src/zz_2_lut.coe");
    while(1){
	if (lutindex == 1025) break;
    ...
    lutindex=0;
    ifstream f_zz_3_lut;
    f_zz_3_lut.open("trg/cdc/src/zz_3_lut.coe");
    while(1){
	if (lutindex == 1025) break;
    ...
    f_iz0den_lut.open("trg/cdc/src/iz0den_lut.coe");
    while(1){
