  ...
  for (int jj=1;jj<=15;jj+=2){
	...
	if (jj==1 or jj==15 ){
	  if (tt==40){
	    ...
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<" downto "<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3 downto 2);"<<endl;
	    outputp<<" "<<endl;
	  }
	  if (tt!=40 && jj==1){
	    outputp<<"Minus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(0) or patternI_"<<tt-2<<"_"<<jj<<"_B(0);"<<endl;
	    outputp<<"Minus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(1) or patternI_"<<tt-2<<"_"<<jj<<"_B(1);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(2) or patternI_"<<tt-2<<"_"<<jj<<"_B(2);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3) or patternI_"<<tt-2<<"_"<<jj<<"_B(3);"<<endl;
	    outputp<<" "<<endl;
	  }
	  if (tt!=40 && jj==15){
	    outputp<<"Minus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(0) or patternI_"<<tt-2<<"_"<<jj<<"_B(0) or patternI_";
	    outputp<<tt<<"_"<<jj-2<<"_D(0) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(0) or patternI_"<<tt<<"_"<<jj-4<<"_G(0) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(0);"<<endl;
	    outputp<<"Minus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(1) or patternI_"<<tt-2<<"_"<<jj<<"_B(1) or patternI_";
	    outputp<<tt<<"_"<<jj-2<<"_D(1) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(1) or patternI_"<<tt<<"_"<<jj-4<<"_G(1) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(1);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(2) or patternI_"<<tt-2<<"_"<<jj<<"_B(2) or patternI_";
	    outputp<<tt<<"_"<<jj-2<<"_D(2) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(2) or patternI_"<<tt<<"_"<<jj-4<<"_G(2) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(2);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3) or patternI_"<<tt-2<<"_"<<jj<<"_B(3) or patternI_";
	    outputp<<tt<<"_"<<jj-2<<"_D(3) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(3) or patternI_"<<tt<<"_"<<jj-4<<"_G(3) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(3);"<<endl;
	    outputp<<" "<<endl;
	  }
	}
	if (jj>=3 && jj<15){
	  if (jj==3 && tt==40){
	    outputp<<"Minus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(0) or patternI_"<<tt<<"_"<<jj-2<<"_D(0);"<<endl;
	    outputp<<"Minus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(1) or patternI_"<<tt<<"_"<<jj-2<<"_D(1);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(2) or patternI_"<<tt<<"_"<<jj-2<<"_D(2);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3) or patternI_"<<tt<<"_"<<jj-2<<"_D(3);"<<endl;
	  }
	  if (jj==3 && tt!=40){
	    outputp<<"Minus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(0) or patternI_"<<tt-2<<"_"<<jj<<"_B(0) or patternI_"<<tt<<"_"<<jj-2<<"_D(0) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(0);"<<endl;
	    outputp<<"Minus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(1) or patternI_"<<tt-2<<"_"<<jj<<"_B(1) or patternI_"<<tt<<"_"<<jj-2<<"_D(1) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(1);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(2) or patternI_"<<tt-2<<"_"<<jj<<"_B(2) or patternI_"<<tt<<"_"<<jj-2<<"_D(2) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(2);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3) or patternI_"<<tt-2<<"_"<<jj<<"_B(3) or patternI_"<<tt<<"_"<<jj-2<<"_D(3) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(3);"<<endl;
	    outputp<<" "<<endl;
	  }
	  if (jj!=3 && tt==40){
	    outputp<<"Minus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(0) or patternI_"<<tt<<"_"<<jj-2<<"_D(0) or patternI_"<<tt<<"_"<<jj-4<<"_G(0);"<<endl;
	    outputp<<"Minus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(1) or patternI_"<<tt<<"_"<<jj-2<<"_D(1) or patternI_"<<tt<<"_"<<jj-4<<"_G(1);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(2) or patternI_"<<tt<<"_"<<jj-2<<"_D(2) or patternI_"<<tt<<"_"<<jj-4<<"_G(2);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3) or patternI_"<<tt<<"_"<<jj-2<<"_D(3) or patternI_"<<tt<<"_"<<jj-4<<"_G(3);"<<endl;
	    outputp<<" "<<endl;
	  }
	  if (jj!=3 && tt!=40){
	    outputp<<"Minus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(0) or patternI_"<<tt-2<<"_"<<jj<<"_B(0) or patternI_"<<tt<<"_"<<jj-2<<"_D(0) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(0) or patternI_"<<tt<<"_"<<jj-4<<"_G(0) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(0);"<<endl;
	    outputp<<"Minus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(1) or patternI_"<<tt-2<<"_"<<jj<<"_B(1) or patternI_"<<tt<<"_"<<jj-2<<"_D(1) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(1) or patternI_"<<tt<<"_"<<jj-4<<"_G(1) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(1);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt<<"_"<<jj<<"_A(2) or patternI_"<<tt-2<<"_"<<jj<<"_B(2) or patternI_"<<tt<<"_"<<jj-2<<"_D(2) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(2) or patternI_"<<tt<<"_"<<jj-4<<"_G(2) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(2);"<<endl;
	    outputp<<"Minus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt<<"_"<<jj<<"_A(3) or patternI_"<<tt-2<<"_"<<jj<<"_B(3) or patternI_"<<tt<<"_"<<jj-2<<"_D(3) or patternI_"<<tt-2<<"_"<<jj-2<<"_E(3) or patternI_"<<tt<<"_"<<jj-4<<"_G(3) or patternI_"<<tt-2<<"_"<<jj-4<<"_H(3);"<<endl;
	    outputp<<" "<<endl;
	  }
	}
      }
	...
	if (jj==1 or jj==15 ){
	  ...
	  if (tt!=38 && jj==1){
	    outputpp<<"Plus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(0) or patternI_"<<tt+3<<"_"<<jj<<"_B(0);"<<endl;
	    outputpp<<"Plus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(1) or patternI_"<<tt+3<<"_"<<jj<<"_B(1);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(2) or patternI_"<<tt+3<<"_"<<jj<<"_B(2);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(3) or patternI_"<<tt+3<<"_"<<jj<<"_B(3);"<<endl;
	    outputpp<<" "<<endl;
	  }
	  if (tt!=38 && jj==15){
	    outputpp<<"Plus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(0) or patternI_"<<tt+3<<"_"<<jj<<"_B(0) or patternI_";
	    outputpp<<tt+1<<"_"<<jj-2<<"_D(0) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(0) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(0) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(0);"<<endl;
	    outputpp<<"Plus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(1) or patternI_"<<tt+3<<"_"<<jj<<"_B(1) or patternI_";
	    outputpp<<tt+1<<"_"<<jj-2<<"_D(1) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(1) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(1) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(1);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(2) or patternI_"<<tt+3<<"_"<<jj<<"_B(2) or patternI_";
	    outputpp<<tt+1<<"_"<<jj-2<<"_D(2) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(2) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(2) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(2);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(3) or patternI_"<<tt+3<<"_"<<jj<<"_B(3) or patternI_";
	    outputpp<<tt+1<<"_"<<jj-2<<"_D(3) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(3) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(3) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(3);"<<endl;
	    outputpp<<" "<<endl;
	  }
	}
	if (jj>=3 && jj<15){
	  if (jj==3 && tt==38){
	    outputpp<<"Plus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(0) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(0);"<<endl;
	    outputpp<<"Plus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(1) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(1);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(2) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(2);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(3) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(3);"<<endl;
	  }
	  if (jj==3 && tt!=38){
	    outputpp<<"Plus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(0) or patternI_"<<tt+3<<"_"<<jj<<"_B(0) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(0) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(0);"<<endl;
	    outputpp<<"Plus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(1) or patternI_"<<tt+3<<"_"<<jj<<"_B(1) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(1) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(1);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(2) or patternI_"<<tt+3<<"_"<<jj<<"_B(2) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(2) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(2);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(3) or patternI_"<<tt+3<<"_"<<jj<<"_B(3) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(3) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(3);"<<endl;
	    outputpp<<" "<<endl;
	  }
	  if (jj!=3 && tt==38){
	    outputpp<<"Plus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(0) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(0) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(0);"<<endl;
	    outputpp<<"Plus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(1) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(1) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(1);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(2) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(2) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(2);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(3) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(3) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(3);"<<endl;
	    outputpp<<" "<<endl;
	  }
	  if (jj!=3 && tt!=38){
	    outputpp<<"Plus_row"<<jj<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(0) or patternI_"<<tt+3<<"_"<<jj<<"_B(0) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(0) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(0) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(0) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(0);"<<endl;
	    outputpp<<"Plus_row"<<jj<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(1) or patternI_"<<tt+3<<"_"<<jj<<"_B(1) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(1) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(1) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(1) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(1);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt+1<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(2) or patternI_"<<tt+3<<"_"<<jj<<"_B(2) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(2) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(2) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(2) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(2);"<<endl;
	    outputpp<<"Plus_row"<<jj+1<<"("<<tt<<")<=patternI_"<<tt+1<<"_"<<jj<<"_A(3) or patternI_"<<tt+3<<"_"<<jj<<"_B(3) or patternI_"<<tt+1<<"_"<<jj-2<<"_D(3) or patternI_"<<tt+3<<"_"<<jj-2<<"_E(3) or patternI_"<<tt+1<<"_"<<jj-4<<"_G(3) or patternI_"<<tt+3<<"_"<<jj-4<<"_H(3);"<<endl;
	    outputpp<<" "<<endl;
	  }
	}
      }
