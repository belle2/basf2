...
def add_ecl_trigger(path, SourceOfTC=3, ETMConditionDB=True, ConditionDBFAM=True):
    """
    ...
    # select if conditionDB is used for FAM (False: no use, True: use)
    trgeclfam.param('ConditionDBFAM', ConditionDBFAM)
