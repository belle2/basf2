...
void TRGGRLDQMModule::defineHisto()
{
  ...
  h_wc_TSF0 = new TH1F("h_wirecnt_TSF0", "The wire counter from TSF 0", 301, 0, 300);
  h_wc_TSF0->GetXaxis()->SetTitle("Number of wires for TSF 0 input");
  h_wc_TSF1 = new TH1F("h_wirecnt_TSF1", "The wire counter from TSF 1", 301, 0, 300);
  h_wc_TSF1->GetXaxis()->SetTitle("Number of wires for TSF 1 input");
  h_wc_TSF2 = new TH1F("h_wirecnt_TSF2", "The wire counter from TSF 2", 301, 0, 300);
  h_wc_TSF2->GetXaxis()->SetTitle("Number of wires for TSF 2 input");
  h_wc_TSF3 = new TH1F("h_wirecnt_TSF3", "The wire counter from TSF 3", 301, 0, 300);
  h_wc_TSF3->GetXaxis()->SetTitle("Number of wires for TSF 3 input");
  h_wc_TSF4 = new TH1F("h_wirecnt_TSF4", "The wire counter from TSF 4", 301, 0, 300);
  h_wc_TSF4->GetXaxis()->SetTitle("Number of wires for TSF 4 input");
  h_wc_TSF5 = new TH1F("h_wirecnt_TSF5", "The wire counter from TSF 5", 301, 0, 300);
