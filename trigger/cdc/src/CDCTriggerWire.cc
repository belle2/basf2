...
CDCTriggerWire::CDCTriggerWire(unsigned id,
		   unsigned localId,
		   CDCTriggerLayer * l,
		   const P3D & fp,
		   const P3D & bp)
...
// int
// CDCTriggerWire::localIdForPlus(void) const {
...
// int
// CDCTriggerWire::localIdForMinus(void) const {
...
// void
// CDCTriggerWire::wirePosition(float z,
...
int
CDCTriggerWire::localIdDifference(const CDCTriggerWire & a) const {
