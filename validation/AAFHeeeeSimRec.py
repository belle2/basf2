...
<header>
  ...
  <description>This steering file produces 100 non radiative ee->eeee events with AAFH, runs the detector simulation with mixed in background, and performs the standard reconstruction.</description>
</header>
"""
