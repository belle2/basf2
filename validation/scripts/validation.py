...
class Validation:
    ...
    def run_validation(self):
        ...
        self.log.note(
            "Controller: {} ({})".format(
                selected_control.name(), selected_control.description()
            )
        )
        ...
        def handle_waiting_script(script_obj: Script):
            ...
            if script_obj.control.available():
                ...
                if self.quiet:
                    ...
                    print(
                        "Started [{},{}]: {}".format(
                            len(waiting), len(running), script_obj.path
                        )
                    )
    ...
    try:
        ...
        if not validation.dry:
            ...
            if cmd_arguments.send_mails:
                ...
                validation.log.note(
                    "Save mail data to {}".format(validation.get_log_folder())
                )
