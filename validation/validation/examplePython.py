...
hist2d = TH2F("example_2d_histogram", "example_2d_title", 60, -3, 3, 60, -3, 3)
...
teff.GetListOfFunctions().Add(
    TNamed("Description", "Efficiency plot of something")
)
...
graph_err.GetListOfFunctions().Add(
    TNamed("Description", "TGraphErrors plot of something")
)
