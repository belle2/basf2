...
The *VTX-5layer-2026-July-baseline* is considered as the current baseline geometry, updated to match the latest CAD drawings. It supersedes the *VTX-5layer-2025-baseline*.

Currently following geometries are available:

- VTX-5layer-2026-July-baseline
