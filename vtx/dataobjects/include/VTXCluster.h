...
namespace Belle2 {
  ...
  /** The VTX Cluster class
    * This class stores all information about reconstructed VTX clusters
    ...
    */
  class VTXCluster: public RelationsObject {
  public:
     ...
     */
    VTXCluster(VxdID sensorID, float uPosition, float vPosition, float uError,
