...
#include <vtx/dbobjects/VTXSensorInfoPar.h>
...
namespace Belle2 {
  ...
  */
  ...
  class VTXGeometryPar: public VXDGeometryPar {
  public:
    //! Default constructor
    VTXGeometryPar() {}
    /** build support */
    ...
    /** get  sensorInfos */
    std::vector<VTXSensorInfoPar*>& getSensorInfos()  {return m_SensorInfo;}
    /** get  Endflanges */
  ...
  private:
    ...
    std::vector<VTXSensorInfoPar*> m_SensorInfo;
    ...
    /** Height of VTX endflange coutOuts */
    double m_cutOutHeight {0};
    /** Shift of VTX endflange coutOuts */
    double m_cutOutShift {0};
    /** Rphi of VTX endflange coutOuts */
    double m_cutOutRphi {0};
    /** Start Rphi of VTX endflange coutOuts */
    double m_cutOutStartPhi {0};
    /** Delta Rphi of VTX endflange coutOuts */
    double m_cutOutDeltaPhi {0};

    /** Number of VTX carbon tubes */
    int m_nTubes {0};
    /** MinZ of VTX carbon tubes */
    double m_tubesMinZ {0};
    /** MaxZ of VTX carbon tubes */
    double m_tubesMaxZ {0};
    /** MinR of VTX carbon tubes */
    double m_tubesMinR {0};
    /** MaxZ of VTX carbon tubes */
    double m_tubesMaxR {0};
    /** Rphi of VTX carbon tubes */
    double m_tubesRPhi {0};
    /** Start Rphi of VTX carbon tubes */
    double m_tubesStartPhi {0};
    /** Delta Phi of VTX carbon tubes */
