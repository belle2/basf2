...
b2.set_random_seed("Belle II Upgrade")
...
ma.inputMdstList(
    ...
    filelist=["./vtx_mdst_1111540100.root"],
    path=main
)
...
# standard: all tracks except from Kshorts (default is standard_PXD)
vertex.TagV("B0", fitAlgorithm="Rave", trackFindingType="standard", path=main)
