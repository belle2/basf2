...
"""
Plot VTX position estimator payload

Usage: basf2 plotVTXPositionEstimator.py -- --resultdir=results --dbfile=./localdb/database.txt
"""
...
class PlotClusterPositionEstimatorPayload(b2.Module):
    """Plot the VTXClusterPositionEstimator playload """

    def __init__(self, resultdir):
        """Initialize"""
        super().__init__()  # don't forget to call parent constructor
        #: Position estimator payload
        self.position_estimator = Belle2.PyDBObj('VTXClusterPositionEstimatorPar')
