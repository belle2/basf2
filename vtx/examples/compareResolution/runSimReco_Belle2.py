...
#
# This script produces tuples for nominal Belle II with 2 layer PXD and 4 layer
# SVD.
#
# Usage: basf2 runSimReco_Belle2.py -n 2000 -- --gen "dimuon"
##############################################################################
...
rec.add_mc_reconstruction(main, pruneTracks=False)
...
ana.fillParticleList(
    ...
    writeOut=True,
    path=main)
ana.variablesToNtuple('mu+:mu_dimuon', variables=track_variables, filename='belle2_analysis_mu_dimuon.root', path=main)
...
ana.variablesToNtuple(
    ...
    filename='belle2_analysis_dimuons.root',
    path=main)
...
ana.variablesToNtuple(
    ...
    filename='belle2_analysis_{}_all_charged.root'.format(
        args['gen']),
    path=main)
