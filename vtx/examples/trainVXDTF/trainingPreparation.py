...
#
# NOTE: if you want to use PXD you set usePXD=True in this script and useSVD=True and useVTX=False!
...
parser = argparse.ArgumentParser(description='Training sample preparation:\
                                     ...
                                     Usage: basf2 trainingPreparation.py -i dataSample.root -- --enable_selection boolean')
parser.add_argument(
    '--enable_selection',
    dest='use_NoKick',
    action='store_const',
...
# This script is for training of the upgrade vertex detector
usePXD = False
useSVD = False
useVTX = True
...
if useSVD:
    ...
    spCreatorVTX.param('NameOfInstance', 'VTXSpacePointCreator')
    spCreatorVTX.param('SpacePoints', 'VTXSpacePoints')
    path.add_module(spCreatorVTX)
