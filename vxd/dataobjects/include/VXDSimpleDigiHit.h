...
namespace Belle2 {
  ...
  public:
    ...
    VXDSimpleDigiHit(): m_sensorID(0), m_u(0), m_v(0), m_vxdTrueHitPtr(NULL) {}
     ...
     */
    VXDSimpleDigiHit(VxdID sensorID, float u, float v, float sigU, float sigV, const VXDTrueHit* vxdTrueHitPtr, bool statusOfVariance):
      m_sensorID(sensorID), m_u(u), m_v(v), m_sigU(sigU), m_sigV(sigV), m_vxdTrueHitPtr(vxdTrueHitPtr), m_statusOfVariance(statusOfVariance)  {}
    ...
    /** Return  */
    bool isVarianceCorrect() const { return m_statusOfVariance; }
  ...
  protected:
    ...
    bool m_statusOfVariance; /**< set to true if this hit was smeared with the variance set in the recoHit*/


    ClassDef(VXDSimpleDigiHit, 1)
  };
