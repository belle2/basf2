...
namespace Belle2 {
  ...
  /**
  * The Class for Heavy Metal Shield Plane
  */

  class HeavyMetalShieldPlanePar: public TObject {
  public:

    //! Default constructor
    HeavyMetalShieldPlanePar() {}
    //! Constructor using Gearbox
    explicit HeavyMetalShieldPlanePar(const GearDir& content) { read(content); }
  ...
  private:
    ...
    ClassDef(HeavyMetalShieldPlanePar, 5);  /**< ClassDef, must be the last term before the closing {}*/
  };

  /**
  * The Class for Heavy Metal Shield Type
  */

  class HeavyMetalShieldTypePar: public TObject {
  public:

    //! Default constructor
    HeavyMetalShieldTypePar() {}
    //! Constructor using Gearbox
    explicit HeavyMetalShieldTypePar(const GearDir& content) { read(content); }
    //! Read parameters from Gearbox
    void read(const GearDir&);
    //! Get name
    std::string getName(void) const { return m_name; }
    //! Get material name
    std::string getMaterialName(void) const { return m_materialName; }
    //! Get MinPhi in rad
    ...
    //! Get planes
    std::vector<HeavyMetalShieldPlanePar> getPlanes(void) const { return m_planes; }
  ...
  private:
    ...
    //! Planes
    std::vector<HeavyMetalShieldPlanePar> m_planes;

    ClassDef(HeavyMetalShieldTypePar, 5);  /**< ClassDef, must be the last term before the closing {}*/
  };
  ...
  */
  ...
  public:
    ...
    void read(const GearDir&);
    //! Get shields
    std::vector<HeavyMetalShieldTypePar> getShields(void) const { return m_shields; }

  private:
    //! Shields
    std::vector<HeavyMetalShieldTypePar> m_shields;
