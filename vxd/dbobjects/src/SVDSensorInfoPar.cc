...
double SVDSensorInfoPar::getElectronMobility(double E) const
{
...
double SVDSensorInfoPar::getHoleMobility(double E) const
{
...
*/
/*
const TVector3 SVDSensorInfoPar::getVelocity(CarrierType carrier,
...
*/
/*
const TVector3& SVDSensorInfoPar::getLorentzShift(double u, double v) const
{
...
*/
/*
double SVDSensorInfoPar::getLorentzShift(bool uCoordinate, double position) const
{
  if (uCoordinate)
