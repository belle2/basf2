...
namespace Belle2 {
  /** Namespace to provide code needed by both Vertex Detectors, PXD, SVD, VTX and also testbeam telescopes */
  namespace VXD {
    /**
    ...
    public:
       ...
       * @param sensortype Whether to only return the layer IDs for PXD, SVD, VTX or all VXD layers (default)
    ...
    private:
      ...
      /** Set of all VTX layer IDs */
      std::set<Belle2::VxdID> m_vtxLayers;
